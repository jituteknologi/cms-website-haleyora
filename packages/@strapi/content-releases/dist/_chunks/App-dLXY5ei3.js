...
const ReleaseModal = ({
  ...
  const {
    timezoneList,
    systemTimezone = { value: "UTC+00:00-Africa/Abidjan " },
  } = getTimezones(
      ...
      /* @__PURE__ */ jsxRuntime.jsx(formik.Formik, {
        onSubmit: (values) => {
          handleSubmit({
            ...
            scheduledAt: values.isScheduled
              ? getScheduledTimestamp(values)
              : null,
          });
        },
        initialValues: {
                      ...
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.Checkbox,
                        {
                          ...
                          children: /* @__PURE__ */ jsxRuntime.jsx(
                            ...
                            {
                              textColor: values.isScheduled
                                ? "primary600"
                                : "neutral800",
                              fontWeight: values.isScheduled
                                ? "semiBold"
                                : "regular",
                              children: formatMessage({
                              ...
                              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                                ...
                                children: /* @__PURE__ */ jsxRuntime.jsx(
                                  designSystem.DatePicker,
                                  {
                                    ...
                                    required: true,
                                    minDate: dateFnsTz.utcToZonedTime(
                                      /* @__PURE__ */ new Date(),
                                      values.timezone.split("&")[1]
                                    ),
                                  }
                                ),
                              }),
                    ...
                    children: formatMessage(
                      {
                        ...
                        defaultMessage:
                          "{isCreatingRelease, select, true {Continue} other {Save}}",
                      },
                      { isCreatingRelease }
                    ),
                  }
...
const TimezoneComponent = ({ timezoneOptions }) => {
  ...
  const [timezoneList, setTimezoneList] =
    React__namespace.useState(timezoneOptions);
  React__namespace.useEffect(() => {
    if (values.date) {
      const { timezoneList: timezoneList2 } = getTimezones(
      ...
      const updatedTimezone =
        values.timezone &&
        timezoneList2.find(
          (tz) => tz.value.split("&")[1] === values.timezone.split("&")[1]
        );
      if (updatedTimezone) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Combobox, {
    ...
    required: true,
    children: timezoneList.map((timezone) =>
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.ComboboxOption,
        { value: timezone.value, children: timezone.value.replace(/&/, " ") },
        timezone.value
      )
    ),
  });
...
const ReleasesGrid = ({ sectionTitle, releases = [], isError = false }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, {
    gap: 4,
    children: releases.map(({ id, name, scheduledAt, status }) =>
      /* @__PURE__ */ jsxRuntime.jsx(
...
const ReleasesPage = () => {
  ...
  const [releaseModalShown, setReleaseModalShown] =
  ...
  const [createRelease, { isLoading: isSubmittingForm }] =
    index.useCreateReleaseMutation();
  ...
  const totalPendingReleases =
    (isSuccess && response.currentData?.meta?.pendingReleasesCount) || 0;
  const hasReachedMaximumPendingReleases =
    totalPendingReleases >= maximumReleases;
          ...
          children: [
            hasReachedMaximumPendingReleases &&
              /* @__PURE__ */ jsxRuntime.jsx(StyledAlert, {
                marginBottom: 6,
                action: /* @__PURE__ */ jsxRuntime.jsx(v2.Link, {
                ...
                children: formatMessage({
                  ...
                  defaultMessage:
                    "Upgrade to manage an unlimited number of releases.",
                }),
              }),
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.TabGroup, {
              label: formatMessage({
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(
                      helperPlugin.PageSizeURLQuery,
                      {
                        options: ["8", "16", "32", "64"],
                        defaultValue:
                          response?.currentData?.meta?.pagination?.pageSize.toString(),
                      }
                    ),
                    /* @__PURE__ */ jsxRuntime.jsx(
...
const ReleaseDetailsLayout = ({
  ...
  const [publishRelease, { isLoading: isPublishing }] =
    index.usePublishReleaseMutation();
  const toggleNotification = helperPlugin.useNotification();
  const { formatAPIError } = helperPlugin.useAPIErrorHandler();
  const {
  ...
  const scheduledText = isScheduled
    ? formatMessage(
        ...
        },
        {
          ...
          offset: index.getTimezoneOffset(
            release.timezone,
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, {
                permissions: index.PERMISSIONS.publish,
                children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, {
                  size: "S",
                  variant: "default",
...
const ReleaseDetailsBody = () => {
  ...
  const { displayedHeaders, hasI18nEnabled } = runHookWaterfall(
  ...
  if (isLoading || isReleaseLoading) {
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
      children: /* @__PURE__ */ jsxRuntime.jsx(
        helperPlugin.LoadingIndicatorPage,
        {}
      ),
  ...
  if (Object.keys(releaseActions).length === 0) {
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
      children: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.NoContent, {
        content: {
  ...
  const options = hasI18nEnabled
    ? GROUP_BY_OPTIONS
    : GROUP_BY_OPTIONS_NO_LOCALE;
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
    children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
      gap: 8,
      direction: "column",
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(
            designSystem.Flex,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Table.Root, {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsxs(
                    helperPlugin.Table.Content,
                    {
                      children: [
                          ...
                          helperPlugin.Table.Head,
                          {
                            children: [
                              displayedHeaders.map(
                                ({ key: key2, fieldSchema, metadatas, name }) =>
                                  /* @__PURE__ */ jsxRuntime.jsx(
                        ...
                        /* @__PURE__ */ jsxRuntime.jsx(
                          helperPlugin.Table.Body,
                          {
                            children: releaseActions[key].map(
                              (
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.PageSizeURLQuery, {
              defaultValue: releaseMeta?.pagination?.pageSize.toString(),
            }),
            /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.PaginationURLQuery, {
              pagination: {
...
const ReleaseDetailsPage = () => {
  ...
  const [updateRelease, { isLoading: isSubmittingForm }] =
    index.useUpdateReleaseMutation();
  const [deleteRelease, { isLoading: isDeletingRelease }] =
    index.useDeleteReleaseMutation();
  ...
  if (isLoadingDetails) {
    return /* @__PURE__ */ jsxRuntime.jsx(ReleaseDetailsLayout, {
      toggleEditReleaseModal,
      toggleWarningSubmit,
      children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
        children: /* @__PURE__ */ jsxRuntime.jsx(
          helperPlugin.LoadingIndicatorPage,
          {}
        ),
  ...
  const scheduledAt =
    releaseData?.scheduledAt && timezone
      ? dateFnsTz.utcToZonedTime(releaseData.scheduledAt, timezone)
      : null;
  const date = scheduledAt
    ? format__default.default(scheduledAt, "yyyy-MM-dd")
    : null;
