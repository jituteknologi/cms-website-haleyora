...
const axiosBaseQuery = async ({ url, method, data, config }) => {
  try {
    ...
    return {
      ...
      updateReleaseAction: build.mutation({
        ...
        async onQueryStarted(
          { body, params, query: query2, actionPath },
...
const DeleteReleaseActionItem = ({ releaseId, actionId }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, {
    permissions: PERMISSIONS.deleteAction,
    children: /* @__PURE__ */ jsxRuntime.jsx(StyledMenuItem, {
      variant: "danger",
...
const ReleaseActionEntryLinkItem = ({ contentTypeUid, entryId, locale }) => {
  const { formatMessage } = reactIntl.useIntl();
  const collectionTypePermissions = useTypedSelector(
    (state) => state.rbacProvider.collectionTypesRelatedPermissions
  );
  const updatePermissions = contentTypeUid
    ? collectionTypePermissions[contentTypeUid]?.[
        "plugin::content-manager.explorer.update"
      ]
    : [];
  const canUpdateEntryForLocale = Boolean(
    !locale ||
      updatePermissions?.find((permission) =>
...
const Root = ({ children, hasTriggerBorder = false }) => {
  ...
  return (
    ...
    /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, {
      permissions: [...PERMISSIONS.deleteAction, ...PERMISSIONS.update],
      children: /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, {
        children: [
...
const ActionOption = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(FieldWrapper, {
    ...
    children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.FieldLabel, {
      htmlFor: `${name}-${actionType}`,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.VisuallyHidden, {
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.FieldInput, {
            type: "radio",
            id: `${name}-${actionType}`,
            name,
...
const NoReleases = () => {
  const { formatMessage } = reactIntl.useIntl();
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.NoContent, {
    content: {
...
const AddActionToReleaseModal = ({ handleClose, contentTypeUid, entryId }) => {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(formik.Formik, {
        ...
        children: ({ values, setFieldValue }) => {
          return /* @__PURE__ */ jsxRuntime.jsxs(formik.Form, {
            children: [
              releases?.length === 0
                ? /* @__PURE__ */ jsxRuntime.jsx(NoReleases, {})
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          ...
          children: [
            ...
            releases?.map((release) => {
              return /* @__PURE__ */ jsxRuntime.jsxs(
                designSystem.Flex,
                {
                  ...
                  borderWidth: "1px",
                  borderStyle: "solid",
                  borderColor: getReleaseColorVariant(
                    release.actions[0].type,
                    "200"
                  ),
                  overflow: "hidden",
                  hasRadius: true,
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                      ...
                      paddingLeft: 4,
                      paddingRight: 4,
                      background: getReleaseColorVariant(
                        release.actions[0].type,
                        "100"
                      ),
                      width: "100%",
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.Typography,
                        {
                          fontSize: 1,
                          variant: "pi",
                          textColor: getReleaseColorVariant(
                            release.actions[0].type,
                            "600"
                          ),
                          children: formatMessage(
                          ...
                          helperPlugin.CheckPermissions,
                          {
                            ...
                            children: /* @__PURE__ */ jsxRuntime.jsxs(
                              ReleaseActionMenu.Root,
                              {
                                ...
                                children: [
                                  /* @__PURE__ */ jsxRuntime.jsx(
                                    ReleaseActionMenu.EditReleaseItem,
            ...
            /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, {
              permissions: PERMISSIONS.createAction,
        ...
        isModalOpen &&
          /* @__PURE__ */ jsxRuntime.jsx(AddActionToReleaseModal, {
...
const ReleaseAction = ({ ids, model }) => {
  ...
  const releases = response.data?.data;
  const [createManyReleaseActions, { isLoading }] =
    useCreateManyReleaseActionsMutation();
  const handleSubmit = async (values) => {
    const locale = modifiedData.locale;
        ...
        title: formatMessage(
          ...
          },
          {
            entriesAlreadyInRelease:
              response2.data.meta.entriesAlreadyInRelease,
            totalEntries: response2.data.meta.totalEntries,
          }
        ),
        message: response2.data.meta.entriesAlreadyInRelease
          ? notificationMessage
          : "",
      };
                            ...
                            /* @__PURE__ */ jsxRuntime.jsx(
                              designSystem.FieldLabel,
                              {
                                children: formatMessage({
                                  ...
                                  defaultMessage:
                                    "What do you want to do with these entries?",
                                }),
                              }
                            ),
                            /* @__PURE__ */ jsxRuntime.jsx(
...
const useReleasesList = (entryId) => {
  ...
  const listViewData = useTypedSelector(
    (state) => state["content-manager_listView"].data
  );
  ...
  return {
    displayedHeaders: [
      ...displayedHeaders,
      {
        ...
        name: "releasedAt",
        cellFormatter: (props) =>
          /* @__PURE__ */ jsxRuntime.jsx(ReleaseListCell, { ...props }),
      },
    ],
    layout,
  };
...
const ReleaseListCell = ({ id }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
    ...
    children: /* @__PURE__ */ jsxRuntime.jsx(Button, {
      ...
      ref: buttonRef,
      children: /* @__PURE__ */ jsxRuntime.jsxs(ActionWrapper, {
        height: "2rem",
        width: "2rem",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
                ...
                ? formatMessage(
                    {
                      ...
                      defaultMessage:
                        "{number} {number, plural, one {release} other {releases}}",
                    },
                    {
              ...
              visible &&
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Popover, {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx("ul", {
                    children: releases.map(({ id: id2, name }) =>
                      /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.Box,
                        {
                          padding: 3,
                          as: "li",
                          children: /* @__PURE__ */ jsxRuntime.jsx(v2.Link, {
                            href: `/admin/plugins/content-releases/${id2}`,
                            isExternal: false,
                            children: name,
                          }),
                        },
        ...
        return __variableDynamicImportRuntimeHelper(
          /* @__PURE__ */ Object.assign({
            "./translations/en.json": () =>
              Promise.resolve().then(() => require("./en-HrREghh3.js")),
          }),
          `./translations/${locale}.json`
        )
          .then(({ default: data }) => {
            return {
              data: helperPlugin.prefixPluginTranslations(
                data,
                "content-releases"
              ),
              locale,
