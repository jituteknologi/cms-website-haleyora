const en = {
  ...
  "content-manager-edit-view.add-to-release.action-type-label":
  ...
  "content-manager-edit-view.add-to-release.notification.success":
    "Entry added to release",
  "content-manager-edit-view.add-to-release.no-releases-message":
    "No available releases. Open the list of releases and create a new one from there.",
  "content-manager-edit-view.add-to-release.redirect-button":
    "Open the list of releases",
  "content-manager-edit-view.list-releases.title":
  ...
  "content-manager-edit-view.remove-from-release.notification.success":
    "Entry removed from release",
  ...
  "content-manager-list-view.add-to-release.action-type-label":
    "What do you want to do with these entries?",
  "content-manager-list-view.add-to-release.notification.success.title":
    "Successfully added to release.",
  "content-manager-list-view.add-to-release.notification.success.message":
  ...
  "content-manager.list-view.releases-number":
  ...
  "pages.PurchaseRelease.not-available":
  ...
  "header.actions.created.description":
  ...
  "pages.Details.tab.emptyEntries":
  ...
  "page.ReleaseDetails.table.action-published":
    "This entry was <b>{isPublish, select, true {published} other {unpublished}}</b>.",
  "pages.ReleaseDetails.publish-notification-success":
  ...
  "pages.Releases.notification.error.title":
    "Your request could not be processed.",
  "pages.Releases.notification.error.message":
    "Please try again or open another release.",
  ...
  "pages.ReleaseDetails.entry-validation.already-published":
    "Already published",
  "pages.ReleaseDetails.entry-validation.ready-to-publish": "Ready to publish",
  "pages.ReleaseDetails.entry-validation.already-unpublished":
    "Already unpublished",
  "pages.ReleaseDetails.entry-validation.ready-to-unpublish":
    "Ready to unpublish",
  ...
  "pages.ReleaseDetails.header-subtitle.scheduled":
    "Scheduled for {date} at {time} ({offset})",
};
