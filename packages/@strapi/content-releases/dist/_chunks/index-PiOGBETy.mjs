...
const DeleteReleaseActionItem = ({ releaseId, actionId }) => {
  ...
  return /* @__PURE__ */ jsx(CheckPermissions, {
    ...
    children: /* @__PURE__ */ jsx(StyledMenuItem, {
      variant: "danger",
          ...
          return /* @__PURE__ */ jsxs(Form, {
            children: [
                        ...
                        /* @__PURE__ */ jsx(Box, {
                          ...
                          children: /* @__PURE__ */ jsx(SingleSelect, {
                            ...
                            children: releases?.map((release) =>
                              /* @__PURE__ */ jsx(
                                SingleSelectOption,
                                { value: release.id, children: release.name },
                                release.id
                              )
                            ),
                          }),
              ...
              /* @__PURE__ */ jsx(ModalFooter, {
                startActions: /* @__PURE__ */ jsx(Button$1, {
                  onClick: handleClose,
                  variant: "tertiary",
                  name: "cancel",
                  children: formatMessage({
  ...
  return /* @__PURE__ */ jsx(CheckPermissions, {
    ...
    children: /* @__PURE__ */ jsxs(Box, {
      ...
      children: [
        ...
        isModalOpen &&
          /* @__PURE__ */ jsx(AddActionToReleaseModal, {
  ...
  return {
    displayedHeaders: [
      ...displayedHeaders,
      {
        ...
        name: "releasedAt",
        cellFormatter: (props) =>
          /* @__PURE__ */ jsx(ReleaseListCell, { ...props }),
      },
    ],
    layout,
  };
...
const ReleaseListCell = ({ id }) => {
  ...
  return /* @__PURE__ */ jsx(Flex, {
    ...
    children: /* @__PURE__ */ jsx(Button, {
      ...
      ref: buttonRef,
      children: /* @__PURE__ */ jsxs(ActionWrapper, {
        height: "2rem",
        width: "2rem",
        children: [
          /* @__PURE__ */ jsx(Typography, {
      ...
      locales.map((locale) => {
        return __variableDynamicImportRuntimeHelper(
          /* @__PURE__ */ Object.assign({
            "./translations/en.json": () => import("./en-ltT1TlKQ.mjs"),
          }),
