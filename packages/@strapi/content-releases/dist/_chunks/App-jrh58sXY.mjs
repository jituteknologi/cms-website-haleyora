...
import {
  RelativeTime as RelativeTime$1,
  useNotification,
  useAPIErrorHandler,
  useQueryParams,
  useTracking,
...
import {
  g as getTimezoneOffset,
  p as pluginId,
  u as useGetReleasesQuery,
  a as useCreateReleaseMutation,
  P as PERMISSIONS,
  i as isAxiosError,
  b as useGetReleaseQuery,
  c as useUpdateReleaseMutation,
  d as useDeleteReleaseMutation,
  e as usePublishReleaseMutation,
  f as useTypedDispatch,
  h as useGetReleaseActionsQuery,
  j as useUpdateReleaseActionMutation,
  R as ReleaseActionOptions,
  k as ReleaseActionMenu,
  r as releaseApi,
} from "./index-PiOGBETy.mjs";
  ...
  return /* @__PURE__ */ jsxs(Main, {
    ...
    children: [
      /* @__PURE__ */ jsx(HeaderLayout, {
        ...
        primaryAction: /* @__PURE__ */ jsx(CheckPermissions, {
              ...
              ? /* @__PURE__ */ jsxs(Flex, {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx(PaginationURLQuery, {
                      pagination: {
                        pageCount:
                          response?.currentData?.meta?.pagination?.pageCount ||
                          0,
                      },
                    }),
                  ],
...
const ReleaseDetailsBody = () => {
  ...
  if (isLoading || isReleaseLoading) {
    return /* @__PURE__ */ jsx(ContentLayout, {
      children: /* @__PURE__ */ jsx(LoadingIndicatorPage, {}),
    });
  }
  ...
  if (isError || !releaseActions) {
    return /* @__PURE__ */ jsx(ContentLayout, {
      children: /* @__PURE__ */ jsx(AnErrorOccurred, {}),
    });
  }
            ...
            Flex,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(Flex, {
                  role: "separator",
                  "aria-label": key,
                  children: /* @__PURE__ */ jsx(Badge, { children: key }),
                }),
...
const ReleaseDetailsPage = () => {
  ...
  if (isLoadingDetails) {
    return /* @__PURE__ */ jsx(ReleaseDetailsLayout, {
      toggleEditReleaseModal,
      toggleWarningSubmit,
      children: /* @__PURE__ */ jsx(ContentLayout, {
        children: /* @__PURE__ */ jsx(LoadingIndicatorPage, {}),
      }),
    });
  }
  ...
  const scheduledAt =
    releaseData?.scheduledAt && timezone
      ? utcToZonedTime(releaseData.scheduledAt, timezone)
      : null;
