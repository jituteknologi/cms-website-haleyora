...
const index = require("./index-mjWlxKqq.js");
...
const EmptyStateIconWrapper$1 = styled__default.default(designSystem.Box)`
  svg {
    height: ${88 / 16}rem;
  }
`;
...
const EmptyStateIconWrapper = styled__default.default(designSystem.Box)`
  svg {
    height: ${88 / 16}rem;
  }
`;
const CustomGithubButton = styled__default.default(v2.LinkButton)`
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(CustomGithubButton, {
            isExternal: true,
            startIcon: /* @__PURE__ */ jsxRuntime.jsx(icons.Github, {}),
...
`;
const RightSideCloudContainer = styled__default.default(designSystem.Box)`
  position: absolute;
  top: 400px;
  right: 0;
...
`;
const LeftSideCloudContainer = styled__default.default(designSystem.Box)`
  position: absolute;
  top: 150px;
  left: 220px;
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
        padding: 10,
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.GridLayout, {
            children: [
...
exports.App = App;
//# sourceMappingURL=App-Gh4oSOHw.js.map
