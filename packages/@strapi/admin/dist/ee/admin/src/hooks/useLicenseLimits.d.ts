...
declare function useLicenseLimits({ enabled }?: UseLicenseLimitsArgs): {
  license:
    | {
        ...
        features: (
          | import("../../../../shared/contracts/admin").SSOFeature
          | import("../../../../shared/contracts/admin").AuditLogsFeature
          | import("../../../../shared/contracts/admin").ReviewWorkflowsFeature
          | import("../../../../shared/contracts/admin").ContentReleasesFeature
        )[];
    ...
    | undefined;
  getFeature: <T>(
    name: "review-workflows" | "sso" | "audit-logs" | "cms-content-releases"
