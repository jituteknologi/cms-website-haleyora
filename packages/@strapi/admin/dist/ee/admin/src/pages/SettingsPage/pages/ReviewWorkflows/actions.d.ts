...
export declare function setWorkflow({
  workflow,
}: {
...
export declare function setWorkflows({
  workflows,
}: {
  workflows: Workflow[];
}): {
...
export declare function updateStage(
  stageId: number,
...
export declare function updateStagePosition(
  oldIndex: number,
  newIndex: number
): {
  type: string;
...
export declare function setRoles(
