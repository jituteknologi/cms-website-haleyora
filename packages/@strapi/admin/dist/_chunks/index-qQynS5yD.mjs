...
import {
  ...
  TrackingProvider,
  useStrapiApp,
  GuidedTourProvider as GuidedTourProvider$1,
  StrapiAppProvider,
  LibraryProvider,
  ...
  useLibrary,
  useLockScroll,
  GenericInput as GenericInput$1,
  useOverlayBlocker,
  getAPIInnerErrors,
  ...
  PageSizeURLQuery,
  PaginationURLQuery,
  NoPermissions as NoPermissions$1,
...
import {
  ...
  Accordion,
  AccordionToggle,
  AccordionContent as AccordionContent$1,
  KeyboardNavigable,
  BaseLink,
  Popover,
  FocusTrap,
...
import {
  ...
  Json,
  Uid,
  Component as Component$1,
  DynamicZone as DynamicZone$1,
  ArrowLeft,
  PlusCircle,
  Code,
  HeadingOne,
    ...
    children: [
      /* @__PURE__ */ jsxs("head", {
        children: [
          ...
          /* @__PURE__ */ jsx("meta", { name: "bingbot", content: "noindex" }),
          /* @__PURE__ */ jsx("meta", {
            name: "baiduspider",
            content: "noindex",
          }),
...
const [ConfigurationContextProvider, useConfiguration] = createContext$1(
...
const Logo = () => {
  ...
  return /* @__PURE__ */ jsx(Img, {
    src: auth2?.custom?.url || auth2.default,
    "aria-hidden": true,
    alt: "",
  });
};
                  ...
                  children: /* @__PURE__ */ jsxs(Flex, {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsx(PasswordInput$2, {
                        ...
                        endAction: /* @__PURE__ */ jsx(FieldActionWrapper$1, {
                          onClick: (e) => {
                            e.stopPropagation();
...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () => (await import("./Login-Bop3n16U.mjs")).LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () => (await import("./constants-4YpDDDmy.mjs")).FORMS,
    {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx(ContentLayout, {
        children: /* @__PURE__ */ jsx(EmptyStateLayout, {
          action: /* @__PURE__ */ jsx(LinkButton$1, {
            variant: "secondary",
              ...
              /* @__PURE__ */ jsxs(Flex, {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx(Box, {
                    ...
                    paddingBottom: 1,
                    width: pxToRem(250),
                    children: /* @__PURE__ */ jsx(TypographyCenter, {
                      variant: "alpha",
                      as: "h1",
                      id: "usecase-title",
                      children: formatMessage({
...
const AuthenticatedApp = React.lazy(() =>
  import("./AuthenticatedApp-V2Dm6x5Q.mjs")
    .then((n) => n.A)
...
const App$2 = ({
  ...
  const adminPermissions = useEnterprise(
    ...
    async () => (await import("./constants-jWFql0Ju.mjs")).ADMIN_PERMISSIONS_EE,
    {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-jWFql0Ju.mjs")).ROUTES_EE,
    {
      defaultValue: [],
    }
  );
  ...
  return /* @__PURE__ */ jsxs(React.Suspense, {
    fallback: /* @__PURE__ */ jsx(LoadingIndicatorPage, {}),
    children: [
      ...
      /* @__PURE__ */ jsx(ConfigurationProvider, {
        authLogo: {
          default: authLogo,
          custom: {
            url: customAuthLogo ?? "",
        ...
        children: /* @__PURE__ */ jsx(TrackingProvider, {
          ...
          children: /* @__PURE__ */ jsxs(Switch, {
            children: [
              ...
              /* @__PURE__ */ jsx(PrivateRoute, {
                path: "/usecase",
                children: /* @__PURE__ */ jsx(UseCasePage, {}),
              }),
              /* @__PURE__ */ jsx(PrivateRoute, {
                path: "/",
                children: /* @__PURE__ */ jsx(AuthenticatedApp, {}),
              }),
...
const InjectionZone = ({ area, ...props }) => {
  ...
  return /* @__PURE__ */ jsx(Fragment, {
    children: components.map((component) =>
      /* @__PURE__ */ jsx(component.Component, { ...props }, component.name)
    ),
  });
};
const GuidedTourProvider = ({ children }) => {
  const [
    ...
    dispatch,
  ] = React.useReducer(reducer$8, initialState$9, initialiseState);
  ...
  return /* @__PURE__ */ jsx(GuidedTourProvider$1, {
    guidedTourState,
    currentStep,
    setCurrentStep,
...
const Theme = ({ children, themes }) => {
  ...
  return /* @__PURE__ */ jsxs(DesignSystemProvider, {
    ...
    children: [children, /* @__PURE__ */ jsx(GlobalStyle, {})],
  });
};
      ...
      children: /* @__PURE__ */ jsx(LanguageProvider, {
        ...
        children: /* @__PURE__ */ jsx(Theme, {
          ...
          children: /* @__PURE__ */ jsx(QueryClientProvider, {
            client: queryClient,
            children: /* @__PURE__ */ jsx(StrapiAppProvider, {
              getPlugin,
              getAdminInjectedComponents,
              menu,
              plugins,
              ...
              runHookSeries,
              settings,
              children: /* @__PURE__ */ jsx(LibraryProvider, {
                components,
                fields,
                children: /* @__PURE__ */ jsx(CustomFieldsProvider, {
                  customFields,
                  children: /* @__PURE__ */ jsx(
                    AutoReloadOverlayBlockerProvider,
                    {
                      children: /* @__PURE__ */ jsx(OverlayBlockerProvider, {
...
const getFieldName = (stringName) =>
  stringName.split(".").filter((string) => isNaN$1(parseInt(string, 10)));
        ...
        if (min) {
          if (attribute.required) {
            dynamicZoneSchema = dynamicZoneSchema
              .test("min", translatedErrors.min, (value) => {
...
const createYupSchemaAttribute = (type, validations, options2) => {
  ...
  if (type === "json") {
    schema = yup
      .mixed(translatedErrors.json)
      .test("isJSON", translatedErrors.json, (value) => {
        if (options2.isJSONTestDisabled) {
          return true;
        }
  ...
  if (["number", "integer", "float", "decimal"].includes(type)) {
    schema = yup
      .number()
      .transform((cv) => (isNaN$1(cv) ? void 0 : cv))
      .typeError();
  }
  if (type === "biginteger") {
  ...
  return /* @__PURE__ */ jsxs(Dialog, {
    ...
    children: [
      /* @__PURE__ */ jsx(DialogBody, {
        ...
        children: /* @__PURE__ */ jsxs(Flex, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsx(Flex, {
              children: /* @__PURE__ */ jsx(InjectionZoneList, {
      ...
      /* @__PURE__ */ jsx(DialogFooter, {
        startAction: /* @__PURE__ */ jsx(Button, {
...
const Root$1 = ({
  ...
  return /* @__PURE__ */ jsxs(Table$1.Body, {
    children: [
      children,
      /* @__PURE__ */ jsx(DialogConfirmDelete, {
...
const BoldChunk$1 = (chunks) =>
  /* @__PURE__ */ jsx(Typography, { fontWeight: "bold", children: chunks });
    ...
    return /* @__PURE__ */ jsxs(Flex, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Tooltip, {
          ...
          children: /* @__PURE__ */ jsx(TypographyMaxWidth$3, {
            textColor: "danger600",
            variant: "omega",
            fontWeight: "semiBold",
            ellipsis: true,
...
const SelectedEntriesTableContent = ({
  ...
  return /* @__PURE__ */ jsxs(Table$1.Content, {
    children: [
      /* @__PURE__ */ jsxs(Table$1.Head, {
        children: [
          /* @__PURE__ */ jsx(Table$1.HeaderCheckboxCell, {}),
          /* @__PURE__ */ jsx(Table$1.HeaderCell, {
        ...
        children: rows.map((row, index) =>
          /* @__PURE__ */ jsxs(
            Tr,
            {
              children: [
                /* @__PURE__ */ jsx(Td, {
                  children: /* @__PURE__ */ jsx(Table.CheckboxDataCell, {
                    rowId: row.id,
                    index,
                  }),
                }),
...
const BulkActionsRenderer = () => {
  ...
  return /* @__PURE__ */ jsx(Flex, {
    ...
    children: /* @__PURE__ */ jsx(DescriptionComponentRenderer, {
      ...
      children: (actions) =>
        actions.map((action) =>
          /* @__PURE__ */ jsx(BulkActionAction, { ...action }, action.id)
        ),
    }),
  });
};
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      ...
      action.dialog?.type === "dialog"
        ? /* @__PURE__ */ jsx(BulkActionConfirmDialog, {
            ...action.dialog,
            variant: action.variant,
...
const BulkActionModal = ({
  ...
  return /* @__PURE__ */ jsxs(ModalLayout, {
    borderRadius: "4px",
    overflow: "hidden",
    onClose: handleClose,
    labelledBy: id,
...
const CardDragPreview = ({ labelField, isSibling = false }) => {
  return /* @__PURE__ */ jsxs(FieldContainer$1, {
    ...
    children: [
      /* @__PURE__ */ jsxs(Flex, {
        gap: 3,
        children: [
          /* @__PURE__ */ jsx(DragButton$2, {
            alignItems: "center",
            cursor: "all-scroll",
            padding: 3,
            children: /* @__PURE__ */ jsx(Drag, {}),
          }),
          /* @__PURE__ */ jsx(TypographyMaxWidth$2, {
  ...
  return /* @__PURE__ */ jsxs(Flex, {
    ...
    children: [
      /* @__PURE__ */ jsxs(Flex, {
        ...
        width: "100%",
        children: [
          /* @__PURE__ */ jsx(ComboboxWrapper, {
            marginRight: "auto",
            maxWidth: size2 <= 6 ? "100%" : "70%",
            width: "100%",
...
const ListItem = ({ data, index, style }) => {
  ...
  return /* @__PURE__ */ jsxs(RelationItem, {
    ariaDescribedBy,
    canDrag,
    disabled,
    ...
    index,
    name: name2,
    endAction: /* @__PURE__ */ jsx(DisconnectButton, {
...
const RelationItem = ({
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: isDragging
      ? /* @__PURE__ */ jsx(RelationItemPlaceholder, {})
      : /* @__PURE__ */ jsxs(Flex, {
          paddingTop: 2,
          paddingBottom: 2,
          ...
          children: [
            ...
            endAction &&
              /* @__PURE__ */ jsx(Box, { paddingLeft: 4, children: endAction }),
          ],
        }),
  });
};
...
const RelationInputDataManager = ({
  ...
  const componentId = componentUid
    ? get(modifiedData, fieldNameKeys.slice(0, -1))?.id
    : void 0;
  ...
  const currentLastPage = Math.ceil(
    get(initialData, name2, []).length / RELATIONS_TO_DISPLAY
  );
  ...
  return /* @__PURE__ */ jsx(RelationInput, {
    error,
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: /* @__PURE__ */ jsxs(Flex, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(Box, {
          paddingLeft: 4,
          children: /* @__PURE__ */ jsx(DisconnectButton, {
            type: "button",
            children: /* @__PURE__ */ jsx(Icon, { width: "12px", as: Cross }),
          }),
        }),
    ...
    try {
      ...
      const collectionTypeLinksPermissions = await Promise.all(
        collectionTypeSectionLinks.map(({ permissions: permissions2 }) =>
          hasPermissions(allPermissions, permissions2)
        )
      );
...
function LayoutDndProvider({
  ...
  return /* @__PURE__ */ jsx(LayoutDndContext.Provider, {
    value: {
      attributes,
      buttonData,
      goTo,
...
const LinkToCTB = () => {
  ...
  return /* @__PURE__ */ jsx(CheckPermissions, {
    permissions,
    children: /* @__PURE__ */ jsx(LinkButton$2, {
    ...
    children: [
      /* @__PURE__ */ jsxs(Flex, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs(Flex, {
            children: [
              /* @__PURE__ */ jsx(CustomIconButton$2, {
                label: formatMessage(
                  {
                    id: getTranslation(
      ...
      attribute?.type === "component" &&
        /* @__PURE__ */ jsx(ComponentFieldList, {
          componentUid: attribute.component,
        }),
      attribute?.type === "dynamiczone" &&
        /* @__PURE__ */ jsx(DynamicZoneList, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs(CustomFlex, {
          ...
          children: [
            ...
            !isHidden &&
              /* @__PURE__ */ jsx(FieldButtonContent, {
                attribute,
                onEditField,
                onDeleteField,
                children,
...
const RowItemsLayout = ({
  ...
  return /* @__PURE__ */ jsx(DisplayedFieldButton, {
...
const GenericInput = ({
  ...
  switch (type) {
    ...
    case "bool": {
      return /* @__PURE__ */ jsx(ToggleInput, {
        onChange: (e) => {
          ...
          GridItem,
          {
            ...
            children: /* @__PURE__ */ jsx(Select, {
              ...
              children: FIELD_SIZES.map(([value, label]) =>
                /* @__PURE__ */ jsx(Option$1, { value, children: label }, value)
              ),
            }),
          },
          "size"
...
const FormModal = ({
  ...
  return /* @__PURE__ */ jsx(ModalLayout, {
    onClose: onToggle,
    labelledBy: "title",
    children: /* @__PURE__ */ jsxs("form", {
      onSubmit,
      children: [
        /* @__PURE__ */ jsx(ModalHeader, {
          children: /* @__PURE__ */ jsxs(HeaderContainer$1, {
            children: [
        ...
        /* @__PURE__ */ jsx(ModalBody, {
          children: /* @__PURE__ */ jsx(Grid$1, {
            gap: 4,
            children: /* @__PURE__ */ jsx(ModalForm, {
              onMetaChange,
              onSizeChange,
            }),
          }),
        ...
        /* @__PURE__ */ jsx(ModalFooter, {
          ...
          endActions: /* @__PURE__ */ jsx(Button, {
            type: "submit",
            children: formatMessage({
              id: "global.finish",
              defaultMessage: "Finish",
  ...
  produce(state, (draftState) => {
    ...
    switch (action.type) {
      ...
      case "REMOVE_FIELD": {
        ...
        if (
          row.length === 1 ||
          (row.length === 2 && get(row, [1, "name"], "") === "_TEMP_")
        ) {
...
const EditSettingsView = ({
  ...
  const [reducerState, dispatch] = useReducer(reducer$6, initialState$6, () =>
  ...
  return /* @__PURE__ */ jsx(LayoutDndProvider, {
    isContentTypeView,
    attributes,
    modifiedData,
    slug,
        ...
        /* @__PURE__ */ jsxs("form", {
          ...
          children: [
            /* @__PURE__ */ jsx(HeaderLayout, {
              title: formatMessage(
                {
                  ...
                  defaultMessage: `Configure the view - ${upperFirst(
                    modelName
                  )}`,
                },
              ...
              navigationAction: /* @__PURE__ */ jsx(Link$4, {
...
const ComponentCategory = ({
  ...
  return /* @__PURE__ */ jsxs(Accordion, {
    ...
    size: "S",
    children: [
      /* @__PURE__ */ jsx(AccordionToggle, {
        variant,
        title: formatMessage({ id: category, defaultMessage: category }),
        togglePosition: "left",
      }),
      /* @__PURE__ */ jsx(AccordionContent$1, {
        children: /* @__PURE__ */ jsx(Box, {
          paddingTop: 4,
          paddingBottom: 4,
          paddingLeft: 3,
...
const baseHandleConvert = (editor, attributesToSet) => {
  ...
  const entry = Editor$1.above(editor, {
    match: (node) =>
      !Editor$1.isEditor(node) && node.type !== "text" && node.type !== "link",
...
const pressEnterTwiceToExit = (editor) => {
  const nodeEntry = Editor$1.above(editor, {
    match: (node2) =>
      !Editor$1.isEditor(node2) && !["link", "text"].includes(node2.type),
  });
  ...
  if (linkEntry) {
    ...
    if (text !== "" && text !== Editor$1.string(editor, linkPath)) {
      const linkNodeChildrens = Array.from(
        Node.children(editor, linkPath, { reverse: true })
      );
  ...
  ({ link, children, attributes }, forwardedRef) => {
    ...
    const handleSave = (e) => {
      ...
      if (editor.selection && Range.isCollapsed(editor.selection)) {
        const [, parentPath] = Editor$1.parent(
          editor,
...
const handleBackspaceKeyOnList = (editor, event) => {
  ...
  const [currentListItem, currentListItemPath] = Editor$1.parent(
    editor,
    editor.selection.anchor
  );
  const [currentList, currentListPath] = Editor$1.parent(
    editor,
    currentListItemPath
  );
  const isListEmpty =
  ...
  if (isListEmpty) {
    ...
    if (previousEntry && nextEntry) {
      ...
      if (
        !Editor$1.isEditor(previousList) &&
        !isText$1(previousList) &&
        isListNode$1(previousList) &&
        !Editor$1.isEditor(nextList) &&
        !isText$1(nextList) &&
...
const handleEnterKeyOnList = (editor) => {
  ...
  if (isListEmpty) {
    ...
    const isNodeEnd = Editor$1.isEnd(
      editor,
      editor.selection.anchor,
      currentListItemPath
    );
...
const paragraphBlocks = {
  paragraph: {
    ...
    handleEnterKey(editor) {
      ...
      const [fragmentedNode] = Editor$1.parent(
        editor,
...
const BlocksDropdown = () => {
  ...
  const handleSelect = (optionKey) => {
    ...
    const editorIsEmpty =
      ...
      Editor$1.isEmpty(editor, editor.children[0]);
  ...
  React.useEffect(() => {
    if (editor.selection) {
      ...
      const anchorBlockKey = getKeys(blocks).find(
        (blockKey) =>
          !Editor$1.isEditor(selectedNode) &&
...
const DragAndDropElement = ({
  ...
  return /* @__PURE__ */ jsxs(Wrapper$1, {
    ...
    children: [
      ...
      isDragging
        ? /* @__PURE__ */ jsx(CloneDragItem, { dragHandleTopMargin, children })
...
const BlocksContent = ({ placeholder, ariaLabelId }) => {
  ...
  const checkSnippet = (event) => {
    ...
    const [textNode, textNodePath] = Editor$1.node(
      editor,
      editor.selection.anchor.path
    );
...
const modifiers = {
  ...
  strikethrough: {
    ...
    renderLeaf: (children) =>
      /* @__PURE__ */ jsx(StrikeThroughText, { children }),
  },
  code: {
    icon: Code,
...
const withLinks = (editor) => {
  ...
  editor.apply = (operation) => {
    if (operation.type === "insert_node") {
      if (
        !Editor$1.isEditor(operation.node) &&
  ...
  editor.insertText = (text) => {
    if (
      ...
      const selectionIsAtEndOfLink =
        ...
        Point.equals(
          editor.selection.anchor,
          Editor$1.end(editor, linksInSelection[0][1])
        );
            ...
            /* @__PURE__ */ jsxs(TextValidation, {
              ...
              children: [
                availability?.isAvailable
                  ...
                  : /* @__PURE__ */ jsx(ExclamationMarkCircle, {}),
                /* @__PURE__ */ jsx(Typography, {
    ...
    return /* @__PURE__ */ jsxs(EditorAndPreviewWrapper, {
      children: [
        /* @__PURE__ */ jsx(EditorStylesContainer, {
          ...
          children: /* @__PURE__ */ jsx("textarea", { ref: textareaRef }),
        }),
        ...
        /* @__PURE__ */ jsxs(StyledFlex, {
          children: [
            ...
            /* @__PURE__ */ jsxs(MainButtons, {
              children: [
                /* @__PURE__ */ jsx(CustomIconButton$1, {
                  disabled: true,
                  label: "Bold",
                  name: "Bold",
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxs(IconButtonGroup, {
                    children: [
                      ...
                      /* @__PURE__ */ jsx(CustomLinkIconButton, {
                        onClick: () =>
              ...
              children: [
                /* @__PURE__ */ jsxs(Typography, {
                  ...
                  children: [
                    label,
                    required &&
                      /* @__PURE__ */ jsx(TypographyAsterisk, {
                        textColor: "danger600",
                        children: "*",
                      }),
                  ],
...
const Inputs = ({
  ...
  const isRequired = React.useMemo(
    () => get(validations, ["required"], false),
    [validations]
  );
  ...
  if (type === "relation") {
    return (
      ...
      /* @__PURE__ */ jsx(RelationInputDataManager, {
        ...metadatas,
        ...fieldSchema,
        componentUid,
  ...
  return /* @__PURE__ */ jsx(GenericInput$1, {
...
const RepeatableComponent$1 = ({
  ...
  if (componentValueLength === 0) {
    return /* @__PURE__ */ jsx(ComponentInitializer, {
      error: errorMessage,
      isReadOnly,
      onClick: handleClick,
    });
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs(AccordionGroup, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(AccordionFooter, {
            children: /* @__PURE__ */ jsx(Flex, {
              justifyContent: "center",
              height: "48px",
              background: "neutral0",
              children: /* @__PURE__ */ jsx(TextButtonCustom, {
                disabled: isReadOnly,
                onClick: handleClick,
                startIcon: /* @__PURE__ */ jsx(Plus, {}),
                children: formatMessage({
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs(Flex, {
        ...
        children: [
          !isRepeatable &&
            !isInitialized &&
            /* @__PURE__ */ jsx(ComponentInitializer, {
              isReadOnly,
              onClick: handleClickAddNonRepeatableComponentToField,
            }),
          !isRepeatable &&
            isInitialized &&
            /* @__PURE__ */ jsx(NonRepeatableComponent, {
              componentUid,
              isFromDynamicZone,
              isNested,
              name: name2,
          ...
          isRepeatable &&
            /* @__PURE__ */ jsx(RepeatableComponent$1, {
...
const DynamicComponent = ({
  ...
  const accordionActions = !isFieldAllowed
    ? null
    : /* @__PURE__ */ jsxs(ActionsFlex, {
        gap: 0,
        children: [
          /* @__PURE__ */ jsx(IconButtonCustom, {
            noBorder: true,
            label: formatMessage(
              {
  ...
  return /* @__PURE__ */ jsxs(ComponentContainer, {
    ...
    children: [
      /* @__PURE__ */ jsx(Flex, {
        justifyContent: "center",
        children: /* @__PURE__ */ jsx(Rectangle, { background: "neutral200" }),
      }),
      /* @__PURE__ */ jsx(StyledBox, {
        ...
        children: isDragging
          ...
          : /* @__PURE__ */ jsxs(Accordion, {
              ...
              children: [
                /* @__PURE__ */ jsx(AccordionToggle, {
                  startIcon: /* @__PURE__ */ jsx(ComponentIcon, {
                    icon,
...
const AccordionContentRadius = styled(Box)`
  border-radius: 0 0 ${({ theme }) => theme.spaces[1]}
    ...
    ContentManagerEditViewDataManagerContext.Provider,
    {
      ...
      children:
        ...
        (!isCreatingEntry && !initialData.id && !isSingleType)
          ? /* @__PURE__ */ jsx(Main, {
              "aria-busy": "true",
              children: /* @__PURE__ */ jsx(LoadingIndicatorPage, {}),
            })
          : /* @__PURE__ */ jsxs(Fragment, {
              children: [
                !isSaving
...
const Header = ({ allowedActions: { canUpdate, canCreate, canPublish } }) => {
  ...
  const currentContentTypeName = get(
    layout,
    ["info", "displayName"],
    "NOT FOUND"
  );
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      /* @__PURE__ */ jsx(HeaderLayout, {
        ...
        primaryAction,
        subtitle,
        navigationAction: /* @__PURE__ */ jsx(Link$1, {
          startIcon: /* @__PURE__ */ jsx(ArrowLeft, {}),
          onClick: (e) => {
            e.preventDefault();
            goBack();
...
const InformationBoxCE = () => {
  return /* @__PURE__ */ jsxs(Information.Root, {
    children: [
...
const EditViewPage = ({
  ...
  const Information2 = useEnterprise(
    InformationBoxCE,
    async () =>
      (await import("./InformationBoxEE-2joxHMYk.mjs")).InformationBoxEE
  );
  useOnce(() => {
  ...
  return /* @__PURE__ */ jsx(ContentTypeFormWrapper, {
    collectionType,
    slug,
    id,
    origin,
    children: ({
      ...
      return /* @__PURE__ */ jsx(EditViewDataManagerProvider, {
        allowedActions,
        createActionAllowedFields,
        componentsDataStructure,
        contentTypeDataStructure,
                ...
                children: [
                  /* @__PURE__ */ jsx(GridItem, {
                    ...
                    children: /* @__PURE__ */ jsx(Flex, {
                      ...
                      alignItems: "stretch",
                      gap: 6,
                      children: formattedContentTypeLayout.map((row, index) => {
                            ...
                            Box,
                            {
                              children: /* @__PURE__ */ jsx(Grid$1, {
                                ...
                                children: /* @__PURE__ */ jsx(GridItem, {
                                  ...
                                  s: 12,
                                  xs: 12,
                                  children: /* @__PURE__ */ jsx(DynamicZone, {
                                    name: name2,
                                    fieldSchema,
                                    metadatas,
                                    ...restProps,
                          ...
                          children: /* @__PURE__ */ jsxs(Flex, {
                            ...
                            children: [
                              ...
                              allowedActions.canDelete &&
                                !isCreatingEntry &&
                                /* @__PURE__ */ jsx(DeleteLink, { onDelete }),
                            ],
                          }),
                        }),
                      ],
...
const EditViewLayoutManager = ({ layout, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(ProtectedEditViewPage, {
    ...rest,
...
const Settings = ({
  ...
  const sortOptions = useEnterprise(
    sortOptionsCE,
    async () =>
      (await import("./constants-_8pVvG0H.mjs"))
...
const DraggableCard = ({
  ...
  return /* @__PURE__ */ jsxs(FieldWrapper, {
    ...
    children: [
      ...
      !isDragging &&
        isDraggingSibling &&
        /* @__PURE__ */ jsx(CardDragPreview, { isSibling: true, labelField }),
      !isDragging &&
        !isDraggingSibling &&
        /* @__PURE__ */ jsxs(FieldContainer, {
          borderColor: "neutral150",
          background: "neutral100",
          hasRadius: true,
          justifyContent: "space-between",
...
const ListSettingsView = ({ layout, slug }) => {
  ...
  const [{ fieldToEdit, fieldForm, initialData, modifiedData }, dispatch] =
    React.useReducer(reducer$3, initialState$3, () => ({
      ...initialState$3,
      initialData: layout,
      modifiedData: layout,
    }));
...
const Filter = ({ displayedFilters }) => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      ...
      isVisible &&
        /* @__PURE__ */ jsx(FilterPopoverURLQuery, {
          displayedFilters,
          isVisible,
          onToggle: handleToggle,
          source: buttonRef,
        }),
      /* @__PURE__ */ jsx(FilterListURLQuery, {
...
const SingleComponent = ({ content, metadatas }) => {
  ...
  return /* @__PURE__ */ jsx(Tooltip, {
    ...
    children: /* @__PURE__ */ jsx(SingleComponentTypography, {
      textColor: "neutral800",
      ellipsis: true,
      ...
      /* @__PURE__ */ jsx(Menu.Content, {
        children: content.map((item) =>
          /* @__PURE__ */ jsx(
            ...
            {
              disabled: true,
              children: /* @__PURE__ */ jsx(RepeatableComponentTypography, {
                ellipsis: true,
                children: /* @__PURE__ */ jsx(CellValue, {
                  type: mainField.type,
...
const MediaSingle = ({
  ...
  return /* @__PURE__ */ jsx(Tooltip, {
    ...
    children: /* @__PURE__ */ jsx(FileWrapper, { children: fileExtension }),
  });
};
...
const MediaMultiple = ({ content }) => {
  return /* @__PURE__ */ jsx(AvatarGroup, {
...
const RelationSingle = ({ metadatas, content }) => {
  return /* @__PURE__ */ jsx(TypographyMaxWidth$1, {
    textColor: "neutral800",
    ellipsis: true,
    children: /* @__PURE__ */ jsx(CellValue, {
              ...
              children: [
                data.results.map((entry) =>
                  /* @__PURE__ */ jsx(
                    ...
                    {
                      disabled: true,
                      children: /* @__PURE__ */ jsx(TypographyMaxWidth$1, {
                        ellipsis: true,
                        children: /* @__PURE__ */ jsx(CellValue, {
                          type: metadatas.mainField?.type ?? "integer",
                          value: metadatas.mainField?.name
...
const CellContent = ({
  ...
  switch (fieldSchema.type) {
    ...
    default:
      return /* @__PURE__ */ jsx(TypographyMaxWidth, {
        ellipsis: true,
        textColor: "neutral800",
        children: /* @__PURE__ */ jsx(CellValue, {
          type: fieldSchema.type,
          ...
          children: /* @__PURE__ */ jsxs(Flex, {
            ...
            children: [
              /* @__PURE__ */ jsx(CheckPermissions, {
                permissions:
                  permissions2.contentManager?.collectionTypesConfigurations,
                children: /* @__PURE__ */ jsx(LinkButton$3, {
                  size: "S",
                  startIcon: /* @__PURE__ */ jsx(Layer, {}),
                  variant: "secondary",
                  as: NavLink,
...
const ListViewPage = ({
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () =>
      (await import("./constants-jro5nuh2.mjs")).REVIEW_WORKFLOW_COLUMNS_EE,
    {
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } =
        await import("./ReviewWorkflowsColumn-MHXwihX0.mjs");
  ...
  const reviewWorkflowFilter = useEnterprise(
    ...
    async () =>
      (await import("./constants-jro5nuh2.mjs")).REVIEW_WORKFLOW_FILTERS,
    {
  ...
  return /* @__PURE__ */ jsxs(Main, {
    ...
    children: [
      ...
      !canRead &&
        /* @__PURE__ */ jsx(ActionLayout, {
          endActions: /* @__PURE__ */ jsx(InjectionZone, {
      ...
      /* @__PURE__ */ jsx(ContentLayout, {
        children: canRead
          ? /* @__PURE__ */ jsxs(Flex, {
              ...
              alignItems: "stretch",
              children: [
                /* @__PURE__ */ jsxs(Table$1.Root, {
                  rows: data,
                  isLoading,
                  colCount,
                  children: [
                    /* @__PURE__ */ jsx(Table$1.ActionBar, {
                      children: /* @__PURE__ */ jsx(BulkActionsRenderer, {}),
                    }),
                    /* @__PURE__ */ jsxs(Table$1.Content, {
                      children: [
                        /* @__PURE__ */ jsxs(Table$1.Head, {
                          children: [
                            /* @__PURE__ */ jsx(Table$1.HeaderCheckboxCell, {}),
                            ...
                            /* @__PURE__ */ jsx(
                              Table$1.HeaderHiddenActionsCell,
                              {}
                            ),
                          ],
                        }),
                        /* @__PURE__ */ jsx(Table$1.LoadingBody, {}),
                        /* @__PURE__ */ jsx(Table$1.EmptyBody, {
                        ...
                        /* @__PURE__ */ jsx(AutoCloneFailureModal, {
                                      ...
                                      if (hasReviewWorkflows) {
                                        ...
                                        if (name2 === "strapi_assignee") {
                                          return /* @__PURE__ */ jsx(
                                            Td,
                                            {
                                              children: rowData.strapi_assignee
                                                ? /* @__PURE__ */ jsx(
                ...
                /* @__PURE__ */ jsxs(Flex, {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsx(PaginationURLQuery, {
  ...
  return /* @__PURE__ */ jsxs(Switch, {
    children: [
      /* @__PURE__ */ jsx(Route, {
        ...
        render: (props2) =>
          collectionType === "collection-types"
            ? /* @__PURE__ */ jsx(ListViewLayoutManager, { slug, layout })
            : /* @__PURE__ */ jsx(EditViewLayoutManager, { layout, ...props2 }),
      }),
      /* @__PURE__ */ jsx(Route, {
        exact: true,
        path: `${currentPath}/configurations/edit`,
        children: /* @__PURE__ */ jsx(CheckPagePermissions, {
          permissions:
            permissions2.contentManager?.collectionTypesConfigurations,
          children: /* @__PURE__ */ jsx(EditSettingsView, {
            ...
            children: [
              /* @__PURE__ */ jsx(Route, {
                ...
                children: /* @__PURE__ */ jsx(CheckPagePermissions, {
                  permissions:
                    permissions2.contentManager?.collectionTypesConfigurations,
                  children: /* @__PURE__ */ jsx(ListSettingsView, {
              ...
              /* @__PURE__ */ jsx(Route, {
                ...
                exact: true,
                render: (props2) =>
                  /* @__PURE__ */ jsx(EditViewLayoutManager, {
                    layout,
                    ...props2,
                  }),
              }),
...
const ComponentSettingsView = () => {
  const [{ isLoading, data: layout }, dispatch] = React.useReducer(
    reducer$1,
    initialState$1
  );
  const schemas = useTypedSelector(selectSchemas);
  ...
  return /* @__PURE__ */ jsx(CheckPagePermissions, {
...
const NoContentType = () => {
  ...
  return /* @__PURE__ */ jsxs(Main, {
    children: [
      ...
      /* @__PURE__ */ jsx(ContentLayout, {
        children: /* @__PURE__ */ jsx(EmptyStateLayout, {
          action: /* @__PURE__ */ jsx(LinkButton$3, {
            as: NavLink,
            variant: "secondary",
            startIcon: /* @__PURE__ */ jsx(Plus, {}),
...
const NoPermissions = () => {
  ...
  return /* @__PURE__ */ jsxs(Main, {
    children: [
      ...
      /* @__PURE__ */ jsx(ContentLayout, {
        children: /* @__PURE__ */ jsx(NoPermissions$1, {}),
      }),
    ],
  });
};
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs(Layout, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(ModelsContext.Provider, {
            value: { refetchData },
            children: /* @__PURE__ */ jsxs(Switch, {
              children: [
                /* @__PURE__ */ jsx(Route, {
                ...
                /* @__PURE__ */ jsx(Route, {
                  ...
                  children: /* @__PURE__ */ jsx(NoPermissions, {}),
                }),
                /* @__PURE__ */ jsx(Route, {
                  path: "/content-manager/no-content-types",
                  children: /* @__PURE__ */ jsx(NoContentType, {}),
                }),
                /* @__PURE__ */ jsx(Route, {
                  path: "",
...
class StrapiApp {
  ...
  createCustomConfigurations = async () => {
    ...
    if (this.customConfigurations?.theme) {
      ...
      if (lightTheme2) merge(this.configurations.themes.light, lightTheme2);
      if (darkTheme2) merge(this.configurations.themes.dark, darkTheme2);
    }
    ...
    const arrayOfPromises = this.configurations.locales.map((locale) => {
      return __variableDynamicImportRuntimeHelper(
        /* @__PURE__ */ Object.assign({
          "./translations/ar.json": () => import("./ar-jktgflyG.mjs"),
          "./translations/ca.json": () => import("./ca-g_TZ9Gyb.mjs"),
          "./translations/cs.json": () => import("./cs-pnCQlrWo.mjs"),
          "./translations/de.json": () => import("./de-uQFFWv6o.mjs"),
          "./translations/dk.json": () => import("./dk-QgYCviRU.mjs"),
          "./translations/en.json": () => import("./en-LlTBXie5.mjs"),
          "./translations/es.json": () => import("./es-h5dK2UFx.mjs"),
          "./translations/eu.json": () => import("./eu-7yW2eEOy.mjs"),
          "./translations/fr.json": () => import("./fr-I-0ckcEU.mjs"),
          "./translations/gu.json": () => import("./gu-k2JKO75-.mjs"),
          "./translations/he.json": () => import("./he-SUOZnrPI.mjs"),
          "./translations/hi.json": () => import("./hi-eUDhoDjK.mjs"),
          "./translations/hu.json": () => import("./hu-Nw7d3QWI.mjs"),
          "./translations/id.json": () => import("./id-xMqk-8lW.mjs"),
          "./translations/it.json": () => import("./it-rHB9s1La.mjs"),
          "./translations/ja.json": () => import("./ja-WD-v2aCc.mjs"),
          "./translations/ko.json": () => import("./ko-bqCJmLX_.mjs"),
          "./translations/ml.json": () => import("./ml-NdVWq6KA.mjs"),
          "./translations/ms.json": () => import("./ms-gansS54r.mjs"),
          "./translations/nl.json": () => import("./nl--_EbnSVw.mjs"),
          "./translations/no.json": () => import("./no-9cS1N6hE.mjs"),
          "./translations/pl.json": () => import("./pl-3EvXSIl8.mjs"),
          "./translations/pt-BR.json": () => import("./pt-BR-8-G6vaMo.mjs"),
          "./translations/pt.json": () => import("./pt-TrdDLCZ4.mjs"),
          "./translations/ru.json": () => import("./ru-mivqkjAk.mjs"),
          "./translations/sa.json": () => import("./sa-AbTtHezl.mjs"),
          "./translations/sk.json": () => import("./sk-IoQ_DY_j.mjs"),
          "./translations/sv.json": () => import("./sv-SHJ67uau.mjs"),
          "./translations/th.json": () => import("./th-TrS9p5eO.mjs"),
          "./translations/tr.json": () => import("./tr-f8ouRTmt.mjs"),
          "./translations/uk.json": () => import("./uk-x2flwIlG.mjs"),
          "./translations/vi.json": () => import("./vi-BbeHSbqs.mjs"),
          "./translations/zh-Hans.json": () => import("./zh-Hans-eY3IWdFB.mjs"),
          "./translations/zh.json": () => import("./zh-cZop7tV1.mjs"),
        }),
...
//# sourceMappingURL=index-qQynS5yD.mjs.map
