...
import {
  ...
  s as useTypedDispatch,
  a as useAuth,
  t as useUpdateMeMutation,
  v as useIsSSOLockedQuery,
  w as setAppTheme,
...
const ProfilePage = () => {
  ...
  const currentTheme = useTypedSelector(
...
const PreferencesSection = ({ onChange, values, localeNames }) => {
  const { formatMessage } = useIntl();
  const themesToDisplay = useTypedSelector(
...
export { ProfilePage };
//# sourceMappingURL=ProfilePage-Z1dDvamO.mjs.map
