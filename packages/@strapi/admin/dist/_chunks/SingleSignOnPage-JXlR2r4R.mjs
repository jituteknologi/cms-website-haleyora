...
import {
  ...
  W as useGetProviderOptionsQuery,
  X as useUpdateProviderOptionsMutation,
...
const schema = yup.object().shape({
  ...
  defaultRole: yup.mixed().when("autoRegister", (value, initSchema) => {
    return value
      ? initSchema.required(translatedErrors.required)
      : initSchema.nullable();
  }),
  ssoLockedRoles: yup
    .array()
...
//# sourceMappingURL=SingleSignOnPage-JXlR2r4R.mjs.map
