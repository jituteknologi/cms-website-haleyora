...
const it = {
  ...
  "Auth.form.error.confirmed":
    "L'email del tuo account non è stata confermata.",
  "Auth.form.error.email.invalid": "Questa email non è valida.",
  "Auth.form.error.email.provide":
    "Per favore inserisci il tuo nome utente o la tua email.",
  ...
  "Auth.form.error.password.format":
    "La tua password non può contenere il simbolo `$` per più di tre volte.",
  "Auth.form.error.password.local":
    "Questo utente non ha mai impostato una password locale, accedi gentilmente tramite il provider usato durante la creazione dell'account",
  ...
  "Auth.form.register.news.label":
    "Tienimi aggiornato in merito a nuove funzionalità e futuri sviluppi (così facendo accetti {terms} e {policy}).",
  ...
  "HomePage.welcome.congrats.content":
    "Ti sei loggato come primo amministratore. Per scoprire le funzionalità di Strapi,",
  "HomePage.welcome.congrats.content.bold":
    "ti consigliamo di creare la tua prima Collezione.",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "Alcuni ruoli non possono essere eleminati poiché sono associati agli utenti",
  "Roles.ListPage.notification.delete-not-allowed":
    "Un ruolo non può essere eliminato se associato ad utenti",
  "Roles.components.List.empty.withSearch":
    "Nessun ruolo corrisponde alla ricerca ({search})...",
  ...
  "Settings.permissions.category":
    "Impostazioni permessi per la categoria {category}",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "Evento disponibile solo per contenuti con gestione stati Bozza/Pubblicazione abilitati",
  ...
  "Settings.webhooks.list.description":
    "Ricevi notifiche di cambiamenti in POST.",
  ...
  "Users.components.List.empty.withSearch":
    "Nessun utente corrisponde alla ricerca ({search})...",
  ...
  "app.components.DownloadInfo.text":
    "Potrebbe volerci un minuto. Grazie della pazienza.",
  ...
  "app.components.HomePage.community.content":
    "Discuti con i membri del team, i contributori e gli sviluppatori tramite i nostri canali.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Siamo felici di averti come membro della comunità. Siamo costantemente alla ricerca di feedback, quindi sentitevi liberi di inviarci messaggi diretti su ",
  "app.components.HomePage.welcomeBlock.content.again":
    "Speriamo che tu stia facendo progressi sul tuo progetto ... Sentiti libero di leggere l'ultima novità riguardo Strapi. Stiamo dando il massimo per migliorare il prodotto in base al tuo feedback.",
  ...
  "app.components.ImgPreview.hint":
    "Trascina il tuo file in quest'area o {browse} un file da caricare.",
  ...
  "app.components.InstallPluginPage.Download.description":
    "Il download e l'installazione del plugin potrebbero richiedere qualche secondo.",
  "app.components.InstallPluginPage.Download.title": "Scaricando...",
  "app.components.InstallPluginPage.description":
    "Estendi la tua app senza sforzi.",
  ...
  "app.components.LeftMenuLinkContainer.noPluginsInstalled":
    "Nessun plugin ancora installato",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "La funzione autoReload necessità di essere abilitata. Per favore, avvia la app con il comando `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Per ragioni di sicurezza, il plugin puo essere scaricato solo in ambiente di sviluppo.",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Si è verificato un errore durante l'installazione del plugin",
  ...
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "Se non ricevi questo link, contatta l'amministratore.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "La ricezione del link per reimpostare la password potrebbere richiedere qualche secondo.",
  ...
  "components.AutoReloadBlocker.description":
    "Avvia Strapi con uno dei seguenti comandi:",
  "components.AutoReloadBlocker.header":
    "Ricarica funzionalità è richiesto per questo plugin.",
  ...
  "components.Input.error.validation.regex":
    "Questo valore non coincide con la regex.",
  ...
  "components.OverlayBlocker.description":
    "Stai utilizzando una funzionalità che necessita del riavvio del server. Per favore, attendi che il server ritorni attivo.",
  "components.OverlayBlocker.description.serverError":
    "Il server deve essere riavviato, per favore controlla i tuoi log nel terminale.",
  "components.OverlayBlocker.title": "Attendo il riavvio...",
  "components.OverlayBlocker.title.serverError":
    "Il riavvio sta impiegando più del previsto",
  "components.PageFooter.select": "elementi per pagina",
  "components.ProductionBlocker.description":
    "Per ragioni di sicurezza dobbiamo disabilitare questo plugin in altri ambienti.",
  "components.ProductionBlocker.header":
    "Questo plugin è disponibile solo in sviluppo.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Trascina & rilascia file, incolla dagli appunti o {browse}.",
  ...
  "content-manager.EditRelations.title": "Dati relazionali",
  "content-manager.api.id": "API ID",
  "content-manager.components.AddFilterCTA.add": "Filtri",
  "content-manager.components.AddFilterCTA.hide": "Filtri",
  "content-manager.components.DraggableAttr.edit": "Clicca per modificare",
  "content-manager.components.DynamicZone.pick-compo": "Scegli un componente",
  "content-manager.components.DynamicZone.required": "Componente richiesto",
  ...
  "content-manager.components.EmptyAttributesBlock.description":
    "Puoi cambiare le tue impostazioni",
  "content-manager.components.FieldItem.linkToComponentLayout":
    "Modifica impaginazione componente",
  "content-manager.components.FilterOptions.button.apply": "Applica",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Imposta le condizioni da applicare per filtrare gli elementi",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "Filtri",
  "content-manager.components.FiltersPickWrapper.hide": "Nascondi",
  "content-manager.components.LimitSelect.itemsPerPage": "Elementi per pagina",
  "content-manager.components.NotAllowedInput.text":
    "Non hai il permesso di vedere questo campo",
  "content-manager.components.Search.placeholder": "Ricerca elementi...",
  "content-manager.components.Select.draft-info-title": "Stato: Bozza",
  "content-manager.components.Select.publish-info-title": "Stato: Pubblicato",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "Personalizza l'aspetto della schermata di modifica.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "Definisci le impostazioni delle liste di elementi.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "Configura la vista - {name}",
  "content-manager.components.TableDelete.delete": "Elimina tutti",
  "content-manager.components.TableDelete.deleteSelected":
    "Elimina selezionato",
  "content-manager.components.TableEmpty.withFilters":
    "Nessun {contentType} con questi filtri...",
  "content-manager.components.TableEmpty.withSearch":
    "Nessun {contentType} corrispondente alla ricerca ({search})...",
  "content-manager.components.TableEmpty.withoutFilter":
    "Non ci sono {contentType}...",
  "content-manager.components.empty-repeatable":
    "Ancora nessun elemento. Clicca il pulsante sottostante per aggiungerne uno.",
  "content-manager.components.notification.info.maximum-requirement":
    "Hai già raggiunto il massimo numero di campi",
  "content-manager.components.notification.info.minimum-requirement":
    "È stato aggiunto un campo per soddisfare il requisito minimo",
  "content-manager.components.repeatable.reorder.error":
    "Si è verificato un errore durante il riordinamento del campo del componente",
  "content-manager.components.reset-entry": "Azzera elemento",
  "content-manager.components.uid.apply": "applica",
  "content-manager.components.uid.available": "disponibile",
  "content-manager.components.uid.regenerate": "rigenera",
  "content-manager.components.uid.suggested": "suggerito",
  "content-manager.components.uid.unavailable": "non disponibile",
  "content-manager.containers.Edit.Link.Layout": "Configura impaginazione",
  "content-manager.containers.Edit.Link.Model": "Modifica la Collezione",
  "content-manager.containers.Edit.addAnItem": "Aggiungi un elemento...",
  "content-manager.containers.Edit.clickToJump":
    "Clicca per andare all'elemento",
  "content-manager.containers.Edit.delete": "Elimina",
  "content-manager.containers.Edit.delete-entry": "Elimina questo elemento",
  "content-manager.containers.Edit.editing": "Modifica in corso...",
  "content-manager.containers.Edit.information": "Informazioni",
  "content-manager.containers.Edit.information.by": "Da",
  "content-manager.containers.Edit.information.draftVersion": "versione bozza",
  "content-manager.containers.Edit.information.editing": "Modifica",
  "content-manager.containers.Edit.information.lastUpdate": "Aggiornato",
  ...
  "content-manager.containers.Edit.reset": "Azzera",
  "content-manager.containers.Edit.returnList": "Torna alla lista",
  "content-manager.containers.Edit.seeDetails": "Dettagli",
  "content-manager.containers.Edit.submit": "Salva",
  ...
  "content-manager.containers.Home.introduction":
    "Per modificare le voci, visitare il link nel menu di sinistra. Questo plugin non ha un modo per modificare le impostazioni ed è ancora in fase di sviluppo attivo.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Gestisci i tuoi dati attraverso un'interfaccia bella e potente.",
  "content-manager.containers.Home.pluginHeaderTitle": "Gestore Contenuti",
  "content-manager.containers.List.draft": "Bozza",
  ...
  "content-manager.containers.SettingPage.attributes": "Attributi",
  ...
  "content-manager.containers.SettingPage.editSettings.description":
    "Sposta i campi per costruire il layout",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title.description":
    "Scegli quale campo mostrare dell'elemento",
  "content-manager.containers.SettingPage.editSettings.relation-field.description":
    "Scegli il campo da mostrare nelle liste e durante la modifica",
  ...
  "content-manager.containers.SettingPage.listSettings.description":
    "Scegli le opzioni per questa Collezione",
  "content-manager.containers.SettingPage.listSettings.title":
    "Lista (impostazioni)",
  "content-manager.containers.SettingPage.pluginHeaderDescription":
    "Configura le impostazioni specifiche per questa Collezione",
  "content-manager.containers.SettingPage.settings": "Impostazioni",
  "content-manager.containers.SettingPage.view": "Vista",
  "content-manager.containers.SettingViewModel.pluginHeader.title":
    "Gestore Contenuti - {name}",
  "content-manager.containers.SettingsPage.Block.contentType.description":
    "Configura le impostazioni specifiche",
  ...
  "content-manager.containers.SettingsPage.Block.generalSettings.description":
    "Configura le impostazioni di default per le tue Collezioni",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "Configura le impostazioni per tutti i Tipi Collezione e i Gruppi",
  "content-manager.containers.SettingsView.list.subtitle":
    "Configura il layout e la vista per i tuoi tipi Collezione e i gruppi",
  "content-manager.containers.SettingsView.list.title": "Configurazioni vista",
  "content-manager.emptyAttributes.button": "Vai al costruttore di collezioni",
  "content-manager.emptyAttributes.description":
    "Aggiungi il primo campo al tuo Tipo Collezione",
  "content-manager.emptyAttributes.title": "Nessun campo presente",
  "content-manager.error.attribute.key.taken": "Questo valore esiste già",
  "content-manager.error.attribute.sameKeyAndName": "Non possono essere uguali",
  "content-manager.error.attribute.taken":
    "Esiste già un campo con questo nome",
  "content-manager.error.contentTypeName.taken": "Questo nome esiste già",
  "content-manager.error.model.fetch":
    "Si è verificato un errore durante il caricamento dei modelli di configurazione.",
  ...
  "content-manager.error.record.delete":
    "Si è verificato un errore durante la cancellazione dell'elemento.",
  ...
  "content-manager.error.record.update":
    "Si è verificato un errore durante l'aggiornamento dell'elemento.",
  "content-manager.error.records.count":
    "Si è verificato un errore durante il conteggio degli elementi.",
  "content-manager.error.records.fetch":
    "Si è verificato un errore durante il caricamento degli elementi.",
  "content-manager.error.schema.generation":
    "Si è verificato un errore durante la generazione dello schema.",
  "content-manager.error.validation.json": "Non è un JSON",
  "content-manager.error.validation.max": "Il valore è troppo alto.",
  "content-manager.error.validation.maxLength": "Il valore è troppo lungo.",
  "content-manager.error.validation.min": "Il valore è troppo basso.",
  "content-manager.error.validation.minLength": "Il valore è troppo breve.",
  "content-manager.error.validation.minSupMax": "Non può essere superiore",
  "content-manager.error.validation.regex":
    "Il valore non corrisponde alla RegEx.",
  "content-manager.error.validation.required": "Questo valore è richiesto.",
  "content-manager.form.Input.bulkActions": "Abilita azioni in blocco",
  "content-manager.form.Input.defaultSort":
    "Attributo di ordinamento di default",
  "content-manager.form.Input.description": "Descrizione",
  "content-manager.form.Input.description.placeholder":
    "Mostra nome nel profilo",
  "content-manager.form.Input.editable": "Campo modificabile",
  "content-manager.form.Input.filters": "Abilita filtri",
  "content-manager.form.Input.label": "Etichetta",
  "content-manager.form.Input.label.inputDescription":
    "Questo valore sovrascrive l'etichetta mostrata nell'intestazione della tabella",
  "content-manager.form.Input.pageEntries": "Righe per pagina",
  "content-manager.form.Input.pageEntries.inputDescription":
    "Nota: Puoi sovrascrivere questo valore nella pagina delle impostazioni del Tipo Collezione.",
  "content-manager.form.Input.placeholder": "Segnaposto",
  "content-manager.form.Input.placeholder.placeholder":
    "Il mio fantastico valore",
  "content-manager.form.Input.search": "Abilita ricerca",
  "content-manager.form.Input.search.field": "Abilita ricerca su questo campo",
  "content-manager.form.Input.sort.field":
    "Abilita ordinamento su questo campo",
  "content-manager.form.Input.wysiwyg": "Mostra come WYSIWYG",
  "content-manager.global.displayedFields": "Campi visualizzati",
  "content-manager.groups": "Gruppi",
  "content-manager.groups.numbered": "Gruppi ({number})",
  "content-manager.models": "Tipi Collezione",
  "content-manager.models.numbered": "Tipi Collezione ({number})",
  "content-manager.notification.error.displayedFields":
    "Devi avere almeno un campo visualizzato",
  "content-manager.notification.error.relationship.fetch":
    "Si è verificato un errore durante il caricamento della relazione.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Devi avere almeno un attributo con ordinamento abilitato",
  ...
  "content-manager.pageNotFound": "Pagina non trovata",
  "content-manager.permissions.not-allowed.create":
    "Non sei autorizzato a creare documenti",
  "content-manager.permissions.not-allowed.update":
    "Non sei autorizzato a vedere questo documento",
  "content-manager.plugin.description.long":
    "Permette di vedere, modificare e cancellare i dati presenti nel database in modo veloce.",
  "content-manager.plugin.description.short":
    "Permette di vedere, modificare e cancellare i dati presenti nel database in modo veloce.",
  "content-manager.success.record.delete": "Eliminato",
  "content-manager.success.record.publish": "Pubblicato",
  "content-manager.success.record.save": "Salvato",
  "content-manager.success.record.unpublish": "Non pubblicato",
  "content-manager.popUpWarning.warning.publish-question":
    "Vuoi ancora pubblicarlo?",
  "content-manager.popUpwarning.warning.has-draft-relations.button-confirm":
    "Sì, pubblica",
  "form.button.done": "Fatto",
  "global.prompt.unsaved":
    "Sei sicuro di voler lasciare questa pagina? Tutte le modifiche effettuate verranno perse.",
  "notification.contentType.relations.conflict":
    "Questo Tipo di Contenuto ha delle relazioni in conflitto",
  ...
  "notification.permission.not-allowed-read":
    "Non sei abilitato a visualizzare questo documento",
  ...
  "notification.version.update.message":
    "Una nuova versione di Strapi è disponibile!",
...
//# sourceMappingURL=it-rHB9s1La.mjs.map
