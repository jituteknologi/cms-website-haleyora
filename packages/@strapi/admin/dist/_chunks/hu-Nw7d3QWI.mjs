...
const hu = {
  ...
  "Auth.components.Oops.text.admin":
    "Amennyiben ez hiba, kérjük vegye fel a kapcsolatot az adminisztrátorokkal!",
  ...
  "Auth.form.button.login.providers.error":
    "Nem sikerült kapcsolódni a szolgáltatón keresztül",
  ...
  "Auth.form.error.password.format":
    "A jelszó nem tartalmazhatja a `$` szimbólumot többször, mint három.",
  "Auth.form.error.password.local":
    "Ez a felhasználó nem állított be jelszót, kérjük jelentkezzen be szolgáltatón keresztül.",
  ...
  "Auth.form.error.ratelimit":
    "Túl sok próbálkozás, kérjük próbálkozzon újra egy perc múlva.",
  ...
  "Auth.form.forgot-password.email.label.success":
    "Az email-t sikeresen kiküldtük",
  ...
  "Auth.form.password.hint":
    "A jelszónak legalább 8 karaktert, 1 nagybetűt, 1 kisbetűt és 1 számot kell tartalmaznia.",
  "Auth.form.password.show-password": "Jelszó megjelenítése",
  "Auth.form.register.news.label":
    "Értesítést kérek az új funkciókról és javításokról (ezzel elfogadja a {terms} és a {policy}).",
  "Auth.form.register.subtitle":
    "Ez csak az admin oldalra való bejelentkezésre ad lehetőséget. Minden elmentett adat a saját adatbázisaba kerül mentésre.",
  ...
  "HomePage.helmet.title": "Kezdőlap",
  "HomePage.roadmap": "Nézze meg a terveinket",
  "HomePage.welcome.congrats": "Gratulálunk!",
  "HomePage.welcome.congrats.content":
    "Első adminisztrátorként jelentkezett be. Ahhoz, hogy felfedezhesse a Strapi funkcióit,",
  "HomePage.welcome.congrats.content.bold":
    "azt ajánljuk, hogy hozza létre az első tartalomtípust.",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "Egyes szerepkörök nem törölhetők, mivel felhasználókhoz vannak társítva",
  "Roles.ListPage.notification.delete-not-allowed":
    "A felhasználókhoz társított szerepkör nem törölhető",
  "Roles.RoleRow.select-all": "{name} kiválasztása tömeges műveletekhez",
  "Roles.RoleRow.user-count":
    "{number, plural, =0 {# felhasználó} one {# felhasználó} other {# felhasználók}}",
  "Roles.components.List.empty.withSearch":
    "Nincs a keresésnek megfelelő szerepkör ({search})...",
  ...
  "Settings.application.customization.carousel-hint":
    "Változtasd meg az admin panel logóját (Max méret: {dimension}x{dimension}, Max fájlméret: {size}KB)",
  ...
  "Settings.application.customization.modal.tab.label":
    "Hogyan szeretnéd feltölteni az állományaidat?",
  ...
  "Settings.application.customization.modal.upload.file-validation":
    "Max méret: {dimension}x{dimension}, Max méret: {size}KB",
  "Settings.application.customization.modal.upload.error-format":
    "Rossz formátumot töltöttél fel (csak a következő formátumokat fogadja el: jpeg, jpg, png, svg).",
  "Settings.application.customization.modal.upload.error-size":
    "A feltöltött fájl túl nagy (max méret: {dimension}x{dimension}, max fájlméret: {size}KB)",
  ...
  "Settings.application.customization.modal.pending.title":
    "Logó készen áll a feltöltésre",
  "Settings.application.customization.modal.pending.subtitle":
    "Kezeljed a kiválasztott logót a feltöltés előtt",
  ...
  "Settings.permissions.category.plugins":
    "{category} plugin engedélyeinek beállításai",
  ...
  "Settings.permissions.conditions.no-actions":
    "Először választania kell egy műveletet (create, read, update, ...) mielőtt megadja a feltételeket.",
  ...
  "Settings.permissions.select-all-by-permission":
    "Minden {label} hozzáféres kiválasztása",
  "Settings.permissions.select-by-permission":
    "{label} hozzáféres kiválasztása",
  ...
  "Settings.permissions.users.form.sso.description":
    "Ha engedélyezve van (ON), a felhasználók bejelentkezhetnek SSO-n keresztül",
  "Settings.permissions.users.listview.header.subtitle":
    "Minden felhasználó, aki hozzáfér a Strapi adminisztrációs panelhez",
  ...
  "Settings.profile.form.section.experience.clear.select":
    "A kiválasztott felület nyelvének törlése",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "Ez csak a saját felületét jeleníti meg a kiválasztott nyelven.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "A kiválasztás csak az Ön számára módosítja a felület nyelvét. Kérjük, olvassa el ezt a {document}, hogy más nyelveket a csapata számára is elérhetővé tehesse.",
  "Settings.profile.form.section.experience.mode.label": "Felület mód",
  "Settings.profile.form.section.experience.mode.hint":
    "Megjeleníti a felhasználói felületedet a kiválasztott módban.",
  ...
  "Settings.roles.create.description":
    "Határozza meg a szerephezkörhöz biztosított jogokat",
  ...
  "Settings.roles.form.button.users-with-role":
    "{number, plural, =0 {# felhasználó} one {# felhasználó} other {# felhasználók}} ezzel a szereppel",
  ...
  "Settings.sso.description":
    "Konfigurálja az egyszeri bejelentkezés funkció beállításait.",
  "Settings.sso.form.defaultRole.description":
    "Az új hitelesített felhasználót a kiválasztott szerepkörhöz csatolja",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "Nincs megfelelő engedélye az adminisztrátori szerepkörök olvasásához",
  "Settings.sso.form.defaultRole.label": "Alapértelmezett szerepkör",
  "Settings.sso.form.registration.description":
    "Egyszeri bejelentkezéskor, ha nincs fiók, hozzon létre új felhasználót",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "Ez az esemény csak olyan tartalmak esetében létezik, amelyeknél engedélyezve van a Piszkozat/Közzététel rendszer",
  ...
  "Settings.webhooks.to.delete":
    "{webhooksToDeleteLength, plural, one {# elem} other {# elemek}} kiválasztva",
  ...
  "Usecase.notification.success.project-created":
    "A projekt sikeresen létrehozva",
  "Usecase.other": "Egyéb",
  ...
  "Users.components.List.empty.withFilters":
    "Nincs a beállított szűrőknek megfelelő felhasználó..",
  "Users.components.List.empty.withSearch":
    "Nincs a keresének megfelelő felhasználó ({search})...",
  ...
  "admin.pages.MarketPlacePage.offline.subtitle":
    "Csatlakoznia kell az internethez a Strapi Market eléréséhez.",
  ...
  "admin.pages.MarketPlacePage.plugin.tooltip.verified":
    "Bővítmény hitelesítve a Strapi által",
  "admin.pages.MarketPlacePage.plugin.version":
    'Frissítsd a Strapi verziód: "{strapiAppVersion}" erre: "{versionRange}"',
  "admin.pages.MarketPlacePage.plugin.version.null":
    'Nem sikerült ellenőrizni a kompatibilitást a Strapi verzióddal: "{strapiAppVersion}"',
  "admin.pages.MarketPlacePage.plugin.githubStars":
    "Ezt a plugint {starsCount} csillagra jelölték a GitHub-on",
  "admin.pages.MarketPlacePage.plugin.downloads":
    "Ezt a plugint hetente {downloadsCount} alkalommal töltik le",
  "admin.pages.MarketPlacePage.providers": "Szolgáltatók",
  "admin.pages.MarketPlacePage.provider.githubStars":
    "Ezt a szolgáltatót {starsCount} csillagra jelölték a GitHub-on",
  "admin.pages.MarketPlacePage.provider.downloads":
    "Ezt a szolgáltatót hetente {downloadsCount} alkalommal töltik le",
  ...
  "admin.pages.MarketPlacePage.tab-group.label":
    "Strapi pluginek és szolgáltatók",
  "admin.pages.MarketPlacePage.missingPlugin.title": "Hiányzik egy plugin?",
  "admin.pages.MarketPlacePage.missingPlugin.description":
    "Mondd el, milyen pluginra van szükséged, és tájékoztatjuk a közösségi plugin fejlesztőinket, hogy esetleg ötletet meríthessenek belőle!",
  ...
  "app.components.BlockLink.blog.content":
    "Olvassa el a legfrissebb híreket a Strapiról és az ökoszisztémáról.",
  "app.components.BlockLink.code": "Kód példák",
  "app.components.BlockLink.code.content":
    "Tanuljon a közösség által fejlesztett valós projektek segítségével.",
  "app.components.BlockLink.documentation.content":
    "Fedezze fel az alapvető fogalmakat, útmutatókat és utasításokat.",
  "app.components.BlockLink.tutorial": "Oktatóanyagok",
  "app.components.BlockLink.tutorial.content":
    "Kövesse az utasításokat a Strapi használatához és testreszabásához.",
  ...
  "app.components.DownloadInfo.text":
    "Ez eltarthat egy percig. Köszönjük a türelmét.",
  ...
  "app.components.EmptyStateLayout.content-permissions":
    "Nincs megfelelő jogosultsága a tartalomhozhoz",
  "app.components.GuidedTour.CM.create.content":
    "<p>Hozz létre és kezelj minden tartalmat itt a Tartalomkezelőben.</p><p>Például: A Blog weboldal példáját folytatva, írhatsz egy Cikket, mentheted és publikálhatod úgy, ahogy szeretnéd.</p><p>💡 Gyors tipp - Ne felejtsd el publikálni a létrehozott tartalmat.</p>",
  "app.components.GuidedTour.CM.create.title": "⚡️ Tartalom létrehozása",
  "app.components.GuidedTour.CM.success.content":
    "<p>Szuper, még egy lépés van hátra!</p><b>🚀 Lásd a tartalmat működés közben</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    "<p>A Gyűjtemény típusok segítségével több bejegyzést tudsz kezelni, míg az Egy típusok a csak egy bejegyzés kezelésére alkalmasak.</p> <p>Például: Egy Blog weboldalnál a Cikkek lennek egy Gyűjtemény típus, míg a Honlap lenne egy Egy típus.</p>",
  "app.components.GuidedTour.CTB.create.cta.title":
    "Hozz létre egy Gyűjtemény típust",
  "app.components.GuidedTour.CTB.create.title":
    "🧠 Hozz létre első Gyűjtemény típust",
  "app.components.GuidedTour.CTB.success.content":
    "<p>Jól haladsz!</p><b>⚡️ Mit szeretnél megosztani a világgal?</b>",
  "app.components.GuidedTour.CTB.success.title": "1. lépés: Kész ✅",
  "app.components.GuidedTour.apiTokens.create.content":
    "<p>Hozz létre itt egy hitelesítési token-t, és töltsd le az általad létrehozott tartalmat.</p>",
  "app.components.GuidedTour.apiTokens.create.cta.title":
    "API Token generálása",
  "app.components.GuidedTour.apiTokens.create.title":
    "🚀 Lásd a tartalmat működés közben",
  "app.components.GuidedTour.apiTokens.success.content":
    "<p>Lásd a tartalmat működés közben az HTTP kéréssel:</p><ul><li><p>Erre a URL-re: <light>https://'<'YOUR_DOMAIN'>'/api/'<'YOUR_CT'>'</light></p></li><li><p>Ezzel a fejléccel: <light>Authorization: bearer '<'YOUR_API_TOKEN'>'</light></p></li></ul><p>További lehetőségek a tartalommal való interakcióhoz, lásd a <documentationLink>dokumentációt</documentationLink>.</p>",
  ...
  "app.components.GuidedTour.home.CM.title":
    "⚡️ Mire szeretnéd megosztani a világgal?",
  "app.components.GuidedTour.home.CTB.cta.title":
    "Menj a Content type Builder-be",
  "app.components.GuidedTour.home.CTB.title":
    "🧠 Építsd fel a tartalom struktúráját",
  ...
  "app.components.HomePage.community.content":
    "Beszélgessen a csapattagokkal, a közreműködőkkel és a fejlesztőkkel különböző csatornákon.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Gratulálunk! Első rendszergazdaként jelentkezett be. A Strapi által nyújtott funkciók felfedezéséhez javasoljuk, hogy hozza létre első tartalomtípusát!",
  "app.components.HomePage.welcomeBlock.content.again":
    "Reméljük, hogy jól halad a projektje! Olvassa el a Strapi legfrissebb híreit. Visszajelzései alapján mindent megteszünk, hogy javítsuk a terméket.",
  ...
  "app.components.ImgPreview.hint":
    "Húzza a fájlt erre a területre, vagy {browse} a feltöltendő fájlért",
  ...
  "app.components.InstallPluginPage.Download.description":
    "A bővítmény letöltése és telepítése eltarthat néhány másodpercig.",
  "app.components.InstallPluginPage.Download.title": "Letöltés...",
  "app.components.InstallPluginPage.description":
    "Bővítse alkalmazását erőfeszítés nélkül.",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "A bővítmény eltávolítása eltarthat néhány másodpercig.",
  ...
  "app.components.ListPluginsPage.helmet.title": "A bővítmények listája",
  "app.components.Logout.logout": "Kijelentkezés",
  "app.components.Logout.profile": "Profil",
  "app.components.MarketplaceBanner":
    "Fedezze fel a közösség által épített modulokat, és még sok más fantasztikus dolgot, amik segítenek a projekt elindításában.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "Az automatikus újratöltés funkciót engedélyezni kell. Kérjük, indítsa el az alkalmazást ezzel a paranccsal: `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Biztonsági okokból egy plugin csak fejlesztői környezetben tölthető le.",
  ...
  "app.components.Users.MagicLink.connect":
    "Másolja ki és ossza meg ezt a linket, hogy hozzáférést biztosítson ehhez a felhasználóhoz",
  "app.components.Users.MagicLink.connect.sso":
    "Küldje el ezt a linket a felhasználónak. Az első bejelentkezés történhet SSO szolgáltatón keresztül",
  ...
  "app.components.Users.ModalCreateBody.block-title.roles.description":
    "Egy felhasználónak lehet egy, illetve több szerepköre is",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Hiba történt a bővítmény eltávolítása közben",
  "app.containers.App.notification.error.init":
    "Hiba történt az API kérése közben",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "Ha nem kapja meg ezt a linket, forduljon az adminisztrátorhoz.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "Eltarthat néhány percig, amíg megkapja a jelszó-helyreállítási linket.",
  ...
  "app.containers.Users.EditPage.roles-bloc-title":
  ...
  clearLabel,
  "coming.soon":
    "Ez a tartalom jelenleg fejlesztés alatt áll, és néhány héten belül újra elérhető lesz!",
  "component.Input.error.validation.integer":
    "Az értéknek egész számnak kell lennie",
  "components.AutoReloadBlocker.description":
    "Futtassa a Strapit a következő parancsok egyikével:",
  "components.AutoReloadBlocker.header":
    "Ehhez a bővítményhez töltse be újra a funkciót.",
  ...
  "components.FilterOptions.FILTER_TYPES.$startsWithi":
    "ezzel kezdődik (nem nagybetű érzékeny)",
  ...
  "components.NotAllowedInput.text":
    "Nincs jogosultsága a mező megtekintéséhez",
  "components.OverlayBlocker.description":
    "Olyan funkciót használ, amelynek újra kell indítania a szervert. Kérjük, várja meg, amíg a szerver feláll.",
  "components.OverlayBlocker.description.serverError":
    "A szervernek újra kellett volna indulnia, kérjük, ellenőrizze a logokat a terminálban.",
  "components.OverlayBlocker.title": "Újraindításra vár...",
  "components.OverlayBlocker.title.serverError":
    "Az újraindítás a vártnál tovább tart",
  "components.PageFooter.select": "Bejegyzések oldalanként",
  "components.ProductionBlocker.description":
    "Biztonsági okokból le kell tiltanunk ezt a bővítményt más környezetekben.",
  "components.ProductionBlocker.header":
    "Ez a bővítmény csak fejlesztői környezetben érhető el.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Fájlok behúzása, beillesztése a vágólapról vagy {browse}.",
  ...
  "content-manager.ListViewTable.relation-loaded": "A kapcsolatok betöltődtek",
  ...
  "content-manager.components.AddFilterCTA.add": "Szűrők",
  "content-manager.components.AddFilterCTA.hide": "Szűrők",
  "content-manager.components.DragHandle-label": "Húz",
  "content-manager.components.DraggableAttr.edit":
    "Kattintson a szerkesztéshez",
  "content-manager.components.DraggableCard.delete.field": "{item} törlése",
  "content-manager.components.DraggableCard.edit.field": "{item} szerkesztése",
  "content-manager.components.DraggableCard.move.field": "{item} mozgatása",
  "content-manager.components.ListViewTable.row-line": "{number}. sor",
  ...
  "content-manager.components.FieldItem.linkToComponentLayout":
    "Állítsa be az összetevő elrendezését",
  "content-manager.components.FieldSelect.label": "Mező hozzáadása",
  "content-manager.components.FilterOptions.button.apply": "Alkalmaz",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Állítsa be a bejegyzések szűréséhez alkalmazandó feltételeket",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "Szűrők",
  "content-manager.components.FiltersPickWrapper.hide": "Elrejt",
  "content-manager.components.LeftMenu.Search.label": "Tartalomtípus keresése",
  "content-manager.components.LeftMenu.collection-types": "Gyűjteménytípusok",
  "content-manager.components.LeftMenu.single-types": "Egyedülálló típusok",
  ...
  "content-manager.components.NotAllowedInput.text":
    "Nincs jogosultság a mező megtekintéséhez",
  "content-manager.components.RepeatableComponent.error-message":
    "Az összetevő(k) hibát tartalmaz(nak)",
  "content-manager.components.Search.placeholder": "Bejegyzés keresése...",
  "content-manager.components.Select.draft-info-title": "Állapot: Piszkozat",
  "content-manager.components.Select.publish-info-title": "Állapot: Közzétett",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "A szerkesztési nézet megjelenésének testreszabása.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "A listanézet beállításainak megadása.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "A nézet testreszabása - {name}",
  "content-manager.components.TableDelete.delete": "Mindegyik törlése",
  "content-manager.components.TableDelete.deleteSelected":
    "A kiválasztott elem törlése",
  "content-manager.components.TableDelete.label": "{number} elem kiválasztva",
  "content-manager.components.TableEmpty.withFilters":
    "Nincsenek {contentType} az alkalmazott szűrőkkel...",
  "content-manager.components.TableEmpty.withSearch":
    "A megadott kereséssel ({search}) nincs {contentType}...",
  "content-manager.components.TableEmpty.withoutFilter":
    "Nincs {contentType}...",
  "content-manager.components.empty-repeatable":
    "Még nincs elem hozzáadva. Kattintson az alábbi gombra a hozzáadásához.",
  "content-manager.components.notification.info.maximum-requirement":
    "Már elérte a mezők maximális számát",
  "content-manager.components.notification.info.minimum-requirement":
    "A minimális követelménynek megfelelő mezőt hozzáadtuk",
  "content-manager.components.repeatable.reorder.error":
    "Hiba történt az mezők átrendezése közben. Kérjük, próbálja újra",
  "content-manager.components.reset-entry": "Bejegyzés visszaállítása",
  "content-manager.components.uid.apply": "alkalmaz",
  "content-manager.components.uid.available": "Elérhető",
  "content-manager.components.uid.regenerate": "Megújít",
  "content-manager.components.uid.suggested": "javasolt",
  "content-manager.components.uid.unavailable": "Nem érhető el",
  "content-manager.containers.Edit.Link.Layout": "Az elrendezés testreszabása",
  "content-manager.containers.Edit.Link.Model":
    "A gyűjteménytípus szerkesztése",
  "content-manager.containers.Edit.addAnItem": "Elem hozzáadása...",
  "content-manager.containers.Edit.clickToJump":
    "Kattintson a bejegyzésre ugráshoz",
  "content-manager.containers.Edit.delete": "Törlés",
  "content-manager.containers.Edit.delete-entry": "Bejegyzés törlése",
  "content-manager.containers.Edit.editing": "Szerkesztés...",
  "content-manager.containers.Edit.information": "Információ",
  "content-manager.containers.Edit.information.by": "által",
  "content-manager.containers.Edit.information.created": "Létrehozva",
  "content-manager.containers.Edit.information.draftVersion": "piszkozat",
  "content-manager.containers.Edit.information.editing": "Szerkesztés",
  "content-manager.containers.Edit.information.lastUpdate": "Utolsó frissítés",
  "content-manager.containers.Edit.information.publishedVersion":
    "közzétett változat",
  "content-manager.containers.Edit.pluginHeader.title.new":
    "Bejegyzés létrehozása",
  "content-manager.containers.Edit.reset": "Visszaállítás",
  "content-manager.containers.Edit.returnList": "Vissza a listához",
  "content-manager.containers.Edit.seeDetails": "Részletek",
  "content-manager.containers.Edit.submit": "Mentés",
  "content-manager.containers.EditSettingsView.modal-form.edit-field":
    "Mező szerkesztése",
  "content-manager.containers.EditView.add.new-entry": "Bejegyzés hozzáadása",
  "content-manager.containers.EditView.notification.errors": "Az űrlap hibás",
  "content-manager.containers.Home.introduction":
    "A bejegyzések szerkesztéséhez lépjen a bal oldali menüben található hivatkozásra. Ennek a bővítménynek nem módosíthatóak a beállításai, és még mindig aktív fejlesztés alatt áll.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Kezelje bejegyzéseit egy sokoldalú és szép felületen keresztül.",
  "content-manager.containers.Home.pluginHeaderTitle": "Tartalomkezelő",
  "content-manager.containers.List.draft": "Piszkozat",
  "content-manager.containers.List.errorFetchRecords": "Hiba",
  ...
  "content-manager.containers.ListSettingsView.modal-form.edit-label":
    "{fieldName} szerkesztése",
  "content-manager.containers.SettingPage.add.field": "Másik mező beszúrása",
  "content-manager.containers.SettingPage.attributes": "Attribútummezők",
  "content-manager.containers.SettingPage.attributes.description":
    "Attribútumok sorrendjének meghatározása",
  "content-manager.containers.SettingPage.editSettings.description":
    "Húzza a megfelelő helyre a mezőket a végleges megjelenítés kialakításához",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title.description":
    "A bejegyzés megjelenített mezőjének beállítása",
  "content-manager.containers.SettingPage.editSettings.relation-field.description":
    "A megjelenített mező beállítása szerkesztési és listanézetben",
  "content-manager.containers.SettingPage.editSettings.title":
    "Nézet szerkesztése (beállítások)",
  "content-manager.containers.SettingPage.layout": "Elrendezés",
  "content-manager.containers.SettingPage.listSettings.description":
    "Konfigurálja a beállításokat ehhez a gyűjteménytípushoz",
  "content-manager.containers.SettingPage.listSettings.title":
    "Lista nézet (beállítások)",
  "content-manager.containers.SettingPage.pluginHeaderDescription":
    "Gyűjteménytípus speciális beállításainak megadása",
  "content-manager.containers.SettingPage.settings": "Beállítások",
  "content-manager.containers.SettingPage.view": "Nézet",
  "content-manager.containers.SettingViewModel.pluginHeader.title":
    "Tartalom kezelő - {name}",
  ...
  "content-manager.containers.SettingsPage.Block.generalSettings.description":
    "A gyűjteménytípusok alapértelmezett beállításainak testreszabása",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "Az összes gyűjteménytípus és csoport beállításainak testreszabása",
  "content-manager.containers.SettingsView.list.subtitle":
    "A gyűjteménytípusok és csoportok elrendezésének és megjelenítésének testreszabása",
  ...
  "content-manager.edit-settings-view.link-to-ctb.components":
    "Komponensek szerkesztése",
  "content-manager.edit-settings-view.link-to-ctb.content-types":
    "Tartalomtípusok szerkesztése",
  "content-manager.emptyAttributes.button":
    "Ugrás a gyűjteménytípus-készítőhöz",
  "content-manager.emptyAttributes.description":
    "Adja hozzá az első mezőt a gyűjtemény típusához",
  "content-manager.emptyAttributes.title": "Még nincsenek mezők",
  "content-manager.error.attribute.key.taken": "Ez az érték már létezik",
  "content-manager.error.attribute.sameKeyAndName": "Nem lehetnek egyenlők",
  "content-manager.error.attribute.taken": "Ez a mezőnév már létezik",
  "content-manager.error.contentTypeName.taken": "Ez a név már létezik",
  "content-manager.error.model.fetch":
    "Hiba történt a modellek konfigurációjának lekérése során.",
  "content-manager.error.record.create":
    "Hiba történt a rekord létrehozása közben.",
  "content-manager.error.record.delete":
    "Hiba történt a rekord törlése közben.",
  "content-manager.error.record.fetch": "Hiba történt a rekord lekérése során.",
  "content-manager.error.record.update":
    "Hiba történt a rekord frissítése közben.",
  "content-manager.error.records.count":
    "Hiba történt a rekordok számának lekérése közben.",
  "content-manager.error.records.fetch":
    "Hiba történt a rekordok lekérése közben.",
  "content-manager.error.schema.generation":
    "Hiba történt a séma létrehozása során.",
  "content-manager.error.validation.json": "Nem megfelelő JSON formátum",
  "content-manager.error.validation.max": "A megadott érték túl magas.",
  "content-manager.error.validation.maxLength": "A megadott érték túl hosszú.",
  "content-manager.error.validation.min": "A megadott érték túl alacsony.",
  "content-manager.error.validation.minLength": "A megadott érték túl rövid.",
  "content-manager.error.validation.minSupMax": "Nem lehet magasabb",
  "content-manager.error.validation.regex": "A megadott érték nem megfelelő.",
  "content-manager.error.validation.required": "Az érték megadása kötelező.",
  "content-manager.form.Input.bulkActions": "Tömeges művelet engedélyezése",
  "content-manager.form.Input.defaultSort":
    "Alapértelmezett rendezési attribútum",
  "content-manager.form.Input.description": "Leírás",
  "content-manager.form.Input.description.placeholder":
    "Megjelenítési név a profilban",
  "content-manager.form.Input.editable": "Szerkeszthető mező",
  "content-manager.form.Input.filters": "Szűrők engedélyezése",
  "content-manager.form.Input.label": "Címke",
  "content-manager.form.Input.label.inputDescription":
    "Ez az érték felülírja a táblázat fejlécében megjelenő címkét",
  "content-manager.form.Input.pageEntries": "Bejegyzések oldalanként",
  "content-manager.form.Input.pageEntries.inputDescription":
    "Megjegyzés: Ezt az értéket felülírhatja a Gyűjteménytípus beállításainak oldalán.",
  "content-manager.form.Input.placeholder": "Helykitöltő",
  "content-manager.form.Input.placeholder.placeholder": "Alapérték",
  "content-manager.form.Input.search": "Keresés engedélyezése",
  "content-manager.form.Input.search.field":
    "Keresés engedélyezése ezen a mezőn",
  "content-manager.form.Input.sort.field":
    "Rendezés engedélyezése ezen a mezőn",
  "content-manager.form.Input.sort.order": "Alapértelmezett rendezési sorrend",
  "content-manager.form.Input.wysiwyg": "Megjelenítés, mint WYSIWYG",
  "content-manager.global.displayedFields": "Megjelenített mezők",
  "content-manager.groups": "Csoportok",
  "content-manager.groups.numbered": "Csoportok ({number})",
  "content-manager.header.name": "Tartalom",
  "content-manager.link-to-ctb": "Modell szerkesztése",
  "content-manager.models": "Gyűjteménytípusok",
  "content-manager.models.numbered": "Gyűjteménytípusok ({number})",
  "content-manager.notification.error.displayedFields":
    "Legalább egy megjelenített mezőre szükség van",
  "content-manager.notification.error.relationship.fetch":
    "Hiba történt a kapcsolat lekérése során.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Legalább egy attribútumnak rendezhetőnek kell lennie",
  "content-manager.notification.info.minimumFields":
    "Legalább egy mezőt meg kell jeleníteni",
  "content-manager.notification.upload.error":
    "Hiba történt a fájlok feltöltése közben",
  "content-manager.pageNotFound": "Az oldal nem található",
  "content-manager.pages.ListView.header-subtitle":
    "{number, plural, =0 {# bejegyzés} one {# bejegyzés} other {# bejegyzés}} található",
  "content-manager.pages.NoContentType.button": "Tartalomtípus létrehozása",
  "content-manager.pages.NoContentType.text":
    "Még nincs tartalom, javasoljuk, hogy hozza létre az első tartalomtípust.",
  "content-manager.permissions.not-allowed.create":
    "Nem hozhat létre dokumentumot",
  "content-manager.permissions.not-allowed.update":
    "Ezt a dokumentumot nem tekintheti meg",
  "content-manager.plugin.description.long":
    "Gyors mód az adatbázisban lévő adatok megtekintéséhez, szerkesztéséhez és törléséhez.",
  "content-manager.plugin.description.short":
    "Gyors mód az adatbázisban lévő adatok megtekintéséhez, szerkesztéséhez és törléséhez.",
  "content-manager.popover.display-relations.label":
  ...
  "content-manager.popUpwarning.warning.has-draft-relations.message":
    "<b>{count, plural, one { reláció még nincs } other { reláció még nincs } }</b> publikálva, és nem várt viselkedést okozhat.",
  ...
  "global.plugins.content-manager.description":
    "Gyors módja annak, hogy megtekintse, szerkesztse és törölje az adatokat az adatbázisában.",
  "global.plugins.content-type-builder": "Tartalomtípus-építő",
  "global.plugins.content-type-builder.description":
    "Modellezze az API adatszerkezetét. Hozzon létre új mezőket és relationokat csak egy perc alatt. A fájlok automatikusan létrehozódnak és frissülnek a projektjében.",
  "global.plugins.email": "E-mail",
  "global.plugins.email.description":
    "Állítsa be az alkalmazást, hogy e-maileket küldjön.",
  ...
  "global.plugins.graphql.description":
    "GraphQL végpont hozzáadása alapértelmezett API metódusokkal.",
  "global.plugins.documentation": "Dokumentáció",
  "global.plugins.documentation.description":
    "OpenAPI Dokumentum létrehozása és API megjelenítése SWAGGER UI-val.",
  "global.plugins.i18n": "Nemzetköziítés",
  "global.plugins.i18n.description":
    "Ez a plugin lehetővé teszi különböző nyelveken történő tartalom létrehozását, olvasását és frissítését, tanto az Admin Panelból, mint az API-ból.",
  "global.plugins.sentry": "Sentry",
  "global.plugins.sentry.description":
    "Strapi hibaesemények küldése a Sentry-be.",
  "global.plugins.users-permissions": "Szerepek & Engedélyek",
  "global.plugins.users-permissions.description":
    "API védelme teljes hitelesítési folyamattal JWT alapján. Ez a plugin egyúttal olyan ACL stratégiát is tartalmaz, amely lehetővé teszi a felhasználói csoportok közötti engedélyek kezelését.",
  "global.profile": "Profil",
  "global.prompt.unsaved":
    "Biztos, hogy elhagyja ezt az oldalt? Az összes módosítása elveszik",
  ...
  "notification.contentType.relations.conflict":
    "A tartalomtípusnak ellenkező kapcsolatai vannak",
  ...
  "notification.error.tokennamenotunique":
    "Név már hozzárendelve egy másik tokenhez",
...
//# sourceMappingURL=hu-Nw7d3QWI.mjs.map
