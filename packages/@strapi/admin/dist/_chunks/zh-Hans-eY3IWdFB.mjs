...
const zhHans = {
  ...
  "Auth.form.password.hint":
    "必须至少8个字符,包含1个大写字母,1个小写字母和1个数字",
  "Auth.form.password.show-password": "显示密码",
  "Auth.form.register.news.label":
    "关于新功能和即将到来的改进保持更新(这样做即表示您接受{terms}和{policy})。",
  "Auth.form.register.subtitle":
    "凭证仅用于在Strapi中进行身份验证。所有保存的数据都将存储在您的数据库中。",
  ...
  "Settings.apiTokens.createPage.permissions.header.hint":
    "选择应用程序的操作或插件的操作,然后单击齿轮图标以显示绑定的路由",
  ...
  "Settings.application.customization.carousel-hint":
    "更改管理面板logo(最大尺寸:{dimension}x{dimension},最大文件大小:{size}KB)",
  ...
  "Settings.application.customization.modal.upload.error-size":
    "上传的文件太大(最大尺寸:{dimension}x{dimension},最大文件大小:{size}KB)",
  "Settings.application.customization.modal.upload.file-validation":
    "最大尺寸:{dimension}x{dimension},最大大小:{size}KB",
  ...
  "Settings.permissions.auditLogs.entry.create":
    "创建条目{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.entry.delete":
    "删除条目{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.entry.publish":
    "发布条目 {model, select, undefined {} other {({model})}}",
  "Settings.permissions.auditLogs.entry.unpublish":
    "取消发布条目{model, select, undefined {} other { ({model})}}",
  "Settings.permissions.auditLogs.entry.update":
    "更新条目{model, select, undefined {} other { ({model})}}",
  ...
  "Settings.review-workflows.page.title": "审阅工作流程",
  "Settings.review-workflows.page.subtitle":
    "{count, plural, one {# 阶段} other {# 阶段}}",
  "Settings.review-workflows.page.isLoading": "工作流正在加载",
  "Settings.review-workflows.page.delete.confirm.body":
    "分配给已删除阶段的所有条目将移动到上一阶段。您确定要保存吗?",
  "Settings.review-workflows.stage.name.label": "阶段名称",
  ...
  "Settings.roles.form.button.users-with-role":
    "{number, plural, =0 {无用户} one {1个用户} other {#个用户}}拥有此角色",
  ...
  "Settings.webhooks.to.delete":
    "选择了 {webhooksToDeleteLength, plural, one {# 个webhook} other {# 个webhooks}}",
  ...
  "app.components.GuidedTour.CM.create.content":
    "<p>在此处的内容管理器中创建和管理所有内容。</p><p>例如:进一步考虑博客网站的例子,可以根据喜好编写、保存和发布文章。</p><p>💡 快速提示 — 不要忘记发布您创建的内容。</p>",
  "app.components.GuidedTour.CM.create.title": "⚡️ 创建内容",
  "app.components.GuidedTour.CM.success.content":
    "<p>太棒了,还剩最后一步!</p><b>🚀 查看实际内容</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    "<p>集合类型有助于管理多个条目,单个类型适合管理仅一个条目。</p> <p>例如:对于博客网站,文章将是集合类型,而首页将是单个类型。</p>",
  ...
  "app.components.GuidedTour.apiTokens.success.content":
    "<p>通过发出HTTP请求查看实际内容:</p><ul><li><p>网址: <light>https://'<'YOUR_DOMAIN'>'/api/'<'YOUR_CT'>'</light></p></li><li><p>标头: <light>Authorization: bearer '<'YOUR_API_TOKEN'>'</light></p></li></ul><p>有关与内容交互的更多方式,请参阅<documentationLink>文档</documentationLink>。</p>",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "恭喜您!您已登录为第一个管理员。为了发现Strapi提供的强大功能,我们建议您创建您的第一个内容类型!",
  "app.components.HomePage.welcomeBlock.content.again":
    "我们希望您在项目上取得进展!请随时阅读关于Strapi的最新新闻。我们正根据您的反馈尽最大努力改进产品。",
  ...
  "app.components.MarketplaceBanner":
    "在Strapi市场上发现社区构建的插件,以及许多其他很酷的东西来启动您的项目。",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "需要启用autoReload功能。请使用 yarn develop 启动您的应用程序。",
  ...
  "content-manager.components.DynamicZone.missing-components":
    "缺少 {number, plural, =0 {# 个组件} other {# 个组件}}",
  ...
  "content-manager.containers.Home.introduction":
    "要编辑条目,请转到左侧菜单中的特定链接。此插件没有适当的方式来编辑设置,它仍在积极开发中。",
  ...
  "content-manager.containers.ListPage.displayedFields": "显示的字段",
  "content-manager.containers.ListPage.items":
    "{number, plural, =0 {项目} one {项目} other {项目}}",
  ...
  "content-manager.dnd.drop-item":
    "{item}已放置。列表中的最终位置:{position}。",
  "content-manager.dnd.grab-item":
    "{item}已抓取。当前列表位置:{position}。按上下箭头更改位置,空格键放置,Esc键取消。",
  ...
  "content-manager.form.Input.hint.character.unit":
    "{maxValue, plural, one { 个字符} other { 个字符}}",
  "content-manager.form.Input.hint.minMaxDivider": " / ",
  "content-manager.form.Input.hint.text":
    "{min, select, undefined {} other {最小. {min}}}{divider}{max, select, undefined {} other {最大. {max}}}{unit}{br}{description}",
  ...
  "content-manager.popUpwarning.warning.has-draft-relations.message":
    "<b>{count, plural, one { 个关系} other { 个关系} }</b> 尚未发布,可能会导致意外行为。",
  ...
  "global.plugins.content-type-builder.description":
    "为您的 API 建模数据结构。在短短一分钟内创建新的字段和关系。文件会自动在您的项目中创建和更新。",
  "global.plugins.documentation": "文档",
  "global.plugins.documentation.description":
    "创建 OpenAPI 文档并通过 SWAGGER UI 可视化您的 API。",
  ...
  "global.plugins.graphql.description":
    "添加具有默认 API 方法的 GraphQL 端点。",
  "global.plugins.i18n": "国际化",
  "global.plugins.i18n.description":
    "此插件可让您使用不同语言在管理面板和 API 中创建、读取和更新内容。",
  ...
  "global.plugins.users-permissions.description":
    "基于 JWT 的完整认证流程来保护您的 API。此插件还带有一个 ACL 策略,允许您在用户组之间管理权限。",
  "global.profile": "简介",
  ...
  "notification.ee.warning.at-seat-limit.title":
    "已达 {licenseLimitStatus, select, OVER_LIMIT {超出} AT_LIMIT {到达}} 座位限制 ({currentUserCount}/{permittedSeats})",
  "notification.ee.warning.over-.message":
    "添加座位以 {licenseLimitStatus, select, OVER_LIMIT {邀请} AT_LIMIT {重新启用}} 用户。如果您已经这样做,但 Strapi 尚未反映出来,请确保重新启动您的应用程序。",
  "notification.error": "发生错误",
  "notification.error.invalid.configuration":
    "您的配置无效,请在服务器日志中查看更多信息。",
...
//# sourceMappingURL=zh-Hans-eY3IWdFB.mjs.map
