...
const index = require("./index-VyjiJi0S.js");
...
const [PermissionsDataManagerProvider, usePermissionsDataManagerContext] =
  reactContext.createContext("PermissionsDataManager");
const usePermissionsDataManager = () =>
...
const formatPermissionsForAPI = (modifiedData) => {
  ...
  const collectionTypesPermissions = formatContentTypesPermissions(
    modifiedData.collectionTypes
  );
  const singleTypesPermissions = formatContentTypesPermissions(
    ...
    (allPermissions, current) => {
      ...
      const permissions2 = Object.entries(currentSubjectActions).reduce(
        (acc, current2) => {
          ...
          const shouldCreatePermission = createArrayOfValues(permissions3).some(
            (val) => val
          );
          ...
          if (!permissions3?.properties?.enabled) {
            const createdPermissionsArray = Object.entries(
              permissions3.properties
            ).reduce(
              (acc2, current3) => {
                const [propertyName, propertyValue] = current3;
                acc2.properties[propertyName] =
                  createPropertyArray(propertyValue);
                return acc2;
              },
              {
                action: actionName,
...
const createDefaultConditionsForm$1 = (conditions, initialConditions = []) =>
...
const createDefaultPropertiesForm = (
  ...
  const recursivelyCreatePropertyForm = (
    ...
    return children.reduce((acc, current) => {
      ...
      const hasProperty =
        propertyValues.indexOf(`${prefix}${current.value}`) !== -1;
  ...
  return properties.reduce(
    (acc, currentPropertyName) => {
      const foundProperty = subject.properties.find(
...
const createDefaultCTForm = (
  ...
  return actions.reduce((defaultForm, action) => {
    ...
    const contentTypesActions = Object.keys(subjectLayouts).reduce(
      (acc, currentCTUID) => {
        const { actionId, applyToProperties } = action;
        const currentSubjectLayout = subjectLayouts[currentCTUID];
        const properties = currentSubjectLayout.properties.map(
          ({ value }) => value
        );
        ...
        if (
          isEmpty__default.default(applyToProperties) ||
          doesNothaveProperty
        ) {
...
const formatLayout = (layout, groupByKey) => {
  return Object.entries(groupBy__default.default(layout, groupByKey)).map(
    ([itemName, item]) => ({
      category: itemName,
      categoryId: itemName.split(" ").join("-"),
      childrenForm: Object.entries(
        groupBy__default.default(item, "subCategory")
      ).map(([subCategoryName, actions]) => ({
        subCategoryName,
...
const updateConditionsToFalse = (obj) => {
  return Object.keys(obj).reduce((acc, current) => {
    ...
    if (
      index.isObject(currentValue) &&
      !has__default.default(currentValue, "conditions")
    ) {
    ...
    if (
      ...
      const isActionEnabled = createArrayOfValues(
        omit__default.default(currentValue, "conditions")
      ).some((val) => val);
      if (!isActionEnabled) {
        ...
        return {
          ...acc,
          [current]: { ...currentValue, conditions: updatedConditions },
        };
      }
    }
...
const RowLabelWithCheckbox = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
        paddingRight: 2,
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.BaseCheckbox, {
          name: checkboxName,
...
const CollapsePropertyMatrix = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
        children: childrenForm.map(
          ({ children: childrenForm2, label: label2, value, required }, i) =>
...
const ActionRow$1 = ({
  ...
  const { hasAllActionsSelected, hasSomeActionsSelected } =
    React.useMemo(() => {
      return getRowLabelCheckboxState(
        propertyActions,
        modifiedData,
        pathToData,
        propertyName,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
              children: propertyActions.map(
                ({
                  ...
                  if (!isCollapsable) {
                    const checkboxValue = get__default.default(
                      modifiedData,
                      checkboxName,
                      false
                    );
                  ...
                  const data = get__default.default(
                    modifiedData,
                    checkboxName,
                    {}
                  );
      ...
      isActive &&
        /* @__PURE__ */ jsxRuntime.jsx(SubActionRow, {
...
const SubActionRow = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
    ...
    children: [
      ...
      childrenForm.map(
        ({ label, value, required, children: subChildrenForm }, index2) => {
            ...
            LeftBorderTimeline,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  height: rowHeight,
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(StyledBox$1, {
...
const LeftBorderTimeline = styled__default.default(designSystem.Box)`
  border-left: ${({ isVisible, theme }) =>
    isVisible
      ? `4px solid ${theme.colors.primary200}`
...
const ButtonContainer = styled__default.default(designSystem.Box)`
  ${({ hasConditions, disabled, theme }) =>
    ...
    &:before {
      ...
      background: ${
        disabled ? theme.colors.neutral100 : theme.colors.primary600
      };
    }
  `}
`;
...
const ConditionsModal = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  const { availableConditions, modifiedData, onChangeConditions } =
    usePermissionsDataManager();
  const arrayOfOptionsGroupedByCategory = React__namespace.useMemo(() => {
    return Object.entries(
      groupBy__default.default(availableConditions, "category")
    );
  }, [availableConditions]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ModalLayout, {
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalHeader, {
        children: /* @__PURE__ */ jsxRuntime.jsx(v2.Breadcrumbs, {
          id: "condition-modal-breadcrumbs",
          label: headerBreadCrumbs.join(", "),
          children: headerBreadCrumbs.map((label, index2, arr) =>
            /* @__PURE__ */ jsxRuntime.jsx(
              v2.Crumb,
              {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ModalBody, {
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx("ul", {
            children: actionsToDisplay.map(
              ({ actionId, label, pathToConditionsObject }, index2) => {
    ...
    const categoryDefaultForm = arrayOfOptionsGroupedByCategory.reduce(
      (acc2, current2) => {
        ...
        const conditionsForm = relatedConditions.reduce((acc3, current3) => {
          acc3[current3.id] = get__default.default(
...
const ActionRow = ({
  ...
  const handleChange = (val) => {
    if (onChange) {
      onChange(
        name,
        getNewStateFromChangedValues(arrayOfOptionsGroupedByCategory, val)
      );
    }
  };
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
...
const ContentTypeCollapses = ({
  ...
  const handleClickToggleCollapse = (collapseName) => () => {
    const nextCollapseToOpen =
      collapseToOpen === collapseName ? null : collapseName;
    setCollapseToOpen(nextCollapseToOpen);
  };
  return /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {
    children: subjects.map(({ uid, label, properties }, index2) => {
      const isActive = collapseToOpen === uid;
      const availableActions = actions.map((action) => ({
        ...action,
        isDisplayed:
          Array.isArray(action.subjects) && action.subjects.indexOf(uid) !== -1,
      }));
      return /* @__PURE__ */ jsxRuntime.jsxs(
        designSystem.Flex,
        {
          ...
          children: [
            ...
            isActive &&
              properties.map(
                ({ label: propertyLabel, value, children: childrenForm }) => {
                  return /* @__PURE__ */ jsxRuntime.jsx(
...
const Collapse = ({
  ...
  const { hasAllActionsSelected, hasSomeActionsSelected } =
    getCheckboxState(dataWithoutCondition);
  const checkboxesActions = React__namespace.useMemo(() => {
    return generateCheckboxesActions(
      availableActions,
      modifiedData,
      pathToData
    );
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(RowLabelWithCheckbox, {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(Chevron, {
              paddingLeft: 2,
              children: isActive
                ? /* @__PURE__ */ jsxRuntime.jsx(Icons.ChevronUp, {})
                : /* @__PURE__ */ jsxRuntime.jsx(Icons.ChevronDown, {}),
            }),
          }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
            style: { flex: 1 },
            children: checkboxesActions.map(
              ({
                actionId,
                hasSomeActionsSelected: hasSomeActionsSelected2,
                isDisplayed,
...
const generateCheckboxesActions = (
  ...
  return availableActions.map(
    ({ actionId, isDisplayed, applyToProperties, label }) => {
      if (!isDisplayed) {
        return { actionId, hasSomeActionsSelected: false, isDisplayed };
      }
      const baseCheckboxNameArray = [...pathToData.split(".."), actionId];
      const checkboxNameArray = isEmpty__default.default(applyToProperties)
        ? [...baseCheckboxNameArray, "properties", "enabled"]
        : baseCheckboxNameArray;
      const conditionsValue = get__default.default(
        modifiedData,
        [...baseCheckboxNameArray, "conditions"],
        null
      );
      ...
      if (isEmpty__default.default(applyToProperties)) {
        const value = get__default.default(
          modifiedData,
          checkboxNameArray,
          false
        );
...
const GlobalActions = ({ actions = [], isFormDisabled, kind }) => {
  const { formatMessage } = reactIntl.useIntl();
  const { modifiedData, onChangeCollectionTypeGlobalActionCheckbox } =
    usePermissionsDataManager();
  ...
  const checkboxesState = React__namespace.useMemo(() => {
    ...
    const checkboxesState2 = Object.keys(relatedActionsData).reduce(
      (acc, current) => {
          ...
          designSystem.Flex,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.BaseCheckbox, {
                ...
                value: get__default.default(
                  checkboxesState,
                  [actionId, "hasAllActionsSelected"],
                  false
                ),
                indeterminate: get__default.default(
                  checkboxesState,
...
const PluginsAndSettingsPermissions = ({ layout, ...restProps }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    padding: 6,
    background: "neutral0",
    children: layout.map(({ category, categoryId, childrenForm }, index2) => {
      return /* @__PURE__ */ jsxRuntime.jsx(
        Row,
        {
          childrenForm,
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.AccordionContent, {
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
          padding: 6,
          children: childrenForm.map(
            ({ actions, subCategoryName, subCategoryId }) =>
              /* @__PURE__ */ jsxRuntime.jsx(
                SubCategory,
                {
                  actions,
...
const SubCategory = ({
  ...
  const formattedActions = React__namespace.useMemo(() => {
    return actions.map((action) => {
      ...
      const conditionValue = get__default.default(
        modifiedData,
        [...pathToData, action.action, "conditions"],
        {}
      );
      const hasConditions = createArrayOfValues(conditionValue).some(
        (val) => val
      );
      return {
        ...action,
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(ConditionsButton, {
...
const Permissions = React__namespace.forwardRef(
  ({ layout, isFormDisabled, permissions = [] }, api) => {
    const [{ initialData, layouts, modifiedData }, dispatch] =
      React__namespace.useReducer(reducer, initialState, () =>
    ...
    React__namespace.useImperativeHandle(api, () => {
      return {
        getPermissions() {
          ...
          const singleTypesDiff = helperPlugin.difference(
            initialData.singleTypes,
            modifiedData.singleTypes
          );
          ...
          if (isEmpty__default.default(contentTypesDiff)) {
            ...
            didUpdateConditions = Object.values(contentTypesDiff).some(
              (permission = {}) => {
                return Object.values(permission).some((permissionValue) =>
                  has__default.default(permissionValue, "conditions")
                );
              }
            );
          }
    ...
    const handleChangeSimpleCheckbox = React__namespace.useCallback(
      ({ target: { name, value } }) => {
        dispatch({
    ...
    const handleChangeParentCheckbox = React__namespace.useCallback(
      ({ target: { name, value } }) => {
        dispatch({
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(PermissionsDataManagerProvider, {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.TabGroup, {
        id: "tabs",
        label: formatMessage({
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tabs, {
            children: TAB_LABELS.map((tabLabel) =>
              /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Tab,
                {
                  children: formatMessage({
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.TabPanels, {
            style: { position: "relative" },
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.TabPanel, {
  ...
  produce__default.default(state, (draftState) => {
    switch (action.type) {
      case "ON_CHANGE_COLLECTION_TYPE_GLOBAL_ACTION_CHECKBOX": {
        ...
        Object.keys(get__default.default(state, pathToData)).forEach(
          (collectionType) => {
            ...
            if (collectionTypeActionData) {
              ...
              if (!value && updatedValues.conditions) {
                const updatedConditions = updateValues(
      ...
      case "ON_CHANGE_COLLECTION_TYPE_ROW_LEFT_CHECKBOX": {
        ...
        let nextModifiedDataState = cloneDeep__default.default(
          state.modifiedData
        );
        const pathToModifiedDataCollectionType =
          pathToCollectionType.split("..");
        const objToUpdate = get__default.default(
        ...
        Object.keys(objToUpdate).forEach((actionId) => {
          if (
            has__default.default(
              objToUpdate[actionId],
              `properties.${propertyName}`
            )
          ) {
            const objValue = get__default.default(objToUpdate, [
              actionId,
              "properties",
              propertyName,
              rowName,
        ...
        if (!value) {
          nextModifiedDataState = updateConditionsToFalse(
            nextModifiedDataState
          );
        }
      ...
      case "ON_CHANGE_TOGGLE_PARENT_CHECKBOX": {
        ...
        const oldValues = get__default.default(
          nextModifiedDataState,
          pathToValue,
          {}
        );
...
const init = (layout, permissions) => {
  ...
  const defaultForm = {
    collectionTypes: createDefaultCTForm(
      collectionTypes,
      conditions,
      permissions
    ),
...
//# sourceMappingURL=Permissions-34PVE5l6.js.map
