...
const useAdminRoles = require("./useAdminRoles-Azeibt7M.js");
const useContentTypes = require("./useContentTypes-onkhq4uE.js");
const validateWorkflow = require("./validateWorkflow-nEwtJ3ZE.js");
const AuthenticatedApp = require("./AuthenticatedApp-d4HwjDw9.js");
const index = require("./index-VyjiJi0S.js");
const reviewWorkflows = require("./reviewWorkflows-v74f5ogs.js");
const Layout = require("./Layout-ApjEjb_C.js");
const LimitsModal = require("./LimitsModal-gq7jwfap.js");
const constants = require("./constants-L1I-Y-RJ.js");
const useReviewWorkflows = require("./useReviewWorkflows-syV84pfl.js");
...
const ReviewWorkflowsEditPage = () => {
  ...
  const {
    ...
    meta,
    workflows,
  } = useReviewWorkflows.useReviewWorkflows();
  const {
    collectionTypes,
    singleTypes,
    isLoading: isLoadingContentTypes,
  } = useContentTypes.useContentTypes();
  const serverState = reactRedux.useSelector(
    validateWorkflow.selectServerState
  );
  const currentWorkflowIsDirty = reactRedux.useSelector(
    validateWorkflow.selectIsWorkflowDirty
  );
  const currentWorkflow = reactRedux.useSelector(
    validateWorkflow.selectCurrentWorkflow
  );
  const hasDeletedServerStages = reactRedux.useSelector(
    validateWorkflow.selectHasDeletedServerStages
  );
  ...
  const { isLoading: isLoadingRoles, roles: serverRoles } =
    useAdminRoles.useAdminRoles(void 0);
  ...
  const workflow = workflows?.find(
    (workflow2) => workflow2.id === parseInt(workflowId, 10)
  );
  const contentTypesFromOtherWorkflows = workflows
    ?.filter((workflow2) => workflow2.id !== parseInt(workflowId, 10))
    .flatMap((workflow2) => workflow2.contentTypes);
  const limits = getFeature("review-workflows");
  const numberOfWorkflows =
    limits?.[constants.CHARGEBEE_WORKFLOW_ENTITLEMENT_NAME];
  const stagesPerWorkflow =
    limits?.[constants.CHARGEBEE_STAGES_PER_WORKFLOW_ENTITLEMENT_NAME];
  ...
  const submitForm = async () => {
    ...
    try {
      ...
      if ("error" in res) {
        if (
          index.isBaseQueryError(res.error) &&
  ...
  validateWorkflow.useInjectReducer(
    constants.REDUX_NAMESPACE,
    validateWorkflow.reducer
  );
  React__namespace.useEffect(() => {
    ...
    if (!isLoadingContentTypes) {
      dispatch(
        validateWorkflow.setContentTypes({ collectionTypes, singleTypes })
      );
    }
    if (!isLoadingRoles) {
    ...
    dispatch(
      validateWorkflow.setIsLoading(
        isLoadingWorkflow || isLoadingContentTypes || isLoadingRoles
      )
    );
    return () => {
            ...
            /* @__PURE__ */ jsxRuntime.jsx(Layout.Header, {
              ...
              primaryAction:
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, {
                  ...
                  loading:
                    !Boolean(Object.keys(savePrompts).length > 0) && saving,
                ...
                : /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(
                        validateWorkflow.WorkflowAttributes,
                        { canUpdate }
                      ),
                      /* @__PURE__ */ jsxRuntime.jsx(validateWorkflow.Stages, {
                        canDelete,
                        canUpdate,
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(LimitsModal.LimitsModal.Title, {
            children: formatMessage({
              ...
              defaultMessage:
                "You’ve reached the limit of workflows in your plan",
            }),
          }),
          /* @__PURE__ */ jsxRuntime.jsx(LimitsModal.LimitsModal.Body, {
            children: formatMessage({
              ...
              defaultMessage:
                "Delete a workflow or contact Sales to enable more workflows.",
            }),
          }),
        ],
      }),
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(LimitsModal.LimitsModal.Title, {
            children: formatMessage({
              ...
              defaultMessage:
                "You have reached the limit of stages for this workflow in your plan",
            }),
          }),
          /* @__PURE__ */ jsxRuntime.jsx(LimitsModal.LimitsModal.Body, {
            children: formatMessage({
              ...
              defaultMessage:
                "Try deleting some stages or contact Sales to enable more stages.",
            }),
          }),
        ],
      }),
...
//# sourceMappingURL=EditPage-PlgV4-L7.js.map
