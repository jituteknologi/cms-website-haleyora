...
const AuthenticatedApp = require("./AuthenticatedApp-d4HwjDw9.js");
...
const useSettingsMenu = () => {
  ...
  const permissions = reactRedux.useSelector(
    AuthenticatedApp.selectAdminPermissions
  );
  ...
  React__namespace.useEffect(() => {
    const getData = async () => {
      const buildMenuPermissions = (sections2) =>
        Promise.all(
          sections2.reduce((acc, section, sectionIndex) => {
            const linksWithPermissions = section.links.map(
              async (link, linkIndex) => ({
                hasPermission: await helperPlugin.hasPermissions(
                  userPermissions,
                  link.permissions
                ),
                sectionIndex,
          ...
          menu: sections.map((section, sectionIndex) => ({
            ...
            links: section.links.map((link, linkIndex) => {
              const permission = menuPermissions.find(
                (permission2) =>
                  permission2.sectionIndex === sectionIndex &&
                  permission2.linkIndex === linkIndex
              );
              return {
                ...link,
    ...
    const sections = formatLinks([
      {
        ...global,
        links: sortBy__default
          .default(
            [...global.links, ...globalLinks.map(addPermissions)],
            (link) => link.id
          )
          .map((link) => ({
            ...link,
            hasNotification:
              link.id === "000-application-infos" && shouldUpdateStrapi,
          })),
      },
      {
        id: "permissions",
...
const ROUTES_CE = [
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() =>
        require("./CreatePage-jJLx2t7F.js")
      );
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() =>
        require("./EditPage-VGOMmzQ_.js")
      );
  ...
  },
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() =>
        require("./CreatePage-oB2CMjjF.js")
      );
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve()
        .then(() => require("./EditPage-bJwcoPI1.js"))
        .then((n) => n.EditPage$1);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() =>
        require("./ListView-HUto2Z9a.js")
      );
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() =>
        require("./CreateView-E5_ZJ-Vh.js")
      );
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() =>
        require("./EditViewPage-7G0Sf6s3.js")
      );
  ...
  },
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() =>
        require("./CreateView-VaG7ng5p.js")
      );
      return ProtectedCreateView;
    },
...
const [LogoInputContextProvider, useLogoInputContext] =
  reactContext.createContext("LogoInput");
const LogoInput = ({
  canUpdate,
  customLogo,
  defaultLogo,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(LogoInputContextProvider, {
    setLocalImage,
    localImage,
    ...
    children: [
      ...
      currentStep
        ? /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ModalLayout, {
            labelledBy: "modal",
            onClose: handleClose,
            children: [
              ...
              currentStep === "upload"
                ? /* @__PURE__ */ jsxRuntime.jsx(AddLogoDialog, {})
                : /* @__PURE__ */ jsxRuntime.jsx(PendingLogoDialog, {
                    onChangeLogo,
                  }),
            ],
          })
...
const AddLogoDialog = () => {
  const { formatMessage } = reactIntl.useIntl();
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.TabGroup, {
    label: formatMessage({
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
        ...
        paddingRight: 8,
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tabs, {
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tab, {
                children: formatMessage({
...
const URLForm = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const res = await axios__default.default.get(url.toString(), {
        responseType: "blob",
        timeout: 8e3,
      });
      ...
      if (err instanceof axios.AxiosError) {
        ...
        setError(
          formatMessage(err.displayMessage, {
            size: SIZE,
            dimension: DIMENSION,
          })
        );
...
const ComputerForm = () => {
  ...
  const { setLocalImage, goToStep, onClose } =
    useLogoInputContext("ComputerForm");
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx("form", {
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
          ...
          paddingTop: 6,
          paddingBottom: 6,
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field, {
            name: id,
            error: fileError,
...
const PendingLogoDialog = ({ onChangeLogo }) => {
  const { formatMessage } = reactIntl.useIntl();
  const { localImage, setLocalImage, goToStep, onClose } =
    useLogoInputContext("PendingLogoDialog");
  const handleGoBack = () => {
    setLocalImage(void 0);
    goToStep("upload");
  };
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
            maxWidth: helperPlugin.pxToRem(180),
            children: localImage?.url
              ? /* @__PURE__ */ jsxRuntime.jsx(ImageCardAsset, {
                  asset: localImage,
                })
              : null,
          }),
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.CardContent, {
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.CardSubtitle, {
                children: `${asset.ext?.toUpperCase()} - ${asset.width}✕${
                  asset.height
                }`,
              }),
            ],
...
const ApplicationInfoPage = () => {
  ...
  const { settings } = reactRedux.useSelector(
    AuthenticatedApp.selectAdminPermissions
  );
  const {
    communityEdition,
    ...
    async () =>
      (
        await Promise.resolve().then(() =>
          require("./AdminSeatInfo-IvRzj9In.js")
        )
      ).AdminSeatInfoEE
  );
  const {
  ...
  const isSaveDisabled =
    logos.auth.custom === serverLogos.auth.custom &&
    logos.menu.custom === serverLogos.menu.custom;
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Layout, {
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.SettingsPageTitle, {
        name: formatMessage({
...
const SettingsPage = () => {
  ...
  const routes = index.useEnterprise(
    ROUTES_CE,
    async () =>
      (await Promise.resolve().then(() => require("./constants-t8b57vSd.js")))
        .ROUTES_EE,
    {
  ...
  const pluginsRoutes = Object.values(settings).flatMap((section) => {
    ...
    return links.map((link) =>
      index.createRoute(link.Component, link.to, link.exact || false)
    );
  });
  if (isLoading) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Layout, {
    sideNav: /* @__PURE__ */ jsxRuntime.jsx(SettingsNav, { menu }),
    children: [
...
const makeUniqueRoutes = (routes) =>
  routes.filter(
    (route, index2, refArray) =>
      refArray.findIndex((obj) => obj.to === route.to) === index2
  );
exports.SettingsPage = SettingsPage;
exports.makeUniqueRoutes = makeUniqueRoutes;
//# sourceMappingURL=SettingsPage-r7M2dq3I.js.map
