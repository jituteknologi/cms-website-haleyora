...
const AdminSeatInfoEE = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.GridItem, {
    col: 6,
    s: 12,
    children: [
                ...
                },
                {
                  ...
                  text: (chunks) =>
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
                      fontWeight: "semiBold",
                      textColor:
                        enforcementUserCount > permittedSeats
                          ? "danger500"
                          : void 0,
                      children: chunks,
                    }),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(v2.Link, {
        href: isHostedOnStrapiCloud
          ? BILLING_STRAPI_CLOUD_URL
          : BILLING_SELF_HOSTED_URL,
        isExternal: true,
...
//# sourceMappingURL=AdminSeatInfo-IvRzj9In.js.map
