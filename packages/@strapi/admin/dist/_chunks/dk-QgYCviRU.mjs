...
const dk = {
  ...
  "Auth.components.Oops.text.admin":
    "Hvis dette er en fejl, kontakt venligst din administrator.",
  ...
  "Auth.form.button.login.providers.error":
    "Vi kan ikke forbinde dig gennem den valgte provider.",
  ...
  "Auth.form.error.email.provide":
    "Angiv venligst dit brugernavn eller e-mail.",
  ...
  "Auth.form.error.password.format":
    "Dit kodeord må ikke indeholde tegnet `$` mere end 3 gange.",
  "Auth.form.error.password.local":
    "Denne bruger har ikke angivet et lokalt kodeord, log venligst ind via link fra oprettelsen.",
  ...
  "Auth.form.password.hint":
    "Kodeord skal indeholde mindst 8 tegn, 1 stort bogstav, 1 lille bogstav og 1 tal",
  "Auth.form.password.show-password": "Vis kodeord",
  "Auth.form.register.news.label":
    "Hold mig opdateret omkring nye features og kommende forbedringer (ved at gøre dette accepterer du {terms} og {policy}).",
  "Auth.form.register.subtitle":
    "Dit login bliver kun brugt til at autentificere dig selv i admin panelet. Alle gemte data bliver gemt i din egen database.",
  ...
  "HomePage.welcome.congrats.content":
    "Du er logget ind som den første administrator. For at lære de gode features som Strapi har,",
  "HomePage.welcome.congrats.content.bold":
    "anbefaler vi at du opretter din første dokument type.",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "Nogle roller kunne ikke slettes da de er forbundet til en eller flere brugere",
  "Roles.ListPage.notification.delete-not-allowed":
    "En rolle kan ikke slettes hvis den er forbundet til en bruger",
  "Roles.RoleRow.select-all": "Vælg {name} for bulk handling",
  "Roles.components.List.empty.withSearch":
    "Der er ingen rolle der matcher søgningen ({search})...",
  ...
  "Settings.permissions.category.plugins":
    "Rettighedsindstilling for {category} plugin",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "Dette vil kun vise dit eget interface i det valgte sprog.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "Valget vil kun ændre sproget for dig. Referér venligst til dette {here} for at gøre andre sprog tilgængelige for dit hold.",
  ...
  "Settings.sso.description":
    "Ændre indstillingerne for Single Sign-On funktionen.",
  "Settings.sso.form.defaultRole.description":
    "Det vil forbinde nye autentificerede brugere til den valgte rolle",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "Du skal have tilladelse til at læse admin roller",
  "Settings.sso.form.defaultRole.label": "Standard rolle",
  "Settings.sso.form.registration.description":
    "Opret ny bruger med SSO log ind hvis ingen bruger findes",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "Dette event findes kun for indhold med udkast/offentliggør system slået til",
  ...
  "Settings.webhooks.list.empty.description":
    "Tilføj din første til denne liste.",
  ...
  "Users.components.List.empty.withFilters":
    "Der er ingen brugere med de valgte filtre...",
  "Users.components.List.empty.withSearch":
    "Der er ingen brugere der matcher søgningen ({search})...",
  ...
  "app.components.BlockLink.blog.content":
    "Læs de seneste nyheder omkring Strapi og økosystemet.",
  "app.components.BlockLink.code": "Kode eksempler",
  "app.components.BlockLink.code.content":
    "Lær ved at teste rigtige projekter udviklet af community.",
  "app.components.BlockLink.documentation.content":
    "Opdag essentielle koncepter, guides og instruktioner.",
  "app.components.BlockLink.tutorial": "Tutorials",
  "app.components.BlockLink.tutorial.content":
    "Følg step-by-step instruktioner til at bruge og ændre Strapi.",
  ...
  "app.components.DownloadInfo.text":
    "Dette kan tage et øjeblik, tak for din tålmodighed.",
  ...
  "app.components.EmptyStateLayout.content-permissions":
    "Du har ikke tilladelse til at tilgå indholdet",
  ...
  "app.components.HomePage.community.content":
    "Diskutér med team medlemmer, contributors og udviklere på forskellige kanaler.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Vi er glade for at have dig som en dig af fællesskabet. Vi leder konstant efter feedback så send os gerne en besked på ",
  "app.components.HomePage.welcomeBlock.content.again":
    "Vi håber at det går fremad med dit projekt... Læs gerne de seneste nyheder omkring Strapi. Vi gør vores bedste for at forbedre produktet baseret på din feedback.",
  ...
  "app.components.ImgPreview.hint":
    "Drag & drop din fil til dette område eller {browse} efter en fil at uploade",
  ...
  "app.components.InstallPluginPage.Download.description":
    "Det tager muligvis et øjeblik at downloade og installere dette plugin.",
  ...
  "app.components.LeftMenuLinkContainer.noPluginsInstalled":
    "Ingen plugins installeret endnu",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "Det tager muligvis et øjeblik at afinstallere dette plugin.",
  "app.components.ListPluginsPage.deletePlugin.title": "Afinstallerer",
  "app.components.ListPluginsPage.description":
    "Liste over installerede plugins i dette projekt.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "AutoReload funktionen skal aktiveres. Start venligst din app med `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Af sikkerhedsmæssige årsager kan et plugin kun downloades i et development miljø.",
  ...
  "app.components.Users.MagicLink.connect":
    "Send dette link til brugeren for at de kan connecte.",
  "app.components.Users.MagicLink.connect.sso":
    "Send dette link til brugeren. Det første log ind kan klares med en SSO provider",
  ...
  "app.components.Users.ModalCreateBody.block-title.roles.description":
    "En bruger kan have en eller flere roller",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Der skete en fejl under afinstallering af dette plugin",
  "app.containers.App.notification.error.init":
    "Der skete en fejl under forespørgelse af API",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "Hvis du ikke modtager dette link, kontakt venligst din administrator.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "Det tager muligvis et øjeblik at modtage dit kodeord link.",
  ...
  clearLabel,
  "coming.soon":
    "Dette indhold er under konstruktion og er tilbage om et par uger!",
  "component.Input.error.validation.integer": "Værdien skal være et helt tal",
  "components.AutoReloadBlocker.description":
    "Kør Strapi med en af følgende kommandoer:",
  "components.AutoReloadBlocker.header":
    "Reload funktion er påkrævet for dette plugin.",
  ...
  "components.Input.error.contain.lowercase":
    "Kodeord skal indeholde mindst et lille bogstav",
  "components.Input.error.contain.number":
    "Kodeord skal indehold mindst et tal",
  "components.Input.error.contain.uppercase":
    "Kodeord skal indholde mindst et stort bogstav",
  "components.Input.error.contentTypeName.taken":
    "Dette navn er allerede taget",
  ...
  "components.OverlayBlocker.description":
    "Du bruger en feature der kræver genstart. Vent veligst til serveren er oppe.",
  "components.OverlayBlocker.description.serverError":
    "Serveren skulle have restartet, tjek venligst dine logs i terminalen.",
  "components.OverlayBlocker.title": "Venter på genstart...",
  "components.OverlayBlocker.title.serverError":
    "Genstart tager længere end forventet",
  "components.PageFooter.select": "elementer pr side",
  "components.ProductionBlocker.description":
    "Af sikkerhedsmæssige årsager deaktiveres dette plugin i andre miljøer.",
  "components.ProductionBlocker.header":
    "Dette plugin er kun tilgængeligt under udvikling.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Drag & drop filer, indsæt fra udklipsholder eller {browse}.",
  ...
  "content-manager.App.schemas.data-loaded":
    "Skemaerne er blevet hentet succesfuldt",
  "content-manager.ListViewTable.relation-loaded":
    "Relationerne er blevet hentet",
  ...
  "content-manager.components.DragHandle-label": "Træk",
  "content-manager.components.DraggableAttr.edit": "Klik for at redigere",
  ...
  "content-manager.components.DynamicZone.add-component":
    "Tilføj et komponent til {componentName}",
  "content-manager.components.DynamicZone.delete-label": "Slet {name}",
  "content-manager.components.DynamicZone.error-message":
    "Komponentet indeholder fejl",
  "content-manager.components.DynamicZone.missing-components":
    "Der {number, plural, =0 {er # manglende komponenter} one {er # manglende komponent} other {er # manglende komponenter}}",
  "content-manager.components.DynamicZone.move-down-label":
    "Flyt komponent ned",
  "content-manager.components.DynamicZone.move-up-label": "Flyt komponent op",
  "content-manager.components.DynamicZone.pick-compo": "Vælg ét komponent",
  "content-manager.components.DynamicZone.required": "Komponent er påkrævet",
  "content-manager.components.EmptyAttributesBlock.button":
    "Gå til indstillings side",
  "content-manager.components.EmptyAttributesBlock.description":
    "Du kan ændre dine indstillinger",
  "content-manager.components.FieldItem.linkToComponentLayout":
    "Set komponentets layout",
  "content-manager.components.FieldSelect.label": "Tilføj et felt",
  "content-manager.components.FilterOptions.button.apply": "Udfør",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Sæt betingelser for at filtrere elementerne",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "Filtre",
  "content-manager.components.FiltersPickWrapper.hide": "Skjul",
  "content-manager.components.LeftMenu.Search.label": "Søg efter indholdstype",
  "content-manager.components.LeftMenu.collection-types": "Samlingstyper",
  "content-manager.components.LeftMenu.single-types": "Enkelttyper",
  "content-manager.components.LimitSelect.itemsPerPage": "Elementer pr. side",
  "content-manager.components.NotAllowedInput.text":
    "Ingen rettigheder til at se dette felt",
  "content-manager.components.RepeatableComponent.error-message":
    "Komponent(er) har fejl",
  "content-manager.components.Search.placeholder": "Søg efter elementer...",
  "content-manager.components.Select.draft-info-title": "Tilstand: Udkast",
  "content-manager.components.Select.publish-info-title":
    "Tilstand: Offentliggjort",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "Konfigurér hvordan redigerings visningen ser ud.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "Definér indstillingerne for listevisningen.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "Konfigurér visningen - {name}",
  "content-manager.components.TableDelete.delete": "Slet alt",
  "content-manager.components.TableDelete.deleteSelected": "Slet valgte",
  "content-manager.components.TableDelete.label":
    "{number, plural, one {# element} other {# elementer}} valgt",
  "content-manager.components.TableEmpty.withFilters":
    "Der er ingen {contentType} med de valgte filtre...",
  "content-manager.components.TableEmpty.withSearch":
    "Der er ingen {contentType} der matcher søgningen ({search})...",
  "content-manager.components.TableEmpty.withoutFilter":
    "Der er ingen {contentType}...",
  "content-manager.components.empty-repeatable":
    "Ingen elementer endnu. Klik på knappen herunder for at tilføje et.",
  "content-manager.components.notification.info.maximum-requirement":
    "Du er nået grænsen for antal felter",
  "content-manager.components.notification.info.minimum-requirement":
    "Et felt er blevet tilføjet for at matche minimums kravet",
  "content-manager.components.repeatable.reorder.error":
    "Der skete en fejl under re-arrangering af dit komponents felter, prøv igen senere",
  "content-manager.components.reset-entry": "Nulstil element",
  "content-manager.components.uid.apply": "udfør",
  "content-manager.components.uid.available": "tilgængelig",
  "content-manager.components.uid.regenerate": "regenerér",
  "content-manager.components.uid.suggested": "foreslået",
  "content-manager.components.uid.unavailable": "utilgængelig",
  "content-manager.containers.Edit.Link.Layout": "Konfigurér layoutet",
  "content-manager.containers.Edit.Link.Model": "Redigér dokument type",
  "content-manager.containers.Edit.addAnItem": "Tilføj et element...",
  "content-manager.containers.Edit.clickToJump":
    "Klik for at hoppe til elementet",
  "content-manager.containers.Edit.delete": "Slet",
  "content-manager.containers.Edit.delete-entry": "Slet dette dokument",
  "content-manager.containers.Edit.editing": "Redigerer...",
  "content-manager.containers.Edit.information": "Information",
  "content-manager.containers.Edit.information.by": "Af",
  "content-manager.containers.Edit.information.created": "Oprettet",
  "content-manager.containers.Edit.information.draftVersion": "udkast version",
  "content-manager.containers.Edit.information.editing": "Redigerer",
  "content-manager.containers.Edit.information.lastUpdate": "Sidste opdatering",
  "content-manager.containers.Edit.information.publishedVersion":
    "offentliggjort version",
  "content-manager.containers.Edit.pluginHeader.title.new": "Opret et element",
  "content-manager.containers.Edit.reset": "Nulstil",
  "content-manager.containers.Edit.returnList": "Gå tilbage til liste",
  ...
  "content-manager.containers.EditView.notification.errors":
    "Formularen indeholder nogle fejl",
  "content-manager.containers.Home.introduction":
    "For at redigere dine elementer, gå til de specefikke link i venstremenuen. Dette plugin har ikke en korrekt måde at redigere indstillinger og er stadig under aktiv udvikling.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Håndtér dine elementer gennem et kraftfuld og smukt interface.",
  "content-manager.containers.Home.pluginHeaderTitle": "Indhold",
  "content-manager.containers.List.draft": "Udkast",
  "content-manager.containers.List.errorFetchRecords": "Fejl",
  ...
  "content-manager.containers.ListPage.items":
    "{number, plural, =0 {elementer} one {element} other {elementer}}",
  ...
  "content-manager.containers.SettingPage.attributes": "Egenskabsfelter",
  "content-manager.containers.SettingPage.attributes.description":
    "Derfinér rækkefølgen på egenskaberne",
  "content-manager.containers.SettingPage.editSettings.description":
    "Drag & drop felterne for at bygge layoutet",
  ...
  "content-manager.containers.SettingsPage.Block.contentType.description":
    "Konfigurér specifikke indstillinger",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "Konfigurér indstillingerne for alle dine dokument typer og grupper",
  "content-manager.containers.SettingsView.list.subtitle":
    "Konfigurér layoutet og visning af dine dokument typer og grupper",
  "content-manager.containers.SettingsView.list.title":
    "Visnings konfigurationer",
  "content-manager.edit-settings-view.link-to-ctb.components":
    "Redigér komponentet",
  "content-manager.edit-settings-view.link-to-ctb.content-types":
    "Redigér indholdstypen",
  "content-manager.emptyAttributes.button": "Gå til dokument type bygger",
  "content-manager.emptyAttributes.description":
    "Tilføj dit første felt til din dokument type",
  "content-manager.emptyAttributes.title": "Der er endnu ingen felter",
  "content-manager.error.attribute.key.taken": "Denne værdi findes allerede",
  "content-manager.error.attribute.sameKeyAndName": "Kan ikke være ens",
  "content-manager.error.attribute.taken": "Dette feltnavn er allerede taget",
  "content-manager.error.contentTypeName.taken": "Dette navn er allerede taget",
  "content-manager.error.model.fetch":
    "Der skete en fejl under indhenting af model konfiguration.",
  "content-manager.error.record.create":
    "Der skete en fejl under element oprettelse.",
  "content-manager.error.record.delete":
    "Der skete en fejl under element sletning.",
  "content-manager.error.record.fetch":
    "Der skete en fejl under indhentning af element.",
  "content-manager.error.record.update":
    "Der skete en fejl under element opdatering.",
  "content-manager.error.records.count":
    "Der skete en fejl under indhentning af element antal.",
  "content-manager.error.records.fetch":
    "Der skete en fejl under indhentning af elementer.",
  "content-manager.error.schema.generation":
    "Der skete en fejl under generering af schema.",
  "content-manager.error.validation.json": "Dette er ikke JSON",
  "content-manager.error.validation.max": "Værdien er for høj.",
  "content-manager.error.validation.maxLength": "Værdien er for lang.",
  "content-manager.error.validation.min": "Værdien er for lav.",
  "content-manager.error.validation.minLength": "Værdien er for kort.",
  "content-manager.error.validation.minSupMax": "Kan ikke overstige",
  "content-manager.error.validation.regex":
    "Værdien matcher ikke angivet RegEx.",
  "content-manager.error.validation.required": "Værdien er påkrævet.",
  "content-manager.form.Input.bulkActions": "Aktivér bulk handlinger",
  "content-manager.form.Input.defaultSort": "Standard sorterings egenskab",
  "content-manager.form.Input.description": "Beskrivelse",
  "content-manager.form.Input.description.placeholder":
    "Visningsnavn i profilen",
  "content-manager.form.Input.editable": "Redigerbart felt",
  "content-manager.form.Input.filters": "Aktivér filtre",
  "content-manager.form.Input.label": "Label",
  "content-manager.form.Input.label.inputDescription":
    "Denne værdi overskriver den viste label i tabellens hoved",
  "content-manager.form.Input.pageEntries": "Elementer pr. side",
  "content-manager.form.Input.pageEntries.inputDescription":
    "Note: Du kan overskrive denne værdi under dokument type indstillings siden.",
  "content-manager.form.Input.placeholder": "Placeholder",
  "content-manager.form.Input.placeholder.placeholder": "Min awesome værdi",
  "content-manager.form.Input.search": "Aktivér søgning",
  "content-manager.form.Input.search.field": "Aktivér søgning for dette felt",
  "content-manager.form.Input.sort.field": "Aktivér sortering for dette felt",
  "content-manager.form.Input.sort.order": "Standard sorteringssrækkefølge",
  "content-manager.form.Input.wysiwyg": "Vis som WYSIWYG",
  "content-manager.global.displayedFields": "Viste felter",
  "content-manager.groups": "Grupper",
  "content-manager.groups.numbered": "Grupper ({number})",
  "content-manager.header.name": "Indhold",
  "content-manager.link-to-ctb": "Redigér modellen",
  "content-manager.models": "Dokument typer",
  "content-manager.models.numbered": "Dokument typer ({number})",
  "content-manager.notification.error.displayedFields":
    "Du skal have mindst et synligt felt",
  "content-manager.notification.error.relationship.fetch":
    "Der skete en fejl under indhentning af relation.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Du skal have en egenskab med sortering tilladt",
  "content-manager.notification.info.minimumFields":
    "Du skal have mindst et synligt felt",
  "content-manager.notification.upload.error":
    "Der skete en fejl under upload af dine filer",
  "content-manager.pageNotFound": "Siden kunne ikke findes",
  "content-manager.pages.ListView.header-subtitle":
    "{number, plural, =0 {# elementer} one {# element} other {# elementer}} fundet",
  "content-manager.pages.NoContentType.button": "Opret din første indholdstype",
  "content-manager.pages.NoContentType.text":
    "Du har ikke noget indhold endnu, vi anbefaler at du opretter din første indholdstype.",
  ...
  "content-manager.permissions.not-allowed.update":
    "Du har ikke tilladelse til at se dette dokument",
  "content-manager.plugin.description.long":
    "Hurtig måde at se, redigere og slette data i din database.",
  "content-manager.plugin.description.short":
    "Hurtig måde at se, redigere og slette data i din database.",
  "content-manager.popover.display-relations.label": "Vis relationer",
  "content-manager.success.record.delete": "Slettet",
  "content-manager.success.record.publish": "Offentliggjort",
  ...
  "content-manager.utils.data-loaded":
    "The {number, plural, =1 {element er} other {elementer er}} blevet hentet succesfuldt",
  "content-manager.popUpWarning.warning.publish-question":
    "Vil du stadig offentliggøre det?",
  ...
  "content-manager.popUpwarning.warning.has-draft-relations.message":
    "<b>{count, plural, =0 { af dine indholdsrelationer er} one { af dine indholdsrelationer er} other { af dine indholdsrelationer er}}</b> endnu ikke offentliggjort.<br></br>Det kan muligvis føre til links der ikke virker, samt andre fejl i dit projekt.",
  "form.button.done": "Færdig",
  "global.prompt.unsaved":
    "Er du sikker på at du vil forlade denne side? Alle dine ændringer vil gå tabt",
  "notification.contentType.relations.conflict":
    "Der er en eller flere konflikter med indholdstypens relationer",
  ...
  "notification.version.update.message":
    "En ny version af Strapi er tilgængelig!",
...
//# sourceMappingURL=dk-QgYCviRU.mjs.map
