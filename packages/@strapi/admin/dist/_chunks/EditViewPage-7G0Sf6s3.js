...
const apiTokens = require("./apiTokens-JqxtCsPu.js");
const constants = require("./constants-RMqZXSqh.js");
const TokenTypeSelect = require("./TokenTypeSelect-F79ta7iK.js");
...
const [ApiTokenPermissionsContextProvider, useApiTokenPermissionsContext] =
  reactContext.createContext("ApiTokenPermissionsContext");
...
const useApiTokenPermissions = () =>
  useApiTokenPermissionsContext("useApiTokenPermissions");
...
const MethodBox = styled__default.default(designSystem.Box)`
  margin: -1px;
  border-radius: ${({ theme }) => theme.spaces[1]} 0 0 ${({ theme }) =>
  theme.spaces[1]};
`;
const BoundRoute = ({
  route = {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
            paddingLeft: 2,
            paddingRight: 2,
            children: map__default.default(formattedRoute, (value) =>
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion, {
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.AccordionToggle, {
        title: capitalize__default.default(label),
      }),
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                      ...
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.Checkbox,
                        {
                          ...
                          onValueChange: () => {
                            onChangeSelectAll({
                              target: { value: [...controller.actions] },
                            });
                          },
                          disabled,
                          children: formatMessage({
                            ...
                            CheckboxWrapper,
                            {
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntime.jsx(
                                  designSystem.Checkbox,
                                  {
                                    value: selectedActions.includes(
                                      action.actionId
                                    ),
                                    name: action.actionId,
                                    onValueChange: () => {
                                      onChange({
                                        target: { value: action.actionId },
                                      });
                                    },
                                    disabled,
...
const ContentTypesSection = ({ section = null, ...props }) => {
  const [indexExpandedCollpsedContent, setIndexExpandedCollpsedContent] =
    React__namespace.useState(null);
  const handleExpandedCollpsedContentIndex = (index2) =>
    setIndexExpandedCollpsedContent(index2);
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    padding: 4,
    background: "neutral0",
    children:
      section &&
      section.map((api, index2) =>
        /* @__PURE__ */ jsxRuntime.jsx(
...
const Permissions = ({ ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, {
    ...
    background: "neutral0",
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.GridItem, {
        col: 7,
        paddingTop: 6,
        paddingBottom: 6,
        paddingLeft: 7,
        ...
        children: [
          ...
          data?.permissions &&
            /* @__PURE__ */ jsxRuntime.jsx(ContentTypesSection, {
...
const schema = yup__namespace.object().shape({
  ...
  lifespan: yup__namespace
    .number()
    .integer()
    .min(0)
    .nullable()
    .defined(helperPlugin.translatedErrors.required),
});
    ...
    switch (action.type) {
      ...
      case "ON_CHANGE_READ_ONLY": {
        const onlyReadOnlyActions = draftState.data.allActionsIds.filter(
          (actionId) =>
            actionId.includes("find") || actionId.includes("findOne")
        );
...
const EditView = () => {
  ...
  const permissions = index.useTypedSelector(
    (state2) => state2.admin_app.permissions
  );
  ...
  const handleSubmit = async (body, formik2) => {
    ...
    try {
      if (isCreating) {
        ...
        history.replace(`/settings/api-tokens/${res.data.id}`, {
          apiToken: res.data,
        });
...
//# sourceMappingURL=EditViewPage-7G0Sf6s3.js.map
