...
import {
  b as useGetAPITokenQuery,
  c as useCreateAPITokenMutation,
  d as useUpdateAPITokenMutation,
} from "./apiTokens-t5Agrc8F.mjs";
import { A as API_TOKEN_TYPE } from "./constants-fJt30IoY.mjs";
import {
  T as TokenName,
  a as TokenDescription,
  L as LifeSpanInput,
  b as TokenTypeSelect,
  F as FormHead,
  c as TokenBox,
} from "./TokenTypeSelect-HPb-tc3H.mjs";
      ...
      /* @__PURE__ */ jsxs(Flex, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Box, {
            paddingLeft: 2,
            paddingRight: 2,
            children: map(formattedRoute, (value) =>
              /* @__PURE__ */ jsxs(
                Typography,
                {
          ...
          children:
            ...
            routes[actionSection].map((route) => {
              return route.config.auth?.scope?.includes(selectedAction) ||
                ...
                ? /* @__PURE__ */ jsx(BoundRoute, { route }, route.handler)
                : null;
            }),
        })
      : /* @__PURE__ */ jsxs(Flex, {
...
const ContentTypesSection = ({ section = null, ...props }) => {
  const [indexExpandedCollpsedContent, setIndexExpandedCollpsedContent] =
    React.useState(null);
  const handleExpandedCollpsedContentIndex = (index) =>
    ...
    children: [
      /* @__PURE__ */ jsxs(GridItem, {
        ...
        children: [
          ...
          data?.permissions &&
            /* @__PURE__ */ jsx(ContentTypesSection, {
...
const schema = yup.object().shape({
  ...
  lifespan: yup
    ...
    .min(0)
    .nullable()
    .defined(translatedErrors.required),
});
...
//# sourceMappingURL=EditViewPage-eBg6Xxbl.mjs.map
