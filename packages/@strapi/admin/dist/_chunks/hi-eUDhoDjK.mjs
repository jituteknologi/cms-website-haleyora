...
const hi = {
  ...
  "Auth.components.Oops.text.admin":
    "अगर यह गलती है, तो कृपया अपने व्यवस्थापक से संपर्क करें.",
  ...
  "Auth.form.button.login.providers.error":
    "हम आपको चयनित प्रदाता के माध्यम से कनेक्ट नहीं कर सकते हैं।",
  ...
  "Auth.form.error.blocked":
    "आपका खाता व्यवस्थापक द्वारा अवरुद्ध कर दिया गया है",
  ...
  "Auth.form.error.email.provide":
    "कृपया अपना उपयोगकर्ता नाम या अपना ईमेल प्रदान करें।",
  ...
  "Auth.form.error.password.format":
    "आपके पासवर्ड में `$` का प्रतीक तीन बार से अधिक नहीं हो सकता।",
  "Auth.form.error.password.local":
    "इस उपयोगकर्ता ने कभी भी स्थानीय पासवर्ड सेट नहीं किया है, कृपया खाता निर्माण के दौरान उपयोग किए गए प्रदाता के माध्यम से लॉगिन करें।",
  ...
  "Auth.form.error.ratelimit":
    "बहुत अधिक प्रयास, कृपया एक मिनट में पुन: प्रयास करें।",
  ...
  "Auth.form.password.hint":
    "कम से कम 8 अक्षर, 1 अपरकेस, 1 लोअरकेस और 1 नंबर होना चाहिए",
  "Auth.form.password.show-password": "पासवर्ड दिखाए",
  "Auth.form.register.news.label":
    "मुझे नई सुविधाओं और आगामी सुधारों के बारे में अपडेट रखें (ऐसा करने से आप {शर्तें} और {नीति} स्वीकार करते हैं)।",
  "Auth.form.register.subtitle":
    "क्रेडेंशियल का उपयोग केवल Strapi में प्रमाणित करने के लिए किया जाता है। सभी सहेजे गए डेटा आपके डेटाबेस में संग्रहीत किए जाएंगे।",
  ...
  "HomePage.helmet.title": "होमपेज",
  "HomePage.roadmap": "हमारा रोडमैप देखें",
  "HomePage.welcome.congrats": "बधाई!",
  "HomePage.welcome.congrats.content":
    "आप पहले व्यवस्थापक के रूप में लॉग इन हैं। Strapi द्वारा प्रदान की गई शक्तिशाली विशेषताओं की खोज करने के लिए,",
  "HomePage.welcome.congrats.content.bold":
    "हम आपको अपना पहला संग्रह-प्रकार बनाने की सलाह देते हैं।",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "कुछ भूमिकाओं को हटाया नहीं जा सका क्योंकि वे उपयोगकर्ताओं से संबद्ध हैं",
  "Roles.ListPage.notification.delete-not-allowed":
    "उपयोगकर्ताओं के साथ संबद्ध होने पर भूमिका को हटाया नहीं जा सकता",
  "Roles.RoleRow.select-all": "बल्क कार्रवाइयों के लिए {नाम} चुनें",
  "Roles.RoleRow.user-count":
    "{संख्या, बहुवचन, =0 {# उपयोगकर्ता} एक {# उपयोगकर्ता} अन्य {# उपयोगकर्ता}}",
  "Roles.components.List.empty.withSearch":
    "खोज से संबंधित कोई भूमिका नहीं है ({खोज})...",
  ...
  "Settings.tokens.copy.editMessage":
    "सुरक्षा कारणों से, आप अपना टोकन केवल एक बार देख सकते हैं.",
  "Settings.tokens.copy.editTitle": "यह टोकन अब उपलब्ध नहीं है।",
  "Settings.tokens.copy.lastWarning":
    "इस टोकन को कॉपी करना सुनिश्चित करें, आप इसे दोबारा नहीं देख पाएंगे!",
  "Settings.apiTokens.create": "नया एपीआई टोकन बनाएं",
  "Settings.apiTokens.description":
    "एपीआई का उपभोग करने के लिए उत्पन्न टोकन की सूची",
  "Settings.apiTokens.emptyStateLayout":
    "आपके पास अभी तक कोई सामग्री नहीं है...",
  ...
  "Settings.permissions.category.plugins":
    "{श्रेणी} प्लगइन के लिए अनुमतियाँ सेटिंग",
  ...
  "Settings.permissions.conditions.no-actions":
    "उन पर शर्तों को परिभाषित करने से पहले आपको पहले क्रियाओं का चयन करना होगा (बनाएं, पढ़ें, अपडेट करें, ...)",
  ...
  "Settings.permissions.select-all-by-permission":
    "सभी {लेबल} अनुमतियों का चयन करें",
  ...
  "Settings.permissions.users.form.sso.description":
    "सक्षम (चालू) होने पर, उपयोगकर्ता एसएसओ के माध्यम से लॉगिन कर सकते हैं",
  "Settings.permissions.users.listview.header.subtitle":
    "वे सभी उपयोगकर्ता जिनके पास Strapi व्यवस्थापक पैनल तक पहुंच है",
  "Settings.permissions.users.tabs.label": "टैब अनुमतियां",
  "Settings.profile.form.notify.data.loaded":
    "आपका प्रोफ़ाइल डेटा लोड कर दिया गया है",
  "Settings.profile.form.section.experience.clear.select":
    "चयनित इंटरफ़ेस भाषा साफ़ करें",
  ...
  "Settings.roles.form.button.users-with-role":
    "{संख्या, बहुवचन, =0 {# उपयोगकर्ता} एक {# उपयोगकर्ता} अन्य {# उपयोगकर्ता}} इस भूमिका के साथ",
  ...
  "Settings.sso.description":
    "एकल साइन-ऑन सुविधा के लिए सेटिंग्स कॉन्फ़िगर करें।",
  "Settings.sso.form.defaultRole.description":
    "यह नए प्रमाणित उपयोगकर्ता को चयनित भूमिका से जोड़ देगा",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "आपको व्यवस्थापक भूमिकाओं को पढ़ने की अनुमति की आवश्यकता है",
  "Settings.sso.form.defaultRole.label": "डिफ़ॉल्ट भूमिका",
  "Settings.sso.form.registration.description":
    "यदि कोई खाता मौजूद नहीं है तो SSO लॉगिन पर नया उपयोगकर्ता बनाएं",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "यह घटना केवल उन सामग्रियों के लिए मौजूद है जिनमें ड्राफ्ट/प्रकाशन प्रणाली सक्षम है",
  ...
  "Settings.webhooks.to.delete":
    "{webhooksToDeleteLength, बहुवचन, एक {# संपत्ति} अन्य {# संपत्ति}} चयनित",
  ...
  "Usecase.notification.success.project-created":
    "परियोजना सफलतापूर्वक बनाई गई है",
  "Usecase.other": "अन्य",
  ...
  "admin.pages.MarketPlacePage.missingPlugin.description":
    "हमें बताएं कि आप किस प्लगइन की तलाश कर रहे हैं और अगर वे प्रेरणा की तलाश में हैं तो हम अपने समुदाय प्लगइन डेवलपर्स को बताएंगे!",
  anErrorOccurred,
  ...
  "app.components.BlockLink.blog.content":
    "Strapi और पारिस्थितिकी तंत्र के बारे में नवीनतम समाचार पढ़ें।",
  "app.components.BlockLink.code": "कोड उदाहरण",
  "app.components.BlockLink.code.content":
    "वास्तविक परियोजनाओं का परीक्षण करके जानें समुदाय का विकास हुआ।",
  "app.components.BlockLink.documentation.content":
    "आवश्यक अवधारणाओं, गाइडों और निर्देशों की खोज करें।",
  "app.components.BlockLink.tutorial": "ट्यूटोरियल",
  "app.components.BlockLink.tutorial.content":
    "Strapi का उपयोग और कस्टमाइज़ करने के लिए चरण-दर-चरण निर्देशों का पालन करें।",
  ...
  "app.components.DownloadInfo.text":
    "इसमें एक मिनट लग सकता है। आपके धैर्य के लिए धन्यवाद।",
  ...
  "app.components.EmptyStateLayout.content-permissions":
    "आपके पास उस सामग्री तक पहुंचने की अनुमति नहीं है",
  "app.components.GuidedTour.CM.create.content":
    "<p>कंटेंट मैनेजर में यहां सभी सामग्री बनाएं और प्रबंधित करें।</p><p>पूर्व: ब्लॉग वेबसाइट के उदाहरण को आगे बढ़ाते हुए, कोई एक लेख लिख सकता है, उसे सहेज सकता है और अपनी पसंद के अनुसार प्रकाशित कर सकता है।</p>< p>💡 त्वरित युक्ति - आपके द्वारा बनाई गई सामग्री पर प्रकाशित करें हिट करना न भूलें।</p>",
  "app.components.GuidedTour.CM.create.title": "️ सामग्री बनाएं",
  "app.components.GuidedTour.CM.success.content":
    "<p>बहुत बढ़िया, एक आखिरी कदम!</p><b>🚀 सामग्री को क्रियान्वित देखें</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    "<p>संग्रह प्रकार आपको कई प्रविष्टियों को प्रबंधित करने में मदद करते हैं, एकल प्रकार केवल एक प्रविष्टि को प्रबंधित करने के लिए उपयुक्त होते हैं।</p> <p>उदा: एक ब्लॉग वेबसाइट के लिए, लेख एक संग्रह प्रकार होगा जबकि एक मुखपृष्ठ एकल प्रकार होगा। </p>",
  ...
  "app.components.GuidedTour.CTB.success.content":
    "<p>अच्छा चल रहा है!</p><b>⚡️ आप दुनिया के साथ क्या साझा करना चाहेंगे?</b>",
  "app.components.GuidedTour.CTB.success.title": "चरण 1: पूर्ण✅",
  "app.components.GuidedTour.apiTokens.create.content":
    "<p>यहां एक प्रमाणीकरण टोकन जेनरेट करें और आपके द्वारा अभी-अभी बनाई गई सामग्री को पुनः प्राप्त करें।</p>",
  "app.components.GuidedTour.apiTokens.create.cta.title":
    "एक एपीआई टोकन उत्पन्न करें",
  "app.components.GuidedTour.apiTokens.create.title":
    "🚀 कार्रवाई में सामग्री देखें",
  "app.components.GuidedTour.apiTokens.success.content":
    "<p>HTTP अनुरोध करके सामग्री को क्रियान्वित देखें:</p><ul><li><p>इस URL पर: <light>https://'<'YOUR_DOMAIN'>'/api/'<'YOUR_CT '>'</light></p></li><p>शीर्षक के साथ: <light>प्राधिकरण: वाहक '<'Your_API_TOKEN'>'</light></p></li> </ul><p>सामग्री के साथ इंटरैक्ट करने के अधिक तरीकों के लिए, <दस्तावेज़ीकरणलिंक>दस्तावेज़ीकरण</दस्तावेज़ीकरणलिंक> देखें।</p>",
  ...
  "app.components.GuidedTour.home.CM.title":
    "⚡️ आप दुनिया के साथ क्या साझा करना चाहेंगे?",
  "app.components.GuidedTour.home.CTB.cta.title":
    "सामग्री प्रकार बिल्डर पर जाएं",
  ...
  "app.components.HomePage.community.content":
    "विभिन्न चैनलों पर टीम के सदस्यों, योगदानकर्ताओं और डेवलपर्स के साथ चर्चा करें।",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "बधाई! आप पहले व्यवस्थापक के रूप में लॉग इन हैं। Strapi द्वारा प्रदान की गई शक्तिशाली सुविधाओं को खोजने के लिए, हम आपको अपना पहला सामग्री प्रकार बनाने की सलाह देते हैं!",
  "app.components.HomePage.welcomeBlock.content.again":
    "हमें उम्मीद है कि आप अपनी परियोजना पर प्रगति कर रहे हैं! Strapi के बारे में नवीनतम समाचार पढ़ने के लिए स्वतंत्र महसूस करें। हम आपकी प्रतिक्रिया के आधार पर उत्पाद को बेहतर बनाने के लिए अपना सर्वश्रेष्ठ दे रहे हैं।",
  ...
  "app.components.ImgPreview.hint":
    "अपनी फ़ाइल को इस क्षेत्र में खींचें और छोड़ें या किसी फ़ाइल को अपलोड करने के लिए {ब्राउज़ करें}",
  ...
  "app.components.InstallPluginPage.Download.description":
    "प्लगइन को डाउनलोड और इंस्टॉल करने में कुछ सेकंड लग सकते हैं।",
  ...
  "app.components.LeftMenuLinkContainer.noPluginsInstalled":
    "अभी तक कोई प्लग इन इंस्टॉल नहीं है",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "प्लगइन को अनइंस्टॉल करने में कुछ सेकंड लग सकते हैं।",
  "app.components.ListPluginsPage.deletePlugin.title": "की स्थापना रद्द",
  "app.components.ListPluginsPage.description":
    "परियोजना में स्थापित प्लगइन्स की सूची।",
  "app.components.ListPluginsPage.helmet.title": "सूची प्लगइन्स",
  "app.components.Logout.logout": "लॉग आउट",
  "app.components.Logout.profile": "प्रोफ़ाइल",
  "app.components.MarketplaceBanner":
    "Strapi Awesome पर समुदाय द्वारा बनाए गए प्लग इन और अपने प्रोजेक्ट को किकस्टार्ट करने के लिए कई और शानदार चीज़ें खोजें।",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "AutoReload सुविधा को सक्षम करने की आवश्यकता है। कृपया अपना ऐप `यार्न डिवेलप` के साथ शुरू करें।",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "सुरक्षा कारणों से, एक प्लगइन केवल विकास के माहौल में ही डाउनलोड किया जा सकता है।",
  "app.components.PluginCard.PopUpWarning.install.impossible.title":
    "डाउनलोड करना असंभव है",
  ...
  "app.components.Users.MagicLink.connect":
    "इस उपयोगकर्ता को एक्सेस देने के लिए इस लिंक को कॉपी और शेयर करें",
  "app.components.Users.MagicLink.connect.sso":
    "उपयोगकर्ता को यह लिंक भेजें, पहला लॉगिन एसएसओ प्रदाता के माध्यम से किया जा सकता है",
  ...
  "app.components.Users.ModalCreateBody.block-title.roles.description":
    "एक उपयोगकर्ता की एक या कई भूमिकाएँ हो सकती हैं",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "प्लगइन की स्थापना रद्द करते समय एक त्रुटि हुई",
  "app.containers.App.notification.error.init":
    "एपीआई का अनुरोध करते समय एक त्रुटि हुई",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "यदि आपको यह लिंक नहीं मिलता है, तो कृपया अपने व्यवस्थापक से संपर्क करें।",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "आपका पासवर्ड पुनर्प्राप्ति लिंक प्राप्त करने में कुछ मिनट लग सकते हैं।",
  ...
  "app.page.not.found":
    "उफ़! आप जिस पेज की तलाश कर रहे हैं, वह हमें नहीं मिल रहा है...",
  ...
  clearLabel,
  "coming.soon":
    "यह सामग्री वर्तमान में निर्माणाधीन है और कुछ हफ्तों में वापस आ जाएगी!",
  "component.Input.error.validation.integer": "मान एक पूर्णांक होना चाहिए",
  "components.AutoReloadBlocker.description":
    "निम्न आदेशों में से एक के साथ Strapi चलाएँ:",
  "components.AutoReloadBlocker.header":
    "इस प्लगइन के लिए रीलोड फीचर की आवश्यकता है।",
  ...
  "components.FilterOptions.FILTER_TYPES.$containsi":
    "शामिल है (case insensitive)",
  "components.FilterOptions.FILTER_TYPES.$endsWith":
    "इसी के साथ समाप्त होता है",
  "components.FilterOptions.FILTER_TYPES.$endsWithi":
    "इसी के साथ समाप्त होता है (case insensitive)",
  ...
  "components.FilterOptions.FILTER_TYPES.$notContainsi":
    "शामिल नहीं है (case insensitive)",
  ...
  "components.FilterOptions.FILTER_TYPES.$startsWithi":
    "इसके साथ आरंभ होता है (case insensitive)",
  ...
  "components.Input.error.contain.lowercase":
    "पासवर्ड में कम से कम एक लोअरकेस वर्ण होना चाहिए",
  "components.Input.error.contain.number":
    "सांकेतिक शब्द में कम से कम एक संख्या शामिल होना चाहिए",
  ...
  "components.Input.error.validation.lowercase":
    "मान एक लोअरकेस स्ट्रिंग होना चाहिए",
  ...
  "components.Input.error.validation.unique":
    "यह मान पहले ही उपयोग किया जा चुका है।",
  ...
  "components.OverlayBlocker.description":
    "आप एक ऐसी सुविधा का उपयोग कर रहे हैं जिसके लिए सर्वर को पुनरारंभ करने की आवश्यकता है। कृपया सर्वर चालू होने तक प्रतीक्षा करें.",
  "components.OverlayBlocker.description.serverError":
    "सर्वर को पुनरारंभ होना चाहिए था, कृपया टर्मिनल में अपने लॉग जांचें।",
  "components.OverlayBlocker.title": "पुनः आरंभ की प्रतीक्षा कर रहा है...",
  "components.OverlayBlocker.title.serverError":
    "पुनरारंभ अपेक्षा से अधिक समय ले रहा है",
  "components.PageFooter.select": "प्रति पृष्ठ प्रविष्टियाँ",
  "components.ProductionBlocker.description":
    "सुरक्षा उद्देश्यों के लिए हमें इस प्लगइन को अन्य वातावरणों में अक्षम करना होगा।",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "फ़ाइलें खींचें और छोड़ें, क्लिपबोर्ड से चिपकाएं या {ब्राउज़ करें}।",
  ...
  "content-manager.App.schemas.data-loaded": "स्कीमा सफलतापूर्वक लोड हो गए हैं",
  "content-manager.ListViewTable.relation-loaded": "रिश्तों को लोड किया गया है",
  "content-manager.ListViewTable.relation-loading": "संबंध लोड हो रहे हैं",
  "content-manager.ListViewTable.relation-more":
    "इस संबंध में प्रदर्शित की तुलना में अधिक इकाइयां हैं",
  "content-manager.EditRelations.title": "संबंधपरक डेटा",
  "content-manager.HeaderLayout.button.label-add-entry": "नई प्रविष्टि बनाएं",
  "content-manager.api.id": "एपीआई आईडी",
  "content-manager.components.AddFilterCTA.add": "फिल्टर",
  "content-manager.components.AddFilterCTA.hide": "फिल्टर",
  "content-manager.components.DragHandle-label": "खींचें",
  "content-manager.components.DraggableAttr.edit": "सम्पादन के लिए क्लिक करो",
  "content-manager.components.DraggableCard.delete.field": "चीज़ें हटाएं}",
  "content-manager.components.DraggableCard.edit.field": "संपादित {item}",
  "content-manager.components.DraggableCard.move.field": "{आइटम} ले जाएँ",
  "content-manager.components.ListViewTable.row-line": "आइटम लाइन {नंबर}",
  "content-manager.components.DynamicZone.ComponentPicker-label":
    "एक घटक चुनें",
  "content-manager.components.DynamicZone.add-component":
    "{घटक नाम} में एक घटक जोड़ें",
  "content-manager.components.DynamicZone.delete-label": "{नाम} हटाएं",
  "content-manager.components.DynamicZone.error-message": "घटक में त्रुटि है",
  "content-manager.components.DynamicZone.missing-components":
    "वहाँ {संख्या, बहुवचन, =0 {हैं # अनुपलब्ध घटक} एक {is # अनुपलब्ध घटक} अन्य {हैं # अनुपलब्ध घटक}}",
  "content-manager.components.DynamicZone.move-down-label": "घटक नीचे ले जाएँ",
  "content-manager.components.DynamicZone.move-up-label": "घटक ऊपर ले जाएँ",
  "content-manager.components.DynamicZone.pick-compo": "एक घटक चुनें",
  "content-manager.components.DynamicZone.required": "घटक आवश्यक है",
  "content-manager.components.EmptyAttributesBlock.button":
    "सेटिंग पेज पर जाएं",
  "content-manager.components.EmptyAttributesBlock.description":
    "आप अपनी सेटिंग बदल सकते हैं",
  "content-manager.components.FieldItem.linkToComponentLayout":
    "घटक का लेआउट सेट करें",
  "content-manager.components.FieldSelect.label": "एक फ़ील्ड जोड़ें",
  "content-manager.components.FilterOptions.button.apply": "आवेदन करना",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "प्रविष्टियों को फ़िल्टर करने के लिए लागू करने के लिए शर्तें निर्धारित करें",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "फिल्टर",
  "content-manager.components.FiltersPickWrapper.hide": "छिपाना",
  "content-manager.components.LeftMenu.Search.label": "सामग्री प्रकार खोजें",
  ...
  "content-manager.components.LimitSelect.itemsPerPage": "आइटम प्रति पेज",
  "content-manager.components.NotAllowedInput.text":
    "इस फ़ील्ड को देखने की अनुमति नहीं है",
  "content-manager.components.RepeatableComponent.error-message":
    "घटक (ओं) में त्रुटि है",
  "content-manager.components.Search.placeholder": "एक प्रविष्टि खोजें ...",
  "content-manager.components.Select.draft-info-title": "राज्य: मसौदा",
  "content-manager.components.Select.publish-info-title": "राज्य: प्रकाशित",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "अनुकूलित करें कि संपादन दृश्य कैसा दिखेगा।",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "सूची दृश्य की सेटिंग परिभाषित करें.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "दृश्य कॉन्फ़िगर करें - {नाम}",
  "content-manager.components.TableDelete.delete": "सभी हटा दो",
  "content-manager.components.TableDelete.deleteSelected": "चयनित मिटाएं",
  "content-manager.components.TableDelete.label":
    "{संख्या, बहुवचन, एक {# प्रविष्टि} अन्य {# प्रविष्टियां}} चयनित",
  "content-manager.components.TableEmpty.withFilters":
    "लागू किए गए फ़िल्टर के साथ कोई {contentType} नहीं है...",
  "content-manager.components.TableEmpty.withSearch":
    "खोज से संबंधित कोई {contentType} नहीं है ({search})...",
  "content-manager.components.TableEmpty.withoutFilter":
    "कोई {contentType} नहीं है...",
  "content-manager.components.empty-repeatable":
    "अभी तक कोई प्रविष्टि नहीं। एक जोड़ने के लिए नीचे दिए गए बटन पर क्लिक करें।",
  "content-manager.components.notification.info.maximum-requirement":
    "आप पहले ही फ़ील्ड की अधिकतम संख्या तक पहुँच चुके हैं",
  "content-manager.components.notification.info.minimum-requirement":
    "न्यूनतम आवश्यकता से मेल खाने के लिए एक फ़ील्ड जोड़ा गया है",
  "content-manager.components.repeatable.reorder.error":
    "आपके घटक के क्षेत्र को पुन: व्यवस्थित करते समय एक त्रुटि हुई, कृपया पुन: प्रयास करें",
  "content-manager.components.reset-entry": "प्रविष्टि रीसेट करें",
  "content-manager.components.uid.apply": "लागू",
  "content-manager.components.uid.available": "उपलब्ध",
  "content-manager.components.uid.regenerate": "पुनः जेनरेट",
  "content-manager.components.uid.suggested": "सुझाव दिया",
  "content-manager.components.uid.unavailable": "अनुपलब्ध",
  "content-manager.containers.Edit.Link.Layout": "लेआउट कॉन्फ़िगर करें",
  "content-manager.containers.Edit.Link.Model": "संग्रह-प्रकार संपादित करें",
  "content-manager.containers.Edit.addAnItem": "एक आइटम जोड़ें...",
  "content-manager.containers.Edit.clickToJump":
    "प्रवेश पर जाने के लिए क्लिक करें",
  "content-manager.containers.Edit.delete": "मिटाना",
  "content-manager.containers.Edit.delete-entry": "मिटाना",
  "content-manager.containers.Edit.editing": "संपादन...",
  "content-manager.containers.Edit.information": "जानकारी",
  "content-manager.containers.Edit.information.by": "द्वारा",
  "content-manager.containers.Edit.information.created": "बनाया था",
  "content-manager.containers.Edit.information.draftVersion": "मसौदा संस्करण",
  "content-manager.containers.Edit.information.editing": "संपादन",
  "content-manager.containers.Edit.information.lastUpdate": "आखिरी अपडेट",
  "content-manager.containers.Edit.information.publishedVersion":
    "प्रकाशित संस्करण",
  "content-manager.containers.Edit.pluginHeader.title.new":
    "एक प्रविष्टि बनाएँ",
  "content-manager.containers.Edit.reset": "रीसेट",
  "content-manager.containers.Edit.returnList": "सूची पर लौटें",
  "content-manager.containers.Edit.seeDetails": "विवरण",
  "content-manager.containers.Edit.submit": "बचाना",
  "content-manager.containers.EditSettingsView.modal-form.edit-field":
    "फ़ील्ड संपादित करें",
  "content-manager.containers.EditView.add.new-entry": "एक प्रविष्टि जोड़ें",
  "content-manager.containers.EditView.notification.errors":
    "प्रपत्र में कुछ त्रुटियां हैं",
  "content-manager.containers.Home.introduction":
    "अपनी प्रविष्टियों को संपादित करने के लिए बाएं मेनू में विशिष्ट लिंक पर जाएं। इस प्लगइन में सेटिंग्स को संपादित करने का उचित तरीका नहीं है और यह अभी भी सक्रिय विकास के अधीन है।",
  "content-manager.containers.Home.pluginHeaderDescription":
    "एक शक्तिशाली और सुंदर इंटरफ़ेस के माध्यम से अपनी प्रविष्टियाँ प्रबंधित करें।",
  "content-manager.containers.Home.pluginHeaderTitle": "सामग्री प्रबंधक",
  "content-manager.containers.List.draft": "प्रारूप",
  "content-manager.containers.List.errorFetchRecords": "गलती",
  ...
  "content-manager.containers.ListPage.items":
    "{संख्या, बहुवचन, =0 {आइटम} एक {आइटम} अन्य {आइटम}}",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title.description":
    "अपनी प्रविष्टि का प्रदर्शित फ़ील्ड सेट करें",
  "content-manager.containers.SettingPage.editSettings.relation-field.description":
    "प्रदर्शित फ़ील्ड को संपादन और सूची दृश्य दोनों में सेट करें",
  "content-manager.containers.SettingPage.editSettings.title":
    "दृश्य संपादित करें (सेटिंग्स)",
  "content-manager.containers.SettingPage.layout": "विन्यास",
  "content-manager.containers.SettingPage.listSettings.description":
    "इस संग्रह प्रकार के लिए विकल्पों को कॉन्फ़िगर करें",
  "content-manager.containers.SettingPage.listSettings.title":
    "सूची दृश्य (सेटिंग्स)",
  "content-manager.containers.SettingPage.pluginHeaderDescription":
    "इस संग्रह प्रकार के लिए विशिष्ट सेटिंग्स कॉन्फ़िगर करें",
  "content-manager.containers.SettingPage.settings": "समायोजन",
  "content-manager.containers.SettingPage.view": "देखना",
  ...
  "content-manager.containers.SettingsPage.Block.contentType.description":
    "विशिष्ट सेटिंग्स कॉन्फ़िगर करें",
  ...
  "content-manager.containers.SettingsPage.Block.generalSettings.description":
    "अपने संग्रह प्रकारों के लिए डिफ़ॉल्ट विकल्प कॉन्फ़िगर करें",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "अपने सभी संग्रह प्रकारों और समूहों के लिए सेटिंग कॉन्फ़िगर करें",
  "content-manager.containers.SettingsView.list.subtitle":
    "अपने संग्रह प्रकारों और समूहों का लेआउट और प्रदर्शन कॉन्फ़िगर करें",
  "content-manager.containers.SettingsView.list.title": "प्रदर्शन विन्यास",
  "content-manager.edit-settings-view.link-to-ctb.components":
    "घटक संपादित करें",
  "content-manager.edit-settings-view.link-to-ctb.content-types":
    "सामग्री प्रकार संपादित करें",
  "content-manager.emptyAttributes.button": "कलेक्शन टाइप बिल्डर पर जाएं",
  "content-manager.emptyAttributes.description":
    "अपने संग्रह प्रकार में अपना पहला फ़ील्ड जोड़ें",
  "content-manager.emptyAttributes.title": "अभी तक कोई फ़ील्ड नहीं है",
  "content-manager.error.attribute.key.taken": "यह मान पहले से मौजूद है",
  "content-manager.error.attribute.sameKeyAndName": "बराबर नहीं हो सकता",
  "content-manager.error.attribute.taken": "यह फ़ील्ड नाम पहले से मौजूद है",
  "content-manager.error.contentTypeName.taken": "यह नाम पहले से मौजूद है",
  "content-manager.error.model.fetch":
    "मॉडल कॉन्फिगर लाने के दौरान एक त्रुटि हुई।",
  "content-manager.error.record.create":
    "रिकॉर्ड निर्माण के दौरान एक त्रुटि हुई।",
  "content-manager.error.record.delete":
    "रिकॉर्ड हटाने के दौरान एक त्रुटि हुई।",
  "content-manager.error.record.fetch": "रिकॉर्ड लाने के दौरान एक त्रुटि हुई।",
  "content-manager.error.record.update":
    "रिकॉर्ड अद्यतन के दौरान एक त्रुटि हुई।",
  "content-manager.error.records.count":
    "गणना रिकॉर्ड लाने के दौरान एक त्रुटि हुई।",
  "content-manager.error.records.fetch": "रिकॉर्ड लाने के दौरान एक त्रुटि हुई।",
  "content-manager.error.schema.generation":
    "स्कीमा जनरेशन के दौरान कोई त्रुटि उत्पन्न हुई।",
  "content-manager.error.validation.json": "यह JSON नहीं है",
  "content-manager.error.validation.max": "मान बहुत ज़्यादा है.",
  "content-manager.error.validation.maxLength": "मान बहुत लंबा है",
  "content-manager.error.validation.min": "मान बहुत कम है।",
  "content-manager.error.validation.minLength": "मान बहुत छोटा है",
  "content-manager.error.validation.minSupMax": "श्रेष्ठ नहीं हो सकता",
  "content-manager.error.validation.regex": "मान रेगेक्स से मेल नहीं खाता।",
  "content-manager.error.validation.required": "यह मान इनपुट आवश्यक है।",
  "content-manager.form.Input.bulkActions": "बल्क कार्रवाइयां सक्षम करें",
  "content-manager.form.Input.defaultSort": "डिफ़ॉल्ट सॉर्ट विशेषता",
  "content-manager.form.Input.description": "विवरण",
  "content-manager.form.Input.description.placeholder":
    "प्रोफ़ाइल में नाम प्रदर्शित करें",
  "content-manager.form.Input.editable": "संपादन योग्य क्षेत्र",
  "content-manager.form.Input.filters": "फ़िल्टर सक्षम करें",
  "content-manager.form.Input.label": "लेबल",
  "content-manager.form.Input.label.inputDescription":
    "यह मान तालिका के शीर्ष में प्रदर्शित लेबल को ओवरराइड करता है",
  "content-manager.form.Input.pageEntries": "प्रति पृष्ठ प्रविष्टियाँ",
  "content-manager.form.Input.pageEntries.inputDescription":
    "नोट: आप संग्रह प्रकार सेटिंग पृष्ठ में इस मान को ओवरराइड कर सकते हैं।",
  "content-manager.form.Input.placeholder": "प्लेसहोल्डर",
  "content-manager.form.Input.placeholder.placeholder": "मेरा अद्भुत मूल्य",
  "content-manager.form.Input.search": "खोज सक्षम करें",
  "content-manager.form.Input.search.field": "इस क्षेत्र में खोज सक्षम करें",
  "content-manager.form.Input.sort.field":
    "इस फ़ील्ड पर क्रमित करना सक्षम करें",
  "content-manager.form.Input.sort.order": "डिफ़ॉल्ट सॉर्ट क्रम",
  "content-manager.form.Input.wysiwyg": "WYSIWYG के रूप में प्रदर्शित करें",
  "content-manager.global.displayedFields": "प्रदर्शित फ़ील्ड",
  "content-manager.groups": "समूहों",
  "content-manager.groups.numbered": "समूहों ({number})",
  "content-manager.header.name": "विषय",
  "content-manager.link-to-ctb": "मॉडल संपादित करें",
  "content-manager.models": "संग्रह प्रकार",
  "content-manager.models.numbered": "संग्रह प्रकार ({number})",
  "content-manager.notification.error.displayedFields":
    "आपको कम से कम एक प्रदर्शित फ़ील्ड चाहिए",
  "content-manager.notification.error.relationship.fetch":
    "संबंध लाने के दौरान एक त्रुटि हुई।",
  "content-manager.notification.info.SettingPage.disableSort":
    "छँटाई की अनुमति के साथ आपके पास एक विशेषता होनी चाहिए",
  "content-manager.notification.info.minimumFields":
    "आपको कम से कम एक फ़ील्ड प्रदर्शित करने की आवश्यकता है",
  "content-manager.notification.upload.error":
    "आपकी फ़ाइलें अपलोड करते समय एक त्रुटि हुई है",
  "content-manager.pageNotFound": "पृष्ठ नहीं मिला",
  "content-manager.pages.ListView.header-subtitle":
    "{संख्या, बहुवचन, =0 {# प्रविष्टियां} एक {# प्रविष्टि} अन्य {# प्रविष्टियां}} मिली",
  "content-manager.pages.NoContentType.button":
    "अपना पहला सामग्री-प्रकार बनाएं",
  "content-manager.pages.NoContentType.text":
    "आपके पास अभी तक कोई सामग्री नहीं है, हम अनुशंसा करते हैं कि आप अपना पहला सामग्री-प्रकार बनाएं।",
  "content-manager.permissions.not-allowed.create":
    "आपको दस्तावेज़ बनाने की अनुमति नहीं है",
  "content-manager.permissions.not-allowed.update":
    "आपको यह दस्तावेज़ देखने की अनुमति नहीं है",
  "content-manager.plugin.description.long":
    "अपने डेटाबेस में डेटा को देखने, संपादित करने और हटाने का त्वरित तरीका।",
  "content-manager.plugin.description.short":
    "अपने डेटाबेस में डेटा को देखने, संपादित करने और हटाने का त्वरित तरीका।",
  "content-manager.popover.display-relations.label": "प्रदर्शन संबंध",
  "content-manager.success.record.delete": "हटाए गए",
  "content-manager.success.record.publish": "प्रकाशित",
  "content-manager.success.record.save": "बचाया",
  "content-manager.success.record.unpublish": "अप्रकाशित",
  "content-manager.utils.data-loaded":
    "{संख्या, बहुवचन, =1 {प्रविष्टि में} अन्य {प्रविष्टियां हैं}} सफलतापूर्वक लोड हो गए हैं",
  "content-manager.apiError.This attribute must be unique":
    "{फ़ील्ड} अद्वितीय होना चाहिए",
  "content-manager.popUpWarning.warning.publish-question":
    "क्या आप अब भी इसे प्रकाशित करना चाहते हैं?",
  ...
  "content-manager.popUpwarning.warning.has-draft-relations.message":
    "<b>{गिनती, बहुवचन, =0 { आपकी सामग्री संबंध है} एक { आपके सामग्री संबंधों में से} अन्य { आपके सामग्री संबंध हैं}}</b> अभी तक प्रकाशित नहीं हुए हैं।<br></br>यह आपके प्रोजेक्ट पर टूटी कड़ियाँ और त्रुटियाँ उत्पन्न कर सकता है।",
  ...
  "global.prompt.unsaved":
    "क्या आप वाकई इस पेज को छोड़ना चाहते हैं? आपके सभी संशोधन नष्ट हो जाएंगे",
  ...
  "notification.contentType.relations.conflict":
    "सामग्री प्रकार में परस्पर विरोधी संबंध हैं",
...
//# sourceMappingURL=hi-eUDhoDjK.mjs.map
