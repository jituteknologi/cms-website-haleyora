...
const useContentTypes = require("./useContentTypes-onkhq4uE.js");
...
const GuidedTourHomepage = () => {
  ...
  const sections = Object.entries(AuthenticatedApp.LAYOUT_DATA).map(
    ([key, val]) => ({
      key,
      title: val.home.title,
      content: /* @__PURE__ */ jsxRuntime.jsx(v2.LinkButton, {
      ...
      isDone: Object.entries(guidedTourState[key]).every(([, value]) => value),
    })
  );
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
            children: sections.map((section, index2) => {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                          ...
                          children: /* @__PURE__ */ jsxRuntime.jsx(
                            AuthenticatedApp.Number,
                            { state, children: index2 + 1 }
                          ),
                        }),
                    ...
                    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
                          ...
                          marginRight: 5,
                          children:
                            index2 === sections.length - 1
                              ? null
                              : /* @__PURE__ */ jsxRuntime.jsx(
                                  AuthenticatedApp.VerticalDivider,
                                  { state }
                                ),
                        }),
                        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                          marginTop: 2,
                          children:
                            state === AuthenticatedApp.STATES.IS_ACTIVE
                              ? section.content
                              : null,
                        }),
                      ],
                              ...
                              children: [
                                /* @__PURE__ */ jsxRuntime.jsx(
                                  designSystem.Typography,
                                  {
                                    as: "h1",
                                    variant: "alpha",
                                    children: hasAlreadyCreatedContentTypes
                                      ? formatMessage({
                                ...
                                /* @__PURE__ */ jsxRuntime.jsx(WordWrap, {
                                ...
                                hasAlreadyCreatedContentTypes
                                  ? /* @__PURE__ */ jsxRuntime.jsx(v2.Link, {
                                      isExternal: true,
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
                    col: 8,
                    s: 12,
                    children: showGuidedTour
                      ? /* @__PURE__ */ jsxRuntime.jsx(GuidedTourHomepage, {})
                      : /* @__PURE__ */ jsxRuntime.jsx(ContentBlocks, {}),
                  }),
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
                    col: 4,
                    s: 12,
                    children: /* @__PURE__ */ jsxRuntime.jsx(SocialLinks, {}),
                  }),
                ],
              }),
            ],
...
const ContentBlocks = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
    ...
    gap: 5,
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(BlockLink, {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          ...
          gap: 6,
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(CloudCustomWrapper, {
              hasRadius: true,
              padding: 3,
              children: /* @__PURE__ */ jsxRuntime.jsx(CloudIconWrapper, {
                width: "2rem",
                height: "2rem",
                justifyContent: "center",
                hasRadius: true,
      ...
      /* @__PURE__ */ jsxRuntime.jsx(BlockLink, {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.ContentBox, {
          title: formatMessage({
...
const SocialLinks = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(GridGap, {
        children: socialLinksExtended.map(({ icon, link, name }) => {
          return /* @__PURE__ */ jsxRuntime.jsx(
            designSystem.GridItem,
            {
              col: 6,
              s: 12,
              children: /* @__PURE__ */ jsxRuntime.jsx(LinkCustom, {
                size: "L",
                startIcon: icon,
                variant: "tertiary",
                href: link,
...
const HomePage = () => {
  const Page = index.useEnterprise(
    ...
    async () =>
      (await Promise.resolve().then(() => require("./HomePage-KOdImcon.js")))
        .HomePageEE
  );
  if (!Page) {
    return null;
...
//# sourceMappingURL=HomePage-8_8QD2eN.js.map
