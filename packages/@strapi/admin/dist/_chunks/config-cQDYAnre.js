...
const devAliases = {
  ...
  "@strapi/content-releases/strapi-admin":
    "./packages/core/content-releases/admin/src",
  ...
  "@strapi/plugin-color-picker/strapi-admin":
    "./packages/plugins/color-picker/admin/src",
  "@strapi/plugin-documentation/strapi-admin":
    "./packages/plugins/documentation/admin/src",
...
async function loadStrapiMonorepo(cwd) {
  ...
  while (p !== "/") {
    ...
    p = path__default$1.default.dirname(
      path__default$1.default.dirname(readResult.path)
    );
  }
  return void 0;
}
