...
const FormHead = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
    ...
    primaryAction: canEditInputs
      ? /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          gap: 2,
          children: [
            canRegenerate &&
              token?.id &&
              /* @__PURE__ */ jsxRuntime.jsx(Regenerate, {
    ...
    navigationAction: /* @__PURE__ */ jsxRuntime.jsx(jsxRuntime.Fragment, {
...
const TokenBox = ({ token, tokenType }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.ContentBox, {
    endAction:
      token &&
...
const getDateOfExpiration = (createdAt, duration, language = "en") => {
  if (duration && typeof duration === "number") {
    ...
    return dateFns.format(
      dateFns.addDays(new Date(createdAt), durationInDays),
      "PPP",
      {
...
const TokenTypeSelect = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelect, {
    ...
    children:
      options &&
      options.map(({ value: value2, label: label2 }) =>
        /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.SingleSelectOption,
          { value: value2, children: formatMessage(label2) },
          value2
        )
      ),
  });
...
//# sourceMappingURL=TokenTypeSelect-F79ta7iK.js.map
