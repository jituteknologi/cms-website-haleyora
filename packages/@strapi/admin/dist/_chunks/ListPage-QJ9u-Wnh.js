...
const SelectRoles = require("./SelectRoles-OYK2B3u2.js");
...
require("./useAdminRoles-Azeibt7M.js");
...
const ModalForm = ({ onToggle }) => {
  ...
  const roleLayout = index.useEnterprise(
    ROLE_LAYOUT,
    async () =>
      (await Promise.resolve().then(() => require("./ModalForm-cFcYN_zA.js")))
        .ROLE_LAYOUT,
    {
  ...
  const MagicLink = index.useEnterprise(
    ...
    async () =>
      (await Promise.resolve().then(() => require("./MagicLinkEE-fQDGvBPD.js")))
        .MagicLinkEE
  );
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalHeader, {
        children: /* @__PURE__ */ jsxRuntime.jsx(v2.Breadcrumbs, {
          label: headerTitle,
          children: /* @__PURE__ */ jsxRuntime.jsx(v2.Crumb, {
            isCurrent: true,
      ...
      /* @__PURE__ */ jsxRuntime.jsx(formik.Formik, {
        ...
        children: ({ errors, handleChange, values, isSubmitting }) => {
          return /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Form, {
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalBody, {
                children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  ...
                  children: [
                    currentStep !== "create" &&
                      /* @__PURE__ */ jsxRuntime.jsx(MagicLink, {
                        registrationToken,
                      }),
...
const FORM_SCHEMA = yup__namespace.object().shape({
  ...
  email: yup__namespace
    ...
    .required(helperPlugin.translatedErrors.required),
  roles: yup__namespace
    .array()
    .min(1, helperPlugin.translatedErrors.required)
    .required(helperPlugin.translatedErrors.required),
});
const STEPPER = {
  create: {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.BaseCheckbox,
                  {
                    "aria-label": formatMessage(
                      ...
                      {
                        target: AuthenticatedApp.getFullName(
                          data?.firstname ?? "",
                          data.lastname
                        ),
                      }
    ...
    async () =>
      (
        await Promise.resolve().then(() =>
          require("./CreateActionEE-mG66fRGh.js")
        )
      ).CreateActionEE
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
        primaryAction:
          canCreate &&
          /* @__PURE__ */ jsxRuntime.jsx(CreateAction, {
          ...
          startActions: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(Filters.Filters, {
                displayedFilters: DISPLAYED_HEADERS,
              }),
            ],
          }),
        }),
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ContentLayout, {
        children: [
          !canRead &&
            /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.NoPermissions, {}),
          isError &&
            /* @__PURE__ */ jsxRuntime.jsx("div", {
              children: "TODO: An error occurred",
            }),
          canRead &&
            /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.DynamicTable, {
                  contentType: "Users",
                  isLoading,
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(TableRows, {
                    canDelete,
                  }),
                }),
                pagination &&
      ...
      isModalOpened &&
        /* @__PURE__ */ jsxRuntime.jsx(ModalForm, { onToggle: handleToggle }),
    ],
  });
};
const TABLE_HEADERS = [
  ...
  },
  {
    ...
    cellFormatter({ isActive }, { formatMessage }) {
      return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Status, {
...
const ListPage = () => {
  const UsersListPage = index.useEnterprise(
    ...
    async () =>
      ...
      (await Promise.resolve().then(() => require("./ListPage-oEz5aRQg.js")))
        .UserListPageEE
  );
  if (!UsersListPage) {
    return null;
...
const ProtectedListPage = () => {
  const permissions = index.useTypedSelector(
    (state) => state.admin_app.permissions.settings?.users.main
  );
...
//# sourceMappingURL=ListPage-QJ9u-Wnh.js.map
