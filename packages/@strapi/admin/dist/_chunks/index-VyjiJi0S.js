...
const createTypedSelector = (selector) =>
  toolkit.createSelector((state) => state, selector);
...
const { setAdminPermissions, setAppTheme, setAvailableThemes, setLocale } =
  adminSlice.actions;
...
const PrivateRoute = ({ children, ...rest }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
    ...
    render: ({ location: { pathname, search } }) =>
      token !== null
        ? children
        : /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Redirect, {
            to: {
              pathname: "/auth/login",
              search:
                pathname !== "/"
...
const ADMIN_PERMISSIONS_CE = {
  ...
  settings: {
    ...
    "transfer-tokens": {
      ...
      regenerate: [
        { action: "admin::transfer.tokens.regenerate", subject: null },
      ],
    },
    "project-settings": {
        ...
        return {
          authLogo: data.authLogo
            ? {
                ...
                url: helperPlugin.prefixFileUrlWithBackendUrl(
                  data.authLogo.url
                ),
              }
            : void 0,
...
const [ConfigurationContextProvider, useConfiguration] =
  reactContext.createContext("ConfigurationContext");
...
`;
const LocaleToggle = () => {
  const localeNames = useTypedSelector(
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelect, {
    ...
    children: Object.entries(localeNames).map(([language, name2]) =>
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.SingleSelectOption,
        { value: language, children: name2 },
        language
      )
    ),
  });
...
const LayoutContent = ({ children }) =>
  /* @__PURE__ */ jsxRuntime.jsx(Wrapper$3, {
    shadow: "tableShadow",
    hasRadius: true,
    paddingTop: 9,
    paddingBottom: 9,
...
const LOGIN_SCHEMA = yup__namespace.object().shape({
  email: yup__namespace
    .string()
    .email(helperPlugin.translatedErrors.email)
    .required(helperPlugin.translatedErrors.required),
  password: yup__namespace
    .string()
    .required(helperPlugin.translatedErrors.required),
...
const Login = ({ children }) => {
  ...
  const handleLogin = async (body) => {
    ...
    if ("error" in res) {
      ...
      if (
        camelCase__default.default(message).toLowerCase() === "usernotactive"
      ) {
        push("/auth/oops");
        return;
      }
    ...
    children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, {
      children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(formik.Formik, {
              ...
              children: ({ values, errors, handleChange }) =>
                /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Form, {
                  children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx(PasswordInput$2, {
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
            paddingTop: 4,
            children: /* @__PURE__ */ jsxRuntime.jsx(v2.Link, {
              ...
              children: [
                ...
                error
                  ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
                      ...
                      tabIndex: -1,
                      textColor: "danger600",
                      children: isBaseQueryError(error)
...
const checkIfShouldShowSurvey = (settings) => {
  const { enabled, lastResponseDate, firstDismissalDate, lastDismissalDate } =
    settings;
  ...
  if (lastResponseDate) {
    const timeSinceLastResponse =
      Date.now() - new Date(lastResponseDate).getTime();
  ...
  if (lastDismissalDate) {
    const timeSinceLastDismissal =
      Date.now() - new Date(lastDismissalDate).getTime();
  ...
  if (firstDismissalDate) {
    const timeSinceFirstDismissal =
      Date.now() - new Date(firstDismissalDate).getTime();
...
const NpsSurvey = () => {
  ...
  const [isFeedbackResponse, setIsFeedbackResponse] =
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Portal, {
    children: /* @__PURE__ */ jsxRuntime.jsx(formik.Formik, {
      ...
      children: ({ values, handleChange, setFieldValue, isSubmitting }) =>
                          ...
                          return /* @__PURE__ */ jsxRuntime.jsx(
                            FieldWrapper$1,
                            {
                              ...
                              children: /* @__PURE__ */ jsxRuntime.jsxs(
                                designSystem.FieldLabel,
                                {
                                  htmlFor: `nps-survey-rating-${number}-input`,
                                  children: [
                                    /* @__PURE__ */ jsxRuntime.jsx(
                                      designSystem.VisuallyHidden,
                                      {
                                        children:
                                          /* @__PURE__ */ jsxRuntime.jsx(
...
function useNpsSurveySettings() {
  const [npsSurveySettings, setNpsSurveySettings] =
    helperPlugin.usePersistentState("STRAPI_NPS_SURVEY_SETTINGS", {
      enabled: true,
      lastResponseDate: null,
      firstDismissalDate: null,
      lastDismissalDate: null,
...
const REGISTER_USER_SCHEMA = yup__namespace.object().shape({
  ...
  password: yup__namespace
    .string()
    .min(8, helperPlugin.translatedErrors.minLength)
  ...
  confirmPassword: yup__namespace
    .string()
    .oneOf(
      [yup__namespace.ref("password"), null],
      "components.Input.error.password.noMatch"
    )
    .required(helperPlugin.translatedErrors.required),
  registrationToken: yup__namespace
    .string()
    .required(helperPlugin.translatedErrors.required),
});
const REGISTER_ADMIN_SCHEMA = yup__namespace.object().shape({
  ...
  email: yup__namespace
    ...
    .email(helperPlugin.translatedErrors.email)
    .strict()
    .lowercase(helperPlugin.translatedErrors.lowercase)
    .required(helperPlugin.translatedErrors.required),
  confirmPassword: yup__namespace
    .string()
    .oneOf(
...
const Register = ({ hasAdmin }) => {
  ...
  const { data: userInfo, error } = useGetRegistrationInfoQuery(
    registrationToken,
    {
  ...
  React__namespace.useEffect(() => {
    if (error) {
      const message = isBaseQueryError(error)
        ? formatAPIError(error)
        : error.message ?? "";
      toggleNotification({
        type: "warning",
  ...
  const handleRegisterAdmin = async ({ news, ...body }, setFormErrors) => {
    ...
    if ("data" in res) {
      ...
      if (roles) {
        const isUserSuperAdmin = roles.find(
          ({ code }) => code === "strapi-super-admin"
        );
        if (isUserSuperAdmin) {
    ...
    children: /* @__PURE__ */ jsxRuntime.jsxs(LayoutContent, {
      children: [
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
              ...
              children: formatMessage({
                ...
                defaultMessage:
                  "Credentials are only used to authenticate in CMS. All saved data will be stored in your database.",
              }),
            }),
            apiError
              ? /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
        ...
        /* @__PURE__ */ jsxRuntime.jsx(formik.Formik, {
            ...
            try {
              ...
              if (normalizedData.registrationToken) {
                ...
                await handleRegisterAdmin(
                  omit__default.default(normalizedData, [
                    "registrationToken",
                    "confirmPassword",
                  ]),
                  formik2.setErrors
          ...
          validateOnChange: false,
          children: ({ values, errors, handleChange }) => {
            return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Form, {
              children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Main, {
                children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  ...
                  marginTop: 7,
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, {
                      gap: 4,
                      children: [
                        /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
                          col: 6,
                          children: /* @__PURE__ */ jsxRuntime.jsx(
                            designSystem.TextInput,
                            {
                              ...
                              error: errors.firstname
                                ? formatMessage(errors.firstname)
                                : void 0,
                              onChange: handleChange,
                              label: formatMessage({
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(PasswordInput$1, {
                      name: "password",
                      onChange: handleChange,
                      value: values.password,
                      error: errors.password
                        ? formatMessage(errors.password)
                        : void 0,
                      endAction: /* @__PURE__ */ jsxRuntime.jsx(
                        FieldActionWrapper$1,
                        {
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(PasswordInput$1, {
                      ...
                      error: errors.confirmPassword
                        ? formatMessage(errors.confirmPassword)
                        : void 0,
                      endAction: /* @__PURE__ */ jsxRuntime.jsx(
                        FieldActionWrapper$1,
                        {
              ...
              children: ({ values, errors, handleChange }) =>
                /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Form, {
                  children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                    ...
                    gap: 6,
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(PasswordInput, {
                        name: "password",
                        onChange: handleChange,
                        value: values.password,
                        error: errors.password
...
const AuthPage = ({ hasAdmin }) => {
  ...
  const Login$1 = useEnterprise(
    Login,
    async () =>
      (await Promise.resolve().then(() => require("./Login-4FOq3sMY.js")))
        .LoginEE
  );
  const forms = useEnterprise(
    FORMS,
    async () =>
      (await Promise.resolve().then(() => require("./constants-obwPO3fy.js")))
        .FORMS,
    {
...
const NotFoundPage = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, {
    labelledBy: "title",
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
        id: "title",
        title: formatMessage({
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
        children: /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.EmptyStateLayout,
          {
            ...
            hasRadius: true,
            icon: /* @__PURE__ */ jsxRuntime.jsx(Icons.EmptyPictures, {
              width: "10rem",
            }),
            shadow: "tableShadow",
          }
...
const NotFoundPage$1 = /* @__PURE__ */ Object.freeze(
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs("form", {
            ...
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                    paddingTop: 6,
                    paddingBottom: 1,
                    width: helperPlugin.pxToRem(250),
                    children: /* @__PURE__ */ jsxRuntime.jsx(TypographyCenter, {
                      variant: "alpha",
                      as: "h1",
                      id: "usecase-title",
                      children: formatMessage({
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                ...
                gap: 6,
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Select, {
                    id: "usecase",
                    "data-testid": "usecase",
                    label: formatMessage({
                    ...
                    value: role,
                    children: options.map(({ intlLabel, value }) =>
                      /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.Option,
                        { value, children: formatMessage(intlLabel) },
                        value
                      )
                    ),
                  }),
...
const createRoute = (loadComponent, to, exact = false) => {
  return /* @__PURE__ */ jsxRuntime.jsx(
    ...
    {
      render: () =>
        /* @__PURE__ */ jsxRuntime.jsx(LazyCompo, { loadComponent }),
      path: to,
      exact: exact || false,
    },
    to
...
const AuthenticatedApp = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./AuthenticatedApp-d4HwjDw9.js"))
    .then((n) => n.AuthenticatedApp)
    .then((mod) => ({ default: mod.AuthenticatedApp }))
);
const App$2 = ({
  authLogo,
  menuLogo,
  ...
  const adminPermissions = useEnterprise(
    ...
    async () =>
      (await Promise.resolve().then(() => require("./constants-Y8Gj8EuL.js")))
  ...
  const authRoutes = React__namespace.useMemo(() => {
    ...
    return routes.map(({ to, Component: Component2, exact }) =>
      createRoute(Component2, to, exact)
    );
  }, [routes]);
  React__namespace.useEffect(() => {
  ...
  if (initQuery.isLoading || (Array.isArray(routes) && routes.length === 0)) {
    return /* @__PURE__ */ jsxRuntime.jsx(
      helperPlugin.LoadingIndicatorPage,
      {}
    );
  }
  return /* @__PURE__ */ jsxRuntime.jsxs(React__namespace.Suspense, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ConfigurationProvider, {
        authLogo: {
          default: authLogo,
          custom: {
            url: customAuthLogo ?? "",
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Switch, {
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
                  path: "/auth/:authType",
                  render: (routerProps) =>
                    /* @__PURE__ */ jsxRuntime.jsx(AuthPage, {
                      ...routerProps,
                      hasAdmin: Boolean(hasAdmin),
                    }),
                  exact: true,
                }),
                /* @__PURE__ */ jsxRuntime.jsx(PrivateRoute, {
                  path: "/usecase",
...
const GuidedTourProvider = ({ children }) => {
  const [
    ...
    dispatch,
  ] = React__namespace.useReducer(reducer$8, initialState$9, initialiseState);
  const setCurrentStep = (step) => {
    if (step !== null) {
      ...
      const currentStepIndex = sectionArray.findIndex(
        ([key]) => key === stepName
      );
      const previousSteps = sectionArray.slice(0, currentStepIndex);
      const isStepToShow = previousSteps.every(
  ...
  const startSection = (sectionName) => {
    ...
    if (sectionSteps) {
      ...
      const currentSectionIndex = guidedTourArray.findIndex(
        ([key]) => key === sectionName
      );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.GuidedTourProvider, {
    guidedTourState,
    currentStep,
    setCurrentStep,
...
const reducer$8 = (state = initialState$9, action) =>
...
const initialiseState = (initialState2) => {
  ...
  const guidedTourLocaleStorage = helperPlugin.auth.get(
    "GUIDED_TOUR_COMPLETED_STEPS"
  );
  const currentStepLocaleStorage = helperPlugin.auth.get(
  ...
  if (Array.isArray(guidedTourLocaleStorage)) {
    guidedTourLocaleStorage.forEach((step) => {
      ...
      set__default.default(
        copyInitialState,
        ["guidedTourState", sectionName, stepName],
        true
      );
    });
  }
...
const addCompletedStep = (completedStep) => {
  const currentSteps =
    helperPlugin.auth.get("GUIDED_TOUR_COMPLETED_STEPS") ?? [];
...
const LanguageProvider = ({ children, messages }) => {
  ...
  const appMessages = defaultsDeep__default.default(
    messages[locale],
    messages.en
  );
...
const Theme = ({ children, themes }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.DesignSystemProvider, {
    ...
    children: [children, /* @__PURE__ */ jsxRuntime.jsx(GlobalStyle, {})],
  });
};
...
const Providers = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(reactRedux.Provider, {
    store,
    children: /* @__PURE__ */ jsxRuntime.jsx(AuthProvider, {
            ...
            reactQuery.QueryClientProvider,
            {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(
                helperPlugin.StrapiAppProvider,
                {
                  ...
                  settings,
                  children: /* @__PURE__ */ jsxRuntime.jsx(
                    helperPlugin.LibraryProvider,
                    {
                      components,
                      fields,
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                        helperPlugin.CustomFieldsProvider,
                        {
                          customFields,
                          children: /* @__PURE__ */ jsxRuntime.jsx(
                            helperPlugin.AutoReloadOverlayBlockerProvider,
                            {
                              children: /* @__PURE__ */ jsxRuntime.jsx(
                                helperPlugin.OverlayBlockerProvider,
                                {
                                  children: /* @__PURE__ */ jsxRuntime.jsx(
                                    GuidedTourProvider,
                                    {
                                      children: /* @__PURE__ */ jsxRuntime.jsx(
                                        helperPlugin.NotificationsProvider,
                                        { children }
                                      ),
                                    }
                                  ),
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      descriptions.map((description) => {
        ...
        return /* @__PURE__ */ jsxRuntime.jsx(
          Description,
          { id: key, description, props, update },
          key
        );
      }),
      children(states),
...
const generatePermissionsObject = (uid) => {
  const permissions2 = {
    ...
    publish: [
      { action: "plugin::content-manager.explorer.publish", subject: null },
    ],
...
const useAllowedActions = (slug) => {
  ...
  const permissions2 = useTypedSelector(
    (state) => state["content-manager_rbacManager"].permissions
  );
  const { allowedActions } = helperPlugin.useRBAC(
    viewPermissions,
    permissions2 ?? []
  );
...
const getFieldName = (stringName) =>
  stringName
    .split(".")
    .filter((string) => isNaN__default.default(parseInt(string, 10)));
const getMaxTempKey = (arr) => {
  if (arr.length === 0) {
    return -1;
  }
  const maxValue = Math.max(
    ...arr.map((o) => Number(o.id ?? o.__temp_key__ ?? 0))
  );
    ...
    Object.keys(attributes).reduce((acc, current) => {
      ...
      if (attribute.type === "relation") {
        acc[current] = [
          ...
          ? yup__namespace.object().nullable()
          : yup__namespace.array().nullable();
      }
      if (attribute.type === "component") {
            ...
            if (min) {
              if (required) {
                baseSchema = baseSchema.min(
                  min,
                  helperPlugin.translatedErrors.min
                );
              ...
              baseSchema = baseSchema.min(
                1,
                helperPlugin.translatedErrors.required
              );
            }
            if (max) {
              baseSchema = baseSchema.max(
                max,
                helperPlugin.translatedErrors.max
              );
            }
            return baseSchema;
          });
        ...
        const componentSchema = yup__namespace.lazy((obj) => {
          if (obj !== void 0) {
            return attribute.required === true && !options2.isDraft
              ? componentFieldSchema.defined()
              : componentFieldSchema.nullable();
          }
          return attribute.required === true
            ? yup__namespace.object().defined()
            : yup__namespace.object().nullable();
        });
      ...
      if (attribute.type === "dynamiczone") {
        ...
        if (min) {
          if (attribute.required) {
            dynamicZoneSchema = dynamicZoneSchema
              .test("min", helperPlugin.translatedErrors.min, (value) => {
        ...
        if (max) {
          dynamicZoneSchema = dynamicZoneSchema.max(
            max,
            helperPlugin.translatedErrors.max
          );
        }
...
const createYupSchemaAttribute = (type, validations, options2) => {
  ...
  if (type === "blocks") {
    schema = yup__namespace
      .mixed()
      .test("isJSON", helperPlugin.translatedErrors.json, (value) => {
  ...
  if (type === "json") {
    schema = yup__namespace
      .mixed(helperPlugin.translatedErrors.json)
      .test("isJSON", helperPlugin.translatedErrors.json, (value) => {
        if (options2.isJSONTestDisabled) {
          return true;
        }
  ...
  if (["number", "integer", "float", "decimal"].includes(type)) {
    schema = yup__namespace
      .number()
      .transform((cv) => (isNaN__default.default(cv) ? void 0 : cv))
      .typeError();
  }
  if (type === "biginteger") {
  ...
  Object.keys(validations).forEach((validation) => {
    ...
    if (
      !!validationValue || // @ts-expect-error – see comment at top of file
      (!isBoolean__default.default(validationValue) &&
        Number.isInteger(Math.floor(validationValue))) || // @ts-expect-error – see comment at top of file
      validationValue === 0
    ) {
      switch (validation) {
        case "required": {
        ...
        case "maxLength":
          schema = schema.max(
            validationValue,
            helperPlugin.translatedErrors.maxLength
          );
          break;
        case "min": {
          if (type === "biginteger") {
            schema = schema.isSuperior(
              helperPlugin.translatedErrors.min,
              validationValue
            );
          } else {
        ...
        case "minLength": {
          if (!options2.isDraft) {
            schema = schema.min(
              validationValue,
              helperPlugin.translatedErrors.minLength
            );
          }
          break;
        }
...
const InjectionZoneList = ({ area, ...props }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx("ul", {
    children: injectedComponents.map(({ name: name2, Component: Component2 }) =>
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.Box,
        {
          padding: 3,
...
const DialogConfirmDelete = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog, {
    ...
    isOpen,
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.DialogBody, {
        icon: /* @__PURE__ */ jsxRuntime.jsx(Icons.ExclamationMarkCircle, {}),
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          direction: "column",
          alignItems: "stretch",
          gap: 2,
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
              children: /* @__PURE__ */ jsxRuntime.jsx(InjectionZoneList, {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.DialogFooter, {
        startAction: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, {
...
const CheckboxDataCell = ({ rowId, index }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.BaseCheckbox, {
...
const Root$1 = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Table.Body, {
    children: [
      children,
      /* @__PURE__ */ jsxRuntime.jsx(DialogConfirmDelete, {
        isConfirmButtonLoading: isLoading,
        onConfirm: handleConfirmDelete,
        onToggleDialog: () =>
          setIsConfirmDeleteRowOpen(!isConfirmDeleteRowOpen),
...
const TypographyMaxWidth$3 = styled__default.default(designSystem.Typography)`
  max-width: 300px;
`;
const EntryValidationText = ({ validationErrors, isPublished = false }) => {
  const { formatMessage } = reactIntl.useIntl();
  if (validationErrors) {
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
      gap: 2,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Icon, {
          color: "danger600",
          as: Icons.CrossCircle,
        }),
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tooltip, {
          description: validationErrorsMessages,
          children: /* @__PURE__ */ jsxRuntime.jsx(TypographyMaxWidth$3, {
            textColor: "danger600",
            variant: "omega",
            fontWeight: "semiBold",
            ellipsis: true,
...
const SelectedEntriesTableContent = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Table.Content, {
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Table.Head, {
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            helperPlugin.Table.HeaderCheckboxCell,
            {}
          ),
          /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Table.HeaderCell, {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Table.Body, {
...
const SelectedEntriesModalContent = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  const { selectedEntries, rows, isLoading, isFetching } =
    helperPlugin.useTableContext();
  ...
  const selectedEntriesWithNoErrorsCount =
    ...
    selectedEntriesWithErrorsCount -
    selectedEntriesPublished;
  const bulkPublishMutation = reactQuery.useMutation(
    (data) =>
      post(
        `/content-manager/collection-types/${contentType.uid}/actions/bulkPublish`,
        data
      ),
    {
  ...
  const handleConfirmBulkPublish = async () => {
    toggleDialog();
    const { data } = await bulkPublishMutation.mutateAsync({
      ids: entriesToPublish,
    });
  ...
  const getFormattedCountMessage = () => {
    if (publishedCount) {
      return formatMessage(
        {
          id: getTranslation(
            "containers.ListPage.selectedEntriesModal.publishedCount"
          ),
          defaultMessage:
    ...
    return formatMessage(
      {
        id: getTranslation(
          "containers.ListPage.selectedEntriesModal.selectedCount"
        ),
        defaultMessage:
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ModalBody, {
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalFooter, {
        startActions: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, {
          onClick: toggleModal,
          variant: "tertiary",
          children: formatMessage({
            id: "app.components.Button.cancel",
        ...
        endActions: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          gap: 2,
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, {
              onClick: () => refetchModalData(),
              variant: "tertiary",
              loading: isFetching,
              children: formatMessage({
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, {
              ...
              disabled:
                ...
                selectedEntriesWithErrorsCount > 0 ||
                isLoading,
...
const PublishAction = ({ model: slug, ids: ids2 }) => {
  ...
  const { setSelectedEntries: setListViewTableSelectedRows } =
    helperPlugin.useTableContext();
  const [
    {
      query: { sort, plugins },
  ...
  const onSuccessfulPublish = (ids22) => {
    setListViewTableSelectedRows((allIds) =>
      allIds.filter((id) => !ids22.includes(id))
    );
    refetchList();
  };
  ...
  return {
    ...
    dialog: {
      ...
      content: ({ onClose }) => {
        return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Table.Root, {
          rows,
...
const BulkActionsRenderer = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
    gap: 2,
    children: /* @__PURE__ */ jsxRuntime.jsx(DescriptionComponentRenderer, {
      props: {
        model: slug,
        collectionType,
        ids: selectedEntries,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      ...
      action.dialog?.type === "dialog"
        ? /* @__PURE__ */ jsxRuntime.jsx(BulkActionConfirmDialog, {
            ...action.dialog,
            variant: action.variant,
      ...
      action.dialog?.type === "modal"
        ? /* @__PURE__ */ jsxRuntime.jsx(BulkActionModal, {
            ...action.dialog,
...
const BulkActionModal = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ModalLayout, {
    borderRadius: "4px",
    overflow: "hidden",
    onClose: handleClose,
    labelledBy: id,
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalHeader, {
...
const UnpublishAction = ({ ids: ids2, model: slug }) => {
  ...
  const { selectedEntries, setSelectedEntries } =
    helperPlugin.useTableContext();
  const { data, contentType } = useTypedSelector(
    (state) => state["content-manager_listView"]
  );
  const selectedEntriesObjects = data.filter((entry) =>
  ...
  const bulkUnpublishMutation = reactQuery.useMutation(
    async (body) => {
      const { data: data2 } = await post(
        `/content-manager/collection-types/${slug}/actions/bulkUnpublish`,
        body
      );
      return data2;
    },
  ...
  const showUnpublishButton =
    ...
    selectedEntriesObjects.some((entry) => entry.publishedAt);
...
class CustomFields {
  ...
  register(customFields) {
    if (Array.isArray(customFields)) {
      ...
      invariant__default.default(
        intlDescription,
        "An intlDescription must be provided"
      );
      invariant__default.default(
        components,
        "A components object must be provided"
      );
      invariant__default.default(
        components.Input,
        "An Input component must be provided"
      );
      invariant__default.default(
      ...
      if (allFormOptions.length) {
        const optionPathValidations = allFormOptions.reduce(
          optionsValidationReducer,
          []
        );
      ...
      const uid = pluginId
        ? `plugin::${pluginId}.${name2}`
        : `global::${name2}`;
      const uidAlreadyUsed = Object.prototype.hasOwnProperty.call(
        this.customFields,
        uid
      );
      invariant__default.default(
        !uidAlreadyUsed,
        `Custom field: '${uid}' has already been registered`
      );
  ...
  if (!option.name) {
    ...
    acc.push({
      isValidOptionPath:
        ...
        ALLOWED_ROOT_LEVEL_OPTIONS.includes(option.name),
...
const RBACProvider = ({
  ...
  const allPermissions = useTypedSelector(
    (state) => state.rbacProvider.allPermissions
  );
  const dispatch = useTypedDispatch();
  React__namespace.useEffect(() => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.RBACContext.Provider, {
...
const RBACReducer = (state = initialState$8, action) =>
  produce__default.default(state, (draftState) => {
    switch (action.type) {
      case SET_PERMISSIONS$1: {
        ...
        draftState.collectionTypesRelatedPermissions = action.permissions
          ...
          .reduce((acc, current) => {
            ...
            acc[subject] = acc[subject][action2]
              ? {
                  ...acc[subject],
                  [action2]: [...acc[subject][action2], current],
                }
              : { ...acc[subject], [action2]: [current] };
            return acc;
          }, {});
        break;
      }
...
const useSyncRbac = (query, collectionTypeUID, containerName = "listView") => {
  ...
  const relatedPermissions =
    collectionTypesRelatedPermissions[collectionTypeUID];
  React.useEffect(() => {
...
const DragLayer = ({ renderItem }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    ...
    children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
      ...
      children: renderItem({ type: itemType, item }),
    }),
  });
};
const CardDragPreview = ({ labelField, isSibling = false }) => {
  return /* @__PURE__ */ jsxRuntime.jsxs(FieldContainer$1, {
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        gap: 3,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(DragButton$2, {
            alignItems: "center",
            cursor: "all-scroll",
            padding: 3,
            children: /* @__PURE__ */ jsxRuntime.jsx(Icons.Drag, {}),
          }),
          /* @__PURE__ */ jsxRuntime.jsx(TypographyMaxWidth$2, {
...
const FieldContainer$1 = styled__default.default(designSystem.Flex)`
  border: 1px solid
    ${({ theme, isSibling }) =>
      isSibling ? theme.colors.neutral150 : theme.colors.primary200};
  ...
  svg {
    ...
    path {
      fill: ${({ theme, isSibling }) =>
        isSibling ? void 0 : theme.colors.primary600};
    }
  }
`;
      ...
      /* @__PURE__ */ jsxRuntime.jsx(ToggleButton, {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
              maxWidth: helperPlugin.pxToRem(150),
              children: /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.Typography,
                {
...
const useDragAndDrop = (
  ...
  const getDragDirection = (monitor) => {
    if (
      ...
      const deltaY =
        monitor.getInitialClientOffset().y - monitor.getClientOffset().y;
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        width: "100%",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(ComboboxWrapper, {
            marginRight: "auto",
            maxWidth: size <= 6 ? "100%" : "70%",
            width: "100%",
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Combobox, {
              ref: fieldRef,
              autocomplete: "none",
              error,
              name: name2,
              ...
              onChange: (relationId) => {
                ...
                onRelationConnect(
                  data.flat().find((opt) => opt.id.toString() === relationId)
                );
                updatedRelationsWith.current = "onChange";
              },
      ...
      relations.length > 0 &&
        /* @__PURE__ */ jsxRuntime.jsxs(ShadowBox, {
          overflowDirection: overflow,
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.VisuallyHidden, {
              id: ariaDescriptionId,
              children: listAriaDescription,
            }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.VisuallyHidden, {
              "aria-live": "assertive",
              children: liveText,
...
const ShadowBox = styled__default.default(designSystem.Box)`
  ...
  &:before {
    ...
    opacity: ${({ overflowDirection }) =>
      overflowDirection === "top-bottom" || overflowDirection === "top"
        ? 1
        : 0};
  ...
  &:after {
    ...
    bottom: 0;
    opacity: ${({ overflowDirection }) =>
      overflowDirection === "top-bottom" || overflowDirection === "bottom"
        ? 1
        : 0};
    transition: opacity 0.2s ease-in-out;
  }
...
const Option = ({ publicationState, mainField, id }) => {
  ...
  if (publicationState) {
    ...
    const title = isDraft
      ? formatMessage(draftMessage)
      : formatMessage(publishedMessage);
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ComboboxOption, {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
            ellipsis: true,
            children: stringifiedDisplayValue,
          }),
        ],
      }),
    });
...
const ListItem = ({ data, index, style }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(RelationItem, {
    ariaDescribedBy,
    canDrag,
    disabled,
    ...
    index,
    name: name2,
    endAction: /* @__PURE__ */ jsxRuntime.jsx(DisconnectButton, {
      "data-testid": `remove-relation-${id}`,
      disabled,
      type: "button",
      onClick: () => onRelationDisconnect(relations[index]),
      "aria-label": labelDisconnectRelation,
      children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Icon, {
        width: "12px",
        as: Icons.Cross,
      }),
    }),
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tooltip, {
          description: mainField ?? `${id}`,
          children: href
            ? /* @__PURE__ */ jsxRuntime.jsx(LinkEllipsis, {
                to: href,
                children: mainField ?? id,
              })
            : /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
      ...
      publicationState &&
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Status, {
          variant: statusColor,
          showBullet: false,
          size: "S",
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
            fontWeight: "bold",
            textColor: `${statusColor}700`,
            children: publicationStateTranslations[publicationState],
          }),
        }),
    ],
  });
...
const RelationItem = ({
  ...
  const [
    { handlerId, isDragging, handleKeyDown },
    relationRef,
    dropRef,
    dragRef,
    dragPreviewRef,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    ...
    children: isDragging
      ? /* @__PURE__ */ jsxRuntime.jsx(RelationItemPlaceholder, {})
      : /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          paddingTop: 2,
          paddingBottom: 2,
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(FlexWrapper, {
              ...
              children: [
                canDrag
                  ...
                  : null,
                /* @__PURE__ */ jsxRuntime.jsx(ChildrenWrapper, {
                  justifyContent: "space-between",
                  children,
                }),
              ],
...
const ChildrenWrapper = styled__default.default(designSystem.Flex)`
  ...
  min-width: 0;
`;
const getInitialDataPathUsingTempKeys =
  (initialData, modifiedData) => (currentPath) => {
    ...
    return splitPath.reduce((acc, currentValue, index) => {
      ...
      if (
        Array.isArray(initialDataParent) &&
        typeof modifiedDataTempKey === "number"
      ) {
...
const diffRelations = (
  browserStateRelations = [],
  serverStateRelations = []
) => {
  const connected = browserStateRelations.reduce((acc, relation) => {
    if (
      !serverStateRelations.find(
...
const RelationInputDataManager = ({
  ...
  queryInfos: {
    defaultParams,
    shouldDisplayRelationLink: shouldDisplayRelationLink2 = false,
  },
  required,
  relationType,
  size,
  ...
  const componentId = componentUid
    ? get__default.default(modifiedData, fieldNameKeys.slice(0, -1))?.id
    : void 0;
  ...
  const relationFetchEndpoint = React__namespace.useMemo(() => {
    ...
    if (componentUid) {
      return componentId
        ? `/content-manager/relations/${componentUid}/${componentId}/${fieldNameKeys.at(
            -1
          )}`
        : null;
    }
    return `/content-manager/relations/${slug}/${entityId}/${name2
      .split(".")
      .at(-1)}`;
  }, [
    isCreatingEntry,
  ...
  const relationSearchEndpoint = React__namespace.useMemo(() => {
    if (componentUid) {
      return `/content-manager/relations/${componentUid}/${name2
        .split(".")
        .at(-1)}`;
    }
  ...
  const relationsFromModifiedData = get__default.default(
    modifiedData,
    name2,
    []
  );
  const currentLastPage = Math.ceil(
    get__default.default(initialData, name2, []).length / RELATIONS_TO_DISPLAY
  );
  ...
  if (
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.NotAllowedInput, {
      name: name2,
      intlLabel,
      labelAction,
    });
  ...
  const serverRelationsCount = (
    get__default.default(initialData, initialDataPath) ?? []
  ).length;
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(RelationInput, {
    error,
...
const RelationDragPreview = ({ status, displayedValue, width }) => {
  ...
  const statusColor =
    status === PUBLICATION_STATES.DRAFT ? "secondary" : "success";
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    style: { width },
    children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
      paddingTop: 2,
      ...
      children: [
        /* @__PURE__ */ jsxRuntime.jsxs(FlexWrapper, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(ChildrenWrapper, {
              maxWidth: "100%",
              justifyContent: "space-between",
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                  ...
                  paddingBottom: 1,
                  paddingRight: 4,
                  children: /* @__PURE__ */ jsxRuntime.jsx(LinkEllipsis, {
                    href: "",
                    children: /* @__PURE__ */ jsxRuntime.jsx(
                      designSystem.Typography,
                      {
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
          paddingLeft: 4,
          children: /* @__PURE__ */ jsxRuntime.jsx(DisconnectButton, {
            type: "button",
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Icon, {
              width: "12px",
              as: Icons.Cross,
...
const LeftMenu = () => {
  ...
  const singleTypeLinks = useTypedSelector(
    (state) => state["content-manager_app"].singleTypeLinks
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(v2.SubNav, {
    ariaLabel: label,
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(v2.SubNavHeader, {
        label,
        searchable: true,
        value: search,
      ...
      /* @__PURE__ */ jsxRuntime.jsx(v2.SubNavSections, {
...
const {
  MUTATE_COLLECTION_TYPES_LINKS: MUTATE_COLLECTION_TYPES_LINKS$1,
  MUTATE_SINGLE_TYPES_LINKS: MUTATE_SINGLE_TYPES_LINKS$1,
} = HOOKS;
const useContentManagerInitData = () => {
  ...
  const fetchDataRef = React.useRef(async () => {
    ...
    try {
      ...
      const {
        collectionType: collectionTypeLinks,
        singleType: singleTypeLinks,
      } = models.reduce(
        (acc, model) => {
      ...
      const singleTypeSectionLinks = generateLinks(
        singleTypeLinks,
        "singleTypes"
      );
      const collectionTypeLinksPermissions = await Promise.all(
        collectionTypeSectionLinks.map(({ permissions: permissions2 }) =>
          helperPlugin.hasPermissions(allPermissions, permissions2)
        )
      );
      ...
      const singleTypeLinksPermissions = await Promise.all(
        singleTypeSectionLinks.map(({ permissions: permissions2 }) =>
          helperPlugin.hasPermissions(allPermissions, permissions2)
        )
      );
...
const generateLinks = (links, type, configurations = []) => {
  return links
    ...
    .map((link) => {
      ...
      const currentContentTypeConfig = configurations.find(
        ({ uid }) => uid === link.uid
      );
      let search = null;
...
const mergeMetasWithSchema = (data, schemas, mainSchemaKey) => {
  ...
  merged[mainSchemaKey] = merge__default.default(
    {},
    schema,
    data[mainSchemaKey]
  );
...
const getRelationModel = (targetModel, models) =>
...
const createMetasSchema = (initialData, models) => {
  const data = mergeMetasWithSchema(
    cloneDeep__default.default(initialData),
    models,
    "contentType"
  );
...
const formatLayoutWithMetas = (contentTypeConfiguration, models) =>
  contentTypeConfiguration.layouts.edit.reduce((acc, current) => {
    const row = current.map((attribute) => {
      const fieldSchema =
        contentTypeConfiguration.attributes[attribute.name] ?? {};
      const data = {
        ...attribute,
        fieldSchema,
        metadatas:
          contentTypeConfiguration.metadatas[attribute.name].edit ?? {},
      };
...
const shouldDisplayRelationLink = (
  ...
  const targetModel =
    contentTypeConfiguration.attributes[fieldName].targetModel ?? "";
  return models.some((model) => model.uid === targetModel && model.isDisplayed);
};
const formatLayoutForSettingsView = ({ layouts, metadatas, ...rest }) => {
  return {
    ...rest,
    layouts: {
      edit: layouts.edit.map((row) =>
        row.map(({ name: name2, size }) => ({
          name: name2,
          size,
        }))
      ),
    ...
    metadatas: Object.keys(metadatas).reduce((acc, current) => {
...
const useContentTypeLayout$1 = (contentTypeUID) => {
  ...
  const layout = React__namespace.useMemo(
...
function LayoutDndProvider({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(LayoutDndContext.Provider, {
    value: {
      attributes,
      buttonData,
      goTo,
...
const LinkToCTB = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, {
    permissions,
    children: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.LinkButton, {
...
const ComponentFieldList = ({ componentUid }) => {
  ...
  const { formatMessage } = reactIntl.useIntl();
  const componentData = get__default.default(
    componentLayouts,
    [componentUid],
    {}
  );
  const componentLayout = get__default.default(
    componentData,
    ["layouts", "edit"],
    []
  );
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
    ...
    children: [
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                    ...
                    children: /* @__PURE__ */ jsxRuntime.jsx(
                      designSystem.Flex,
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntime.jsx(
                          designSystem.Typography,
                          { textColor: "neutral800", children: rowContent.name }
                        ),
                      }
                    ),
                  }),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
        paddingTop: 2,
        children: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Link, {
...
const DynamicZoneList = ({ components }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
    ...
    padding: 3,
    children: components.map((componentUid) =>
      /* @__PURE__ */ jsxRuntime.jsxs(
        CustomLink,
        {
          hasRadius: true,
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(ComponentIcon, {
              icon: componentLayouts?.[componentUid]?.info?.icon,
            }),
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
              paddingTop: 1,
              children: /* @__PURE__ */ jsxRuntime.jsx(
...
DynamicZoneList.propTypes = {
  components: PropTypes__default.default.arrayOf(
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(CustomIconButton$2, {
                label: formatMessage(
                  {
                    id: getTranslation(
                      "containers.ListSettingsView.modal-form.edit-label"
                    ),
      ...
      attribute?.type === "component" &&
        /* @__PURE__ */ jsxRuntime.jsx(ComponentFieldList, {
          componentUid: attribute.component,
        }),
      attribute?.type === "dynamiczone" &&
        /* @__PURE__ */ jsxRuntime.jsx(DynamicZoneList, {
...
const DisplayedFieldButton = ({
  ...
  React.useEffect(() => {
    dragPreview(reactDndHtml5Backend.getEmptyImage(), {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
    col: size,
    children: /* @__PURE__ */ jsxRuntime.jsxs(Wrapper$2, {
      ref: refs.dropRef,
      showLeftCarret,
      showRightCarret,
      isFirst,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(CustomFlex, {
          ...
          isHidden,
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(DragButton$1, {
              as: "span",
              type: "button",
              ref: refs.dragRef,
            ...
            !isHidden &&
              /* @__PURE__ */ jsxRuntime.jsx(FieldButtonContent, {
                attribute,
                onEditField,
                onDeleteField,
                children,
...
const RowItemsLayout = ({
  ...
  const { setEditFieldToSelect, attributes, modifiedData, moveRow, moveItem } =
    useLayoutDnd();
  const attribute = get__default.default(attributes, [rowItem.name], {});
  const attributeLabel = get__default.default(
    modifiedData,
    ["metadatas", rowItem.name, "edit", "label"],
    ""
  );
  return /* @__PURE__ */ jsxRuntime.jsx(DisplayedFieldButton, {
...
const RowsLayout = ({ row, onRemoveField, rowIndex }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, {
    children: row.rowContent.map((rowItem, index) => {
      return /* @__PURE__ */ jsxRuntime.jsx(
        RowItemsLayout,
        {
          rowItem,
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
          ...
          children: [
            editLayout.map((row, index) =>
              /* @__PURE__ */ jsxRuntime.jsx(
                RowsLayout,
                { row, rowIndex: index, onRemoveField },
                row.rowId
              )
            ),
            /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, {
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.Trigger, {
                ...
                /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.Content, {
                  children: fields.map((field) =>
                    /* @__PURE__ */ jsxRuntime.jsx(
                      v2.Menu.Item,
                      { onSelect: () => onAddField(field), children: field },
                      field
                    )
                  ),
                }),
...
const GenericInput = ({
  ...
  switch (type) {
    ...
    case "bool": {
      return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ToggleInput, {
        onChange: (e) => {
    ...
    case "select": {
      return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Select, {
        value,
        name: name2,
        onChange: (value2) =>
...
const ModalForm = ({ onMetaChange, onSizeChange }) => {
  ...
  const fieldSizes = useTypedSelector(
    (state) => state["content-manager_app"].fieldSizes
  );
  const formToDisplay = React.useMemo(() => {
    if (!selectedField) {
      return [];
    }
    const associatedMetas = get__default.default(
      modifiedData,
      ["metadatas", selectedField, "edit"],
      {}
    );
  ...
  const getSelectedItemSelectOptions = React.useCallback(
    (formType) => {
      ...
      const key = get__default.default(
        modifiedData,
        ["attributes", selectedField, targetKey],
        ""
      );
  ...
  const metaFields = formToDisplay.map((meta) => {
    ...
    if (
      ["media", "json", "boolean"].includes(formType) &&
      meta === "placeholder"
    ) {
      return null;
    }
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        col: 6,
        children: /* @__PURE__ */ jsxRuntime.jsx(GenericInput, {
    ...
    children: [
      ...
      isResizable &&
        /* @__PURE__ */ jsxRuntime.jsx(
          ...
          {
            col: 6,
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Select, {
              ...
              label: formatMessage({
                id: getTranslation(
                  "containers.SettingPage.editSettings.size.label"
                ),
                defaultMessage: "Size",
              }),
              children: FIELD_SIZES.map(([value, label]) =>
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.Option,
...
const FormModal = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalLayout, {
    onClose: onToggle,
    labelledBy: "title",
    children: /* @__PURE__ */ jsxRuntime.jsxs("form", {
      onSubmit,
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalHeader, {
          children: /* @__PURE__ */ jsxRuntime.jsxs(HeaderContainer$1, {
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(FieldTypeIcon, {
                type: getAttrType(),
                customFieldUid,
              }),
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalBody, {
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, {
            gap: 4,
            children: /* @__PURE__ */ jsxRuntime.jsx(ModalForm, {
              onMetaChange,
              onSizeChange,
            }),
          }),
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalFooter, {
          ...
          endActions: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, {
            type: "submit",
            children: formatMessage({
              id: "global.finish",
              defaultMessage: "Finish",
...
const init = (initialState2, mainLayout, components) => {
  ...
  set__default.default(
    initialData,
    ["layouts", "edit"],
    formatLayout(createLayout(mainLayout.layouts.edit))
  );
  return {
    ...initialState2,
    initialData,
...
const reducer$6 = (state = initialState$6, action) =>
  ...
  produce__default.default(state, (draftState) => {
    ...
    switch (action.type) {
      case "MOVE_ROW": {
        const editFieldLayoutValue = get__default.default(
          state,
          layoutPathEdit,
          []
        );
        ...
        set__default.default(
          draftState,
          layoutPathEdit,
          arrayMoveItem(editFieldLayoutValue, fromIndex, toIndex)
        );
        break;
      }
      case "ON_ADD_FIELD": {
        const newState = cloneDeep__default.default(state);
        const attribute = get__default.default(
          newState,
          ["modifiedData", "attributes", action.name],
          {}
        );
        const size =
          ...
          DEFAULT_FIELD_SIZE;
        const listSize = get__default.default(
          newState,
          layoutPathEdit,
          []
        ).length;
        const actualRowContentPath = [
          ...layoutPathEdit,
          listSize - 1,
          "rowContent",
        ];
        const rowContentToSet = get__default.default(
          newState,
          actualRowContentPath,
          []
        );
      ...
      case "REMOVE_FIELD": {
        const row = get__default.default(
          state,
        ...
        if (
          row.length === 1 ||
          (row.length === 2 &&
            get__default.default(row, [1, "name"], "") === "_TEMP_")
        ) {
          const currentRowFieldList = get__default.default(
            state,
            layoutPathEdit,
            []
          );
        ...
        const updatedList = formatLayout(
          get__default.default(newState, layoutPathEdit, [])
        );
      ...
      case "SET_FIELD_TO_EDIT": {
        ...
        draftState.metaForm = {
          metadata: get__default.default(
            state,
            ["modifiedData", "metadatas", action.name, "edit"],
            {}
          ),
          size:
            getFieldSize(action.name, state.modifiedData?.layouts?.edit) ??
            DEFAULT_FIELD_SIZE,
        };
        break;
      }
      case "SUBMIT_META_FORM": {
        ...
        const layoutsCopy = cloneDeep__default.default(
          get__default.default(state, layoutPathEdit, [])
        );
        const nextLayoutValue = setFieldSize(
          state.metaToEdit,
          state.metaForm.size,
          layoutsCopy
        );
...
const EditSettingsView = ({
  ...
  const { componentLayouts, initialData, modifiedData, metaToEdit, metaForm } =
    reducerState;
  const { formatMessage } = reactIntl.useIntl();
  ...
  const editLayoutFields = Object.keys(modifiedData.attributes)
    .filter(
      (attr) =>
        (modifiedData?.metadatas?.[attr]?.edit?.visible ?? false) === true
    )
    .filter(
      (attr) => displayedFields.findIndex((el) => el.name === attr) === -1
    )
    .sort();
  ...
  const handleConfirm = () => {
    const { layouts, metadatas, settings } =
      cloneDeep__default.default(modifiedData);
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(LayoutDndProvider, {
    isContentTypeView,
    attributes,
    modifiedData,
    slug,
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
              title: formatMessage(
                {
                  id: getTranslation(
                    "components.SettingsViewWrapper.pluginHeader.title"
                  ),
                  defaultMessage: `Configure the view - ${upperFirst__default.default(
                    modelName
                  )}`,
                },
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, {
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.GridItem,
                        {
                          col: 6,
                          ...
                          children: /* @__PURE__ */ jsxRuntime.jsx(
                            designSystem.Select,
                            {
                              label: formatMessage({
                                id: getTranslation(
                                  "containers.SettingPage.editSettings.entry.title"
                                ),
                              ...
                              children: entryTitleOptions.map((attribute) =>
                                /* @__PURE__ */ jsxRuntime.jsx(
                                  designSystem.Option,
                                  { value: attribute, children: attribute },
                                  attribute
                                )
                              ),
                            }
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(DisplayedFields, {
                      attributes,
                      editLayout,
            ...
            /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.ConfirmDialog, {
              bodyText: {
...
const isObject = (obj) => {
  return (
    typeof obj === "object" && obj !== null && Array.isArray(obj) === false
  );
};
...
const CLEAR_SET_MODIFIED_DATA_ONLY =
  ...
  return Object.keys(attributes).reduce((acc, current) => {
    ...
    if (type === "component") {
      const currentComponentSchema =
        allComponentsSchema[attribute.component]?.attributes ?? {};
      ...
      if (required === true) {
        acc[current] =
          attribute.repeatable === true ? [] : currentComponentDefaultForm;
      }
...
const ContentTypeFormWrapper = ({
  ...
  const cleanReceivedData = React__namespace.useCallback(
    (data2) => {
      ...
      return helperPlugin.formatContentTypeData(
        cleaned,
        allLayoutData.contentType,
        allLayoutData.components
      );
  ...
  React__namespace.useEffect(() => {
    const componentsDataStructure2 = Object.keys(
      allLayoutData.components
    ).reduce((acc, current) => {
    ...
    const contentTypeDataStructureFormatted =
      helperPlugin.formatContentTypeData(
    ...
    dispatch(
      setDataStructures(
        componentsDataStructure2,
        contentTypeDataStructureFormatted
      )
    );
  ...
  const validParams = React__namespace.useMemo(
    () => buildValidGetParams(query),
    [query]
  );
  React__namespace.useEffect(() => {
  ...
  const onPost = React__namespace.useCallback(
    async (body, trackerProperty) => {
      ...
      try {
        ...
        if (!isSingleType) {
          replace(
            `/content-manager/${collectionType}/${slug}/${data2.id}${rawQuery}`
          );
        }
        return Promise.resolve(data2);
      } catch (err) {
...
const ComponentCategory = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion, {
    expanded: isOpen,
    onToggle: handleToggle,
    size: "S",
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.AccordionToggle, {
        variant,
        title: formatMessage({ id: category, defaultMessage: category }),
        togglePosition: "left",
      }),
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.AccordionContent, {
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
          paddingTop: 4,
          paddingBottom: 4,
          paddingLeft: 3,
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(Grid, {
            children: components.map(
              ({ componentUid, info: { displayName, icon } }) =>
                /* @__PURE__ */ jsxRuntime.jsx(
                  ComponentBox,
                  {
                    as: "button",
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
        paddingTop: 2,
        children: /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.KeyboardNavigable,
          {
            attributeName: "data-strapi-accordion-toggle",
            children: Object.entries(dynamicComponentsByCategory).map(
    ...
    children: [
      ...
      error?.id &&
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
          textColor: "danger600",
          variant: "pi",
          children: formatMessage(error, { ...error.values }),
        }),
    ],
  });
};
...
const useLazyComponents = (componentUids = []) => {
  const [lazyComponentStore, setLazyComponentStore] = React.useState(
    Object.fromEntries(componentStore)
  );
...
const pressEnterTwiceToExit = (editor) => {
  const nodeEntry = slate.Editor.above(editor, {
    match: (node2) =>
      !slate.Editor.isEditor(node2) && !["link", "text"].includes(node2.type),
  });
  if (!nodeEntry || !editor.selection) {
    return;
  }
  const [node, nodePath] = nodeEntry;
  const isNodeEnd = slate.Editor.isEnd(
    editor,
  ...
  const isEmptyLine =
    isText$2(lastTextNode) && lastTextNode.text.endsWith("\n");
...
const editLink = (editor, link) => {
  ...
  if (linkEntry) {
    ...
    if (text !== "" && text !== slate.Editor.string(editor, linkPath)) {
      const linkNodeChildrens = Array.from(
        slate.Node.children(editor, linkPath, { reverse: true })
      );
      linkNodeChildrens.forEach(([, childPath]) => {
        slate.Transforms.removeNodes(editor, { at: childPath });
      });
      slate.Transforms.insertNodes(editor, [{ type: "text", text }], {
  ...
  ({ link, children, attributes }, forwardedRef) => {
    ...
    const [popoverOpen, setPopoverOpen] = React__namespace.useState(
      editor.lastInsertedLinkPath
        ? slate.Path.equals(path, editor.lastInsertedLinkPath)
        : false
    );
    ...
    const [showRemoveButton, setShowRemoveButton] =
      React__namespace.useState(false);
      ...
      try {
        new URL(
          e.target.value?.startsWith("/")
            ? `https://strapi.io${e.target.value}`
            : e.target.value
        );
      } catch (error) {
    ...
    const handleSave = (e) => {
      ...
      if (editor.selection && slate.Range.isCollapsed(editor.selection)) {
        const [, parentPath] = slate.Editor.parent(
          editor,
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(StyledBaseLink, {
          ...attributes,
          ref: composedRefs,
          href: link.url,
        ...
        popoverOpen &&
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Popover, {
            source: linkRef,
            ...
            children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
              ...
              gap: 4,
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field, {
                  width: "368px",
                  children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                    direction: "column",
                    gap: 1,
                    alignItems: "stretch",
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(designSystem.FieldLabel, {
                        children: formatMessage({
                          id: "components.Blocks.popover.text",
                          defaultMessage: "Text",
                        }),
                      }),
                      /* @__PURE__ */ jsxRuntime.jsx(designSystem.FieldInput, {
                        name: "text",
                        placeholder: formatMessage({
...
const handleBackspaceKeyOnList = (editor, event) => {
  ...
  const [currentListItem, currentListItemPath] = slate.Editor.parent(
    editor,
    editor.selection.anchor
  );
  const [currentList, currentListPath] = slate.Editor.parent(
    editor,
    currentListItemPath
  );
  const isListEmpty =
    currentList.children.length === 1 &&
    isText$1(currentListItem.children[0]) &&
  ...
  if (isListEmpty) {
    ...
    slate.Transforms.liftNodes(editor, {
      match: (node) =>
        !slate.Editor.isEditor(node) && node.type === "list-item",
    });
    ...
    if (previousEntry && nextEntry) {
      ...
      if (
        !slate.Editor.isEditor(previousList) &&
        !isText$1(previousList) &&
        isListNode$1(previousList) &&
        !slate.Editor.isEditor(nextList) &&
        !isText$1(nextList) &&
        isListNode$1(nextList)
      ) {
        if (
...
const handleEnterKeyOnList = (editor) => {
  ...
  if (isListEmpty) {
    ...
    if (
      !slate.Editor.isEditor(currentList) &&
      isListNode$1(currentList) &&
...
const paragraphBlocks = {
  paragraph: {
    ...
    handleEnterKey(editor) {
      ...
      const [fragmentedNode] = slate.Editor.parent(
        editor,
        editor.selection.anchor.path
      );
      slate.Transforms.removeNodes(editor);
      const hasNextNode =
        editor.children.length - anchorPathInitialPosition[0] > 1;
      slate.Transforms.insertNodes(
        editor,
        {
          type: "paragraph",
      ...
      slate.Transforms.select(
        editor,
        editor.start([anchorPathInitialPosition[0] + 1])
      );
    },
  },
};
const Blockquote = styled__default.default.blockquote.attrs({
  role: "blockquote",
})`
...
function useConversionModal() {
  ...
  const handleConversionResult = (renderModal) => {
    if (renderModal) {
      setModalComponent(
        React__namespace.cloneElement(renderModal(), { key: Date.now() })
      );
    }
  };
    ...
    children: /* @__PURE__ */ jsxRuntime.jsx(Toolbar__namespace.ToggleItem, {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(FlexButton, {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Icon, {
          ...
          height: 3,
          as: icon,
          color: disabled ? "neutral300" : enabledColor,
        }),
      }),
    }),
  });
...
const BlocksDropdown = () => {
  ...
  const [blockSelected, setBlockSelected] =
    React__namespace.useState("paragraph");
  const handleSelect = (optionKey) => {
    ...
    const editorIsEmpty =
      ...
      slate.Editor.isEmpty(editor, editor.children[0]);
  ...
  React__namespace.useEffect(() => {
    if (editor.selection) {
      ...
      if (currentListEntry) {
        ...
        const [anchorNode] = slate.Editor.parent(
          editor,
          editor.selection.anchor,
          {
            edge: "start",
      ...
      const anchorBlockKey = getKeys(blocks).find(
        (blockKey) =>
          !slate.Editor.isEditor(selectedNode) &&
          blocks[blockKey].matchNode(selectedNode)
      );
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(SelectWrapper, {
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelect, {
          startIcon: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Icon, {
            as: blocks[blockSelected].icon,
          }),
...
const DragAndDropElement = ({
  ...
  const {
    ...
    name: name2,
    setLiveText,
  } = useBlocksEditorContext("drag-and-drop");
  const { formatMessage } = reactIntl.useIntl();
  const [dragVisibility, setDragVisibility] =
    React__namespace.useState("hidden");
      ...
      setLiveText(
        formatMessage(
          ...
          },
          {
            ...
            position: `${newIndexPosition.join(",")} of ${
              editor.children.length
            }`,
          }
        )
  ...
  const [
    { handlerId, isDragging, isOverDropTarget, direction },
    blockRef,
    dropRef,
    dragRef,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(Wrapper$1, {
    ref: (ref) => composedBoxRefs(ref),
    isOverDropTarget,
    children: [
      isOverDropTarget &&
        /* @__PURE__ */ jsxRuntime.jsx(DropPlaceholder, {
          borderStyle: "solid",
          ...
          dragDirection,
          placeholderMargin:
            children.props.as && children.props.as === "li" ? 1 : 2,
        }),
      isDragging
        ? /* @__PURE__ */ jsxRuntime.jsx(CloneDragItem, {
            dragHandleTopMargin,
            children,
          })
...
const baseRenderLeaf = (props, modifiers2) => {
  const wrappedChildren = getEntries(modifiers2).reduce(
...
const baseRenderElement = ({
  ...
  const { element } = props;
  const blockMatch = Object.values(blocks).find((block2) =>
    block2.matchNode(element)
  );
  const block = blockMatch || blocks.paragraph;
  const nodePath = slateReact.ReactEditor.findPath(editor, element);
  if (
    isLinkNode(element) ||
    (isListNode$1(element) && element.indentLevel && element.indentLevel > 0) ||
...
const BlocksContent = ({ placeholder, ariaLabelId }) => {
  ...
  const handleMoveBlocks = (editor2, event) => {
    ...
    if (event.key === "ArrowUp") {
      newIndexPosition =
        currentIndex[0] > 0 ? currentIndex[0] - 1 : currentIndex[0];
    } else {
      newIndexPosition =
        currentIndex[0] < editor2.children.length - 1
          ? currentIndex[0] + 1
          : currentIndex[0];
    }
  ...
  const checkSnippet = (event) => {
    ...
    const [textNode, textNodePath] = slate.Editor.node(
      editor,
      editor.selection.anchor.path
    );
  ...
  const handleScrollSelectionIntoView = () => {
    if (!editor.selection) return;
    const domRange = slateReact.ReactEditor.toDOMRange(
      editor,
      editor.selection
    );
...
const EditorLayout$1 = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.InputWrapper, {
    direction: "column",
    alignItems: "flex-start",
    height: "512px",
    disabled,
...
const stylesToInherit = styled.css`
  ...
  line-height: inherit;
`;
const BoldText = styled__default
  .default(designSystem.Typography)
...
const ItalicText = styled__default.default(designSystem.Typography)`
  ...
  ${stylesToInherit}
`;
const UnderlineText = styled__default
  .default(designSystem.Typography)
  .attrs({ textDecoration: "underline" })`
  ${stylesToInherit}
`;
const StrikeThroughText = styled__default
  .default(designSystem.Typography)
...
const modifiers = {
  bold: {
    ...
    renderLeaf: (children) =>
      /* @__PURE__ */ jsxRuntime.jsx(BoldText, { children }),
  },
  italic: {
    icon: Icons.Italic,
    ...
    renderLeaf: (children) =>
      /* @__PURE__ */ jsxRuntime.jsx(ItalicText, { children }),
  },
  underline: {
    ...
    renderLeaf: (children) =>
      /* @__PURE__ */ jsxRuntime.jsx(UnderlineText, { children }),
  },
  strikethrough: {
    ...
    renderLeaf: (children) =>
      /* @__PURE__ */ jsxRuntime.jsx(StrikeThroughText, { children }),
  },
  code: {
    icon: Icons.Code,
    ...
    renderLeaf: (children) =>
      /* @__PURE__ */ jsxRuntime.jsx(InlineCode, { children }),
  },
};
...
const withLinks = (editor) => {
  ...
  editor.apply = (operation) => {
    if (operation.type === "insert_node") {
      ...
      if (
        slate.Path.hasPrevious(operation.path) &&
        editor.lastInsertedLinkPath &&
        editor.shouldSaveLinkPath
      ) {
        editor.lastInsertedLinkPath = slate.Path.transform(
          editor.lastInsertedLinkPath,
          operation
        );
      }
  ...
  editor.insertText = (text) => {
    if (
      ...
      const selectionIsAtEndOfLink =
        ...
        slate.Point.equals(
          editor.selection.anchor,
          slate.Editor.end(editor, linksInSelection[0][1])
        );
...
const [BlocksEditorProvider, usePartialBlocksEditorContext] =
  reactContext.createContext("BlocksEditor");
...
const BlocksEditor = React__namespace.forwardRef(
  (
    { disabled = false, name: name2, onChange, value, error, ...contentProps },
    forwardedRef
  ) => {
    const { formatMessage } = reactIntl.useIntl();
    ...
    const [isExpandedMode, setIsExpandedMode] =
      React__namespace.useState(false);
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(BlocksEditorProvider, {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsxs(EditorLayout$1, {
                ...
                children: [
                  ...
                  !isExpandedMode &&
                    /* @__PURE__ */ jsxRuntime.jsx(ExpandIconButton, {
                      "aria-label": formatMessage({
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
              ...
              children: [
                ...
                labelAction &&
                  /* @__PURE__ */ jsxRuntime.jsx(LabelAction$2, {
                    paddingLeft: 1,
...
const InputUID = React__namespace.forwardRef(
  (
    ...
    const formattedPlaceholder = placeholder
      ...
      : "";
    const { data: defaultGeneratedUID, isLoading: isGeneratingDefaultUID } =
      reactQuery.useQuery({
    ...
    React__namespace.useEffect(() => {
      if (defaultGeneratedUID) {
        onChange(
          { target: { name: name2, value: defaultGeneratedUID, type: "text" } },
          true
        );
      }
    }, [defaultGeneratedUID, name2, onChange]);
    const { mutate: generateUID, isLoading: isGeneratingUID } =
    ...
    const { data: availabilityData, isLoading: isCheckingAvailability } =
      reactQuery.useQuery({
        ...
        enabled: Boolean(
          debouncedValue !== initialData[name2] &&
            debouncedValue &&
    ...
    const isLoading =
      isGeneratingDefaultUID || isGeneratingUID || isCheckingAvailability;
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.TextInput, {
      ref: forwardedRef,
      disabled,
      error,
      endAction: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
          availability &&
            !showRegenerate &&
            /* @__PURE__ */ jsxRuntime.jsxs(TextValidation, {
              alignItems: "center",
              gap: 1,
              justifyContent: "flex-end",
              ...
              children: [
                availability?.isAvailable
                  ...
                  : /* @__PURE__ */ jsxRuntime.jsx(
                      Icons.ExclamationMarkCircle,
                      {}
                    ),
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
                  textColor: availability.isAvailable
                    ? "success600"
                    : "danger600",
                  variant: "pi",
                  children: formatMessage(
          ...
          !disabled &&
            /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [
                showRegenerate &&
                  /* @__PURE__ */ jsxRuntime.jsx(TextValidation, {
                    alignItems: "center",
                    justifyContent: "flex-end",
                    gap: 1,
                    children: /* @__PURE__ */ jsxRuntime.jsx(
                ...
                /* @__PURE__ */ jsxRuntime.jsx(FieldActionWrapper, {
                  ...
                  children: isLoading
                    ? /* @__PURE__ */ jsxRuntime.jsx(LoadingWrapper, {
                    ...
                    : /* @__PURE__ */ jsxRuntime.jsx(Icons.Refresh, {}),
                }),
              ],
            }),
        ],
...
const md = new Markdown__default.default({
  ...
  highlight(str, lang) {
    if (lang && lang !== "auto" && highlight_js.getLanguage(lang)) {
      return (
        ...
        '"><code>' +
        highlight_js.highlight(lang, str, true).value +
        "</code></pre>"
      );
    }
    if (lang === "auto") {
  ...
  .use(abbr__default.default)
  .use(container__default.default, "warning")
  .use(container__default.default, "tip")
  .use(deflist__default.default)
  .use(emoji__default.default)
  .use(footnote__default.default)
  .use(ins__default.default)
  .use(mark__default.default)
  .use(sub__default.default)
  .use(sup__default.default);
...
const PreviewWysiwyg = ({ data = "" }) => {
  const html = React__namespace.useMemo(
    () =>
      sanitizeHtml__default.default(
        md.render(data.replaceAll("\\n", "\n") || ""),
        {
...
const Wrapper = styled__default.default.div`
  ...
  blockquote {
    ...
    font-style: italic;
    padding: ${({ theme }) => theme.spaces[2]} ${({ theme }) =>
  theme.spaces[5]};
  }
...
const Editor = React__namespace.forwardRef(
  (
    ...
    React__namespace.useEffect(() => {
      ...
      editorRef.current = CodeMirror__default.default.fromTextArea(
        textareaRef.current,
        {
          lineWrapping: true,
          extraKeys: {
      ...
      CodeMirror__default.default.commands.newlineAndIndentContinueMarkdownList =
        newlineAndIndentContinueMarkdownList;
      editorRef.current.on("change", (doc) => {
        onChangeRef.current({
          target: { name: name2, value: doc.getValue(), type: "wysiwyg" },
        });
      });
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs(EditorAndPreviewWrapper, {
      children: [
        ...
        isPreviewMode &&
          /* @__PURE__ */ jsxRuntime.jsx(PreviewWysiwyg, { data: value }),
      ],
    });
  }
);
...
`;
const IconButtonGroupMargin = styled__default.default(
  designSystem.IconButtonGroup
)`
  margin-right: ${({ theme }) => `${theme.spaces[2]}`};
`;
...
const WysiwygFooter = ({ onToggleExpand }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    padding: 2,
    background: "neutral100",
    borderRadius: `0 0 ${4 / 16}rem ${4 / 16}rem`,
    children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
      justifyContent: "flex-end",
      alignItems: "flex-end",
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.SingleSelect, {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.SingleSelectOption,
                  { value: "h1", children: "h1" }
                ),
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.SingleSelectOption,
                  { value: "h2", children: "h2" }
                ),
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.SingleSelectOption,
                ...
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.SingleSelectOption,
                  { value: "h4", children: "h4" }
                ),
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.SingleSelectOption,
                  { value: "h5", children: "h5" }
                ),
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.SingleSelectOption,
                  { value: "h6", children: "h6" }
                ),
              ],
            }),
            /* @__PURE__ */ jsxRuntime.jsxs(MainButtons, {
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(CustomIconButton$1, {
                  disabled: true,
                  label: "Bold",
                  name: "Bold",
                  ...
                  /* @__PURE__ */ jsxRuntime.jsxs(
                    designSystem.IconButtonGroup,
                    {
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntime.jsx(CustomLinkIconButton, {
                          onClick: () =>
                            onActionClick(
                              "Link",
                              editorRef,
...
const Wysiwyg = React__namespace.forwardRef(
  (
    ...
    const [mediaLibVisible, setMediaLibVisible] =
      React__namespace.useState(false);
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, {
                  ...
                  children: [
                    label,
                    required &&
                      /* @__PURE__ */ jsxRuntime.jsx(TypographyAsterisk, {
                        textColor: "danger600",
                        children: "*",
                      }),
                  ],
                ...
                labelAction &&
                  /* @__PURE__ */ jsxRuntime.jsx(LabelAction$1, {
                    paddingLeft: 1,
                    children: labelAction,
                  }),
              ],
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(EditorLayout, {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(WysiwygNav, {
                  ...
                  onTogglePreviewMode: isExpandMode
                    ? void 0
                ...
                !isExpandMode &&
                  /* @__PURE__ */ jsxRuntime.jsx(WysiwygFooter, {
...
const Inputs = ({
  ...
  const disabled = React__namespace.useMemo(
    () => !get__default.default(metadatas, "editable", true),
    [metadatas]
  );
  ...
  const isRequired = React__namespace.useMemo(
    () => get__default.default(validations, ["required"], false),
    [validations]
  );
  const isChildOfDynamicZone = React__namespace.useMemo(() => {
    const attributes = get__default.default(
      currentContentTypeLayout,
      ["attributes"],
      {}
    );
    const foundAttributeType = get__default.default(
      attributes,
      [fieldName[0], "type"],
      null
    );
  ...
  const isUserAllowedToEditField = React__namespace.useMemo(() => {
    ...
    if (isChildOfComponent) {
      const parentFieldName = take__default
        .default(fieldName, fieldName.length - 1)
        .join(".");
  ...
  const shouldDisplayNotAllowedInput =
  ...
  if (type === "relation") {
    return (
      ...
      /* @__PURE__ */ jsxRuntime.jsx(RelationInputDataManager, {
        ...metadatas,
        ...fieldSchema,
        componentUid,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.GenericInput, {
    ...
    isNullable:
      ...
      (fieldSchema.default === null || fieldSchema.default === void 0),
    description: description
      ? { id: description, defaultMessage: description }
      : void 0,
    ...
    placeholder: placeholder
      ? { id: placeholder, defaultMessage: placeholder }
      : void 0,
              ...
              ({
                ...
                return /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.GridItem,
                  {
                    ...
                    s: 12,
                    xs: 12,
                    children: /* @__PURE__ */ jsxRuntime.jsx(Inputs, {
                      componentUid,
                      keys,
                      fieldSchema,
                      metadatas,
...
const RepeatableComponent$1 = ({
  ...
  const mainField =
    "settings" in componentLayoutData
      ? componentLayoutData.settings.mainField ?? "id"
      : "id";
  ...
  if (hasMinError) {
    ...
    componentErrorKeys.some((error) => error.split(".").length > 1) &&
    !hasMinError
  ) {
    errorMessage = {
  ...
  if (componentValueLength === 0) {
    return /* @__PURE__ */ jsxRuntime.jsx(ComponentInitializer, {
      error: errorMessage,
      isReadOnly,
      onClick: handleClick,
    });
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(AccordionGroup, {
        error: errorMessage,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(AccordionContent, {
            "aria-describedby": ariaDescriptionId,
            children: componentValue.map(({ __temp_key__: key }, index) =>
              /* @__PURE__ */ jsxRuntime.jsx(
                Component,
                {
          ...
          /* @__PURE__ */ jsxRuntime.jsx(AccordionFooter, {
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
              justifyContent: "center",
              height: "48px",
              background: "neutral0",
              children: /* @__PURE__ */ jsxRuntime.jsx(TextButtonCustom, {
                disabled: isReadOnly,
                onClick: handleClick,
                startIcon: /* @__PURE__ */ jsxRuntime.jsx(Icons.Plus, {}),
                children: formatMessage({
...
const ActionsFlex$1 = styled__default.default(designSystem.Flex)`
  & .drag-handle {
    ...
    svg {
      path {
        fill: ${({ theme, expanded }) =>
          expanded ? theme.colors.primary600 : void 0};
      }
    }
...
const Component = ({
  ...
  const { modifiedData, removeRepeatableField, triggerFormValidation } =
    helperPlugin.useCMEditViewDataManager();
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    ...
    children: isDragging
      ...
      : /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion, {
          expanded: isOpen,
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.AccordionToggle, {
              action: isReadOnly
                ? null
                : /* @__PURE__ */ jsxRuntime.jsxs(ActionsFlex$1, {
                    gap: 0,
                    expanded: isOpen,
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(CustomIconButton, {
                        expanded: isOpen,
                        noBorder: true,
                        onClick: () => {
...
function getComponentErrorKeys(name2, formErrors = {}) {
  return Object.keys(formErrors)
    .filter((errorKey) => errorKey.startsWith(name2))
    .map((errorKey) =>
      errorKey
        .split(".")
        .slice(0, name2.split(".").length + 1)
        .join(".")
    );
}
const FieldComponent = ({
  ...
  const hasChildrenAllowedFields = React__namespace.useMemo(() => {
    ...
    const relatedChildrenAllowedFields = allowedFields
      ...
      .filter((fieldName) => {
        ...
        return (
          fieldName.slice(0, compoName.length).join(".") === compoName.join(".")
        );
      });
  ...
  const hasChildrenReadableFields = React__namespace.useMemo(() => {
    ...
    const relatedChildrenAllowedFields = allowedFields2
      .map((fieldName) => {
        return fieldName.split(".");
      })
      .filter((fieldName) => {
    ...
    children: [
          ...
          intlLabel &&
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
              ...
              children: [
                ...
                labelAction &&
                  /* @__PURE__ */ jsxRuntime.jsx(LabelAction, {
                    paddingLeft: 1,
                    children: labelAction,
                  }),
              ],
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
          !isRepeatable &&
            !isInitialized &&
            /* @__PURE__ */ jsxRuntime.jsx(ComponentInitializer, {
              isReadOnly,
              onClick: handleClickAddNonRepeatableComponentToField,
            }),
          !isRepeatable &&
            isInitialized &&
            /* @__PURE__ */ jsxRuntime.jsx(NonRepeatableComponent, {
              componentUid,
              isFromDynamicZone,
              isNested,
              name: name2,
          ...
          isRepeatable &&
            /* @__PURE__ */ jsxRuntime.jsx(RepeatableComponent$1, {
...
const DynamicComponent = ({
  ...
  const { icon, friendlyName, mainValue } = React__namespace.useMemo(() => {
    ...
    const mainFieldKey = get__default.default(
      componentLayoutData,
      ["settings", "mainField"],
      "id"
    );
    const mainField =
      get__default.default(modifiedData, [name2, index, mainFieldKey]) ?? "";
  ...
  const composedBoxRefs = composeRefs(boxRef, dropRef);
  const accordionActions = !isFieldAllowed
    ? null
    : /* @__PURE__ */ jsxRuntime.jsxs(ActionsFlex, {
        gap: 0,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(IconButtonCustom, {
            noBorder: true,
            label: formatMessage(
              {
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, {
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Trigger, {
                size: "S",
                endIcon: null,
                paddingLeft: 2,
                paddingRight: 2,
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Content, {
                children: [
                  /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.SubRoot, {
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.SubTrigger, {
                        children: formatMessage({
                          id: getTranslation(
                            "components.DynamicZone.add-item-above"
                          ),
                          defaultMessage: "Add component above",
                        }),
                      }),
                      /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.SubContent, {
                        children: Object.entries(
                          ...
                          /* @__PURE__ */ jsxRuntime.jsxs(
                            ...
                            {
                              children: [
                                /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.Label, {
                                  children: category,
                                }),
                                components.map(
                                  ({
                  ...
                  /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.SubRoot, {
                    children: [
                      /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.SubTrigger, {
                        children: formatMessage({
                          id: getTranslation(
                            "components.DynamicZone.add-item-below"
                          ),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(StyledBox, {
        ...
        children: isDragging
          ...
          : /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Accordion, {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.AccordionToggle, {
                  startIcon: /* @__PURE__ */ jsxRuntime.jsx(ComponentIcon, {
                    icon,
...
const AccordionContentRadius = styled__default.default(designSystem.Box)`
  border-radius: 0 0 ${({ theme }) => theme.spaces[1]} ${({ theme }) =>
  theme.spaces[1]};
`;
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
    ...
    children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
            maxWidth: helperPlugin.pxToRem(356),
            children: [
              /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Typography, {
                variant: "pi",
                textColor: "neutral600",
...
const DynamicZone = ({ name: name2, labelAction, fieldSchema, metadatas }) => {
  ...
  const [addComponentIsOpen, setAddComponentIsOpen] =
    React__namespace.useState(false);
  const [liveText, setLiveText] = React__namespace.useState("");
  const {
  ...
  const { getComponentLayout, components: allComponents } =
  ...
  const getItemPos = (index) =>
    `${index + 1} of ${dynamicDisplayedComponents.length}`;
  const handleCancel = (index) => {
    setLiveText(
      formatMessage(
        {
  ...
  if (
    !isFieldAllowed &&
    (isCreatingEntry || (!isFieldReadable && !isCreatingEntry))
  ) {
    return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.NotAllowedInput, {
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("ol", {
              "aria-describedby": ariaDescriptionId,
              children: dynamicDisplayedComponents.map(
                ({ componentUid, id }, index) =>
                  /* @__PURE__ */ jsxRuntime.jsx(
                    DynamicComponent,
                    {
                      componentUid,
        ...
        if (value.type === "component") {
          ...
          acc[key] = acc[key].map((datum, index) => {
            const componentAttributes =
              components[datum.__component].attributes;
            const data2 = findAllAndReplace(datum, componentAttributes, {
              ignoreFalseyValues,
              path: [...path, key, index.toString()],
              parent: attributes[key],
  ...
  produce__default.default(state, (draftState) => {
    switch (action.type) {
      ...
      case "ADD_REPEATABLE_COMPONENT_TO_FIELD": {
        ...
        const currentValue = [
          ...get__default.default(state, ["modifiedData", ...keys], []),
        ];
      ...
      case "LOAD_RELATION": {
        ...
        const initialDataRelations =
          get__default.default(state, initialDataPath) ?? [];
        const modifiedDataRelations = get__default.default(
          state,
          modifiedDataPath
        );
        ...
        set__default.default(
          draftState,
          initialDataPath,
          uniqBy__default.default(
            [...valuesWithKeys, ...initialDataRelations],
            "id"
          )
        );
        set__default.default(
          ...
          modifiedDataPath,
          uniqBy__default.default(
            [...valuesWithKeys, ...modifiedDataRelations],
            "id"
          )
        );
        break;
      ...
      case "CONNECT_RELATION": {
        ...
        if (toOneRelation) {
          ...
          const [key] = fractionalIndexing.generateNKeysBetween(
            modifiedDataRelations.at(-1)?.__temp_key__,
            null,
            1
          );
          const newRelations = [
            ...modifiedDataRelations,
            { ...value, __temp_key__: key },
          ];
      ...
      case "DISCONNECT_RELATION": {
        ...
        const newRelations = modifiedDataRelation.filter(
          (rel) => rel.id !== id
        );
        set__default.default(draftState, path, newRelations);
        break;
        ...
        if (action.type === "REORDER_RELATION") {
          ...
          const endKey =
            oldIndex > newIndex
              ? modifiedDataRelations[newIndex]?.__temp_key__
              : modifiedDataRelations[newIndex + 1]?.__temp_key__;
          const [newKey] = fractionalIndexing.generateNKeysBetween(
            startKey,
            endKey,
            1
          );
          newRelations.splice(oldIndex, 1);
          newRelations.splice(newIndex, 0, {
            ...currentItem,
            __temp_key__: newKey,
          });
        } else {
      ...
      case "INIT_FORM": {
        ...
        const findAllRelationsAndReplaceWithEmptyArray = findAllAndReplaceSetup(
          ...
          (_, { path }) => {
            if (
              state.modifiedData?.id === data.id &&
              get__default.default(state.modifiedData, path)
            ) {
        ...
        const mergedDataWithPreparedRelations =
          findAllRelationsAndReplaceWithEmptyArray(data, attributes);
        const findComponentsAndReplaceWithTempKey = findAllAndReplaceSetup(
          components,
          (value) =>
            value.type === "dynamiczone" ||
            (value.type === "component" && !value.repeatable),
          (data2) => {
            return Array.isArray(data2)
              ? data2.map((datum, index) => ({
                  ...datum,
                  __temp_key__: index,
                }))
              : {
      ...
      case "MOVE_COMPONENT_DOWN": {
        ...
        set__default.default(
          draftState,
          ["modifiedData", action.dynamicZoneName],
          updatedValue
        );
        break;
      }
      case "MOVE_FIELD": {
        const currentValue = get__default
          .default(state, ["modifiedData", ...action.keys], [])
          .slice();
        const valueToInsert = get__default.default(state, [
          "modifiedData",
          ...action.keys,
          action.dragIndex,
        ]);
      ...
      case "ON_CHANGE": {
        ...
        if (action.shouldSetInitialValue) {
          set__default.default(
            draftState,
            ["initialData", ...action.keys],
            action.value
          );
        }
        if (
          action.keys.length === 2 &&
          get__default.default(state, [
            "modifiedData",
      ...
      case "REMOVE_REPEATABLE_FIELD": {
        ...
        const pathToComponentData = [
          "modifiedData",
          ...take__default.default(action.keys, keysLength),
        ];
        ...
        const currentValue = get__default
          .default(state, pathToComponentData)
          .slice();
      ...
      case "RESET_PUBLISH_CONFIRMATION": {
        draftState.publishConfirmation = {
      ...
      switch (type) {
        ...
        case "media":
          if (attribute.multiple === true) {
            ...
            cleanedData =
              get__default.default(value, 0) instanceof File
                ? null
                : get__default.default(value, "id", null);
          }
          break;
        case "component":
          if (attribute.repeatable) {
        ...
        case "relation": {
          ...
          const actualOldValue = get__default.default(
            rootServerState,
            trueInitialDataPath,
            []
          );
          const connectedRelations = value.reduce(
            (acc2, relation, currentIndex, array) => {
              ...
              if (
                !relationOnServer ||
                relationOnServer.__temp_key__ !== relation.__temp_key__
              ) {
                const position = relationInFront
                  ? { before: relationInFront.id }
                  : { end: true };
          ...
          const disconnectedRelations = actualOldValue.reduce(
            (acc2, relation) => {
              if (
                !value.find((newRelation) => newRelation.id === relation.id)
              ) {
...
const EditViewDataManagerProvider = ({
  ...
  const { trackUsage } = helperPlugin.useTracking();
  const { formatMessage } = reactIntl.useIntl();
  const shouldRedirectToHomepageWhenEditingEntry =
  ...
  React__namespace.useEffect(() => {
    if (
      ...
      !isEqual__default.default(previousInitialValues, initialValues)
    ) {
      dispatch({
        type: "INIT_FORM",
        initialValues,
  ...
  const addComponentToDynamicZone = dispatchAddComponent(
  ...
  const relationConnect = React__namespace.useCallback(
    ({ name: name2, value, toOneRelation }) => {
      dispatch({
  ...
  const addRepeatableComponentToField = dispatchAddComponent(
  ...
  const handleChange = React__namespace.useCallback(
    ({ target }, shouldSetInitialValue = false) => {
  ...
  const handlePublishPromptDismissal = React__namespace.useCallback(
    async (e) => {
      e.preventDefault();
      return dispatch({
  ...
  const shouldCheckDZErrors = React__namespace.useCallback(
    (dzName) => {
      ...
      const shouldCheckErrors2 =
        !isEmpty__default.default(formErrors) && doesDZHaveError;
  ...
  const moveComponentField = React__namespace.useCallback(
    ({ name: name2, newIndex, currentIndex }) => {
      dispatch({
  ...
  const relationDisconnect = React__namespace.useCallback(
    ({ name: name2, id }) => {
      dispatch({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(
    helperPlugin.ContentManagerEditViewDataManagerContext.Provider,
    {
      ...
      children:
        isLoadingForData ||
        (!isCreatingEntry && !initialData.id && !isSingleType)
          ...
          : /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
              children: [
                !isSaving
                  ? /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Prompt, {
                      when: !isEqual__default.default(
                        modifiedData,
                        initialData
                      ),
...
const DeleteLink = ({ onDelete }) => {
  const { hasDraftAndPublish, modifiedData } =
    helperPlugin.useCMEditViewDataManager();
  ...
  const toggleWarningDelete = () =>
    setDisplayDeleteConfirmation((prevState) => !prevState);
  const handleConfirmDelete = async () => {
    try {
...
const DraftAndPublishBadge = () => {
  const { initialData, hasDraftAndPublish } =
    helperPlugin.useCMEditViewDataManager();
  const { formatMessage } = reactIntl.useIntl();
  if (!hasDraftAndPublish) {
    return null;
...
const Header = ({ allowedActions: { canUpdate, canCreate, canPublish } }) => {
  ...
  const { goBack } = reactRouterDom.useHistory();
  const [showWarningUnpublish, setWarningUnpublish] =
    React__namespace.useState(false);
  const { formatMessage } = reactIntl.useIntl();
  const currentContentTypeMainField = get__default.default(
    layout,
    ["settings", "mainField"],
    "id"
  );
  const currentContentTypeName = get__default.default(
    layout,
    ["info", "displayName"],
    "NOT FOUND"
  );
  const didChangeData =
    !isEqual__default.default(initialData, modifiedData) ||
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
        ...
        primaryAction,
        subtitle,
        navigationAction: /* @__PURE__ */ jsxRuntime.jsx(v2.Link, {
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog, {
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(
                    designSystem.Typography,
                    {
                      ...
                      children: formatMessage({
                        id: getTranslation(
                          "popUpWarning.warning.unpublish-question"
                        ),
                        defaultMessage:
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Dialog, {
        ...
        children: [
                    ...
                    formatMessage(
                      ...
                      },
                      {
                        b: (chunks) =>
                          /* @__PURE__ */ jsxRuntime.jsx(
                            designSystem.Typography,
                            { fontWeight: "bold", children: chunks }
                          ),
                        count: draftCount,
                      }
                    ),
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.DialogFooter, {
            startAction: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Button, {
              onClick: onPublishPromptDismissal,
              variant: "tertiary",
              children: formatMessage({
                id: "components.popUpWarning.button.cancel",
                defaultMessage: "Cancel",
...
const Body = () => {
  ...
  const { initialData, isCreatingEntry } =
    helperPlugin.useCMEditViewDataManager();
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        as: "dl",
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(KeyValuePair, {
            label: formatMessage({
...
const InformationBoxCE = () => {
  return /* @__PURE__ */ jsxRuntime.jsxs(Information.Root, {
    children: [
...
const EditViewPage = ({
    ...
    async () =>
      (
        await Promise.resolve().then(() =>
          require("./InformationBoxEE-XL9B065O.js")
        )
      ).InformationBoxEE
  );
  useOnce(() => {
  ...
  const { isLazyLoading, lazyComponentStore } =
    useLazyComponents(customFieldUids);
  const {
    createActionAllowedFields,
    readActionAllowedFields,
    updateActionAllowedFields,
  ...
  const configurationPermissions =
    (collectionType === "single-types"
      ? permissions2.contentManager?.singleTypesConfigurations
      : permissions2.contentManager?.collectionTypesConfigurations) ?? [];
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ContentTypeFormWrapper, {
    collectionType,
    slug,
    id,
    origin,
    children: ({
      ...
      return /* @__PURE__ */ jsxRuntime.jsx(EditViewDataManagerProvider, {
        allowedActions,
        createActionAllowedFields,
        componentsDataStructure,
        contentTypeDataStructure,
        ...
        children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
              children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, {
                gap: 4,
                children: [
                  /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
                    col: 9,
                    ...
                    children: /* @__PURE__ */ jsxRuntime.jsx(
                      designSystem.Flex,
                      {
                        ...
                        alignItems: "stretch",
                        gap: 6,
                        children: formattedContentTypeLayout.map(
                          (row, index) => {
                              ...
                              designSystem.Box,
                              {
                                ...
                                children: /* @__PURE__ */ jsxRuntime.jsx(
                                  designSystem.Flex,
                                  {
                                    ...
                                    alignItems: "stretch",
                                    gap: 6,
                                    children: row.map((columns, gridRowIndex) =>
                                      /* @__PURE__ */ jsxRuntime.jsx(
                                        designSystem.Grid,
                                        {
                                          gap: 4,
                              ...
                              designSystem.Flex,
                              {
                                ...
                                children: [
                                  ...
                                  allowedActions.canDelete &&
                                    !isCreatingEntry &&
                                    /* @__PURE__ */ jsxRuntime.jsx(DeleteLink, {
                                      onDelete,
                                    }),
                                ],
                              }
  ...
  (layout) => {
    ...
    currentLayout.forEach((row) => {
      const hasDynamicZone = row.some(
        ({ name: name2 }) =>
          currentContentTypeLayoutData.attributes[name2]["type"] ===
          "dynamiczone"
      );
      ...
      if (hasDynamicZone) {
        currentRowIndex =
          currentRowIndex === 0 && newLayout[0].length === 0
            ? 0
            : currentRowIndex + 1;
        if (!newLayout[currentRowIndex]) {
          newLayout[currentRowIndex] = [];
...
const selectCustomFieldUids = toolkit.createSelector(
  ...
  (layout) => {
    ...
    const allFields = [
      ...
      ...Object.values(layout.components).flatMap(
        (component) => component.layouts.edit
      ),
    ].flat();
...
const ProtectedEditViewPage = ({ userPermissions = [], ...restProps }) => {
...
const EditViewLayoutManager = ({ layout, ...rest }) => {
  ...
  const [{ query }] = helperPlugin.useQueryParams();
  const { runHookWaterfall } = helperPlugin.useStrapiApp();
  const { permissions: permissions2, isValid: isValidPermissions } =
    useSyncRbac(query, rest.match.params.slug, "editView");
  React__namespace.useEffect(() => {
    const mutatedLayout = runHookWaterfall(MUTATE_EDIT_VIEW_LAYOUT$1, {
      layout,
      query,
    });
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ProtectedEditViewPage, {
    ...rest,
...
const checkIfAttributeIsDisplayable = (attribute) => {
  ...
  return (
    !["json", "dynamiczone", "richtext", "password", "blocks"].includes(type) &&
    !!type
  );
};
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(
                    designSystem.ToggleInput,
                    {
                      ...
                      onChange: (e) =>
                        onChangeEditLabel({
                          target: { name: "sortable", value: e.target.checked },
                        }),
                      onLabel: formatMessage({
                        id: "app.components.ToggleCheckbox.on-label",
                        defaultMessage: "on",
...
const Settings = ({
  ...
  const sortOptions = useEnterprise(
    sortOptionsCE,
    async () =>
      (await Promise.resolve().then(() => require("./constants-WbeIIlk3.js")))
        .REVIEW_WORKFLOW_STAGE_SORT_OPTION_NAME,
    {
      combine(ceOptions, eeOption) {
        return [
          ...ceOptions,
          { ...eeOption, label: formatMessage(eeOption.label) },
        ];
      },
  ...
  const sortOptionsSorted = sortOptions.sort((a, b) =>
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
            width: "100%",
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.ToggleInput, {
              label: formatMessage({
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Select, {
              ...
              onChange: (value) =>
                onChange({ target: { name: "settings.pageSize", value } }),
              name: "settings.pageSize",
              value: modifiedData.settings.pageSize || "",
              children: [10, 20, 50, 100].map((pageSize) =>
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.Option,
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Select, {
              ...
              onChange: (value) =>
                onChange({ target: { name: "settings.defaultSortBy", value } }),
              name: "settings.defaultSortBy",
              value: modifiedData.settings.defaultSortBy || "",
              children: sortOptionsSorted.map(({ value, label }) =>
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.Option,
                  { value, children: label },
                  value
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Select, {
              ...
              onChange: (value) =>
                onChange({
                  target: { name: "settings.defaultSortOrder", value },
                }),
              name: "settings.defaultSortOrder",
              value: modifiedData.settings.defaultSortOrder || "",
              children: ["ASC", "DESC"].map((order) =>
                /* @__PURE__ */ jsxRuntime.jsx(
                  designSystem.Option,
...
const DraggableCard = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(FieldWrapper, {
    ...
    children: [
      isDragging &&
        /* @__PURE__ */ jsxRuntime.jsx(CardDragPreview, { labelField }),
      !isDragging &&
        isDraggingSibling &&
        /* @__PURE__ */ jsxRuntime.jsx(CardDragPreview, {
          isSibling: true,
          labelField,
        }),
      !isDragging &&
        !isDraggingSibling &&
        /* @__PURE__ */ jsxRuntime.jsxs(FieldContainer, {
          borderColor: "neutral150",
          background: "neutral100",
          hasRadius: true,
          justifyContent: "space-between",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntime.jsx(ActionButton, {
                  ...
                  "aria-label": formatMessage(
                    {
                      id: getTranslation(
                        "components.DraggableCard.delete.field"
                      ),
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
              gap: 3,
              children: displayedFields.map((field, index) =>
                /* @__PURE__ */ jsxRuntime.jsx(
                  DraggableCard,
                  {
                    index,
          ...
          /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, {
            children: [
              ...
              /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.Content, {
                children: listRemainingFields.map((field) =>
                  /* @__PURE__ */ jsxRuntime.jsx(
                    v2.Menu.Item,
                    {
                      onSelect: () => handleAddField(field),
                      children: metadatas[field].list.label || field,
                    },
                    field
                  )
                ),
...
const reducer$3 = (state = initialState$3, action) =>
  ...
  produce__default.default(state, (draftState) => {
    ...
    switch (action.type) {
      case "ADD_FIELD": {
        const layoutFieldList = get__default.default(
          state,
          layoutFieldListPath,
          []
        );
        set__default.default(draftState, layoutFieldListPath, [
          ...layoutFieldList,
          action.item,
        ]);
        break;
      ...
      case "SUBMIT_FIELD_FORM": {
        ...
        set__default.default(
          draftState,
          [...fieldMetadataPath, "label"],
          state.fieldForm.label
        );
        set__default.default(
          draftState,
          [...fieldMetadataPath, "sortable"],
          state.fieldForm.sortable
        );
        break;
      }
      default:
...
const ListSettingsView = ({ layout, slug }) => {
  ...
  const [{ fieldToEdit, fieldForm, initialData, modifiedData }, dispatch] =
    React__namespace.useReducer(reducer$3, initialState$3, () => ({
      ...initialState$3,
      initialData: layout,
      modifiedData: layout,
    }));
  ...
  const listRemainingFields = Object.entries(attributes)
    .filter(
      ([name2, attribute]) =>
        checkIfAttributeIsDisplayable(attribute) &&
        !displayedFields.includes(name2)
    )
    .map(([name2]) => name2)
    .sort();
  const sortOptions = Object.entries(attributes)
    .filter(
      ([, attribute]) => !EXCLUDED_SORT_ATTRIBUTE_TYPES.includes(attribute.type)
    )
    .map(([name2]) => ({
      value: name2,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Layout, {
    children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
              ...
              title: formatMessage(
                ...
                {
                  name: upperFirst__default.default(
                    modifiedData.info.displayName
                  ),
                }
              ),
            }),
    ...
    children: [
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
            ...
            children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
              ...
              children: formatMessage({
                id: getTranslation(
                  "containers.ListPage.autoCloneModal.description"
                ),
                defaultMessage:
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
            ...
            direction: "column",
            alignItems: "stretch",
            children: prohibitedFields.map(([fieldPath, reason]) =>
              /* @__PURE__ */ jsxRuntime.jsxs(
                designSystem.Flex,
                {
                  direction: "column",
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
                      direction: "row",
                      as: "ol",
                      children: fieldPath.map((pathSegment, index) =>
                        /* @__PURE__ */ jsxRuntime.jsxs(
                          designSystem.Typography,
                          {
                            fontWeight: "semiBold",
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
                      ...
                      children: formatMessage({
                        id: getTranslation(
                          `containers.ListPage.autoCloneModal.error.${reason}`
                        ),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ModalFooter, {
        ...
        endActions:
          ...
          /* @__PURE__ */ jsxRuntime.jsx(v2.LinkButton, {
            as: reactRouterDom.NavLink,
            to: editPath,
            children: formatMessage({
...
const Filter = ({ displayedFilters }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      ...
      isVisible &&
        /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.FilterPopoverURLQuery, {
          displayedFilters,
          isVisible,
          onToggle: handleToggle,
          source: buttonRef,
        }),
      /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.FilterListURLQuery, {
...
const SingleComponent = ({ content, metadatas }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Tooltip, {
    ...
    children: /* @__PURE__ */ jsxRuntime.jsx(SingleComponentTypography, {
      textColor: "neutral800",
      ellipsis: true,
...
const SingleComponentTypography = styled__default.default(
  designSystem.Typography
)`
  max-width: 250px;
`;
const RepeatableComponent = ({ content, metadatas }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, {
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(MenuTrigger$1, {
        onClick: (e) => e.stopPropagation(),
        children: [
...
const RepeatableComponentTypography = styled__default.default(
  designSystem.Typography
)`
  max-width: 500px;
`;
...
const MediaSingle = ({
  ...
  if (mime.includes("image")) {
    ...
    const mediaURL =
      helperPlugin.prefixFileUrlWithBackendUrl(thumbnail) || fileURL;
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Avatar, {
      src: mediaURL,
...
const MediaMultiple = ({ content }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.AvatarGroup, {
...
const RelationSingle = ({ metadatas, content }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(TypographyMaxWidth$1, {
    textColor: "neutral800",
    ellipsis: true,
    children: /* @__PURE__ */ jsxRuntime.jsx(CellValue, {
      type: metadatas.mainField?.type ?? "integer",
      value: metadatas.mainField?.name
        ? content[metadatas.mainField?.name]
        : content.id,
    }),
  });
};
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Root, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(v2.Menu.Content, {
        children: [
          isLoading &&
            /* @__PURE__ */ jsxRuntime.jsx(v2.Menu.Item, {
              disabled: true,
                ...
                data.results.map((entry) =>
                  /* @__PURE__ */ jsxRuntime.jsx(
                    v2.Menu.Item,
                    {
                      disabled: true,
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                        TypographyMaxWidth$1,
                        {
                          ellipsis: true,
                          children: /* @__PURE__ */ jsxRuntime.jsx(CellValue, {
                            type: metadatas.mainField?.type ?? "integer",
                            value: metadatas.mainField?.name
                              ? entry[metadatas.mainField.name]
                              : entry.id,
                          }),
                        }
                      ),
...
const CellContent = ({
  ...
  switch (fieldSchema.type) {
    ...
    default:
      return /* @__PURE__ */ jsxRuntime.jsx(TypographyMaxWidth, {
        ellipsis: true,
        textColor: "neutral800",
        children: /* @__PURE__ */ jsxRuntime.jsx(CellValue, {
          type: fieldSchema.type,
...
const hasContent = (content, metadatas, fieldSchema) => {
  ...
  if (
    isFieldTypeNumber(fieldSchema.type) &&
      ...
      isVisible &&
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Popover, {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
            ...
            gap: 3,
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPermissions, {
                permissions:
                  permissions2.contentManager?.collectionTypesConfigurations,
                children: /* @__PURE__ */ jsxRuntime.jsx(v2.LinkButton, {
                  size: "S",
...
const FieldPicker = () => {
  ...
  const columns = Object.keys(contentTypeLayout.attributes)
    .filter((name2) =>
      checkIfAttributeIsDisplayable(contentTypeLayout.attributes[name2])
    )
    .map((name2) => ({
      name: name2,
  ...
  const handleChange = (name2) => {
    ...
    dispatch(
      onChangeListHeaders({
        name: name2,
        value: displayedHeadersKeys.includes(name2),
      })
    );
  };
  const handleReset = () => {
        ...
        children: columns.map((header) => {
          ...
          return /* @__PURE__ */ jsxRuntime.jsxs(
            ChackboxWrapper,
            {
              ...
              padding: 2,
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.BaseCheckbox, {
...
const useAllowedAttributes = (contentType, slug) => {
  const { allPermissions } = helperPlugin.useRBACProvider();
  const readPermissionsForSlug = helperPlugin.findMatchingPermissions(
    allPermissions,
    [
      {
  ...
  const attributesWithReadPermissions =
    readPermissionsForSlug?.[0]?.properties?.fields ?? [];
...
const ListViewPage = ({
  ...
  const [isConfirmDeleteRowOpen, setIsConfirmDeleteRowOpen] =
    React__namespace.useState(false);
  const toggleNotification = helperPlugin.useNotification();
  const { trackUsage } = helperPlugin.useTracking();
  ...
  const reviewWorkflowColumns = useEnterprise(
    ...
    async () =>
      (await Promise.resolve().then(() => require("./constants-VsoMjeOR.js")))
  ...
  const ReviewWorkflowsColumns = useEnterprise(
    ...
    async () => {
      const { ReviewWorkflowsStageEE, ReviewWorkflowsAssigneeEE } =
        await Promise.resolve().then(() =>
          require("./ReviewWorkflowsColumn-wFq2rw5O.js")
        );
  ...
  const { refetch } = reactQuery.useQuery(
    ...
    },
    {
      ...
      onSuccess({ pagination: pagination2, results }) {
        if (
          pagination2.page &&
          pagination2.page > pagination2.pageCount &&
          pagination2.pageCount > 0
        ) {
          const query2 = {
            ...params,
      ...
      if (header.fieldSchema.type === "relation") {
        return {
          ...
          metadatas: {
            ...
            label: formatMessage({
              id: getTranslation(
                `containers.ListPage.table-headers.${header.name}`
              ),
    ...
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
        primaryAction: canCreate
          ? /* @__PURE__ */ jsxRuntime.jsx(CreateButton, {
              hasDraftAndPublish,
        ...
        navigationAction: /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Link, {
          startIcon: /* @__PURE__ */ jsxRuntime.jsx(Icons.ArrowLeft, {}),
          to: "/content-manager/",
          children: formatMessage({
            id: "global.back",
      ...
      !canRead &&
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.ActionLayout, {
          endActions: /* @__PURE__ */ jsxRuntime.jsx(InjectionZone, {
      ...
      canRead &&
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.ActionLayout, {
          ...
          startActions: /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [
              isSearchable &&
                /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.SearchURLQuery, {
                  label: formatMessage(
                    {
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
        children: canRead
          ? /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
              ...
              alignItems: "stretch",
              children: [
                /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Table.Root, {
                  rows: data,
                  isLoading,
                  colCount,
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(
                      helperPlugin.Table.ActionBar,
                      {
                        children: /* @__PURE__ */ jsxRuntime.jsx(
                          BulkActionsRenderer,
                          {}
                    ...
                    /* @__PURE__ */ jsxRuntime.jsxs(
                      helperPlugin.Table.Content,
                      {
                        children: [
                          /* @__PURE__ */ jsxRuntime.jsxs(
                            helperPlugin.Table.Head,
                            {
                              children: [
                                /* @__PURE__ */ jsxRuntime.jsx(
                                  helperPlugin.Table.HeaderCheckboxCell,
                                ...
                                /* @__PURE__ */ jsxRuntime.jsx(
                                  helperPlugin.Table.HeaderHiddenActionsCell,
                                  {}
                                ),
                              ],
                            }
                          ...
                          /* @__PURE__ */ jsxRuntime.jsx(
                            helperPlugin.Table.LoadingBody,
                            {}
                          ),
                          /* @__PURE__ */ jsxRuntime.jsx(
                          ...
                          /* @__PURE__ */ jsxRuntime.jsx(Table.Root, {
                                      ...
                                      ({
                                        ...
                                        if (
                                          ...
                                          return /* @__PURE__ */ jsxRuntime.jsx(
                                            designSystem.Td,
                                            {
                                              children: cellFormatter(rowData, {
                                                key,
                                                name: name2,
                                                ...rest,
                                              }),
...
const ListViewLayoutManager = ({ layout, ...props }) => {
  ...
  const [{ query, rawQuery }] = helperPlugin.useQueryParams();
  const { permissions: permissions2, isValid: isValidPermissions } =
    useSyncRbac(query, props.slug, "listView");
...
const ON_CHANGE_LIST_HEADERS =
  "ContentManager/ListView/ON_CHANGE_LIST_HEADERS ";
...
const onChangeListHeaders = (target) => ({
        ...
        if (!value && state.contentType) {
          ...
          switch (attribute.type) {
            case "component": {
              ...
              const mainFieldName =
                state.components[componentName]?.settings.mainField ?? null;
              const mainFieldAttribute =
                state.components[componentName]?.attributes[mainFieldName];
...
const CollectionTypePages = (props) => {
  ...
  const { rawContentTypeLayout, rawComponentsLayouts } =
    React__namespace.useMemo(() => {
      ...
      if (layout?.components) {
        rawComponentsLayouts2 = Object.keys(layout.components).reduce(
          (acc, current) => {
            acc[current] = formatLayoutForSettingsView(
      ...
      return {
        rawContentTypeLayout: rawContentTypeLayout2,
        rawComponentsLayouts: rawComponentsLayouts2,
      };
    }, [layout]);
  if (
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(reactRouterDom.Switch, {
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
        ...
        render: (props2) =>
          collectionType === "collection-types"
            ? /* @__PURE__ */ jsxRuntime.jsx(ListViewLayoutManager, {
                slug,
                layout,
              })
            : /* @__PURE__ */ jsxRuntime.jsx(EditViewLayoutManager, {
                layout,
                ...props2,
              }),
      }),
      /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
        exact: true,
        path: `${currentPath}/configurations/edit`,
        children: /* @__PURE__ */ jsxRuntime.jsx(
          helperPlugin.CheckPagePermissions,
          {
            permissions:
              permissions2.contentManager?.collectionTypesConfigurations,
            children: /* @__PURE__ */ jsxRuntime.jsx(EditSettingsView, {
      ...
      collectionType === "collection-types"
        ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
                path: `${currentPath}/configurations/list`,
                children: /* @__PURE__ */ jsxRuntime.jsx(
                  helperPlugin.CheckPagePermissions,
                  {
                    permissions:
                      permissions2.contentManager
                        ?.collectionTypesConfigurations,
                    children: /* @__PURE__ */ jsxRuntime.jsx(ListSettingsView, {
...
const ComponentSettingsView = () => {
  const [{ isLoading, data: layout }, dispatch] = React__namespace.useReducer(
    reducer$1,
    initialState$1
  );
  const schemas = useTypedSelector(selectSchemas);
  ...
  React__namespace.useEffect(() => {
    ...
    const fetchData = async (source2) => {
      try {
        ...
        dispatch(
          getDataSucceeded$1(mergeMetasWithSchema(data, schemas, "component"))
        );
      } catch (err) {
        if (axios__default.default.isCancel(err)) {
          return;
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPagePermissions, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
        children: /* @__PURE__ */ jsxRuntime.jsx(
          designSystem.EmptyStateLayout,
          {
            action: /* @__PURE__ */ jsxRuntime.jsx(v2.LinkButton, {
              as: reactRouterDom.NavLink,
              variant: "secondary",
              startIcon: /* @__PURE__ */ jsxRuntime.jsx(Icons.Plus, {}),
            ...
            hasRadius: true,
            icon: /* @__PURE__ */ jsxRuntime.jsx(Icons.EmptyDocuments, {
              width: "10rem",
            }),
            shadow: "tableShadow",
          }
...
const App = () => {
  ...
  if (status === "loading") {
    return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, {
      "aria-busy": "true",
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(reactHelmet.Helmet, {
          title: formatMessage({
  ...
  const supportedModelsToDisplay = models.filter(
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(
                    ...
                    {
                      permissions:
                        permissions2.contentManager?.componentsConfigurations,
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                ...
                /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
                  ...
                  children: /* @__PURE__ */ jsxRuntime.jsx(NoPermissions, {}),
                }),
                /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
                  path: "/content-manager/no-content-types",
                  children: /* @__PURE__ */ jsxRuntime.jsx(NoContentType, {}),
                }),
                /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.Route, {
                  path: "",
                  component: helperPlugin.AnErrorOccurred,
                }),
              ],
            }),
          }),
...
function renderDraglayerItem({ type, item }) {
  ...
  switch (actualType) {
    ...
    case ItemTypes.FIELD:
      return /* @__PURE__ */ jsxRuntime.jsx(CardDragPreview, {
...
const reducer = (state = initialState, action) =>
  produce__default.default(state, (draftState) => {
    switch (action.type) {
      ...
      case SET_INIT_DATA: {
        draftState.collectionTypeLinks =
          action.data.authorizedCollectionTypeLinks.filter(
            ({ isDisplayed }) => isDisplayed
          );
        draftState.singleTypeLinks =
          action.data.authorizedSingleTypeLinks.filter(
            ({ isDisplayed }) => isDisplayed
          );
...
const App$1 = /* @__PURE__ */ Object.freeze(
  /* @__PURE__ */ Object.defineProperty(
    {
      __proto__: null,
      App,
...
const injectReducerStoreEnhancer =
  (appReducers) =>
  (next) =>
  (...args) => {
...
const getBasename = () =>
  (process.env.ADMIN_PATH ?? "").replace(window.location.origin, "");
const createHook = () => {
  const _handlers = [];
  return {
    register(fn) {
...
class StrapiApp {
  ...
  addCorePluginMenuLink = (link) => {
    ...
    invariant__default.default(
      link.to,
      `link.to should be defined for ${stringifiedLink}`
    );
    invariant__default.default(
  ...
  addSettingsLink = (sectionId, link) => {
    ...
    invariant__default.default(
      link.id,
      `link.id should be defined for ${stringifiedLink}`
    );
    invariant__default.default(
      link.intlLabel?.id && link.intlLabel?.defaultMessage,
      `link.intlLabel.id & link.intlLabel.defaultMessage for ${stringifiedLink}`
  ...
  addSettingsLinks = (sectionId, links) => {
    ...
    invariant__default.default(
      Array.isArray(links),
      "TypeError expected links to be an array"
    );
    links.forEach((link) => {
  ...
  createCustomConfigurations = async () => {
    ...
    if (this.customConfigurations?.theme) {
      ...
      if (!darkTheme2 && !lightTheme2) {
        ...
        merge__default.default(
          this.configurations.themes.light,
    ...
    if (this.customConfigurations?.notifications?.releases !== void 0) {
      this.configurations.notifications.releases =
        this.customConfigurations.notifications.releases;
    }
  ...
  createSettingSection = (section, links) => {
    ...
    invariant__default.default(
      this.settings[section.id] === void 0,
      "A similar section already exists"
    );
  ...
  getAdminInjectedComponents = (moduleName, containerName, blockName) => {
    try {
      return (
        this.admin.injectionZones[moduleName][containerName][blockName] || []
      );
    } catch (err) {
      console.error("Cannot get injected component", err);
      return [];
  ...
  injectContentManagerComponent = (containerName, blockName, component) => {
    invariant__default.default(
      ...
      `The ${containerName} ${String(
        blockName
      )} zone is not defined in the content manager`
    );
    invariant__default.default(component, "A Component must be provided");
    this.admin.injectionZones.contentManager[containerName][blockName].push(
      component
    );
  };
  injectAdminComponent = (containerName, blockName, component) => {
    invariant__default.default(
      ...
      `The ${containerName} ${String(
        blockName
      )} zone is not defined in the admin`
    );
    invariant__default.default(component, "A Component must be provided");
      ...
      return __variableDynamicImportRuntimeHelper(
        /* @__PURE__ */ Object.assign({
          "./translations/ar.json": () =>
            Promise.resolve().then(() => require("./ar-qfb99PVh.js")),
          "./translations/ca.json": () =>
            Promise.resolve().then(() => require("./ca-bQs9dsIc.js")),
          "./translations/cs.json": () =>
            Promise.resolve().then(() => require("./cs-XYXIcfVY.js")),
          "./translations/de.json": () =>
            Promise.resolve().then(() => require("./de-elBeWdG2.js")),
          "./translations/dk.json": () =>
            Promise.resolve().then(() => require("./dk-qvFj0oFG.js")),
          "./translations/en.json": () =>
            Promise.resolve().then(() => require("./en-UdTZS0x5.js")),
          "./translations/es.json": () =>
            Promise.resolve().then(() => require("./es-hBQ_pL0X.js")),
          "./translations/eu.json": () =>
            Promise.resolve().then(() => require("./eu-VH6nNPXY.js")),
          "./translations/fr.json": () =>
            Promise.resolve().then(() => require("./fr-RVVsyT5B.js")),
          "./translations/gu.json": () =>
            Promise.resolve().then(() => require("./gu-76mTVAc2.js")),
          "./translations/he.json": () =>
            Promise.resolve().then(() => require("./he-RmtdSWtw.js")),
          "./translations/hi.json": () =>
            Promise.resolve().then(() => require("./hi-zD7tX6HS.js")),
          "./translations/hu.json": () =>
            Promise.resolve().then(() => require("./hu-0pmvoLj1.js")),
          "./translations/id.json": () =>
            Promise.resolve().then(() => require("./id-yQtHASS7.js")),
          "./translations/it.json": () =>
            Promise.resolve().then(() => require("./it-RPJqQqp3.js")),
          "./translations/ja.json": () =>
            Promise.resolve().then(() => require("./ja-5uFhM-kW.js")),
          "./translations/ko.json": () =>
            Promise.resolve().then(() => require("./ko-JyirX0Lo.js")),
          "./translations/ml.json": () =>
            Promise.resolve().then(() => require("./ml-QqpcKQgB.js")),
          "./translations/ms.json": () =>
            Promise.resolve().then(() => require("./ms-wbSWdQJ0.js")),
          "./translations/nl.json": () =>
            Promise.resolve().then(() => require("./nl-Foqdtl_-.js")),
          "./translations/no.json": () =>
            Promise.resolve().then(() => require("./no-l_d9yAQN.js")),
          "./translations/pl.json": () =>
            Promise.resolve().then(() => require("./pl-01EnRFRc.js")),
          "./translations/pt-BR.json": () =>
            Promise.resolve().then(() => require("./pt-BR-F3FsQI-D.js")),
          "./translations/pt.json": () =>
            Promise.resolve().then(() => require("./pt-Mve7WzqZ.js")),
          "./translations/ru.json": () =>
            Promise.resolve().then(() => require("./ru-flezEXdc.js")),
          "./translations/sa.json": () =>
            Promise.resolve().then(() => require("./sa-gjKCAmHv.js")),
          "./translations/sk.json": () =>
            Promise.resolve().then(() => require("./sk-xA9DPcmq.js")),
          "./translations/sv.json": () =>
            Promise.resolve().then(() => require("./sv-be1suA3a.js")),
          "./translations/th.json": () =>
            Promise.resolve().then(() => require("./th-7ExcBOpr.js")),
          "./translations/tr.json": () =>
            Promise.resolve().then(() => require("./tr-u4e0KNRe.js")),
          "./translations/uk.json": () =>
            Promise.resolve().then(() => require("./uk-5Ikxxci1.js")),
          "./translations/vi.json": () =>
            Promise.resolve().then(() => require("./vi-SYqVl8vH.js")),
          "./translations/zh-Hans.json": () =>
            Promise.resolve().then(() => require("./zh-Hans-SHNzD0Zk.js")),
          "./translations/zh.json": () =>
            Promise.resolve().then(() => require("./zh-9728QXZm.js")),
        }),
  ...
  runHookSeries = (name2, asynchronous = false) =>
    asynchronous
      ? this.hooksDict[name2].runSeriesAsync()
      : this.hooksDict[name2].runSeries();
  runHookWaterfall = (name2, initialValue, asynchronous = false, store) => {
    return asynchronous
      ? this.hooksDict[name2].runWaterfallAsync(initialValue, store)
      : this.hooksDict[name2].runWaterfall(initialValue, store);
  };
  runHookParallel = (name2) => this.hooksDict[name2].runParallel();
  render() {
    const localeNames = pick__default.default(
      languageNativeNames,
      this.configurations.locales || []
    );
    ...
    const store = this.createStore({
      admin_app: {
        ...
        theme: {
          availableThemes: [],
          currentTheme:
            localStorage.getItem(THEME_LOCAL_STORAGE_KEY) || "system",
        },
        language: {
    ...
    return /* @__PURE__ */ jsxRuntime.jsx(reactRouterDom.BrowserRouter, {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsxs(Providers, {
        components,
        fields,
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(reactHelmet.Helmet, {
            htmlAttributes: {
              lang: localStorage.getItem(LANGUAGE_LOCAL_STORAGE_KEY) || "en",
            },
          }),
          /* @__PURE__ */ jsxRuntime.jsx(App$2, {
...
const renderAdmin = async (
  ...
  if (!mountNode) {
    throw new Error(
      "[@strapi/admin]: Could not find the root element to mount the admin app"
    );
  }
  window.strapi = {
    /**
    ...
    isEE: false,
    telemetryDisabled:
      process.env.STRAPI_TELEMETRY_DISABLED === "true" ? true : false,
    future: {
      isEnabled: (name2) => {
  ...
  try {
    ...
    window.strapi.features = {
      ...
      isEnabled: (featureName) =>
        features2.some((feature) => feature.name === featureName),
    };
...
function useDocument() {
  const validate = (
    entry,
    { contentType, components, isCreatingEntry = false }
  ) => {
    const schema = createYupSchema(
...
//# sourceMappingURL=index-VyjiJi0S.js.map
