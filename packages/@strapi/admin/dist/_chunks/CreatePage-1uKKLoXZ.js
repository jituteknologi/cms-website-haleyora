...
require("./reviewWorkflows-v74f5ogs.js");
...
const ReviewWorkflowsCreatePage = () => {
  ...
  const contentTypesFromOtherWorkflows = workflows?.flatMap(
    (workflow) => workflow.contentTypes
  );
  ...
  React__namespace.useEffect(() => {
    ...
    dispatch(
      validateWorkflow.setIsLoading(isLoadingContentTypes || isLoadingRoles)
    );
    dispatch(
...
//# sourceMappingURL=CreatePage-1uKKLoXZ.js.map
