...
import { s as selectAdminPermissions } from "./AuthenticatedApp-V2Dm6x5Q.mjs";
import {
  SubNav,
  SubNavHeader,
  SubNavSections,
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = useEnterprise(
    ceLinks,
    async () => (await import("./constants-jWFql0Ju.mjs")).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-o6L_K8zP.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage-8nvBHija.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-VeKEtPyX.mjs");
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-zcELnM0p.mjs");
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true,
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import("./EditPage-vlnUWevv.mjs");
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await import("./CreatePage--nAZgwjm.mjs");
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await import(
        "./EditPage-_4I8Oa-k.mjs"
      ).then((n) => n.b);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await import("./ListPage-Dr-G32ny.mjs");
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-u6Hur78O.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-R8w7JCuU.mjs");
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditViewPage-eBg6Xxbl.mjs");
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await import("./CreateView-WmVucWXm.mjs");
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await import("./ListView-0fHREVEs.mjs");
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await import("./EditView-PG_79Ymb.mjs");
      return ProtectedEditView;
    },
...
const LogoInput = ({
  ...
  return /* @__PURE__ */ jsxs(LogoInputContextProvider, {
    setLocalImage,
    localImage,
      ...
      currentStep
        ? /* @__PURE__ */ jsxs(ModalLayout, {
            ...
            children: [
              ...
              currentStep === "upload"
                ? /* @__PURE__ */ jsx(AddLogoDialog, {})
                : /* @__PURE__ */ jsx(PendingLogoDialog, { onChangeLogo }),
            ],
          })
        : null,
    ],
        ...
        children: [
          ...
          /* @__PURE__ */ jsx(Box, {
            ...
            children: localImage?.url
              ? /* @__PURE__ */ jsx(ImageCardAsset, { asset: localImage })
              : null,
          }),
        ],
      }),
  ...
  return /* @__PURE__ */ jsxs(Card, {
    children: [
      /* @__PURE__ */ jsx(CardHeader, {
        children: /* @__PURE__ */ jsx(CardAsset, { size: "S", src: asset.url }),
      }),
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = useEnterprise(
    AdminSeatInfoCE,
    async () => (await import("./AdminSeatInfo-TaZ4UZ-e.mjs")).AdminSeatInfoEE
  );
  const {
  ...
  return /* @__PURE__ */ jsxs(Layout, {
    children: [
      /* @__PURE__ */ jsx(SettingsPageTitle, {
        name: formatMessage({
...
const SettingsPage = () => {
  ...
  const routes = useEnterprise(
    ROUTES_CE,
    async () => (await import("./constants-Xm38B-F8.mjs")).ROUTES_EE,
    {
  ...
  const pluginsRoutes = Object.values(settings).flatMap((section) => {
    ...
    return links.map((link) =>
      createRoute(link.Component, link.to, link.exact || false)
    );
  });
  if (isLoading) {
  ...
  return /* @__PURE__ */ jsxs(Layout, {
    sideNav: /* @__PURE__ */ jsx(SettingsNav, { menu }),
    children: [
      /* @__PURE__ */ jsx(Helmet, {
        title: formatMessage({
          id: "global.settings",
...
const makeUniqueRoutes = (routes) =>
  routes.filter(
    (route, index, refArray) =>
      refArray.findIndex((obj) => obj.to === route.to) === index
  );
export { SettingsPage, makeUniqueRoutes };
//# sourceMappingURL=SettingsPage-Wo10cVFB.mjs.map
