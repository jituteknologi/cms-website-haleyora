...
const anErrorOccurred =
  "Ups! Ein unbekannter Fehler ist aufgetreten. Versuche es erneut.";
...
const de = {
  ...
  "Auth.components.Oops.text.admin":
    "Falls das ein Fehler war, kontaktiere bitte deinen Administrator.",
  ...
  "Auth.form.button.login.providers.error":
    "Durch den ausgewählten Anbieter können wir dich nicht verbinden",
  ...
  "Auth.form.error.confirmed":
    "Deine Account E-Mail-Adresse ist nicht bestätigt.",
  "Auth.form.error.email.invalid": "Diese E-Mail-Adresse ist ungültig.",
  "Auth.form.error.email.provide":
    "Bitte nenne uns deinen Benutzernamen oder deine E-Mail-Adresse.",
  ...
  "Auth.form.error.password.format":
    "Dein Passwort darf nicht mehr als dreimal das Symbol `$` enthalten.",
  "Auth.form.error.password.local":
    "Dieser Benutzer hat kein lokales Passwort. Bitte logge dich mithilfe des Providers ein, der bei der Erstellung des Accounts genutzt wurde.",
  ...
  "Auth.form.error.ratelimit":
    "Zu viele Versuche, bitte versuche es in einer Minute erneut.",
  ...
  "Auth.form.forgot-password.email.label.success":
    "Eine E-Mail wurde erfolgreich verschickt an",
  ...
  "Auth.form.register.news.label":
    "Halte mich über die neuen Features und anstehenden Verbesserungen auf dem Laufenden (damit werden die {terms} und die {policy} akzeptiert).",
  "Auth.form.register.subtitle":
    "Deine Zugangsdaten werden nur verwendet, um dich im Admin Panel einzuloggen. Alle Daten werden in der lokalen Datenbank gespeichert.",
  ...
  "HomePage.helmet.title": "Startseite",
  "HomePage.roadmap": "Siehe unsere Roadmap",
  "HomePage.welcome.congrats": "Herzlichen Glückwunsch!",
  "HomePage.welcome.congrats.content":
    "Angemeldet als erster Administrator. Um die leistungsstarken Funktionen von Strapi zu entdecken,",
  "HomePage.welcome.congrats.content.bold":
    "empfehlen wir Ihren ersten Inhaltstyp zu erstellen.",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "Manche Rollen konnten nicht gelöscht werden, da sie mit Benutzern verknüpft sind",
  "Roles.ListPage.notification.delete-not-allowed":
    "Eine Rolle, die mit einem Benutzer verknüpft ist, kann nicht gelöscht werden",
  ...
  "Roles.components.List.empty.withSearch":
    "Es gibt keine Rolle die der Suche ({search}) entspricht...",
  ...
  "Settings.tokens.copy.editMessage":
    "Aus Sicherheitsgründen kannst du deinen Token nur einmal sehen.",
  "Settings.tokens.copy.editTitle":
    "Auf diesen Token kann nicht mehr zugegriffen werden.",
  "Settings.tokens.copy.lastWarning":
    "Stell sicher, dass dieser Token kopiert wurde, da du ihn nicht noch einmal sehen können wirst!",
  "Settings.apiTokens.create": "Neuen API-Token erstellen",
  "Settings.apiTokens.description":
    "Liste der generierten Tokens mit Zugriff auf die API",
  "Settings.apiTokens.emptyStateLayout": "Du hast noch keinen Inhalt...",
  "Settings.tokens.notification.copied":
  ...
  "Settings.application.description":
    "Globale Informationen über die Administrationsoberfläche",
  ...
  "Settings.application.link-upgrade":
    "Deine Administrationsoberfläche aktualisieren",
  ...
  "Settings.permissions.category":
    "Berechtigungseinstellungen für die {category}",
  "Settings.permissions.category.plugins":
    "Berechtigungseinstellungen für das {category} Plugin",
  ...
  "Settings.permissions.select-all-by-permission":
    "Wähle alle {label}-Berechtigungen",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "Dies wird die Oberfläche für dich in der ausgewählten Sprache darstellen.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "Diese Einstellungen werden nur für dich angewandt. Mehr Informationen dazu {here}.",
  ...
  "Settings.profile.form.section.experience.mode.hint":
    "Zeigt die Oberfläche im gewählten Modus.",
  ...
  "Settings.profile.form.section.helmet.title": "Nutzerprofil",
  "Settings.profile.form.section.profile.page.title": "Profil-Seite",
  "Settings.roles.create.description":
    "Die Berechtigungen einer Rolle festlegen",
  ...
  "Settings.sso.description":
    "Einstellungen des Single Sign-On Features konfigurieren.",
  "Settings.sso.form.defaultRole.description":
    "Die Standard-Rolle wird dem neu erstellten Nutzer zugewiesen",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "Du hast keine Lese-Berechtigung für die Admin-Rollen",
  "Settings.sso.form.defaultRole.label": "Standard-Rolle",
  "Settings.sso.form.registration.description":
    "Neuen Nutzer beim Einloggen über SSO erstellen wenn noch kein Account existiert",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "Entwurf/Veröffentlichen muss für dieses Event aktiviert sein",
  ...
  "Settings.webhooks.list.description":
    "POST-Benachrichtigungen bei Änderungen empfangen.",
  ...
  "Settings.webhooks.to.delete":
    "{webhooksToDeleteLength, plural, one {# Datei} other {# Dateien}} ausgewählt",
  ...
  "Usecase.input.work-type":
    "Welche Rolle beschreibt deine Position am besten?",
  ...
  "Users.components.List.empty.withFilters":
    "Es gibt keine Nutzer die den Filtern entsprechen...",
  "Users.components.List.empty.withSearch":
    "Es gibt keine Nutzer die der Suche ({search}) entsprechen...",
  ...
  "admin.pages.MarketPlacePage.plugin.copy.success":
    "Installations-Befehl ist bereit, in deinem Terminal eingefügt zu werden",
  "admin.pages.MarketPlacePage.plugin.info": "Mehr erfahren",
  "admin.pages.MarketPlacePage.plugin.info.label":
    "Mehr über {pluginName} erfahren",
  ...
  "app.components.BlockLink.blog.content":
    "Lies die neuesten Nachrichten über Strapi und das Ökosystem.",
  "app.components.BlockLink.code": "Code-Beispiele",
  "app.components.BlockLink.code.content":
    "Lerne duch das Testen von echten Projekten, die von der Community entwickelt wurden.",
  "app.components.BlockLink.documentation.content":
    "Entdecke grundlegende Konzepte, Anleitungen und Anweisungen.",
  "app.components.BlockLink.tutorial": "Tutorials",
  "app.components.BlockLink.tutorial.content":
    "Folge Schritt-für-Schritt Anleitungen die zeigen, wie du Strapi nutzen und anpassen kannst.",
  ...
  "app.components.DownloadInfo.text":
    "Dies könnte kurz dauern. Danke für deine Geduld.",
  ...
  "app.components.EmptyStateLayout.content-permissions":
    "Du hast keine ausreichenden Berechtigungen, um auf diesen Inhalt zuzugreifen",
  "app.components.GuidedTour.CM.create.content":
    '<p>Erstelle und verwalte all deinen Inhalt hier im Content Manager.</p><p>Beispiel: Im Beispiel der Blog-Website, kann man einen Artikel schreiben, speichern und veröffentlichen.</p><p>💡 Kleiner Tipp: Vergiss nicht, beim Inhalt den du erstellst, "Veröffentlichen" zu drücken.</p>',
  "app.components.GuidedTour.CM.create.title": "⚡️ Erstelle Inhalt",
  "app.components.GuidedTour.CM.success.content":
    "<p>Super, ein letzter Schritt noch!</p><b>🚀  Sehe deinen Inhalt in Aktion</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    "<p>Sammlungen helfen dir, mehrere Einträge zu managen, während Einzel-Einträge dazu da sind, nur einen Eintrag zu managen.</p> <p>Bsp: Für eine Blog-Website wären die Artikel eine Sammlung, während die Homepage ein Einzel-Eintrag wäre.</p>",
  "app.components.GuidedTour.CTB.create.cta.title": "Einen Inhaltstyp bauen",
  "app.components.GuidedTour.CTB.create.title":
    "🧠 Erstelle deinen ersten Inhaltstyp",
  "app.components.GuidedTour.CTB.success.content":
    "<p>Sehr gut!</p><b>⚡️ Was willst du mit der Welt teilen?</b>",
  "app.components.GuidedTour.CTB.success.title": "Schritt 1: Abgeschlossen ✅",
  "app.components.GuidedTour.apiTokens.create.content":
    "<p>Generiere einen Authentifizierungs-Token hier und greife auf den Inhalt, den du gerade erstellt hast, zu.</p>",
  ...
  "app.components.GuidedTour.home.CM.title":
    "⚡️ Was willst du mit der Welt teilen?",
  "app.components.GuidedTour.home.CTB.cta.title":
    "Gehe zum Content type Builder",
  "app.components.GuidedTour.home.CTB.title":
    "🧠 Baue die Struktur des Inhalts",
  ...
  "app.components.HomePage.community.content":
    "Diskutiere mit Teammitgliedern, Mitwirkenden und Entwicklern auf verschiedenen Kanälen.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Wir freuen uns, dich als Mitglied der Community zu haben. Wir sind offen für Feedback, senden uns einfach eine direkt Nachricht in ",
  "app.components.HomePage.welcomeBlock.content.again":
    "Wir hoffen, dass du Fortschritte bei deinem Projekt machst ... Lese das Neueste über Strapi. Wir geben unser Bestes, um das Produkt auf der Grundlage deines Feedbacks zu verbessern.",
  ...
  "app.components.ImgPreview.hint":
    "Ziehe eine Datei hierher oder {browse} eine Datei zum hochladen aus",
  ...
  "app.components.InstallPluginPage.Download.description":
    "Es kann einige Sekunden dauern, bis das Plugin heruntergeladen und installiert ist.",
  "app.components.InstallPluginPage.Download.title": "Herunterladen...",
  "app.components.InstallPluginPage.description":
    "Erweitere deine App ganz einfach.",
  ...
  "app.components.MarketplaceBanner":
    "Entdecke von der Community entwickelte Plugins und noch viel mehr Dinge, um deinem Projekt zu helfen, auf Strapi Awesome.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "Die AutoReload-Funktion muss nicht aktiviert sein. Bitte die App mit `yarn develop` starten.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Aus Sicherheitsgründen kann ein Plugin nur in einer Entwicklungsumgebung heruntergeladen werden.",
  ...
  "app.components.Users.MagicLink.connect":
    "Diesen Link dem Benutzer zum Registrieren schicken.",
  "app.components.Users.MagicLink.connect.sso":
    "Sende dem Benutzer diesen Link, das erste Login kann über einen SSO-Anbeiter gemacht werden",
  ...
  "app.components.Users.ModalCreateBody.block-title.roles.description":
    "Dein Benutzer kann eine oder mehrere Rollen haben",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Beim Entfernen des Plugins ist ein Fehler aufgetreten",
  "app.containers.App.notification.error.init":
    "Beim Aufruf der API ist ein Fehler aufgetreten.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "Bitte den Administrator kontaktieren, sollte der Link nicht ankommen.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "Es kann ein paar Minuten dauern, bis der Wiederherstellungslink ankommt.",
  ...
  "app.page.not.found":
    "Oh nein! Wir konnten die Seite, nach der du suchst, nicht finden...",
  ...
  clearLabel,
  "coming.soon":
    "Dieser Inhalt ist aktuell unter Bearbeitung und wird in ein paar Wochen zurück sein!",
  "component.Input.error.validation.integer":
    "Der Wert muss eine Ganzzahl sein",
  "components.AutoReloadBlocker.description":
    "Strapi mit einem der folgenden Befehle ausführen:",
  "components.AutoReloadBlocker.header":
    "Dieses Plugin benötigt das Neuladen-Feature.",
  ...
  "components.FilterOptions.FILTER_TYPES.$startsWithi":
    "startet mit (Groß- und Kleinschreibung wird nicht beachtet)",
  ...
  "components.Input.error.attribute.taken":
    "Dieser Feldname ist bereits vergeben",
  ...
  "components.OverlayBlocker.description":
    "Es wird ein Feature verwendet, das einen Neustart des Servers erfordert. Bitte warte bis der Server neu gestartet wurde.",
  "components.OverlayBlocker.description.serverError":
    "Der Server sollte neu gestartet sein, bitte Logs im Terminal überprüfen.",
  ...
  "components.ProductionBlocker.description":
    "Aus Sicherheitsgründen müssen wir dieses Plugin in anderen Umgebungen deaktivieren.",
  "components.ProductionBlocker.header":
    "Dieses Plugin ist nur in der Entwicklungsumgebung verfügbar.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Datei hierher ziehen, {browse} eine Datei zum hochladen auswählen oder aus der Zwischenablage einfügen.",
  ...
  "content-manager.ListViewTable.relation-more":
    "Diese Beziehung enthält mehr Einträge als angezeigt",
  ...
  "content-manager.components.DragHandle-label": "Ziehen",
  "content-manager.components.DraggableAttr.edit": "Klicken zum Bearbeiten",
  ...
  "content-manager.components.DynamicZone.add-component":
    "Füge {componentName} eine Komponente hinzu",
  "content-manager.components.DynamicZone.delete-label": "Lösche {name}",
  "content-manager.components.DynamicZone.error-message":
    "Die Komponente enthält einen oder mehrere Fehler",
  "content-manager.components.DynamicZone.missing-components":
    "{number, plura, one {# Komponente} other {# Komponenten}} fehlen",
  "content-manager.components.DynamicZone.move-down-label":
    "Verschiebe Komponente nach unten",
  "content-manager.components.DynamicZone.move-up-label":
    "Verschiebe Komponente nach oben",
  "content-manager.components.DynamicZone.pick-compo": "Wähle eine Komponente",
  "content-manager.components.DynamicZone.required": "Komponente wird benötigt",
  ...
  "content-manager.components.FieldItem.linkToComponentLayout":
    "Layout der Komponente anpassen",
  "content-manager.components.FieldSelect.label": "Füge Feld hinzu",
  "content-manager.components.FilterOptions.button.apply": "Anwenden",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Lege die Bedingungen fest, unter denen die Einträge gefiltert werden sollen",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "Filter",
  "content-manager.components.FiltersPickWrapper.hide": "Ausblenden",
  "content-manager.components.LeftMenu.Search.label":
    "Suche nach einem Inhaltstyp",
  "content-manager.components.LeftMenu.collection-types": "Sammlungen",
  "content-manager.components.LeftMenu.single-types": "Einzel-Einträge",
  "content-manager.components.LimitSelect.itemsPerPage": "Einträge pro Seite",
  "content-manager.components.NotAllowedInput.text":
    "Keine Berechtigung dieses Feld anzusehen",
  "content-manager.components.RepeatableComponent.error-message":
    "Die Komponente(n) enthält einen/enthalten Fehler",
  "content-manager.components.Search.placeholder":
    "Suche nach einem Eintrag....",
  "content-manager.components.Select.draft-info-title": "Status: Entwurf",
  ...
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "Anpassen, wie die Bearbeitungsansicht aussieht.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "Einstellungen der Listenansicht anpassen.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "Ansicht anpassen - {name}",
  "content-manager.components.TableDelete.delete": "Alle löschen",
  "content-manager.components.TableDelete.deleteSelected":
    "Ausgewählte löschen",
  "content-manager.components.TableDelete.label":
    "{number, plural, one {# Eintrag} other {# Einträge}} ausgewählt",
  "content-manager.components.TableEmpty.withFilters":
    "Es gibt keine {contentType} mit den verwendeten Filtern...",
  "content-manager.components.TableEmpty.withSearch":
    "Es gibt keine {contentType}, die der Suche ({search}) entsprechen...",
  "content-manager.components.TableEmpty.withoutFilter":
    "Es gibt keine {contentType}...",
  "content-manager.components.empty-repeatable":
    "Noch keine Einträge. Nutze den Button unten um einen hinzuzufügen.",
  "content-manager.components.notification.info.maximum-requirement":
    "Die maximale Anzahl an Feldern wurde erreicht",
  "content-manager.components.notification.info.minimum-requirement":
    "Es wurde ein Feld hinzugefügt um die minimale Anzahl zu erfüllen",
  "content-manager.components.repeatable.reorder.error":
    "Während dem Ändern der Reihenfolge der Komponenten ist ein Fehler aufgetreten, bitte versuche es erneut",
  "content-manager.components.reset-entry": "Eintrag zurücksetzen",
  ...
  "content-manager.containers.Edit.Link.Layout": "Layout anpassen",
  "content-manager.containers.Edit.Link.Model": "Sammlung bearbeiten",
  "content-manager.containers.Edit.addAnItem": "Füge ein Item hinzu...",
  "content-manager.containers.Edit.clickToJump":
    "Klicke, um zu einem Eintrag zu springen",
  "content-manager.containers.Edit.delete": "Löschen",
  "content-manager.containers.Edit.delete-entry": "Diesen Eintrag löschen",
  "content-manager.containers.Edit.editing": "Bearbeite...",
  "content-manager.containers.Edit.information": "Informationen",
  "content-manager.containers.Edit.information.by": "Von",
  "content-manager.containers.Edit.information.created": "Erstellt",
  "content-manager.containers.Edit.information.draftVersion": "Entwurf",
  "content-manager.containers.Edit.information.editing": "Bearbeite",
  "content-manager.containers.Edit.information.lastUpdate": "Letzte Änderung",
  "content-manager.containers.Edit.information.publishedVersion":
    "veröffentlichte Version",
  "content-manager.containers.Edit.pluginHeader.title.new": "Eintrag erstellen",
  "content-manager.containers.Edit.reset": "Zurücksetzen",
  "content-manager.containers.Edit.returnList": "Zu Liste zurückkehren",
  ...
  "content-manager.containers.EditSettingsView.modal-form.edit-field":
    "Feld bearbeiten",
  "content-manager.containers.EditView.add.new-entry": "Eintrag hinzufügen",
  ...
  "content-manager.containers.Home.introduction":
    "Um deine Einträge zu verwalten, klicke auf den entsprechenden Link im Menü links. Dieses Plugin ist noch in aktiver Entwicklung und seine Einstellungen können nicht optimal angepasst werden.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Verwalte deine Einträge mithilfe eines mächtigen und wunderschönen Interfaces.",
  "content-manager.containers.Home.pluginHeaderTitle": "Inhalts-Manager",
  "content-manager.containers.List.draft": "Entwurf",
  "content-manager.containers.List.errorFetchRecords": "Fehler",
  ...
  "content-manager.containers.ListPage.items":
    "{number, plural, one {Eintrag} other {Einträge}}",
  ...
  "content-manager.containers.SettingPage.attributes": "Attribut-Felder",
  "content-manager.containers.SettingPage.attributes.description":
    "Reihenfolge der Attribute festlegen",
  "content-manager.containers.SettingPage.editSettings.description":
    "Ziehe die Felder via Drag & Drop, um das Layout zu erstellen",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title.description":
    "Anzeigefeld der Einträge wählen",
  "content-manager.containers.SettingPage.editSettings.relation-field.description":
    "Setze das dargestellte Feld sowohl in der Bearbeiten-, als auch der Listenansicht",
  ...
  "content-manager.containers.SettingPage.listSettings.description":
    "Konfiguriere die Einstellungen für diesen Collection Type",
  ...
  "content-manager.containers.SettingPage.pluginHeaderDescription":
    "Konfiguriere die spezifische Ansicht für diesen Collection Type",
  "content-manager.containers.SettingPage.settings": "Einstellungen",
  "content-manager.containers.SettingPage.view": "Ansicht",
  "content-manager.containers.SettingViewModel.pluginHeader.title":
    "Inhalts-Manager - {name}",
  "content-manager.containers.SettingsPage.Block.contentType.description":
    "Spezifische Einstellungen konfigurieren",
  ...
  "content-manager.containers.SettingsPage.Block.generalSettings.description":
    "Standardoptionen für Sammlungen konfigurieren",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "Einstellungen für alle Sammlungen und Gruppen konfigurieren",
  "content-manager.containers.SettingsView.list.subtitle":
    "Layout und Darstellung für alle Sammlungen und Gruppen konfigurieren",
  "content-manager.containers.SettingsView.list.title": "Darstellungsoptionen",
  ...
  "content-manager.edit-settings-view.link-to-ctb.content-types":
    "Inhalts-Typ bearbeiten",
  "content-manager.emptyAttributes.button": "Zum Sammlungs-Editor",
  "content-manager.emptyAttributes.description":
    "Füge das erste Feld zur Sammlung hinzu",
  "content-manager.emptyAttributes.title": "Es gibt noch keine Felder",
  "content-manager.error.attribute.key.taken": "Dieser Wert existiert bereits",
  "content-manager.error.attribute.sameKeyAndName": "Darf nicht gleich sein",
  "content-manager.error.attribute.taken":
    "Dieser Feldname ist bereits vergeben",
  "content-manager.error.contentTypeName.taken":
    "Dieser Name existiert bereits",
  "content-manager.error.model.fetch":
    "Beim Abruf von model config fetch ist ein Fehler aufgetreten.",
  "content-manager.error.record.create":
    "Beim Anlegen eines Dokuments ist ein Fehler aufgetreten.",
  "content-manager.error.record.delete":
    "Beim Löschen eines Dokuments ist ein Fehler aufgetreten.",
  "content-manager.error.record.fetch":
    "Beim Abruf eines Dokuments ist ein Fehler aufgetreten.",
  "content-manager.error.record.update":
    "Beim Aktualisieren eines Dokuments ist ein Fehler aufgetreten.",
  "content-manager.error.records.count":
    "Beim Abrufen der Anzahl an Einträgen ist ein Fehler aufgetreten.",
  "content-manager.error.records.fetch":
    "Beim Abrufen von Dokumenten ist ein Fehler aufgetreten.",
  "content-manager.error.schema.generation":
    "Bei der Generierung des Schemas ist ein Fehler aufgetreten.",
  "content-manager.error.validation.json": "Dies ist kein JSON",
  "content-manager.error.validation.max": "Dieser Wert ist zu hoch.",
  "content-manager.error.validation.maxLength": "Dieser Wert ist zu lang.",
  "content-manager.error.validation.min": "Dieser Wert ist zu niedrig.",
  "content-manager.error.validation.minLength": "Dieser Wert ist zu kurz.",
  "content-manager.error.validation.minSupMax": "Darf nicht höher sein",
  "content-manager.error.validation.regex":
    "Dieser Wert entspricht nicht dem RegEx.",
  "content-manager.error.validation.required": "Dieser Wert ist erforderlich.",
  "content-manager.form.Input.bulkActions": "Bulk-Bearbeitung aktivieren",
  "content-manager.form.Input.defaultSort": "Standard-Sortierattribut",
  "content-manager.form.Input.description": "Beschreibung",
  "content-manager.form.Input.description.placeholder":
    "Zeige den Namen im Profil",
  "content-manager.form.Input.editable": "Editierbares Feld",
  "content-manager.form.Input.filters": "Filter aktivieren",
  "content-manager.form.Input.label": "Label",
  "content-manager.form.Input.label.inputDescription":
    "Dieser Wert überschreibt das im Kopf der Tabelle angezeigte Label.",
  "content-manager.form.Input.pageEntries": "Einträge pro Seite",
  "content-manager.form.Input.pageEntries.inputDescription":
    "Hinweis: Dieser Wert lässt sich durch die Sammlungs-Einstellungen überschreiben.",
  "content-manager.form.Input.placeholder": "Platzhalter",
  "content-manager.form.Input.placeholder.placeholder":
    "Mein unglaublicher Wert",
  "content-manager.form.Input.search": "Suche aktivieren",
  "content-manager.form.Input.search.field": "Suche in diesem Feld aktivieren",
  "content-manager.form.Input.sort.field":
    "Sortierung in diesem Feld aktivieren",
  "content-manager.form.Input.sort.order": "Standard-Reihenfolge",
  "content-manager.form.Input.wysiwyg": "Als visuellen Editor anzeigen",
  "content-manager.global.displayedFields": "Angezeigte Felder",
  "content-manager.groups": "Gruppen",
  "content-manager.groups.numbered": "Gruppen ({number})",
  "content-manager.header.name": "Inhalt",
  "content-manager.link-to-ctb": "Modell bearbeiten",
  "content-manager.models": "Sammlungen",
  "content-manager.models.numbered": "Sammlungen ({number})",
  "content-manager.notification.error.displayedFields":
    "Du benötigst mindestens ein dargestelltes Feld",
  "content-manager.notification.error.relationship.fetch":
    "Beim Abruf von Beziehungen ist ein Fehler aufgetreten.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Du musst ein Attribut mit aktivierter Sortierung haben.",
  "content-manager.notification.info.minimumFields":
    "Du benötigst mindestens ein dargestelltes Feld",
  "content-manager.notification.upload.error":
    "Beim Hochladen deiner Dateien ist ein Fehler aufgetreten",
  "content-manager.pageNotFound": "Seite nicht gefunden",
  "content-manager.pages.ListView.header-subtitle":
    "{number, plural, one {# Eintrag} other {# Einträge}} gefunden",
  "content-manager.pages.NoContentType.button":
    "Erstelle deinen ersten Inhalts-Typ",
  "content-manager.pages.NoContentType.text":
    "Wenn du noch keinen Inhalt hast, empfehlen wir dir, zuerst einen Inhalts-Typ erstellen.",
  "content-manager.permissions.not-allowed.create":
    "Du hast nicht die erforderlichen Berechtigungen, um ein Dokument zu erstellen",
  "content-manager.permissions.not-allowed.update":
    "Du hast nicht die erforderlichen Berechtigungen, um dieses Dokument anzuschauen",
  "content-manager.plugin.description.long":
    "Greife schnell auf alle Daten in der Datenbank zu und ändere sie.",
  "content-manager.plugin.description.short":
    "Greife schnell auf alle Daten in der Datenbank zu und ändere sie.",
  "content-manager.popover.display-relations.label": "Beziehungen darstellen",
  "content-manager.success.record.delete": "Gelöscht",
  "content-manager.success.record.publish": "Veröffentlicht",
  ...
  "content-manager.utils.data-loaded":
    "{number, plural, =1 {Der Eintrag wurde} other {Die Einträge wurden}} erfolgreich geladen",
  "content-manager.popUpWarning.warning.publish-question":
    "Wollst du diesen Eintrag trotzdem veröffentlichen?",
  ...
  "content-manager.popUpwarning.warning.has-draft-relations.message":
    "<b>{count, plural, =0 { von deinen Inhalts-Beziehungen sind} one { von deinen Inhalts-Beziehungen ist} other { von deinen Inhalts-Beziehungen sind}}</b> noch nicht veröffentlicht.<br></br>Das kann zu kaputten Links und Fehlern in deinem Projekt führen.",
  ...
  "global.prompt.unsaved":
    "Seite wirklich verlassen? Alle Änderungen gehen hierdurch verloren.",
  ...
  "notification.contentType.relations.conflict":
    "Content Type hat Konflikt in Beziehungen",
  ...
  "notification.permission.not-allowed-read":
    "Keine Berechtigung dieses Dokument einzusehen",
  ...
  "notification.version.update.message":
    "Eine neue Strapi Version ist verfügbar",
...
//# sourceMappingURL=de-uQFFWv6o.mjs.map
