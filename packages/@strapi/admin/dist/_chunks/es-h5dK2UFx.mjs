...
const Documentation = "Documentación";
const Email = "Email";
const Password = "Contraseña";
const Provider = "Proveedor";
const ResetPasswordToken = "Restablecer Token de Contraseña";
const Role = "Rol";
const Username = "Nombre de usuario";
const Users = "Usuarios";
const anErrorOccurred = "¡Ups! Algo salió mal. Inténtalo de nuevo.";
const clearLabel = "Limpiar";
const or = "O";
const skipToContent = "Saltar al contenido";
const submit = "Enviar";
const light = "Claro";
const dark = "Oscuro";
const es = {
  ...
  "Auth.components.Oops.text.admin":
    "Si se trata de un error, comuníquese con su administrador.",
  ...
  "Auth.form.button.login.providers.error":
    "No podemos conectarlo a través del proveedor seleccionado.",
  ...
  "Auth.form.error.email.provide":
    "Por favor proporcione su nombre de usuario o su correo electrónico.",
  ...
  "Auth.form.error.password.format":
    "Su contraseña no puede contener el símbolo `$` más de tres veces.",
  "Auth.form.error.password.local":
    "Este usuario nunca estableció una contraseña local, por favor ingrese a través de su proveedor utilizado durante la creación de la cuenta.",
  ...
  "Auth.form.error.ratelimit":
    "Demasiados intentos. Por favor vuelva a intentarlo dentro de un minuto.",
  ...
  "Auth.form.register.news.label":
    "Mantenerme informado sobre las nuevas funciones y las próximas mejoras (al hacer esto, acepta las {terms} y la {policy}).",
  "Auth.form.register.subtitle":
    "Sus credenciales solo se utilizan para autenticarse en el panel de administración. Todos los datos guardados se almacenarán en su propia base de datos.",
  ...
  "HomePage.welcome.congrats.content":
    "Está registrado como el primer administrador. \nPara descubrir las potentes funciones que ofrece Strapi,",
  "HomePage.welcome.congrats.content.bold":
    "le recomendamos que cree su primer Tipo de Colección.",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "Algunos roles no se pudieron eliminar porque están asociados a usuarios",
  "Roles.ListPage.notification.delete-not-allowed":
    "No se puede eliminar un rol si está asociado a usuarios",
  "Roles.RoleRow.select-all": "Seleccione {name} para acciones en bloque",
  "Roles.components.List.empty.withSearch":
    "No hay rol correspondiente a la búsqueda ({search})...",
  ...
  "Settings.application.description":
    "Información global del panel de administración",
  "Settings.application.edition-title": "plan actual",
  ...
  "Settings.permissions.category.plugins":
    "Configuración de permisos para el plugin de {category}",
  ...
  "Settings.permissions.select-all-by-permission":
    "Seleccionar todos los permisos de {label}",
  ...
  "Settings.permissions.users.listview.header.subtitle":
    "Todos los usuarios que tienen acceso al panel de administración de strapi",
  "Settings.permissions.users.tabs.label": "Permisos de pestañas",
  "Settings.profile.form.notify.data.loaded":
    "Se han cargado los datos de tu perfil",
  "Settings.profile.form.section.experience.clear.select":
    "Borrar el idioma de interfaz seleccionado",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "Esto solo mostrará su propia interfaz en el idioma elegido.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "La selección cambiará el idioma de la interfaz solo para usted. Consulte esta {here} para que otros idiomas estén disponibles para su equipo.",
  ...
  "Settings.sso.description":
    "Configure los ajustes para la función de inicio de sesión único (SSO).",
  "Settings.sso.form.defaultRole.description":
    "Asociará al nuevo usuario autenticado al rol seleccionado",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "Debes tener permiso para leer los roles de administrador.",
  "Settings.sso.form.defaultRole.label": "Rol predeterminado",
  "Settings.sso.form.registration.description":
    "Crear un nuevo usuario en el inicio de sesión (SSO) si no existe una cuenta",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "Este evento solo existe para contenidos con el sistema Borrador/Publicación habilitado",
  ...
  "Settings.webhooks.list.description":
    "Recibe notificaciones de cambios POST.",
  "Settings.webhooks.list.empty.description":
    "Agregue el primero a esta lista.",
  ...
  "Settings.webhooks.to.delete":
    "{webhooksToDeleteLength, plural, one {# recurso seleccionado} other {# recursos seleccionados}}",
  ...
  "Users.components.List.empty.withSearch":
    "No hay usuarios correspondientes a la búsqueda ({search})...",
  ...
  "app.components.BlockLink.blog.content":
    "Lea las últimas noticias sobre Strapi y el ecosistema.",
  "app.components.BlockLink.code": "Ejemplos de código",
  "app.components.BlockLink.code.content":
    "Aprenda probando proyectos reales desarrollados por la comunidad.",
  "app.components.BlockLink.documentation.content":
    "Descubra los conceptos esenciales, guías e instrucciones.",
  "app.components.BlockLink.tutorial": "Tutoriales",
  "app.components.BlockLink.tutorial.content":
    "Siga las instrucciones paso a paso para usar y personalizar Strapi.",
  ...
  "app.components.DownloadInfo.text":
    "Esto puede tardar un minuto. Gracias por su paciencia.",
  ...
  "app.components.EmptyStateLayout.content-permissions":
    "No tienes los permisos para acceder a ese contenido.",
  ...
  "app.components.HomePage.community.content":
    "Hable con los miembros del equipo, colaboradores y desarrolladores en diferentes canales.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Estamos felices de tenerlo como miembro de la comunidad. Estamos constantemente en busca de comentarios así que no dude en enviarnos un DM en ",
  "app.components.HomePage.welcomeBlock.content.again":
    "Esperamos que estés progresando en tu proyecto.... Siéntase libre de leer las últimas novedades sobre Strapi. Estamos dando lo mejor de nosotros mismos para mejorar el producto basándonos en sus comentarios.",
  "app.components.HomePage.welcomeBlock.content.issues": "problema.",
  "app.components.HomePage.welcomeBlock.content.raise":
    " o reportar cualquier ",
  "app.components.ImgPreview.hint":
    "Arrastre y suelte el archivo en esta área o {browse} para subir un archivo.",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "Es posible que la desinstalación del plugin tarde unos segundos.",
  "app.components.ListPluginsPage.deletePlugin.title": "Desinstalar",
  "app.components.ListPluginsPage.description":
    "Lista de los plugins instalados en el proyecto.",
  ...
  "app.components.MarketplaceBanner":
    "Descubra los plugins creados por la comunidad y muchas más cosas increíbles para impulsar su proyecto, en Strapi Awesome.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "La función de recarga automática debe estar desactivada. Por favor, inicie su aplicación con `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Por motivos de seguridad, el plugin sólo puede descargarse en entorno de desarrollo.",
  ...
  "app.components.Users.MagicLink.connect":
    "Envíe este enlace al usuario para que se conecte.",
  "app.components.Users.MagicLink.connect.sso":
    "Envíe este enlace al usuario, el primer inicio de sesión se puede realizar a través de un proveedor de SSO",
  ...
  "app.components.Users.SortPicker.sortby.email_asc":
    "Correo electrónico (de la A a la Z)",
  "app.components.Users.SortPicker.sortby.email_desc":
    "Correo electrónico (de la Z a la A)",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Se ha producido un error al desinstalar el plugin",
  "app.containers.App.notification.error.init":
    "Se produjo un error al solicitar la API",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "Si no recibe este enlace, comuníquese con su administrador.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "Es posible que tarde unos minutos en recibir el enlace de recuperación de contraseña.",
  ...
  clearLabel,
  "coming.soon":
    "¡Este contenido está actualmente en construcción y estará de regreso en unas semanas!",
  "component.Input.error.validation.integer":
    "El valor debe ser un número entero",
  "components.AutoReloadBlocker.description":
    "Inicia Strapi con uno de los siguientes comandos:",
  "components.AutoReloadBlocker.header":
    "Es necesario recargar para este plugin.",
  ...
  "components.FilterOptions.FILTER_TYPES.$startsWithi":
    "comienza con (insensible a mayúsculas y minúsculas)",
  ...
  "components.OverlayBlocker.description":
    "Está utilizando una función que necesita que el servidor se reinicie. Por favor, espere hasta que el servidor esté listo..",
  "components.OverlayBlocker.description.serverError":
    "El servidor debería haberse reiniciado, compruebe sus logs en el terminal.",
  "components.OverlayBlocker.title": "Esperando el reinicio...",
  "components.OverlayBlocker.title.serverError":
    "El reinicio está llevando más tiempo de lo esperado",
  "components.PageFooter.select": "entradas por página",
  "components.ProductionBlocker.description":
    "Por razones de seguridad tenemos que desactivar este plugin en otros entornos.",
  "components.ProductionBlocker.header":
    "Este plugin sólo está disponible en entornos de desarrollo.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Arrastrar y soltar archivos, pegar desde el portapapeles o {browse}.",
  ...
  "content-manager.App.schemas.data-loaded":
    "Los esquemas se han cargado correctamente.",
  "content-manager.ListViewTable.relation-loaded":
    "Las relaciones se han cargado",
  ...
  "content-manager.components.DragHandle-label": "Arrastrar",
  "content-manager.components.DraggableAttr.edit": "Click para editar",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Establece las condiciones a aplicar para filtrar registros",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "Filtros",
  "content-manager.components.FiltersPickWrapper.hide": "Ocultar",
  "content-manager.components.LeftMenu.Search.label":
    "Buscar un tipo de contenido",
  "content-manager.components.LeftMenu.collection-types": "Tipos de colección",
  "content-manager.components.LeftMenu.single-types": "Tipos individuales",
  "content-manager.components.LimitSelect.itemsPerPage": "registros por página",
  "content-manager.components.NotAllowedInput.text":
    "Sin permisos para ver este campo",
  "content-manager.components.RepeatableComponent.error-message":
    "Los componentes contienen errores",
  "content-manager.components.Search.placeholder": "Buscar un registro...",
  "content-manager.components.Select.draft-info-title": "Estado: Borrador",
  ...
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "Personaliza cómo se verá la vista de edición.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "Defina la configuración de la vista de lista.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "Configurar la vista - {name}",
  "content-manager.components.TableDelete.delete": "Eliminar todo",
  "content-manager.components.TableDelete.deleteSelected":
    "Eliminar seleccionados",
  "content-manager.components.TableDelete.label":
    "{number, plural, one {# entrada seleccionada} other {# entradas seleccionads}}",
  "content-manager.components.TableEmpty.withFilters":
    "No hay {contentType} con los filtros aplicados...",
  "content-manager.components.TableEmpty.withSearch":
    "No hay {contentType} que coincida con la búsqueda ({search})...",
  "content-manager.components.TableEmpty.withoutFilter":
    "No hay {contentType}...",
  "content-manager.components.empty-repeatable":
    "Aún no hay entrada. Haga clic en el botón de abajo para agregar uno.",
  "content-manager.components.notification.info.maximum-requirement":
    "Ya has alcanzado el número máximo de campos",
  "content-manager.components.notification.info.minimum-requirement":
    "Se ha agregado un campo para cumplir con el requisito mínimo",
  "content-manager.components.repeatable.reorder.error":
    "Se produjo un error al reordenar el campo de su componente. Vuelva a intentarlo.",
  "content-manager.components.reset-entry": "Restablecer entrada",
  "content-manager.components.uid.apply": "aplicar",
  "content-manager.components.uid.available": "disponible",
  "content-manager.components.uid.regenerate": "regenerado",
  "content-manager.components.uid.suggested": "sugerido",
  "content-manager.components.uid.unavailable": "no disponible",
  "content-manager.containers.Edit.Link.Layout": "Configurar el layout",
  "content-manager.containers.Edit.Link.Model": "Edita el Tipo de Colección",
  "content-manager.containers.Edit.addAnItem": "Agregar un registro...",
  "content-manager.containers.Edit.clickToJump": "Click para ir al registro",
  "content-manager.containers.Edit.delete": "Eliminar",
  "content-manager.containers.Edit.delete-entry": "Eliminar esta entrada",
  ...
  "content-manager.containers.Edit.information.created": "Creado",
  "content-manager.containers.Edit.information.draftVersion":
    "versión preliminar",
  "content-manager.containers.Edit.information.editing": "Edición",
  ...
  "content-manager.containers.Edit.returnList": "Regresar a la lista",
  "content-manager.containers.Edit.seeDetails": "Detalles",
  "content-manager.containers.Edit.submit": "Guardar",
  "content-manager.containers.EditSettingsView.modal-form.edit-field":
    "Edita el campo",
  "content-manager.containers.EditView.add.new-entry": "Agregar una entrada",
  "content-manager.containers.EditView.notification.errors":
    "El formulario contiene algunos errores",
  "content-manager.containers.Home.introduction":
    "Para editar sus registros vaya al link en específico en el menu de la izquierda. Este plugin no tiene una manera de editar configuraciones y aún esta en continuo desarrollo.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Gestiona sus registros en una bella y poderoza interfaz.",
  "content-manager.containers.Home.pluginHeaderTitle": "Gestor de Contenido",
  "content-manager.containers.List.draft": "Borrador",
  ...
  "content-manager.containers.ListPage.items":
    "{number, plural, =0 {elementos} one {elemento} other {elementos}}",
  ...
  "content-manager.containers.SettingPage.attributes": "Campos de atributos",
  "content-manager.containers.SettingPage.attributes.description":
    "Defina el orden de sus atributos",
  "content-manager.containers.SettingPage.editSettings.description":
    "Arrastra y suelta los campos para construir el diseño",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title.description":
    "Establece el campo para mostar en tu entrada",
  "content-manager.containers.SettingPage.editSettings.relation-field.description":
    "Establece el campo mostrado en las vistas de lista y edición",
  ...
  "content-manager.containers.SettingPage.listSettings.description":
    "Configure las opciones para este Tipo de Colección",
  ...
  "content-manager.containers.SettingPage.pluginHeaderDescription":
    "Configure los ajustes específicos para este Tipo de Colección",
  "content-manager.containers.SettingPage.settings": "Ajustes",
  "content-manager.containers.SettingPage.view": "Ver",
  "content-manager.containers.SettingViewModel.pluginHeader.title":
    "Administrador de contenido - {name}",
  ...
  "content-manager.containers.SettingsPage.Block.generalSettings.description":
    "Configure las opciones predeterminadas para sus Tipos de Colección",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "Configure los ajustes para todos sus Tipos y Grupos de Colecciones",
  "content-manager.containers.SettingsView.list.subtitle":
    "Configure el diseño y la visualización de sus Tipos y Grupos de Colecciones",
  ...
  "content-manager.edit-settings-view.link-to-ctb.content-types":
    "Edita el tipo de contenido",
  "content-manager.emptyAttributes.button":
    "Ir al constructor de Tipo de Colección",
  "content-manager.emptyAttributes.description":
    "Agregue su primer campo a su Tipo de Colección",
  "content-manager.emptyAttributes.title": "Aún no hay campos",
  "content-manager.error.attribute.key.taken": "Este valor ya existe",
  "content-manager.error.attribute.sameKeyAndName": "No pueden ser iguales",
  "content-manager.error.attribute.taken": "Este campo ya existe",
  "content-manager.error.contentTypeName.taken": "Este nombre ya existe",
  "content-manager.error.model.fetch":
    "Ocurrió un error durante la consulta de configuración de modelos.",
  "content-manager.error.record.create":
    "Ocurrió un error durante la creación del registro.",
  "content-manager.error.record.delete":
    "Ocurrió un error durante la eliminación del registro.",
  "content-manager.error.record.fetch":
    "Ocurrió un error durante la consulta del registro.",
  "content-manager.error.record.update":
    "Ocurrió un error durante la actualización del registro.",
  "content-manager.error.records.count":
    "Ocurrió un error durante la consulta del número de registros.",
  "content-manager.error.records.fetch":
    "Ocurrió un error durante la consulta de registros.",
  "content-manager.error.schema.generation":
    "Ocurrió un error durante la generación de esquema.",
  "content-manager.error.validation.json": "Este no es un JSON",
  "content-manager.error.validation.max": "El valor es muy alto.",
  "content-manager.error.validation.maxLength": "El valor es muy largo.",
  "content-manager.error.validation.min": "El valor es muy bajo.",
  "content-manager.error.validation.minLength": "El valor es muy corto.",
  "content-manager.error.validation.minSupMax": "No puede ser superior",
  "content-manager.error.validation.regex":
    "El valor no cumple la expresión regular.",
  "content-manager.error.validation.required": "Este dato es requerido.",
  "content-manager.form.Input.bulkActions": "Habilitar acciones en bloque",
  "content-manager.form.Input.defaultSort": "Atributo para ordenar por defecto",
  "content-manager.form.Input.description": "Descripción",
  "content-manager.form.Input.description.placeholder":
    "Mostrar nombre en el perfíl",
  "content-manager.form.Input.editable": "Campo editable",
  ...
  "content-manager.form.Input.label.inputDescription":
    "Este valor sobrescribe la etiqueta mostrada en la cabecera de la tabla",
  "content-manager.form.Input.pageEntries": "Entradas por página",
  "content-manager.form.Input.pageEntries.inputDescription":
    "Nota: Puede anular este valor en la página de configuración de Tipo de Colección.",
  "content-manager.form.Input.placeholder": "Placeholder",
  "content-manager.form.Input.placeholder.placeholder": "Mi valor maravilloso",
  "content-manager.form.Input.search": "Habilitar la búsqueda",
  "content-manager.form.Input.search.field":
    "Habilitar la búsqueda para este campo",
  "content-manager.form.Input.sort.field": "Habilitar ordenado para este campo",
  "content-manager.form.Input.sort.order": "Orden por defecto",
  "content-manager.form.Input.wysiwyg": "Mostrar como WYSIWYG",
  "content-manager.global.displayedFields": "Campos mostrados",
  "content-manager.groups": "Grupos",
  "content-manager.groups.numbered": "Grupos ({number})",
  "content-manager.header.name": "Contenido",
  "content-manager.link-to-ctb": "Edita el modelo",
  "content-manager.models": "Tipos de Colección",
  "content-manager.models.numbered": "Tipos de Colección ({number})",
  "content-manager.notification.error.displayedFields":
    "Usted necesita al menos un campo mostrado",
  "content-manager.notification.error.relationship.fetch":
    "Ocurrió un error durante la consulta de la relación.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Necesita tener un habilidato el ordenado en un atributo",
  "content-manager.notification.info.minimumFields":
    "Debe tener al menos un campo mostrado",
  "content-manager.notification.upload.error":
    "Se produjo un error al subir sus archivos",
  "content-manager.pageNotFound": "Página no encontrada",
  "content-manager.pages.ListView.header-subtitle":
    "{number, plural, =0 {# entradas encontradas} one {# entrada encontrada} other {# entradas encontradas}}",
  "content-manager.pages.NoContentType.button":
    "Crea tu primer tipo de contenido",
  "content-manager.pages.NoContentType.text":
    "Aún no tiene ningún contenido, le recomendamos que cree su primer tipo de contenido.",
  "content-manager.permissions.not-allowed.create":
    "No se le permite crear un documento",
  "content-manager.permissions.not-allowed.update":
    "No se le permite ver este documento",
  "content-manager.plugin.description.long":
    "Ver, editar y eliminar información de su base de datos de manera rápida.",
  "content-manager.plugin.description.short":
    "Ver, editar y eliminar información de su base de datos de manera rápida.",
  "content-manager.popover.display-relations.label": "Display relations",
  "content-manager.success.record.delete": "Eliminado",
  "content-manager.success.record.publish": "Publicado",
  "content-manager.success.record.save": "Guardado",
  "content-manager.success.record.unpublish": "Sin publicar",
  "content-manager.utils.data-loaded":
    "{number, plural, =1 {La entrada se ha cargado correctamente} other {Las entradas se han cargado correctamente}}",
  ...
  "global.prompt.unsaved":
    "¿Está seguro de que quiere salir de esta página? Todas sus modificaciones se perderán",
  "notification.contentType.relations.conflict":
    "El Tipo de Contenido tiene relaciones conflictivas",
  ...
  "notification.version.update.message":
    "¡Hay una nueva versión de Strapi disponible!",
  ...
  "Roles.RoleRow.user-count":
    "{number, plural, =0 {#  usuario} one {#  usuario} other {# usuarios}}",
  ...
  "Settings.application.customization.carousel-hint":
    "Cambiar el logo del panel de administración (Dimensión máxima: {dimension}x{dimension}, Tamaño máximo del archivo: {size}KB)",
  ...
  "Settings.application.customization.modal.tab.label":
    "¿Cómo te gustaría subir tus archivos?",
  ...
  "Settings.application.customization.modal.upload.file-validation":
    "Dimensión máxima: {dimension}x{dimension}, Tamaño máximo: {size}KB",
  "Settings.application.customization.modal.upload.error-format":
    "Se cargó un formato incorrecto (formatos aceptados: jpeg, jpg, png, svg).",
  "Settings.application.customization.modal.upload.error-size":
    "El archivo es muy grande (Dimensión máxima: {dimension}x{dimension},Tamaño máximo del archivo: {size}KB)",
  ...
  "Settings.application.customization.modal.pending.subtitle":
    "Gestiona el logo elegido antes de subirlo",
  ...
  "Settings.profile.form.section.experience.mode.hint":
    "Mostrar la interfaz en el modo seleccionado.",
  ...
  "admin.pages.MarketPlacePage.offline.subtitle":
    "Necesita estar conectado a Internet para acceder a Strapi Market.",
  ...
  "admin.pages.MarketPlacePage.tab-group.label":
    "Plugins y proveedores para Strapi",
  "admin.pages.MarketPlacePage.missingPlugin.title": "¿Necesitas un plugin?",
  "admin.pages.MarketPlacePage.missingPlugin.description":
    "¡Díganos qué plugin está buscando y le informaremos a los desarrolladores de plugin de nuestra comunidad en caso de que estén buscando inspiración!",
  "app.components.GuidedTour.CM.create.content":
    "<p>Cree y administre todo el contenido aquí en el Administrador de contenido.</p><p>Ej: tomando el ejemplo del sitio web del blog más allá, uno puede escribir un artículo, guardarlo y publicarlo como desee.</p>< p>💡 Consejo rápido: no olvides presionar publicar en el contenido que crees.</p>",
  "app.components.GuidedTour.CM.create.title": "⚡️ Crear contenido",
  "app.components.GuidedTour.CM.success.content":
    "<p>¡Asombroso, un paso más!</p><b>🚀  Mirar el contenido en acción</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    "<p>Los tipos de colección lo ayudan a administrar varias entradas, los tipos únicos son adecuados para administrar solo una entrada.</p> <p>Ej: para un sitio web de blog, Los artículos serían del tipo Colección, mientras que la Página de inicio sería del tipo Único.</p>",
  "app.components.GuidedTour.CTB.create.cta.title":
    "Crear un tipo de colección",
  "app.components.GuidedTour.CTB.create.title":
    "🧠 Crear un primer tipo de colección",
  "app.components.GuidedTour.CTB.success.content":
    "<p>¡Bien hecho!</p><b>⚡️ ¿Qué te gustaría compartir con el mundo?</b>",
  "app.components.GuidedTour.CTB.success.title": "Paso 1: Completado ✅",
  "app.components.GuidedTour.apiTokens.create.content":
    "<p>Genera un token de autenticación aquí y recupera el contenido que acabas de crear.</p>",
  ...
  "app.components.GuidedTour.home.CM.title":
    "⚡️ ¿Qué te gustaría compartir con el mundo?",
  "app.components.GuidedTour.home.CTB.cta.title":
    "Ir al Creador de tipo de contenido",
  "app.components.GuidedTour.home.CTB.title":
    "🧠 Construye la estructura del contenido",
  ...
  "app.page.not.found":
    "¡Vaya! Parece que no podemos encontrar la página que estás buscando...",
  "components.Input.error.validation.lowercase":
    "El valor debe ser una cadena en minúsculas",
  "content-manager.ListViewTable.relation-loading":
    "Las relaciones se están cargando",
  "content-manager.ListViewTable.relation-more":
    "Esta relación contiene más entidades de las que se muestran",
  "content-manager.apiError.Este atributo debe ser único":
    "{field} debe ser único",
  ...
  "global.plugins.content-manager.description":
    "Forma rápida de ver, editar y eliminar los datos en tu base de datos.",
  "global.plugins.content-type-builder": "Generador de tipo de contenido",
  "global.plugins.content-type-builder.description":
    "Modeliza la estructura de datos de tu API. Crea nuevos campos y relaciones en solo un minuto. Los archivos se crean y actualizan automáticamente en tu proyecto.",
  "global.plugins.email": "Correo electrónico",
  "global.plugins.email.description":
    "Configura tu aplicación para enviar correos electrónicos.",
  ...
  "global.plugins.graphql.description":
    "Agrega un punto final de GraphQL con métodos API predeterminados.",
  "global.plugins.documentation": "Documentación",
  "global.plugins.documentation.description":
    "Cree un documento OpenAPI y visualice su API con SWAGGER UI.",
  "global.plugins.i18n": "Internacionalización",
  "global.plugins.i18n.description":
    "Este complemento permite crear, leer y actualizar contenido en diferentes idiomas, tanto desde el Panel de administración como desde la API.",
  ...
  "global.plugins.users-permissions.description":
    "Proteja su API con un proceso de autenticación completo basado en JWT. Este complemento también viene con una estrategia ACL que le permite administrar los permisos entre los grupos de usuarios.",
...
//# sourceMappingURL=es-h5dK2UFx.mjs.map
