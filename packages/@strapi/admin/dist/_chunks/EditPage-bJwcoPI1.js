...
const useWebhooks = require("./useWebhooks-iXkr6ExT.js");
...
const [WebhookEventProvider, useWebhookEvent] =
  reactContext.createContext("WebhookEvent");
const EventsRoot = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(WebhookEventProvider, {
    isDraftAndPublish,
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.RawThead, {
    children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.RawTr, {
      children: [
        ...
        headers.map((header) => {
          if (
            ["app.utils.publish", "app.utils.unpublish"].includes(
              header?.id ?? ""
            )
          ) {
...
const EventsRow = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  const enabledCheckboxes = events.filter(
    (event) => !disabledEvents.includes(event)
  );
          ...
          designSystem.RawTd,
          {
            children: /* @__PURE__ */ jsxRuntime.jsx(
              designSystem.BaseCheckbox,
              {
                ...
                onValueChange: (value) =>
                  handleSelect({ target: { name: event, value } }),
              }
            ),
          },
          event
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, {
              ...
              children: [
                values.headers.map((header, index2) => {
                  ...
                  const comboboxError =
                    typeof formikError === "object" ? formikError.key : void 0;
                  const textInputError =
                    typeof formikError === "object"
                      ? formikError.value
                      : void 0;
...
const HeaderCombobox = ({ name, onChange, value, ...restProps }) => {
  ...
  React__namespace.useEffect(() => {
    const headerOptions = HTTP_HEADERS.filter(
      (key) =>
        !headers?.some((header) => header.key !== value && header.key === key)
    );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.CreatableCombobox, {
    ...restProps,
    ...
    children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
          col: 6,
          children: !isPending
            ? /* @__PURE__ */ jsxRuntime.jsx(Message, { statusCode, message })
  ...
  if (statusCode >= 300) {
    return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
      ...
      children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
        maxWidth: helperPlugin.pxToRem(250),
        justifyContent: "flex-end",
        title: message,
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
          ellipsis: true,
...
const WebhookForm = ({
  ...
  const { formatMessage } = reactIntl.useIntl();
  const [showTriggerResponse, setShowTriggerResponse] =
    React__namespace.useState(false);
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () =>
      (await Promise.resolve().then(() => require("./EventsTable-C2IKm2Mp.js")))
        .EventsTableEE
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(formik.FormikProvider, {
    value: formik$1,
    children: /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Form, {
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.ContentLayout, {
          children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
            ...
            children: [
              showTriggerResponse &&
                /* @__PURE__ */ jsxRuntime.jsx(TriggerContainer, {
...
const makeWebhookValidationSchema = ({ formatMessage }) =>
...
const EditPage$1 = /* @__PURE__ */ Object.freeze(
...
//# sourceMappingURL=EditPage-bJwcoPI1.js.map
