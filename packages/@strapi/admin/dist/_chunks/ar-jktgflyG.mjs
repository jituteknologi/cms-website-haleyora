...
const ar = {
  ...
  "Auth.form.error.email.provide":
    "يرجى تقديم اسم المستخدم الخاص بك أو البريد الإلكتروني الخاص بك.",
  ...
  "Auth.form.error.password.format":
    "لا يمكن أن تحتوي كلمة مرورك على الرمز `$` أكثر من ثلاث مرات.",
  "Auth.form.error.password.local":
    "لم يقم هذا المستخدم بتعيين كلمة مرور محلية مطلقًا ، الرجاء تسجيل الدخول عبر الموفر المستخدم أثناء إنشاء الحساب.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "نحن سعداء بوجودك كأحد أفراد المجتمع. نحن نبحث باستمرار عن ردود الفعل لا تتردد في مراسلتنا على الخاص ",
  "app.components.HomePage.welcomeBlock.content.again":
    "نأمل أن تحقق تقدمًا في مشروعك ... لا تتردد في قراءة عن اخر إصدار جديد من Strapi. نحن نبذل قصارى جهدنا لتحسين المنتج بناء على ملاحظاتك.",
  ...
  "app.components.ImgPreview.hint":
    "اسحب الملف واسقطة في هذه المساحة او في {browse} لرفعة",
  ...
  "app.components.InstallPluginPage.description":
    "قم بتوسيع التطبيق الخاص بك دون عناء.",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "حدث خطأ أثناء إلغاء تثبيت الإضافة",
  "app.utils.SelectOption.defaultMessage": " ",
  "app.utils.defaultMessage": " ",
  "app.utils.placeholder.defaultMessage": " ",
  "components.AutoReloadBlocker.header":
    "مطلوب ميزة إعادة التحميل لهذه الإضافة.",
  ...
  "components.OverlayBlocker.description":
    "أنت تستخدم ميزة تحتاج إلى إعادة تشغيل الخادم. يرجى الانتظار حتى يعود الخادم.",
  ...
  "components.ProductionBlocker.description":
    "لأغراض السلامة ، يتعين علينا تعطيل هذه الإضافة في بيئات أخرى.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "اسحب الملفات وأفلتها ، والصقها من الحافظة أو {browse}.",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "عيّن الشروط لتطبيقها على ترشيح الإدخالات",
  ...
  "content-manager.components.TableEmpty.withFilters":
    "لا يوجد {contentType} مع المرشحات المطبق...",
  "content-manager.components.TableEmpty.withSearch":
    "لا يوجد {contentType} مطابق للبحث ({search})...",
  ...
  "content-manager.containers.Home.introduction":
    "لتعديل الإدخالات انتقل إلى الرابط المحدد في القائمة اليمنى. لا يحتوي هذه الإضافة على طريقة مناسبة لتعديل الإعدادات ولا يزال قيد التطوير.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "إدارة إدخالاتك من خلال واجهة قوية وجميلة.",
  ...
  "content-manager.containers.SettingPage.editSettings.description":
    "اسحب الحقول وأفلتها لإنشاء التخطيط",
  ...
  "content-manager.error.model.fetch":
    "حدث خطأ أثناء إجراء عملية تكوين النماذج.",
  ...
  "content-manager.form.Input.label.inputDescription":
    "تتجاوز هذه القيمة التسمية المعروضة في رأس الجدول",
  ...
  "content-manager.popUpWarning.bodyMessage.contentType.delete.all":
    "هل أنت متأكد من أنك تريد حذف هذه الأدخالات؟",
  "content-manager.popUpWarning.warning.cancelAllSettings":
    "هل أنت متأكد من أنك تريد إلغاء التعديلاتك؟",
  "content-manager.popUpWarning.warning.updateAllSettings":
    "سيؤدي ذلك إلى تعديل جميع إعداداتك",
  ...
  "admin.pages.MarketPlacePage.missingPlugin.description":
    "أخبرنا ما هو المكون الإضافي الذي تبحث عنه وسنعلم مطوري المكونات الإضافية في مجتمعنا في حال كانوا يبحثون عن الإلهام!",
  "admin.pages.MarketPlacePage.missingPlugin.title": "هل فقدت مكونًا إضافيًا؟",
  "admin.pages.MarketPlacePage.offline.subtitle":
    "يجب أن تكون متصلاً بالإنترنت للوصول إلى سوق سترابي",
  ...
  "admin.pages.MarketPlacePage.filters.categoriesSelected":
    "{count, plural, =0 {No categories} واحد {# category} آخر{# categories}} المحدد",
  "admin.pages.MarketPlacePage.plugin.version":
    ' قم بتحديث إصدار الخاص بك  : "{strapiAppVersion}" ل: "{versionRange}"',
  "admin.pages.MarketPlacePage.plugin.version.null":
    'تعذر التحقق من التوافق مع إصدار Strapi الخاص بك: "{strapiAppVersion}"',
  "app.components.BlockLink.blog.content":
    "اقرأ آخر الأخبار حول Strapi والنظام البيئي.",
  "app.components.BlockLink.cloud": "Strapi سحاب",
  "app.components.BlockLink.cloud.content":
    "نظام أساسي قابل للإنشاء والتعاون بشكل كامل لزيادة سرعة فريقك.",
  "app.components.BlockLink.code.content":
    "تعلم من خلال اختبار المشاريع الحقيقية التي طورها المجتمع.",
  "app.components.BlockLink.documentation.content":
    "اكتشف المفاهيم الأساسية والأدلة والتعليمات.",
  "app.components.BlockLink.tutorial": "دروس",
  "app.components.BlockLink.tutorial.content":
    "Strapi اتبع التعليمات خطوة بخطوة للاستخدام والتخصيص.",
  ...
  "app.components.GuidedTour.CM.create.content":
    "<p>قم بإنشاء وإدارة كل المحتوى هنا في إدارة المحتوى.</p><p>مثال: أخذ مثال موقع المدونة إلى أبعد من ذلك ، يمكن للمرء كتابة مقال وحفظه ونشره كما يحلو له.</p><p>💡 نصيحة سريعة - لا تنس النقر على ’نشر’ على المحتوى الذي تنشئه.</p>",
  "app.components.GuidedTour.CM.create.title": "⚡️ أنشئ محتوى",
  "app.components.GuidedTour.CM.success.content":
    "<p>رائع ، خطوة أخيرة يجب أن تبدأ بها!</p><b>🚀 مشاهدة المحتوى في العمل</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    "<p>تساعدك أنواع المجموعات على إدارة عدة إدخالات ، والأنواع الفردية مناسبة لإدارة إدخال واحد فقط. </ p> <p> على سبيل المثال: بالنسبة إلى موقع مدونة ، ستكون المقالات من نوع المجموعة بينما تكون الصفحة الرئيسية من النوع الفردي.</p>",
  ...
  "app.components.GuidedTour.CTB.success.content":
    "<p>جيد!</p><b>⚡️ ما الذي تود مشاركته مع العالم؟</b>",
  ...
  "app.components.GuidedTour.home.CM.title":
    "⚡️ ما الذي تود مشاركته مع العالم؟",
  "app.components.GuidedTour.home.CTB.cta.title":
    "Content type Builder انتقل إلى",
  ...
  "app.components.InstallPluginPage.Download.description":
    "قد يستغرق تنزيل المكون الإضافي وتثبيته بضع ثوانٍ",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "قد يستغرق الأمر بضع ثوان لإلغاء تثبيت المكون الإضافي",
  "app.components.ListPluginsPage.deletePlugin.title": "إلغاء التثبيت",
  "app.components.MarketplaceBanner":
    "اكتشف المكونات الإضافية التي أنشأها المجتمع ، والعديد من الأشياء الرائعة لبدء مشروعك ، في سوق Strapi.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "يجب تمكين ميزة AutoReload. `yarn develop` يرجى بدء تطبيقك بـ .",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "لأسباب أمنية ، لا يمكن تنزيل المكون الإضافي إلا في بيئة التطوير.",
  ...
  "app.components.Users.MagicLink.connect":
    "انسخ هذا الرابط وشاركه لمنح حق الوصول لهذا المستخدم",
  "app.components.Users.MagicLink.connect.sso":
    "أرسل هذا الرابط إلى المستخدم ، حيث يمكن إجراء أول تسجيل دخول عبر موفر خدمة الدخول الموحد",
  ...
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "إذا لم تستلم هذا الرابط ، فيرجى الاتصال بالمسؤول.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "قد يستغرق استلام رابط استعادة كلمة المرور بضع دقائق.",
  ...
  "app.page.not.found":
    "أُووبس! يبدو أنه لا يمكننا العثور على الصفحة التي تبحث عنها ...",
  ...
  "Auth.form.button.login.providers.error":
    "لا يمكننا توصيلك من خلال المزود المحدد.",
  ...
  "Auth.form.error.ratelimit":
    "محاولات كثيرة ، يرجى المحاولة مرة أخرى خلال دقيقة.",
  ...
  "Auth.form.password.hint":
    "يجب ألا يقل عدد الأحرف عن 8 أحرف ، وحرف كبير واحد ، ورقم واحد صغير ، ورقم واحد",
  "Auth.form.password.show-password": "عرض كلمة المرور",
  "Auth.form.register.news.label":
    "ابقني على اطلاع بالميزات الجديدة والتحسينات القادمة (من خلال القيام بذلك فأنت تقبل {terms} و ال {policy}).",
  "Auth.form.register.subtitle":
    "تُستخدم بيانات الاعتماد فقط للمصادقة في Strapi. سيتم تخزين جميع البيانات المحفوظة في قاعدة البيانات الخاصة بك.",
  ...
  "components.AutoReloadBlocker.description":
    "Strapi قم بتشغيل  باستخدام أحد الأوامر التالية:",
  ...
  "components.Input.error.validation.lowercase":
    "يجب أن تكون القيمة سلسلة أحرف صغيرة",
  ...
  "components.OverlayBlocker.description.serverError":
    "يجب إعادة تشغيل الخادم ، يرجى التحقق من سجلاتك في المحطة.",
  "components.OverlayBlocker.title.serverError":
    "تستغرق إعادة التشغيل وقتًا أطول من المتوقع",
  ...
  "content-manager.components.DynamicZone.error-message":
    "يحتوي المكون على خطأ (أخطاء)",
  "content-manager.components.DynamicZone.missing-components":
    "There {number, plural, =0 {are # missing components} واحد {is # missing component} آخر {are # missing components}}",
  ...
  "content-manager.components.empty-repeatable":
    "لا دخول حتى الان. انقر فوق الزر أدناه لإضافة واحد.",
  "content-manager.components.FieldItem.linkToComponentLayout":
    "قم بتعيين تخطيط المكون",
  ...
  "content-manager.containers.SettingsPage.Block.generalSettings.description":
    "تكوين الخيارات الافتراضية لأنواع المجموعة الخاصة بك",
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "قم بتكوين الإعدادات لجميع أنواع المجموعات والمجموعات الخاصة بك",
  "content-manager.containers.SettingsView.list.subtitle":
    "تكوين تخطيط وعرض أنواع المجموعات والمجموعات الخاصة بك",
  ...
  "content-manager.dnd.instructions":
    "اضغط على مفتاح المسافة للاستيلاء وإعادة الترتيب",
  "content-manager.dnd.reorder":
    "{item}, انتقل. منصب جديد في القائمة: {position}.",
  ...
  "content-manager.form.Input.pageEntries.inputDescription":
    "ملاحظة: يمكنك تجاوز هذه القيمة في صفحة إعدادات نوع المجموعة.",
  ...
  "content-manager.notification.info.minimumFields":
    "يجب أن يكون لديك حقل واحد على الأقل معروض",
  ...
  "content-manager.popUpwarning.warning.has-draft-relations.message":
    "<b>{count, plural, one { relation is } آخر { relations are } }</b> لم تنشر بعد وقد تؤدي إلى سلوك غير متوقع.",
  ...
  "content-manager.popUpWarning.warning.unpublish":
    "إذا لم تنشر هذا المحتوى ، فسيتحول تلقائيًا إلى مسودة.",
  "content-manager.popUpWarning.warning.unpublish-question":
    "هل أنت متأكد أنك لا تريد نشره؟",
  ...
  "global.plugins.content-manager.description":
    "طريقة سريعة لرؤية وتحرير وحذف البيانات في قاعدة البيانات الخاصة بك.",
  "global.plugins.content-type-builder": "منشئ نوع المحتوى",
  "global.plugins.content-type-builder.description":
    "قم بنمذجة بنية البيانات الخاصة بواجهة برمجة التطبيقات (API) الخاصة بك. إنشاء مجالات وعلاقات جديدة في دقيقة واحدة فقط. يتم إنشاء الملفات وتحديثها تلقائيًا في مشروعك.",
  "global.plugins.documentation": "توثيق",
  "global.plugins.documentation.description":
    "قم بإنشاء مستند OpenAPI وتصور API الخاص بك باستخدام SWAGGER UI.",
  "global.plugins.email": "بريد إلكتروني",
  "global.plugins.email.description":
    "تكوين التطبيق الخاص بك لإرسال رسائل البريد الإلكتروني.",
  "global.plugins.graphql": "GraphQL",
  "global.plugins.graphql.description":
    "يضيف نقطة نهاية GraphQL بأساليب واجهة برمجة التطبيقات الافتراضية.",
  "global.plugins.i18n": "تدويل",
  "global.plugins.i18n.description":
    "يمكّن هذا المكون الإضافي من إنشاء المحتوى وقراءته وتحديثه بلغات مختلفة ، سواء من لوحة الإدارة أو من واجهة برمجة التطبيقات.",
  ...
  "global.plugins.users-permissions.description":
    "قم بحماية API الخاص بك من خلال عملية مصادقة كاملة تعتمد على JWT. يأتي هذا المكون الإضافي أيضًا مع إستراتيجية قائمة التحكم بالوصول (ACL) التي تتيح لك إدارة الأذونات بين مجموعات المستخدمين.",
  "global.profile": "حساب تعريفي",
  "global.prompt.unsaved":
    "هل أنت متأكد أنك تريد مغادرة هذه الصفحة؟ ستفقد كل تعديلاتك",
  ...
  "HomePage.welcome.congrats.content":
    "Strapiلقد قمت بتسجيل الدخول باعتبارك المسؤول الأول. لاكتشاف الميزات القوية التي يوفرها",
  "HomePage.welcome.congrats.content.bold":
    "نوصيك بإنشاء أول نوع مجموعة خاص بك.",
  light,
  "Media Library": "مكتبة الوسائط",
  "notification.contentType.relations.conflict":
    "نوع المحتوى له علاقات متضاربة",
  "notification.default.title": "معلومة:",
  "notification.ee.warning.at-seat-limit.title":
    "{LicenseLimitStatus ، حدد ، OVER_LIMIT {Over} AT_LIMIT {At}} حد المقاعد ({currentUserCount} / {allowedSeats})",
  "notification.ee.warning.over-.message":
    "أضف مقاعد إلى {LicenseLimitStatus ، حدد ، OVER_LIMIT {دعوة} AT_LIMIT {re-enable}} مستخدمين. إذا كنت قد فعلت ذلك بالفعل ولكن لم ينعكس في Strapi بعد ، فتأكد من إعادة تشغيل التطبيق الخاص بك.",
  "notification.error.invalid.configuration":
    "لديك تكوين غير صالح ، تحقق من سجل الخادم لمزيد من المعلومات.",
  "notification.error.tokennamenotunique":
    "تم تعيين الاسم بالفعل لرمز مميز آخر",
  ...
  "Settings.apiTokens.createPage.permissions.description":
    "يتم سرد الإجراءات المرتبطة بالمسار فقط أدناه.",
  "Settings.apiTokens.createPage.permissions.header.hint":
    "حدد إجراءات التطبيق أو إجراءات البرنامج المساعد وانقر على أيقونة الترس لعرض المسار المنضم",
  ...
  "Settings.application.customization.auth-logo.carousel-hint":
    "استبدل الشعار في صفحات المصادقة",
  "Settings.application.customization.carousel-hint":
    "تغيير شعار لوحة الإدارة (الحد الأقصى للبعد: {dimension} {dimension} ، الحد الأقصى لحجم الملف: {size} كيلوبايت)",
  ...
  "Settings.application.customization.menu-logo.carousel-hint":
    "استبدل الشعار في شريط التنقل الرئيسي",
  ...
  "Settings.application.customization.modal.pending.subtitle":
    "إدارة الشعار المختار قبل تحميله",
  ...
  "Settings.application.customization.modal.tab.label":
    "كيف تريد تحميل الأصول الخاصة بك؟",
  ...
  "Settings.application.customization.modal.upload.drag-drop":
    "قم بالسحب والإفلات هنا أو",
  "Settings.application.customization.modal.upload.error-format":
    "تم تحميل تنسيق خاطئ (التنسيقات المقبولة فقط: jpeg ، jpg ، png ، svg).",
  "Settings.application.customization.modal.upload.error-network":
    "خطأ في الشبكة",
  "Settings.application.customization.modal.upload.error-size":
    "الملف الذي تم تحميله كبير جدًا (الحد الأقصى للبعد: {dimension} x {dimension} ، الحد الأقصى لحجم الملف: {size} كيلوبايت)",
  "Settings.application.customization.modal.upload.file-validation":
    "أقصى بُعد: {dimension} x {dimension} ، الحد الأقصى للحجم: {size} كيلوبايت",
  ...
  "Settings.application.customization.size-details":
    "أقصى بُعد: {dimension} x {dimension} ، الحد الأقصى لحجم الملف: {size} كيلوبايت",
  ...
  "Settings.application.ee-or-ce":
    "{communityEdition، select، true {Community Edition} أخرى {Enterprise Edition}}",
  "Settings.application.ee.admin-seats.add-seats":
    "{isHostedOnStrapiCloud، select، true {Add seat} other {Contact sales}}",
  "Settings.application.ee.admin-seats.at-limit-tooltip":
    "عند الحد: أضف مقاعد لدعوة المزيد من المستخدمين",
  ...
  "Settings.permissions.auditLogs.entry.create":
    "إنشاء إدخال {model، select، undefined {} other {({model})}}",
  "Settings.permissions.auditLogs.entry.delete":
    "حذف الإدخال {model، select، undefined {} other {({model})}}",
  "Settings.permissions.auditLogs.entry.publish":
    "نشر الإدخال {model، select، undefined {} other {({model})}}",
  "Settings.permissions.auditLogs.entry.unpublish":
    "إلغاء نشر الإدخال {model، select، undefined {} other {({model})}}",
  "Settings.permissions.auditLogs.entry.update":
    "تحديث الإدخال {model، select، undefined {} other {({model})}}",
  "Settings.permissions.auditLogs.filters.combobox.aria-label":
    "ابحث وحدد خيارًا للتصفية",
  "Settings.permissions.auditLogs.listview.header.subtitle":
    "سجلات لجميع الأنشطة التي حدثت في بيئتك",
  ...
  "Settings.permissions.category.plugins":
    "إعدادات الأذونات للمكوِّن الإضافي {category}",
  ...
  "Settings.permissions.conditions.no-actions":
    "تحتاج أولاً إلى تحديد الإجراءات (إنشاء ، قراءة ، تحديث ، ...) قبل تحديد الشروط عليها.",
  ...
  "Settings.permissions.users.form.sso.description":
    "عند التمكين (ON) ، يمكن للمستخدمين تسجيل الدخول عبر SSO",
  ...
  "Settings.permissions.users.listview.header.subtitle":
    "جميع المستخدمين الذين لديهم حق الوصول إلى لوحة إدارة Strapi",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "سيعرض هذا فقط واجهتك الخاصة باللغة المختارة.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "سيتم تطبيق تغييرات التفضيلات عليك فقط. يتوفر مزيد من المعلومات{here}.",
  "Settings.profile.form.section.experience.mode.hint":
    "يعرض واجهتك في الوضع المختار.",
  ...
  "Settings.sso.form.defaultRole.description":
    "سيقوم بإرفاق المستخدم الجديد المصادق عليه بالدور المحدد",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "تحتاج إلى الحصول على إذن لقراءة أدوار المسؤول",
  "Settings.sso.form.defaultRole.label": "الدور الافتراضي",
  "Settings.sso.form.registration.description":
    "أنشئ مستخدمًا جديدًا على تسجيل الدخول الموحّد (SSO) في حالة عدم وجود حساب",
  ...
  "Settings.tokens.copy.editMessage":
    "لأسباب تتعلق بالأمان ، لا يمكنك رؤية رمزك المميز إلا مرة واحدة.",
  "Settings.tokens.copy.editTitle": "لم يعد هذا الرمز المميز يمكن الوصول إليه.",
  "Settings.tokens.copy.lastWarning":
    "تأكد من نسخ هذا الرمز المميز ، فلن تتمكن من رؤيته مرة أخرى!",
  ...
  "Settings.tokens.popUpWarning.message":
    "هل أنت متأكد أنك تريد إعادة إنشاء هذا الرمز المميز؟",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "هذا الحدث موجود فقط للمحتويات مع تمكين نظام المسودة / النشر",
  ...
  "Users.components.List.empty.withFilters":
    "لا يوجد مستخدمون لديهم عوامل التصفية المطبقة ...",
  "Users.components.List.empty.withSearch":
    "لا يوجد مستخدمون مطابقون للبحث({search})...",
};
export {
  Analytics,
  Documentation,
...
//# sourceMappingURL=ar-jktgflyG.mjs.map
