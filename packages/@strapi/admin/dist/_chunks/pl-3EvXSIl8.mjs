...
const pl = {
  ...
  "Auth.form.button.login.providers.error":
    "Nie możemy połączyć Cię za pośrednictwem wybranego dostawcy.",
  ...
  "Auth.form.error.confirmed":
    "Adres e-mail Twojego konta nie został potwierdzony.",
  "Auth.form.error.email.invalid": "Ten e-mail jest nieprawidłowy.",
  "Auth.form.error.email.provide":
    "Podaj swoją nazwę użytkownika lub adres e-mail.",
  ...
  "Auth.form.error.password.format":
    "Twoje hasło nie może zawierać symbolu `$` więcej niż trzy razy.",
  "Auth.form.error.password.local":
    "Ten użytkownik nigdy nie ustawił hasła lokalnego, zaloguj się za pośrednictwem dostawcy użytego podczas tworzenia konta.",
  ...
  "Auth.form.password.hint":
    "Minimum 8 znaków, 1 z dużej litery, 1 z małej litery i 1 cyfra",
  "Auth.form.password.show-password": "Pokaż hasło",
  "Auth.form.register.news.label":
    "Informuj mnie na bieżąco o nowych funkcjach i nadchodzących ulepszeniach (robiąc to, akceptujesz postanowienia zawarte w niniejszych dokumentach - {terms} i {policy}).",
  "Auth.form.register.subtitle":
    "Dane logowania uzywane są tylko do uwierzytelniania w Strapi. Wszystkie zapisane dane będą przechowywane w twojej bazie danych.",
  ...
  "HomePage.welcome.congrats.content":
    "Jesteś zalogowany jako pierwszy administrator. Aby odkryć potężne funkcje oferowane przez Strapi,",
  "HomePage.welcome.congrats.content.bold":
    "zachęcamy do utworzenia pierwszego typu kolekcji.",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "Niektórych ról nie można usunąć, ponieważ są powiązane z użytkownikami",
  "Roles.ListPage.notification.delete-not-allowed":
    "Nie można usunąć roli, jeśli jest powiązana z użytkownikami",
  ...
  "Roles.components.List.empty.withSearch":
    "Brak roli odpowiadającej wyszukiwaniu ({search}) ...",
  ...
  "Settings.tokens.copy.editMessage":
    "Dla bezpieczeństwa, możesz tylko raz zobaczyć swój token.",
  "Settings.tokens.copy.editTitle": "Ten token nie jest już dostępny.",
  "Settings.tokens.copy.lastWarning":
    "Pamiętaj żeby skopiować token, nie będziesz w stanie kolejny raz go zobaczyć!",
  "Settings.apiTokens.create": "Stwórz nowy API Token",
  "Settings.apiTokens.description":
    "Lista wygenerowanych tokenów pozwalających korzystać z API",
  ...
  "Settings.application.description":
    "Globalne informacje dotyczące panelu administratora",
  ...
  "Settings.permissions.category.plugins":
    "Ustawienia uprawnień dla pluginu {category} ",
  ...
  "Settings.permissions.conditions.no-actions":
    "Najpierw musisz wybrać akcje (tworzenie, odczytywanie, aktualizowanie, ...) przed zdefiniowaniem dla nich warunków.",
  ...
  "Settings.permissions.select-all-by-permission":
    "Wybierz wszystkie {label} uprawnienia",
  ...
  "Settings.permissions.users.form.sso":
    "Połącz z logowaniem jednokrotnym (SSO)",
  "Settings.permissions.users.form.sso.description":
    "Po włączeniu (ON) użytkownicy mogą logować się za pomocą logowania jednokrotnego (SSO)",
  "Settings.permissions.users.listview.header.subtitle":
    "Wszyscy użytkownicy posiadający dostęp do panelu admina",
  "Settings.permissions.users.tabs.label": "Uprawnienia",
  "Settings.profile.form.notify.data.loaded":
    "Dane twojego profilu zostały załadowane",
  "Settings.profile.form.section.experience.clear.select":
    "Usuń wybór języka interfejsu",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "Wyświetla aplikację w wybranym języku.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "Zmiany preferencji będą miały zastosowanie tylko do tego profilu. Więcej informacji {tutaj}.",
  "Settings.profile.form.section.experience.mode.label": "Motyw aplikacji",
  "Settings.profile.form.section.experience.mode.hint":
    "Wyświetla aplikację w wybranym motywie.",
  ...
  "Settings.sso.description":
    "Skonfiguruj ustawienia funkcji logowania jednokrotnego (SSO).",
  "Settings.sso.form.defaultRole.description":
    "Połączy to nowego uwierzytelnionego użytkownika do wybranej roli",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "Musisz mieć uprawnienia do odczytu ról administratora",
  "Settings.sso.form.defaultRole.label": "Domyślna rola",
  "Settings.sso.form.registration.description":
    "Utwórz nowego użytkownika przy logowaniu SSO, jeśli konto nie istnieje",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "To zdarzenie istnieje tylko dla treści z włączonym systemem wersji roboczej/publikacji",
  ...
  "Settings.webhooks.list.description":
    "Otrzymaj powiadomienia o zmianach POST.",
  "Settings.webhooks.list.empty.description":
    "Nie ma jeszcze żadnych webhooków",
  ...
  "Settings.webhooks.to.delete":
    "{webhooksToDeleteLength, plural, one {# } other {# }} wybrano",
  ...
  "admin.pages.MarketPlacePage.missingPlugin.description":
    "Powiedz nam jakiego pluginu szukasz, a my damy znać o tym naszym developerom w razie gdyby szukali inspiracji!",
  anErrorOccurred,
  ...
  "app.components.BlockLink.blog.content":
    "Czytaj najnowsze wiadomości na temat Strapi.",
  "app.components.BlockLink.code": "Przykłady",
  "app.components.BlockLink.code.content":
    "Ucz się poprzez testowanie prawdziwych projektów tworzonych przez naszą społeczność.",
  "app.components.BlockLink.documentation.content":
    "Odkryj kluczowe pojęcia, wskazówki i instrukcje.",
  "app.components.BlockLink.tutorial": "Tutoriale",
  "app.components.BlockLink.tutorial.content":
    "Podążaj za instrukcjami krok po kroku żeby użyć i dostosować Strapi.",
  ...
  "app.components.DownloadInfo.text":
    "Może to chwilę potrwać. Dziękujemy za cierpliwość.",
  ...
  "app.components.GuidedTour.CM.create.content":
    "<p>Twórz i zarządzaj zawartością tutaj w Menedżerze Treści.</p><p>Przykład: Weźmy pod uwagę przykład z blogiem, możesz napisać aktykuł, zapisać i opublikować go kiedy tylko chcesz.</p><p>💡 Szybka wskazówka - Nie zapomnij kliknąć opublikuj, w treści którą tworzysz.</p>",
  "app.components.GuidedTour.CM.create.title": "⚡️ Stwórz treść",
  "app.components.GuidedTour.CM.success.content":
    "<p>Super, został ostatni krok!</p><b>🚀 Zobacz materiały w praktyce</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    "<p>Kolekcje pomagają zarządzać wieloma pozycjami, a pojedyncze typy są odpowiednie do zarządzania tylko jednym wpisem.</p> <p>Przykład: Wyobraź sobie stronę z blogiem. Tam artykuły byłyby kolekcjami, a strona główna byłaby pojedynczym typem.</p>",
  ...
  "app.components.GuidedTour.CTB.success.content":
    "<p>Niezła robota!</p><b>⚡️ Czym chciałbyś się podzielić ze światem?</b>",
  "app.components.GuidedTour.CTB.success.title": "Krok 1: Ukończony ✅",
  "app.components.GuidedTour.apiTokens.create.content":
    "<p>Wygeneruj token aby otrzymać dostęp do treści, którą stworzyłeś.</p>",
  "app.components.GuidedTour.apiTokens.create.cta.title": "Wygeneruj API Token",
  "app.components.GuidedTour.apiTokens.create.title":
    "🚀 Zobacz materiały w praktyce",
  "app.components.GuidedTour.apiTokens.success.content":
    "<p>Przetestuj treść wykonując żądanie HTTP:</p><ul><li><p>Pod URL: <light>https://'<'YOUR_DOMAIN'>'/api/'<'YOUR_CT'>'</light></p></li><li><p>Przy użyciu nagłówka: <light>Authorization: bearer '<'YOUR_API_TOKEN'>'</light></p></li></ul><p>Zerknij na <documentationLink>dokumentację</documentationLink> by poznać więcej sposobów na interakcję z treścią.</p>",
  ...
  "app.components.GuidedTour.home.CM.title":
    "⚡️ Czym chciałbyś się podzielić ze światem?",
  "app.components.GuidedTour.home.CTB.cta.title":
    "Przejdź do kreatora typów treści",
  ...
  "app.components.HomePage.community.content":
    "Porozmawiaj z członkami zespołu, współtwórcami i programistami na różnych kanałach.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Cieszymy się, że jesteś częścią społeczności. Nieustannie poszukujemy opinii, więc zachęcamy do wysyłania nam wiadomości",
  "app.components.HomePage.welcomeBlock.content.again":
    "Mamy nadzieję, że robisz postępy w swoim projekcie! Zachęcamy do zapoznania się z najnowszymi wiadomościami o Strapi. Dokładamy wszelkich starań, aby ulepszyć produkt w oparciu o Wasze opinie.",
  ...
  "app.components.ImgPreview.hint":
    "Przeciągnij i upuść plik w tym obszarze lub {browse}, aby przesłać plik",
  ...
  "app.components.LeftMenuLinkContainer.noPluginsInstalled":
    "Nie zainstalowano jeszcze żadnych pluginów",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "Odinstalowanie pluginu może zająć kilka sekund.",
  ...
  "app.components.ListPluginsPage.helmet.title": "Lista pluginów",
  "app.components.Logout.logout": "Wyloguj",
  "app.components.Logout.profile": "Profil",
  "app.components.MarketplaceBanner":
    "Odkryj pluginy tworzone przez społeczność oraz wiele więcej rzeczy żeby odpalić projekt, używając Strapi.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "Funkcja autoReload musi być włączona. Uruchom aplikację za pomocą polecenia `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Ze względów bezpieczeństwa plugin można pobrać tylko w środowisku programistycznym.",
  "app.components.PluginCard.PopUpWarning.install.impossible.title":
    "Pobieranie jest niemożliwe",
  ...
  "app.components.Users.MagicLink.connect":
    "Wyślij ten link do użytkownika, aby mógł się połączyć.",
  "app.components.Users.MagicLink.connect.sso":
    "Wyślij ten link do użytkownika, pierwsze logowanie można wykonać za pośrednictwem dostawcy SSO",
  ...
  "app.components.Users.ModalCreateBody.block-title.roles.description":
    "Twój użytkownik może mieć jedną lub kilka ról",
  ...
  "app.components.Users.SortPicker.sortby.username_asc":
    "Nazwa użytkownika (od A do Z)",
  "app.components.Users.SortPicker.sortby.username_desc":
    "Nazwa użytkownika (od Z do A)",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Wystąpił błąd podczas odinstalowywania pluginu",
  "app.containers.App.notification.error.init":
    "Wystąpił błąd podczas żądania interfejsu API",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "Jeśli nie otrzymasz tego łącza, skontaktuj się z administratorem.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "Do otrzymania linku do odzyskiwania hasła może minąć kilka minut.",
  ...
  clearLabel,
  "coming.soon":
    "Ta zawartość jest aktualnie w trakcie budowy i wróci za jakiś czas!",
  "component.Input.error.validation.integer":
    "Wartość ta musi być liczbą całkowitą",
  "components.AutoReloadBlocker.description":
    "Uruchom Strapi za pomocą jednego z następujących poleceń:",
  "components.AutoReloadBlocker.header":
    "Ten plugin wymaga funkcji przeładowania.",
  ...
  "components.FilterOptions.FILTER_TYPES.$endsWithi":
    "kończy się (wielkość liter nie ma znaczenia)",
  ...
  "components.FilterOptions.FILTER_TYPES.$startsWithi":
    "zaczyna się na (wielkość liter nie ma znaczenia)",
  ...
  "components.Input.error.validation.lowercase":
    "Wartość musi być zapisana małymi literami",
  ...
  "components.OverlayBlocker.description":
    "Używasz funkcji, która wymaga ponownego uruchomienia serwera. Poczekaj, aż serwer się uruchomi.",
  "components.OverlayBlocker.description.serverError":
    "Serwer powinien się już zrestartować, sprawdź swoje logi w terminalu.",
  "components.OverlayBlocker.title": "Czekam na ponowne uruchomienie...",
  "components.OverlayBlocker.title.serverError":
    "Ponowne uruchomienie trwa dłużej niż oczekiwano",
  "components.PageFooter.select": "wpisów na stronie",
  "components.ProductionBlocker.description":
    "Ze względów bezpieczeństwa musimy wyłączyć ten plugin w innych środowiskach.",
  "components.ProductionBlocker.header":
    "Ten plugin jest dostępna tylko w trybie deweloperskim.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Przeciągnij i upuść pliki, wklej ze schowka lub {browse}.",
  ...
  "content-manager.App.schemas.data-loaded":
    "Schematy zostały poprawnie załadowane",
  "content-manager.ListViewTable.relation-loaded": "Relacje zostały załadowane",
  "content-manager.ListViewTable.relation-loading": "Trwa ładowanie relacji",
  "content-manager.ListViewTable.relation-more":
    "Ta relacja zwiera więcej wartości nież wyświetlana",
  "content-manager.EditRelations.title": "Relacje",
  "content-manager.HeaderLayout.button.label-add-entry": "Dodaj nowy wpis",
  "content-manager.api.id": "API ID",
  "content-manager.components.AddFilterCTA.add": "Filtry",
  "content-manager.components.AddFilterCTA.hide": "Filtry",
  "content-manager.components.DragHandle-label": "Przenieś",
  "content-manager.components.DraggableAttr.edit": "Kliknij by edytować",
  ...
  "content-manager.components.DraggableCard.move.field": "Przenieś {item}",
  "content-manager.components.ListViewTable.row-line": "rząd {number}",
  "content-manager.components.DynamicZone.ComponentPicker-label":
    "Wybierz komponent",
  "content-manager.components.DynamicZone.add-component":
    "Dodaj komponent do {componentName}",
  "content-manager.components.DynamicZone.delete-label": "Usuń {name}",
  "content-manager.components.DynamicZone.error-message":
    "Komponent zawiera błąd/błędy",
  "content-manager.components.DynamicZone.missing-components":
    "Brakuje {number, plural, =0 {# komponentów} one {# komponentu} other {# komponentów}}",
  "content-manager.components.DynamicZone.move-down-label": "Przesuń niżej",
  "content-manager.components.DynamicZone.move-up-label": "Przesuń wyżej",
  "content-manager.components.DynamicZone.pick-compo":
    "Wybierz jeden komponent",
  ...
  "content-manager.components.FieldItem.linkToComponentLayout":
    "Ustaw układ komponentu",
  "content-manager.components.FieldSelect.label": "Dodaj pole",
  "content-manager.components.FilterOptions.button.apply": "Zastosuj",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Ustawianie warunków filtrowania elementów.",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "Filtry",
  "content-manager.components.FiltersPickWrapper.hide": "Ukryj",
  "content-manager.components.LeftMenu.Search.label": "Szukaj",
  "content-manager.components.LeftMenu.collection-types": "Typy kolekcji",
  "content-manager.components.LeftMenu.single-types": "Pojedynczy typ",
  "content-manager.components.LimitSelect.itemsPerPage": "Elementów na stronę",
  "content-manager.components.NotAllowedInput.text":
    "Brak uprawnień do zobaczenia tego pola",
  "content-manager.components.RepeatableComponent.error-message":
    "Komponent zawiera błąd/błędy",
  "content-manager.components.Search.placeholder": "Szukaj elementu...",
  "content-manager.components.Select.draft-info-title": "Stan: Szkic",
  "content-manager.components.Select.publish-info-title": "Stan: Opublikowany",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "Dostosuj wygląd widoku edycji.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "Zdefiniuj ustawienia widoku listy.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "Skonfiguruj widok - {name}",
  "content-manager.components.TableDelete.delete": "Usuń",
  "content-manager.components.TableDelete.deleteSelected": "Usuń zaznaczone",
  "content-manager.components.TableDelete.label":
    "{number, plural, one {# wpis zaznaczony} other {# wpisy zaznaczone}}",
  "content-manager.components.TableEmpty.withFilters":
    "Nie istnieją elementy {contentType} zgodne z zastosowanymi filtrami...",
  "content-manager.components.TableEmpty.withSearch":
    "Nie istnieją elementy {contentType} zgodne z wyszukiwaną frazą ({search})...",
  "content-manager.components.TableEmpty.withoutFilter":
    "Nie istnieją jeszcze elementy związane z {contentType}... Stwórz pierwszy jak najszybciej!",
  "content-manager.components.empty-repeatable":
    "Jeszcze nie ma wpisu. Kliknij przycisk poniżej, aby go dodać.",
  "content-manager.components.notification.info.maximum-requirement":
    "Osiągięto maksymalną liczbę pól",
  "content-manager.components.notification.info.minimum-requirement":
    "Dodano pole spełniające minimalne wymagania",
  "content-manager.components.repeatable.reorder.error":
    "Wystąpił błąd podczas zmiany pozycji komponentu, spróbuj raz jeszcze",
  "content-manager.components.reset-entry": "Zresetuj wpis",
  "content-manager.components.uid.apply": "zastostuj",
  "content-manager.components.uid.available": "Dostępny",
  "content-manager.components.uid.regenerate": "Odnów",
  "content-manager.components.uid.suggested": "zasugerowany",
  "content-manager.components.uid.unavailable": "Niedostępny",
  "content-manager.containers.Edit.Link.Layout": "Skonfiguruj układ",
  "content-manager.containers.Edit.Link.Model": "Edytuj typ kolekcji",
  "content-manager.containers.Edit.addAnItem": "Dodaj element...",
  "content-manager.containers.Edit.clickToJump":
    "Kliknij aby przejść do elementu",
  "content-manager.containers.Edit.delete": "Usuń",
  "content-manager.containers.Edit.delete-entry": "Usuń ten wpis",
  "content-manager.containers.Edit.editing": "Edytowanie...",
  "content-manager.containers.Edit.information": "Informacje",
  "content-manager.containers.Edit.information.by": "Przez",
  "content-manager.containers.Edit.information.created": "Stworzony",
  "content-manager.containers.Edit.information.draftVersion": "wersja szkicu",
  "content-manager.containers.Edit.information.editing": "Edytowanie",
  "content-manager.containers.Edit.information.lastUpdate":
    "Ostatnia aktualizacja",
  "content-manager.containers.Edit.information.publishedVersion":
    "wersja publikacji",
  "content-manager.containers.Edit.pluginHeader.title.new": "Nowy wpis",
  "content-manager.containers.Edit.reset": "Wyczyść",
  "content-manager.containers.Edit.returnList": "Wróć do listy",
  "content-manager.containers.Edit.seeDetails": "Szczegóły",
  "content-manager.containers.Edit.submit": "Prześlij",
  ...
  "content-manager.containers.Home.introduction":
    "Aby edytować wpisy przejdź do odpowiedniego linku w menu po lewej. Ten plugin nie ma odpowiedniego sposobu na edytowanie ustawień i nadal jest w trakcie rozwijania.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Zarządzaj swoimi danymi za pomocą potężnego i pięknego interfejsu.",
  "content-manager.containers.Home.pluginHeaderTitle": "Treści",
  "content-manager.containers.List.draft": "Szkic",
  "content-manager.containers.List.errorFetchRecords": "Błąd",
  ...
  "content-manager.containers.SettingPage.attributes": "Pola atrybutów",
  "content-manager.containers.SettingPage.attributes.description":
    "Zdefiniuj kolejność atrybutów",
  "content-manager.containers.SettingPage.editSettings.description":
    "Przeciągnij i upuś pola by zbudować układ",
  ...
  "content-manager.containers.SettingsPage.Block.generalSettings.description":
    "Skonfiguruj domyślne opcje dla twoich typów kolekcji",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "Skonfiguruj domyślne opcje wszystkich twoich modeli",
  "content-manager.containers.SettingsView.list.subtitle":
    "Skonfiguruj układ i wyświetlanie modeli i grup",
  "content-manager.containers.SettingsView.list.title": "Wyświetl ustawienia",
  "content-manager.edit-settings-view.link-to-ctb.components":
    "Edytuj komponent",
  "content-manager.edit-settings-view.link-to-ctb.content-types": "Edytuj",
  "content-manager.emptyAttributes.button": "Przejdź do konstruktora modeli",
  "content-manager.emptyAttributes.description":
    "Dodaj swoje pierwszy atrybut do modelu",
  "content-manager.emptyAttributes.title": "Nie ma jeszcze żadnych atrybutów",
  "content-manager.error.attribute.key.taken": "Ta wartość już istnieje",
  "content-manager.error.attribute.sameKeyAndName": "Nie mogą być takie same",
  "content-manager.error.attribute.taken": "Atrybut o tej nazwie już istnieje",
  "content-manager.error.contentTypeName.taken": "Ta nazwa już istnieje",
  "content-manager.error.model.fetch":
    "Wystąpił błąd podczas pobierania konfiguracji modelów.",
  ...
  "content-manager.error.record.fetch":
    "Wystąpił błąd podczas pobierania rekordu.",
  "content-manager.error.record.update":
    "Wystąpił błąd podczas zmiany rekordu.",
  "content-manager.error.records.count":
    "Wystąpił błąd podczas liczenia rekordów.",
  "content-manager.error.records.fetch":
    "Wystąpił błąd podczas pobierania rekordów.",
  "content-manager.error.schema.generation":
    "Wystąpił błąd podczas generowania schematu.",
  "content-manager.error.validation.json": "To nie jest JSON",
  "content-manager.error.validation.max": "Wartość jest za wysoka.",
  "content-manager.error.validation.maxLength": "Wartość jest za długa.",
  "content-manager.error.validation.min": "Wartość jest za niska.",
  "content-manager.error.validation.minLength": "Wartość jest za krótka.",
  "content-manager.error.validation.minSupMax": "Nie może być większa",
  "content-manager.error.validation.regex":
    "Wartość nie jest zgodna z wymaganym wzorcem.",
  "content-manager.error.validation.required":
    "Wpisanie wartości dla tego atrybutu jest wymagane.",
  "content-manager.form.Input.bulkActions": "Włącz akcje masowe",
  "content-manager.form.Input.defaultSort": "Domyślny atrybut sortowania",
  "content-manager.form.Input.description": "Opis",
  "content-manager.form.Input.description.placeholder": "Nazwa wyświetlana",
  "content-manager.form.Input.editable": "Edytowalne pole",
  "content-manager.form.Input.filters": "Włącz filtry",
  "content-manager.form.Input.label": "Etykieta",
  "content-manager.form.Input.label.inputDescription":
    "Ta wartość nadpisuje etykietę wyświetlaną w nagłówku tabeli",
  "content-manager.form.Input.pageEntries": "Wpisy na stronę",
  "content-manager.form.Input.pageEntries.inputDescription":
    "Uwaga: Możesz zmienić tę wartość na stronie ustawień modeli.",
  "content-manager.form.Input.placeholder": "Placeholder",
  "content-manager.form.Input.placeholder.placeholder": "Moja wartość",
  "content-manager.form.Input.search": "Włącz wyszukiwanie",
  "content-manager.form.Input.search.field": "Włącz wyszukiwanie po tym polu",
  "content-manager.form.Input.sort.field": "Włącz sortowanie po tym polu",
  "content-manager.form.Input.sort.order": "Domyślne sortowanie",
  "content-manager.form.Input.wysiwyg": "Wyświetl jako edytor WYSIWYG",
  "content-manager.global.displayedFields": "Wyświetlane pola",
  "content-manager.groups": "Grupy",
  "content-manager.groups.numbered": "Grupy ({number})",
  "content-manager.header.name": "Zawartość",
  "content-manager.link-to-ctb": "Edytuj model",
  "content-manager.models": "Typy Kolekcji",
  "content-manager.models.numbered": "Modele ({number})",
  "content-manager.notification.error.displayedFields":
    "Co najmniej jedno pole musi być wyświetlane",
  "content-manager.notification.error.relationship.fetch":
    "Wystąpił błąd podczas pobierania relacji.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Co najmniej jeden atrybut musi mieć włączoną możliwość sortowania",
  "content-manager.notification.info.minimumFields":
    "Musisz wyświetlić przynajmniej jedno pole",
  "content-manager.notification.upload.error":
    "Wystąpił bład podczas przesyłania plików",
  "content-manager.pageNotFound": "Strona nie znaleziona",
  "content-manager.pages.ListView.header-subtitle":
    "{number, plural, =0 {#} one {# } other {# }} znaleziono",
  "content-manager.pages.NoContentType.button": "Stwórz pierszy Content-Type",
  "content-manager.pages.NoContentType.text":
    "Nie masz jeszcze żadnej zawartości. Polecamy stworzyć pierwszy Content-Type.",
  "content-manager.permissions.not-allowed.create":
    "Brak uprawnień do stworzenia dokumentu",
  "content-manager.permissions.not-allowed.update":
    "Brak uprawnień do odczytu dokumentu",
  "content-manager.plugin.description.long":
    "Szybki sposób na przeglądanie, zmianę i usuwanie elementów z twojej bazy danych.",
  "content-manager.plugin.description.short":
    "Szybki sposób na przeglądanie, zmianę i usuwanie elementów z twojej bazy danych.",
  "content-manager.popover.display-relations.label": "Wyświetl powiązania",
  ...
  "content-manager.success.record.unpublish": "Cofnięto publikację",
  "content-manager.utils.data-loaded": "Udało się załadować wpis/wpisy.",
  "content-manager.apiError.This attribute must be unique":
    "{field} musi być unikalne",
  "content-manager.popUpWarning.warning.publish-question":
    "Czy nadal chcesz to opublikować?",
  ...
  "global.prompt.unsaved":
    "Czy na pewno chcesz opuścić tę stronę? Wszystkie twoje modyfikacje zostaną utracone",
  ...
  "notification.contentType.relations.conflict":
    "Typ treści ma sprzeczne relacje",
  ...
  "notification.permission.not-allowed-read":
    "Nie masz uprawnień, by zobaczyć ten dokument",
...
//# sourceMappingURL=pl-3EvXSIl8.mjs.map
