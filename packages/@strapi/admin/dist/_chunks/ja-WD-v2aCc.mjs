const Analytics = "分析";
const Documentation = "ドキュメンテーション";
const Email = "Eメール";
const Password = "パスワード";
const Provider = "プロバイダ";
const ResetPasswordToken = "パスワードトークンをリセット";
const Role = "Role";
...
const ja = {
  ...
  "Auth.form.register.news.label":
    "新機能や今後の改善についての最新情報を受け取る(受け取る場合は{terms}と{policy}に同意したこととします)。",
  "Auth.form.register.subtitle":
    "認証情報は、管理パネルで自分を認証するためにのみ使用されます。保存されているすべてのデータは自分のデータベースに保存されます。",
  ...
  "HomePage.welcome.congrats.content":
    "初期管理者としてログインしました。Strapiが提供する強力な機能を探すために、",
  "HomePage.welcome.congrats.content.bold":
    "まずはコンテンツタイプを作ることをオススメします。",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "いくつかのロールはユーザーにひもづいているため削除できませんでした",
  "Roles.ListPage.notification.delete-not-allowed":
    "ユーザーにひもづいているロールは削除できません",
  ...
  "Settings.permissions.conditions.no-actions":
    "条件を定義する前に最初に作業（作成・閲覧・更新等）を選択する必要があります。",
  ...
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "Selection will change the interface language only for you. Please refer to this {here} to make other languages available for your team.",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "このイベントは下書き・公開のシステムが有効になったコンテンツでのみ発生します",
  ...
  "Users.components.List.empty.withFilters":
    "適用されたフィルターにマッチするユーザーがいません…",
  "Users.components.List.empty.withSearch":
    "検索（{search}）に合致するユーザーがいません…",
  ...
  "app.components.HomePage.community.content":
    "異なるチャンネルでチームメンバー、コントリビューターやデベロッパーと議論する",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "私たちはコミュニティメンバーのひとりとしてあなたをお待ちしております。私たちは常にフィードバックを求めていますので、DMを送ってください",
  "app.components.HomePage.welcomeBlock.content.again":
    "あなたのプロジェクトを進歩させていただければ幸いです... Strapiに関する最新の新情報をお読みください。私たちはあなたのフィードバックに基づいて製品を改善するために最善を尽くしています。",
  ...
  "app.components.ImgPreview.hint":
    "ファイルをドラッグ&ドロップ、もしくは、アップロード{browse}",
  ...
  "components.OverlayBlocker.description":
    "サーバーのリスタートが必要な機能を使用しています。サーバーが起動するまでお待ち下さい",
  ...
  "components.ProductionBlocker.description":
    "このプラグインは、安全のため、他の環境では無効する必要があります",
  "components.ProductionBlocker.header":
    "このプラグインはデベロップ環境でのみ利用できます",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "ファイルをドラッグ＆ドロップ, クリップボードからペースト もしくは {browse}.",
  ...
  "content-manager.components.TableEmpty.withFilters":
    "適用されたフィルタには{contentType}はありません...",
  "content-manager.components.TableEmpty.withSearch":
    "検索に対応する{contentType}はありません（{search}）...",
  ...
  "content-manager.containers.Home.introduction":
    "あなたのエントリーを編集するには、左側のメニューの特定のリンクに行きます。このプラグインは設定を編集する適切な方法がなく、まだアクティブな開発中です",
  "content-manager.containers.Home.pluginHeaderDescription":
    "パワフルで美しいインターフェイスでエントリを管理します。",
  ...
  "content-manager.error.attribute.sameKeyAndName":
    "同じにすることはできません",
  "content-manager.error.attribute.taken": "このフィールド名は既に存在します",
  "content-manager.error.contentTypeName.taken": "この名前は既に存在します",
  "content-manager.error.model.fetch":
    "モデルの設定フェッチ中にエラーが発生しました",
  ...
  "content-manager.error.records.count":
    "カウントレコードのフェッチ中にエラーが発生しました.",
  "content-manager.error.records.fetch":
    "レコードの取得中にエラーが発生しました",
  "content-manager.error.schema.generation":
    "スキーマの生成中にエラーが発生しました",
  "content-manager.error.validation.json": "これはJSONではありません",
  "content-manager.error.validation.max": "値が高すぎます",
  "content-manager.error.validation.maxLength": "値が長すぎます",
  "content-manager.error.validation.min": "値が低すぎます",
  "content-manager.error.validation.minLength": "値が小さすぎます",
  "content-manager.error.validation.minSupMax": "優れていることはできません",
  "content-manager.error.validation.regex": "値は正規表現と一致しません",
  "content-manager.error.validation.required": "この値の入力は必須です",
  "content-manager.form.Input.bulkActions": "一括処理を有効にする",
  "content-manager.form.Input.defaultSort": "デフォルトのソート属性",
  "content-manager.form.Input.description": "説明文",
  "content-manager.form.Input.description.placeholder": "プロフィールの表示名",
  "content-manager.form.Input.editable": "編集可能なフィールド",
  "content-manager.form.Input.filters": "フィルタを有効にする",
  "content-manager.form.Input.label": "Label",
  "content-manager.form.Input.label.inputDescription":
    "この値は、テーブルの先頭に表示されるラベル",
  ...
  "global.prompt.unsaved":
    "ページから離れてもいいですか？編集中のものは全て失われます",
  "notification.contentType.relations.conflict":
    "コンテンツタイプがリレーションと競合しています",
...
//# sourceMappingURL=ja-WD-v2aCc.mjs.map
