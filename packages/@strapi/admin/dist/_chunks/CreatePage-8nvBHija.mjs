...
import {
  ...
  A as useGetRolePermissionLayoutQuery,
  B as useGetRolePermissionsQuery,
  D as useCreateRoleMutation,
  E as useUpdateRolePermissionsMutation,
  x as isBaseQueryError,
} from "./index-qQynS5yD.mjs";
import { P as Permissions } from "./Permissions-GD25CJav.mjs";
    ...
    try {
      ...
      if (
        ...
        if ("error" in updateRes) {
          if (
            isBaseQueryError(updateRes.error) &&
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ jsx(GridItem, {
                                  ...
                                  children: /* @__PURE__ */ jsx(Textarea, {
                                    ...
                                    error:
                                      errors.description &&
                                      formatMessage({ id: errors.description }),
                                    onChange: handleChange,
...
//# sourceMappingURL=CreatePage-8nvBHija.mjs.map
