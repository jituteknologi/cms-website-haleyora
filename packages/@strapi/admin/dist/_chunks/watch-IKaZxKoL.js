...
const webpackDevMiddleware__default =
  /* @__PURE__ */ _interopDefault(webpackDevMiddleware);
const webpackHotMiddleware__default =
  /* @__PURE__ */ _interopDefault(webpackHotMiddleware);
  ...
  return new Promise((res) => {
    ...
    const serveAdmin = async (ctx2, next) => {
      ...
      if (devMiddleware.context.outputFileSystem.createReadStream) {
        ...
        const filename = path__default.default.resolve(
          finalConfig.output?.path,
          "index.html"
        );
        ctx2.type = "html";
        ctx2.body =
          devMiddleware.context.outputFileSystem.createReadStream(filename);
      }
    };
