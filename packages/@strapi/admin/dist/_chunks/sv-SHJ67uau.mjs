...
const anErrorOccurred = "Hoppsan! Något gick fel. Försök igen.";
...
const sv = {
  ...
  "Auth.components.Oops.text.admin":
    "Kontakta din administratör om du tror detta är av misstag.",
  ...
  "Auth.form.button.login.providers.error":
    "Vi kan inte logga in dig med den valda tjänsten.",
  ...
  "Auth.form.error.confirmed":
    "E-postadressen för ditt konto är inte verifierad.",
  ...
  "Auth.form.error.invalid":
    "Användarnamn/e-postadress eller lösenordet är felaktigt.",
  "Auth.form.error.params.provide": "Felaktiga parametrar angivna.",
  "Auth.form.error.password.format":
    "Ditt lösenord får inte innehålla symbolen `$` mer än tre gånger.",
  "Auth.form.error.password.local":
    "Denna användare har inte ett lokalt lösenord, logga in via den tjänsten som användes när kontot skapades.",
  ...
  "Auth.form.password.hint":
    "Måste bestå av minst 8 tecken, en stor bokstav, en liten bokstav och en siffra",
  "Auth.form.password.show-password": "Visa lösenord",
  "Auth.form.register.news.label":
    "Håll mig uppdaterad om nya funktioner och förbättringar (genom att göra detta godkänner du {terms} och {policy}).",
  "Auth.form.register.subtitle":
    "Inloggningsuppgifter används bara för att logga in i Strapi. All data kommer att sparas i din databas.",
  ...
  "HomePage.welcome.congrats.content":
    "Du är inloggad som administratör. För att upptäcka de kraftfulla funktionerna från Strapi,",
  "HomePage.welcome.congrats.content.bold":
    "vi rekommenderar dig att skapa din första innehållstyp.",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "Några roller kunde inte tas bort eftersom de är kopplade till minst en användare",
  "Roles.ListPage.notification.delete-not-allowed":
    "En roll kan inte tas bort om den är kopplad till någon användare",
  ...
  "Roles.components.List.empty.withSearch":
    "Det finns inga roller som matchar sökningen ({search})...",
  ...
  "Settings.tokens.copy.lastWarning":
    "Kopiera denna token nu, den kommer inte visas igen!",
  "Settings.apiTokens.create": "Skapa en ny API-token",
  "Settings.apiTokens.description":
    "Lista över genererade tokens för att använda API:t",
  ...
  "Settings.apiTokens.createPage.permissions.description":
    "Endast åtgärder som är kopplade till en rutt listas nedan.",
  "Settings.tokens.RegenerateDialog.title": "Återställ token",
  "Settings.tokens.popUpWarning.message":
    "Är du säker på att du vill återställa denna token?",
  ...
  "Settings.application.customization.carousel-hint":
    "Ändra adminpanelens logotyp (Högsta upplösning: {dimension}x{dimension}, Största filstorlek: {size}KB)",
  ...
  "Settings.application.customization.modal.tab.label":
    "Hur vill du ladda dina mediefiler?",
  ...
  "Settings.application.customization.modal.upload.file-validation":
    "Högsta upplösning: {dimension}x{dimension}, Största filstorlek: {size}KB",
  "Settings.application.customization.modal.upload.error-format":
    "Fel format uppladdat (tillåtna format: jpeg, jpg, png, svg).",
  "Settings.application.customization.modal.upload.error-size":
    "Den uppladdade filen är för stor (Högsta upplösning: {dimension}x{dimension}, Största filstorlek: {size}KB)",
  ...
  "Settings.application.customization.modal.pending.title":
    "Loggan är redo att laddas upp",
  "Settings.application.customization.modal.pending.subtitle":
    "Ändra den valda loggan innan du laddar upp den",
  ...
  "Settings.permissions.category.plugins":
    "Behörighetsinställningar för {category}-plugin-programmet",
  ...
  "Settings.permissions.conditions.no-actions":
    "Du måste först välja åtgärder (skapa, läsa, uppdatera, ...) innan du definierar behörigheter för dem.",
  ...
  "Settings.permissions.select-all-by-permission":
    "Välj alla behörighet för {label}",
  ...
  "Settings.permissions.users.form.sso.description":
    "När aktivt (PÅ) kan användare logga in med SSO",
  "Settings.permissions.users.listview.header.subtitle":
    "Alla användare som har tillgång till Strapi-adminpanel",
  ...
  "Settings.profile.form.section.experience.clear.select":
    "Återställ det valda gränssnittsspråket",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "Detta kommer bara att visa ditt egna gränssnitt på det valda språket.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "Ändringar av inställningar kommer bara att gälla dig. Mer information finns {here}.",
  ...
  "Settings.sso.form.defaultRole.description":
    "Den kommer att koppla den nya inloggade användaren till den valda rollen",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "Du måste ha behörighet att läsa administratörsrollerna",
  "Settings.sso.form.defaultRole.label": "Standardroll",
  "Settings.sso.form.registration.description":
    "Skapa ny användare med SSO-inloggning om kontot saknas",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "Den här händelsen finns endast för innehåll med funktionen Utkast/Publicera aktiverat",
  ...
  "Users.components.List.empty.withFilters":
    "Det finns inga användare som matchar filtreringen...",
  "Users.components.List.empty.withSearch":
    "Det finns inga användare som matchar sökningen ({search})...",
  ...
  "admin.pages.MarketPlacePage.offline.subtitle":
    "Du måste vara ansluten till Internet för att komma åt Strapi-marknaden.",
  ...
  "admin.pages.MarketPlacePage.plugin.copy.success":
    "Installationskommandot redo att klistras in i din terminal",
  ...
  "admin.pages.MarketPlacePage.plugin.version.null":
    'Det går inte att verifiera kompatibiliteten med din Strapi-version: "{strapiAppVersion}"',
  "admin.pages.MarketPlacePage.plugin.githubStars":
    "Detta plugin stjärnmarkerades {starsCount} på GitHub",
  "admin.pages.MarketPlacePage.plugin.downloads":
    "Detta plugin har {downloadsCount} nedladdningar per vecka",
  "admin.pages.MarketPlacePage.providers": "Tjänster",
  "admin.pages.MarketPlacePage.provider.githubStars":
    "Den här leverantören stjärnmärktes med {starsCount} på GitHub",
  "admin.pages.MarketPlacePage.provider.downloads":
    "Denna tjänsten har {downloadsCount} nedladdningar per vecka",
  ...
  "admin.pages.MarketPlacePage.missingPlugin.description":
    "Berätta vilket plugin du letar efter så kan vi meddela våra plugin-utvecklare om de letar efter inspiration!",
  ...
  "admin.pages.MarketPlacePage.filters.collectionsSelected":
    "{count, plural, =0 {Inga samlingar valda} one {# samling vald} other {# samlingar valda}}",
  "admin.pages.MarketPlacePage.filters.categories": "Kategorier",
  "admin.pages.MarketPlacePage.filters.categoriesSelected":
    "{count, plural, =0 {Inga kategorier valda} one {# kategori vald} other {# kategorier valda}}",
  anErrorOccurred,
  ...
  "app.components.BlockLink.blog.content":
    "Läs de senaste nyheterna om Strapi och Strapi-ekosystemet.",
  "app.components.BlockLink.code": "Kodexempel",
  "app.components.BlockLink.code.content":
    "Lär dig genom att testa riktiga projekt som utvecklade av Strapi-communityn.",
  "app.components.BlockLink.documentation.content":
    "Upptäck de viktigaste koncepten, guiderna och instruktionerna.",
  "app.components.BlockLink.tutorial": "Guider",
  "app.components.BlockLink.tutorial.content":
    "Följ steg-för-steg-instruktionerna för att använda och anpassa Strapi.",
  ...
  "app.components.DownloadInfo.text":
    "Detta kan ta någon minut. Tack för ditt tålamod.",
  ...
  "app.components.EmptyStateLayout.content-permissions":
    "Du har inte behörighet att komma åt detta innehållet",
  "app.components.GuidedTour.CM.create.content":
    "<p>Skapa och hantera allt innehåll här i innehållshanteraren.</p><p>För att ta exemplet bloggwebbplats vidare kan man skriva en artikel, spara och publicera den som de vill.</p><p>💡 Tips - Glöm inte att trycka på publicera på det innehåll du skapar.</p>",
  "app.components.GuidedTour.CM.create.title": "⚡️ Skapa innehåll",
  "app.components.GuidedTour.CM.success.content":
    "<p>Perfekt, ett sista steg kvar!</p><b>🚀  Se ditt innehåll live</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    '<p>Samlingstyper hjälper dig att hantera flera poster, Engångstyper är lämpliga för att hantera bara en post.</p> <p>För en bloggwebbplats skulle "Artiklar" vara en samlingstyp medan en "Startsida" skulle vara en engångstyp.</p>',
  "app.components.GuidedTour.CTB.create.cta.title": "Skapa en samlingstyp",
  "app.components.GuidedTour.CTB.create.title":
    "🧠 Skapa din första samlingstyp",
  "app.components.GuidedTour.CTB.success.content":
    "<p>Bra jobbat!</p><b>⚡️ Vad skulle du vilja dela med dig till världen?</b>",
  "app.components.GuidedTour.CTB.success.title": "Steg 1: Avklarat ✅",
  "app.components.GuidedTour.apiTokens.create.content":
    "<p>Skapa en autentiseringstoken här och hämta innehållet du just skapat.</p>",
  ...
  "app.components.GuidedTour.home.CM.title":
    "⚡️ Vad skulle du vilja dela med dig till världen?",
  "app.components.GuidedTour.home.CTB.cta.title":
    "Gå till innehållstypsskaparen",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Vi är glada över att ha dig som en del av communityn. Vi letar ständigt efter feedback så skicka oss DM på ",
  "app.components.HomePage.welcomeBlock.content.again":
    "Vi hoppas att kommer framåt med ditt projekt... Läs gärna de senaste nyheterna om Strapi. Vi gör vårt bästa för att förbättra produkten baserat på din feedback.",
  ...
  "app.components.ImgPreview.hint":
    "Dra och släpp din fil i det här området eller {bläddra} efter en fil att ladda upp",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "Det kan ta några sekunder att avinstallera plugin-programmet.",
  "app.components.ListPluginsPage.deletePlugin.title": "Avinstallerar",
  "app.components.ListPluginsPage.description":
    "Lista över de installerade plugin-programmen i projektet.",
  ...
  "app.components.MarketplaceBanner":
    "Upptäck plugins som skapats av Strapi-communityn, och många fler fantastiska saker för att rivstarta ditt projekt, på Strapi Awesome.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "AutoReload-funktionen måste vara inaktiverad. Starta din app med `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Av säkerhetsskäl kan ett plugin bara laddas ner i en utvecklingsmiljö.",
  "app.components.PluginCard.PopUpWarning.install.impossible.title":
    "Nedladdning är inte möjlig",
  ...
  "app.components.Users.MagicLink.connect":
    "Kopiera och dela denna länk för att ge åtkomst till denna användare",
  "app.components.Users.MagicLink.connect.sso":
    "Skicka denna länk till användaren, den första inloggningen kan göras via en SSO-tjänst",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Ett fel inträffade vid avinstallation av pluginet",
  "app.containers.App.notification.error.init":
    "Ett fel uppstod när API:t begärdes",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "Om du inte får den här länken, kontakta din administratör.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "Det kan ta några minuter att få lösenordsåterställningslänken.",
  ...
  clearLabel,
  "coming.soon":
    "Det här innehållet är för närvarande under uppbyggnad och kommer tillbaka om några veckor!",
  "component.Input.error.validation.integer": "Värdet måste vara ett heltal",
  "components.AutoReloadBlocker.description":
    "Kör Strapi med ett av de följande kommandon:",
  "components.AutoReloadBlocker.header":
    "Reload-funktionen krävs för detta plugin.",
  ...
  "components.FilterOptions.FILTER_TYPES.$containsi":
    "innehåller (okänslig för skiftläge)",
  ...
  "components.FilterOptions.FILTER_TYPES.$startsWithi":
    "börjar med (okänslig för skiftläge)",
  ...
  "components.Input.error.validation.json":
    "Detta stämmer inte med JSON-formatet",
  "components.Input.error.validation.lowercase":
    "Värdet får bara bestå av små bokstäver",
  ...
  "components.OverlayBlocker.description":
    "Du använder en funktion som behöver servern att starta om. Vänta tills servern är igång.",
  "components.OverlayBlocker.description.serverError":
    "Servern borde ha startat om, kontrollera dina loggar i terminalen.",
  "components.OverlayBlocker.title": "Väntar på omstart...",
  "components.OverlayBlocker.title.serverError":
    "Omstarten tar längre tid än väntat",
  "components.PageFooter.select": "poster per sida",
  "components.ProductionBlocker.description":
    "För säkerhetsskäl måste vi inaktivera detta plugin i andra miljöer.",
  "components.ProductionBlocker.header":
    "Denna plugin är endast tillgänglig under utveckling.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Dra och släpp filer, klistra in från urklipp eller {bläddra}.",
  ...
  "content-manager.App.schemas.data-loaded": "Scheman har lästs in",
  ...
  "content-manager.ListViewTable.relation-more":
    "Denna relation innehåller mer data än vad som visas",
  ...
  "content-manager.components.DraggableAttr.edit": "Klicka för att redigera",
  ...
  "content-manager.components.ListViewTable.row-line": "artikelrad {nummer}",
  ...
  "content-manager.components.DynamicZone.missing-components":
    "Det {number, plural, =0 {# saknas komponenter} one {# saknas en komponent} other {are # saknas komponenter}}",
  "content-manager.components.DynamicZone.move-down-label":
    "Flytta ned komponenten",
  "content-manager.components.DynamicZone.move-up-label":
    "Flytta upp komponenten",
  ...
  "content-manager.components.FilterOptions.button.apply": "Verkställ",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Ställ in de villkor som ska gälla för att filtrera posterna",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "Filter",
  "content-manager.components.FiltersPickWrapper.hide": "Göm",
  ...
  "content-manager.components.LeftMenu.single-types": "Engångstyper",
  "content-manager.components.LimitSelect.itemsPerPage": "Objekt per sida",
  ...
  "content-manager.components.RepeatableComponent.error-message":
    "Komponenten/komponenterna innehåller fel",
  ...
  "content-manager.components.Select.publish-info-title": "Status: Publicerat",
  ...
  "content-manager.components.TableDelete.delete": "Ta bort allt",
  "content-manager.components.TableDelete.deleteSelected": "Ta bort valda",
  ...
  "content-manager.components.TableEmpty.withFilters":
    "Det finns inga {contentType} med de valda filtren...",
  ...
  "content-manager.components.empty-repeatable":
    "Inga poster än. Klicka på knappen nedan för att lägga till en.",
  ...
  "content-manager.components.repeatable.reorder.error":
    "Ett fel uppstod när du ändrade ordningen på komponentens fält, försök igen",
  "content-manager.components.reset-entry": "Återställ posten",
  "content-manager.components.uid.apply": "verkställ",
  "content-manager.components.uid.available": "Tillgänglig",
  "content-manager.components.uid.regenerate": "Återgenerera",
  "content-manager.components.uid.suggested": "föreslaget",
  "content-manager.components.uid.unavailable": "Otillgänglig",
  ...
  "content-manager.containers.Edit.clickToJump":
    "Klicka för att gå till posten",
  "content-manager.containers.Edit.delete": "Ta bort",
  "content-manager.containers.Edit.delete-entry": "Ta bort denna posten",
  ...
  "content-manager.containers.Edit.information.draftVersion": "utkastsversion",
  ...
  "content-manager.containers.Home.introduction":
    "För att redigera dina poster gå till postens länk i vänstermenyn. Detta plugin har inte ett fungerande sätt att redigera inställningar och är fortfarande under aktiv utveckling.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Hantera poster genom ett kraftfullt och vackert gränssnitt.",
  "content-manager.containers.Home.pluginHeaderTitle": "Innehållshanteraren",
  ...
  "content-manager.containers.SettingPage.editSettings.description":
    "Dra och släpp fälten för att skapa layouten",
  ...
  "content-manager.containers.SettingsPage.Block.contentType.description":
    "Konfigurera de specificerade inställningarna",
  ...
  "content-manager.emptyAttributes.description":
    "Lägg till ditt första fält i din samlingstyp",
  ...
  "content-manager.error.attribute.sameKeyAndName": "Måste vara unika",
  ...
  "content-manager.error.model.fetch":
    "Ett fel inträffade under hämtning av modellkonfigurationen.",
  "content-manager.error.record.create":
    "Ett fel uppstod under skapandet av posten.",
  "content-manager.error.record.delete":
    "Ett fel uppstod under raderingen av posten.",
  "content-manager.error.record.fetch": "Ett fel uppstod under posthämtningen.",
  "content-manager.error.record.update": "Ett fel uppstod under poständringen.",
  "content-manager.error.records.count":
    "Ett fel uppstod under räkning av posthämtningen",
  "content-manager.error.records.fetch":
    "Ett fel uppstod under hämtning av poster.",
  "content-manager.error.schema.generation":
    "Ett fel uppstod under schemagenerering.",
  "content-manager.error.validation.json": "Det här är inte JSON",
  "content-manager.error.validation.max": "Värdet är för högt.",
  "content-manager.error.validation.maxLength": "Värdet är för långt.",
  "content-manager.error.validation.min": "Värdet är för lågt.",
  "content-manager.error.validation.minLength": "Värdet är för kort.",
  "content-manager.error.validation.minSupMax": "Kan inte vara överstigande",
  "content-manager.error.validation.regex": "Värdet matchar inte regexet.",
  "content-manager.error.validation.required": "Detta inputvärde krävs.",
  "content-manager.form.Input.bulkActions": "Aktivera massåtgärder",
  "content-manager.form.Input.defaultSort": "Standardsorteringsattribut",
  "content-manager.form.Input.description": "Beskrivning",
  "content-manager.form.Input.description.placeholder": "Visa namn i profilen",
  ...
  "content-manager.form.Input.label.inputDescription":
    "Detta värde överskrider etiketten som visas i tabellhuvudet",
  "content-manager.form.Input.pageEntries": "Poster per sida",
  "content-manager.form.Input.pageEntries.inputDescription":
    "Obs! Du kan överskrida det här värdet på inställningssidan för samlingstypen.",
  ...
  "content-manager.form.Input.search.field":
    "Aktivera sökning av det här fältet",
  "content-manager.form.Input.sort.field":
    "Aktivera sortering av det här fältet",
  "content-manager.form.Input.sort.order": "Standardsorteringsordning",
  ...
  "content-manager.notification.error.displayedFields":
    "Du behöver minst ett fält som visas upp",
  "content-manager.notification.error.relationship.fetch":
    "Ett fel uppstod under relationshämtning.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Du måste ha ett attribut med sortering tillåtet",
  "content-manager.notification.info.minimumFields":
    "Du måste ha minst ett fält uppvisat",
  "content-manager.notification.upload.error":
    "Ett fel uppstod när dina filer laddades upp",
  "content-manager.pageNotFound": "Sidan hittas inte",
  "content-manager.pages.ListView.header-subtitle":
    "{number, plural, =0 {# poster} one {# post} other {# poster}} hittade",
  "content-manager.pages.NoContentType.button": "Skapa din första innehållstyp",
  "content-manager.pages.NoContentType.text":
    "Du har inget innehåll än, vi föreslår att du skapar din första innehållstyp.",
  "content-manager.permissions.not-allowed.create":
    "Du får inte skapa ett dokument",
  "content-manager.permissions.not-allowed.update":
    "Du får inte se detta dokument",
  "content-manager.plugin.description.long":
    "Snabbt sätt att se, redigera och ta bort data i din databas.",
  "content-manager.plugin.description.short":
    "Snabbt sätt att se, redigera och ta bort data i din databas.",
  "content-manager.popover.display-relations.label": "Visa relationer",
  "content-manager.select.currently.selected": "{count} valda",
  "content-manager.success.record.delete": "Borttagna",
  "content-manager.success.record.publish": "Publicerade",
  ...
  "content-manager.utils.data-loaded":
    "{number, plural, =1 {Posten} other {Posterna}} har laddats",
  ...
  "content-manager.popUpwarning.warning.has-draft-relations.message":
    "<b>{count, plural, =0 { av dina innehållsrelationer är} one { av dina innehållsrelationer är} other { av dina innehållsrelationer är}}</b> inte publicerade ännu.<br></br>Det kan skapa trasiga länkar och fel i ditt projekt.",
  ...
  "global.plugins.content-type-builder.description":
    "Modellera datastrukturen för ditt API. Skapa nya fält och relationer snabbt. Filerna skapas och uppdateras automatiskt i ditt projekt.",
  ...
  "global.plugins.graphql.description":
    "Lägger till GraphQL-endpoint med standard-API-metoder.",
  "global.plugins.documentation": "Dokumentation",
  "global.plugins.documentation.description":
    "Skapa ett OpenAPI-dokument och visualisera ditt API med SWAGGER UI.",
  "global.plugins.i18n": "Internationalisering",
  "global.plugins.i18n.description":
    "Denna plugin gör det möjligt att skapa, läsa och uppdatera innehåll på olika språk, både från adminpanelen och från API:et.",
  ...
  "global.plugins.users-permissions.description":
    "Skydda ditt API med en autentiseringsprocess baserad på JWT. Detta plugin kommer också med ACL som låter dig hantera behörigheterna mellan användargrupperna.",
  "global.profile": "Profil",
  "global.prompt.unsaved":
    "Är du säker på att du vill lämna den här sidan? Alla dina ändringar kommer att gå förlorade",
  ...
  "notification.contentType.relations.conflict":
    "Innehållstypen har inkompatibla relationer",
  ...
  "notification.error.tokennamenotunique":
    "Namnet används redan av en annan token",
...
//# sourceMappingURL=sv-SHJ67uau.mjs.map
