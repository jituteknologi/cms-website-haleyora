...
const ListView = () => {
  ...
  React__namespace.useEffect(() => {
    push({
      search: qs__default.default.stringify(
        { sort: "name:ASC" },
        { encode: false }
      ),
    });
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.ContentLayout, {
        children: [
          ...
          canRead &&
            transferTokens$1.length > 0 &&
            /* @__PURE__ */ jsxRuntime.jsx(Table.Table, {
          ...
          canRead &&
            canCreate &&
            transferTokens$1.length === 0 &&
            /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.NoContent, {
              content: {
...
//# sourceMappingURL=ListView-GZj1TPXW.js.map
