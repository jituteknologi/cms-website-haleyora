...
import {
  A as ACTION_SET_WORKFLOW,
  c as ACTION_SET_WORKFLOWS,
  d as ACTION_ADD_STAGE,
  e as ACTION_RESET_WORKFLOW,
  f as ACTION_SET_CONTENT_TYPES,
  g as ACTION_SET_ROLES,
  h as ACTION_SET_IS_LOADING,
  i as ACTION_UPDATE_WORKFLOW,
  j as ACTION_CLONE_STAGE,
  k as ACTION_DELETE_STAGE,
  l as ACTION_UPDATE_STAGE,
  m as ACTION_UPDATE_STAGES,
  n as ACTION_UPDATE_STAGE_POSITION,
  b as STAGE_COLOR_DEFAULT,
  R as REDUX_NAMESPACE,
  D as DRAG_DROP_TYPES,
} from "./constants-8sAt6dKz.mjs";
import {
  a as getAvailableStageColors,
  g as getStageColorByHex,
} from "./colors-YeFa2BnS.mjs";
...
const selectServerState = createSelector(
  selectNamespace,
...
const Stage = ({
  ...
  const [colorField, colorMeta, colorHelper] = useField(
    `stages.${index}.color`
  );
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx(ConfirmDialog.Root, {
        ...
        children: /* @__PURE__ */ jsx(ConfirmDialog.Body, {
                          ...
                          children: /* @__PURE__ */ jsx(Typography, {
                            ...
                            children: formatMessage(
                              ...
                              },
                              {
                                ...
                                i: (...children) =>
                                  /* @__PURE__ */ jsx(ContentTypeTakeNotice, {
                                    children,
                                  }),
                              }
                            ),
  ...
  try {
    ...
    if (error instanceof yup.ValidationError) {
      error.inner.forEach((error2) => {
        if (error2.path) set(errors, error2.path, error2.message);
      });
    }
    return errors;
  }
...
//# sourceMappingURL=validateWorkflow-cqSZZDgN.mjs.map
