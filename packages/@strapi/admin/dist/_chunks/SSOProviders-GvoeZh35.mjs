...
const SSOProviders = ({ providers, displayAllProviders }) => {
    ...
    return /* @__PURE__ */ jsx(Grid, {
      ...
      children: providers.map((provider) =>
        /* @__PURE__ */ jsx(
          ...
          {
            col: 4,
            children: /* @__PURE__ */ jsx(SSOProviderButton, { provider }),
          },
          provider.uid
        )
      ),
  ...
  return /* @__PURE__ */ jsx(SSOProvidersWrapper, {
    ...
    children: providers.map((provider) =>
      /* @__PURE__ */ jsx(SSOProviderButton, { provider }, provider.uid)
    ),
  });
};
  ...
  return /* @__PURE__ */ jsx(Tooltip, {
    ...
    children: /* @__PURE__ */ jsx(SSOButton, {
      ...
      children: provider.icon
        ...
        : /* @__PURE__ */ jsx(Typography, { children: provider.displayName }),
    }),
  });
};
...
//# sourceMappingURL=SSOProviders-GvoeZh35.mjs.map
