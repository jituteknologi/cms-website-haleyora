...
import {
  p as useEnterprise,
  H as useCreateUserMutation,
  x as isBaseQueryError,
  j as useTypedSelector,
  k as useAdminUsers,
  J as useDeleteManyUsersMutation,
...
import { M as MagicLinkCE, S as SelectRoles } from "./SelectRoles-Q7FxAHaJ.mjs";
import { g as getFullName } from "./AuthenticatedApp-V2Dm6x5Q.mjs";
...
import "./useAdminRoles-1eHA6jB7.mjs";
...
const ModalForm = ({ onToggle }) => {
  ...
  const MagicLink = useEnterprise(
    MagicLinkCE,
    async () => (await import("./MagicLinkEE-xTlGsx4K.mjs")).MagicLinkEE
  );
            ...
            children: [
              /* @__PURE__ */ jsx(ModalBody, {
                children: /* @__PURE__ */ jsxs(Flex, {
                  ...
                  children: [
                    currentStep !== "create" &&
                      /* @__PURE__ */ jsx(MagicLink, { registrationToken }),
                    /* @__PURE__ */ jsxs(Box, {
                      children: [
...
const ListPageCE = () => {
  ...
  const CreateAction = useEnterprise(
    CreateActionCE,
    async () => (await import("./CreateActionEE-Gpsnkp99.mjs")).CreateActionEE
  );
  ...
  return /* @__PURE__ */ jsxs(Main, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx(HeaderLayout, {
        primaryAction:
          canCreate &&
          /* @__PURE__ */ jsx(CreateAction, { onClick: handleToggle }),
        title,
      ...
      /* @__PURE__ */ jsxs(ContentLayout, {
        children: [
          ...
          isError &&
            /* @__PURE__ */ jsx("div", { children: "TODO: An error occurred" }),
          canRead &&
            /* @__PURE__ */ jsxs(Fragment, {
              children: [
                /* @__PURE__ */ jsx(DynamicTable, {
                  contentType: "Users",
                  isLoading,
      ...
      isModalOpened &&
        /* @__PURE__ */ jsx(ModalForm, { onToggle: handleToggle }),
    ],
  });
};
const TABLE_HEADERS = [
...
const ListPage = () => {
  const UsersListPage = useEnterprise(
    ...
    async () =>
      ...
      (await import("./ListPage-R8Mv7jb0.mjs")).UserListPageEE
  );
  if (!UsersListPage) {
    return null;
  }
...
//# sourceMappingURL=ListPage-zcELnM0p.mjs.map
