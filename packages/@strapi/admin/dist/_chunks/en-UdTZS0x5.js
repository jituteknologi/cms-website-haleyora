...
const en = {
  ...
  "HomePage.welcome.congrats.content":
    "You are logged in as the first administrator. To discover the powerful features provided by Strapi,",
  ...
  "admin.pages.MarketPlacePage.tab-group.label":
    "Plugins and Providers for Strapi",
  anErrorOccurred,
  ...
  "app.components.MarketplaceBanner":
    "Discover plugins built by the community, and many more awesome things to kickstart your project, on Strapi Marketplace.",
  ...
  "content-manager.containers.ListPage.autoCloneModal.title":
    "This entry can't be duplicated directly.",
  ...
  "content-manager.containers.ListPage.autoCloneModal.error.unique":
    "Identical values in a unique field are not allowed.",
  "content-manager.containers.ListPage.autoCloneModal.error.relation":
    "Duplicating the relation could remove it from the original entry.",
