...
const pt = {
  ...
  "Auth.form.error.email.provide":
    "Por favor, preenche com o nome de utilizador ou email.",
  ...
  "Auth.form.error.password.format":
    "A sua palavra-passe não pode conter o símbolo `$` mais do que 3 vezes.",
  "Auth.form.error.password.local":
    "Este utilizador nunca definiu uma palavra-passe local, por favor, faz login pelo serviço utilizado durante a criação da conta.",
  ...
  "Auth.form.error.ratelimit":
    "Demasiadas tentativas, por favor, tenta novamente daqui a um minuto.",
  ...
  "Auth.form.register.news.label":
    "Manter-me atualizado sobre novas funcionalidades e futuras melhorias (ao fazê-lo, estás a aceitar os {terms} e a {policy}).",
  ...
  "HomePage.welcome.congrats.content":
    "Iniciaste sessão como o primeiro administrador. Para descobrires as poderosas funcionalidades do Strapi,",
  "HomePage.welcome.congrats.content.bold":
    "recomendamos que cries o teu primeiro modelo.",
  "New entry": "Novo item",
  Password,
  Provider,
  ResetPasswordToken,
  ...
  "Settings.webhooks.list.description":
    "Obtém notificações POST de alterações.",
  "Settings.webhooks.list.empty.description":
    "Adiciona o teu primeiro webhook a esta lista.",
  ...
  "app.components.HomePage.community.content":
    "Conversa com membros da equipa, contribuidores e desenvolvedores através de diferentes canais.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Estamos felizes em ter-te como um dos membros da comunidade. Estamos constantemente à procura de feedback, por isso sente-te à vontade para nos enviares uma mensagem em privado no ",
  "app.components.HomePage.welcomeBlock.content.again":
    "Esperamos que estejas a progredir no teu projeto... Sente-te à vontade em ler as nossas últimas publicações sobre o Strapi. Estamos a dar o nosso melhor para melhorar o produto, baseando-nos no teu feedback.",
  ...
  "app.components.ImgPreview.hint":
    "Arraste & solte o seu ficheiro nesta área ou {browse} um ficheiro para o carregar",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "A funcionalidade autoReload precisa de estar ligada. Por favor, inicia a tua aplicação com `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Por questões de segurança, um plugin só pode ser descarregado num ambiente de desenvolvimento.",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Ocorreu um erro ao desinstalar a extensão",
  "app.containers.App.notification.error.init":
    "Ocorreu um erro ao efetuar um pedido para a API",
  ...
  "component.Input.error.validation.integer":
    "Este valor precisa de ser um número inteiro",
  "components.AutoReloadBlocker.description":
    "Inicia o Strapi com um dos seguintes comandos:",
  "components.AutoReloadBlocker.header":
    "A funcionalidade autoReload é necessária para esta extensão.",
  ...
  "components.Input.error.attribute.taken":
    "Já existe um atributo com este nome",
  "components.Input.error.contentTypeName.taken":
    "Já existe um tipo de conteúdo com este nome",
  ...
  "components.OverlayBlocker.description":
    "Estás a usar uma funcionalidade que precisa que o servidor seja reiniciado. Por favor, aguarda até que o servidor esteja totalmente reiniciado.",
  "components.OverlayBlocker.description.serverError":
    "O servidor já deveria ter reiniciado. Por favor verifica os logs no terminal.",
  "components.OverlayBlocker.title": "A aguardar pela reinicialização...",
  "components.OverlayBlocker.title.serverError":
    "A reinicialização está a demorar mais do que o esperado",
  "components.PageFooter.select": "itens por página",
  "components.ProductionBlocker.description":
    "Por motivos de segurança, temos que desativar esta extensão noutros ambientes.",
  "components.ProductionBlocker.header":
    "Esta extensão está disponível apenas em ambiente de desenvolvimento.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Arrasta e solta ficheiros, cola da área de transferência ou {browse}.",
  "components.WysiwygBottomControls.uploadFiles.browse": "selecione-os",
  "components.popUpWarning.message":
    "Tens a certeza que pretendes apagar isto?",
  ...
  "content-manager.components.EmptyAttributesBlock.button":
    "Ir para a página de configurações",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Definir as condições a serem aplicadas para filtrar as entradas",
  ...
  "content-manager.components.LimitSelect.itemsPerPage": "Itens por página",
  "content-manager.components.Search.placeholder":
    "Procurar por uma entrada...",
  "content-manager.components.TableDelete.delete": "Apagar tudo",
  "content-manager.components.TableDelete.deleteSelected":
    "Excluir selecionado",
  "content-manager.components.TableEmpty.withFilters":
    "Não há {contentType} com os filtros aplicados...",
  "content-manager.components.TableEmpty.withSearch":
    "Não há {contentType} correspondente à pesquisa ({search})...",
  "content-manager.components.TableEmpty.withoutFilter":
    "Não há {contentType}...",
  "content-manager.containers.Edit.addAnItem": "Adicionar uma entrada...",
  "content-manager.containers.Edit.clickToJump":
    "Clique para saltar para a entrada",
  "content-manager.containers.Edit.delete": "Apagar",
  "content-manager.containers.Edit.editing": "Editando...",
  "content-manager.containers.Edit.reset": "Restabelecer",
  ...
  "content-manager.containers.Home.introduction":
    "Para editar suas entradas, acesse o link específico no menu à esquerda. Esta extensão não tem uma maneira correcta de editar configurações e ainda está em desenvolvimento activo.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Administre as suas entradas através de uma interface poderosa e bonita.",
  "content-manager.containers.Home.pluginHeaderTitle": "Gestor de conteúdos",
  "content-manager.containers.List.errorFetchRecords": "Erro",
  "content-manager.containers.ListPage.displayedFields": "Campos visíveis",
  ...
  "content-manager.error.model.fetch":
    "Ocorreu um erro durante a configuração dos modelos de pesquisa.",
  "content-manager.error.record.create":
    "Ocorreu um erro durante a criação de registo.",
  "content-manager.error.record.delete":
    "Ocorreu um erro durante a exclusão do registo.",
  "content-manager.error.record.fetch":
    "Ocorreu um erro durante o registo de pesquisa.",
  "content-manager.error.record.update":
    "Ocorreu um erro durante a actualização do registo.",
  "content-manager.error.records.count":
    "Ocorreu um erro durante a contagem de registos a pesquisar.",
  "content-manager.error.records.fetch":
    "Ocorreu um erro durante os registos de busca.",
  "content-manager.error.schema.generation":
    "Ocorreu um erro durante a geração de esquemas.",
  ...
  "content-manager.error.validation.maxLength": "O valor é muito longo.",
  ...
  "content-manager.error.validation.required":
    "O valor desta entrada é obrigatória.",
  "content-manager.form.Input.bulkActions": "Activar acções em massa",
  "content-manager.form.Input.defaultSort": "Ordenação por defeito",
  "content-manager.form.Input.description": "Descrição",
  "content-manager.form.Input.description.placeholder":
    "Nome a exibir no perfil",
  "content-manager.form.Input.editable": "Campo editável",
  "content-manager.form.Input.filters": "Activar filtros",
  "content-manager.form.Input.label": "Legenda",
  "content-manager.form.Input.label.inputDescription":
    "Este valor sobrepõe a legenda visível no cabeçalho da tabela",
  "content-manager.form.Input.pageEntries": "Entradas por página",
  "content-manager.form.Input.placeholder": "Preenchimento",
  "content-manager.form.Input.placeholder.placeholder":
    "O meu valor espetacular",
  "content-manager.form.Input.search": "Activar pesquisa",
  "content-manager.form.Input.search.field": "Active a pesquisa neste campo",
  "content-manager.form.Input.sort.field": "Active a ordenação neste campo",
  "content-manager.notification.error.displayedFields":
    "Precisa de ter pelo menos um campo visível",
  "content-manager.notification.error.relationship.fetch":
    "Ocorreu um erro durante a pesquisa da relação.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Precisa de ter pelo menos um atributo com ordenação activa",
  "content-manager.pageNotFound": "Página não encontrada",
  "content-manager.plugin.description.long":
    "Maneira rápida de ver, editar e excluir os dados da sua base de dados.",
  ...
  "content-manager.popUpWarning.bodyMessage.contentType.delete.all":
    "Tem a certeza de que pretende apagar estas entradas?",
  "content-manager.popUpWarning.warning.cancelAllSettings":
    "Tem a certeza de que quer cancelar as alterações?",
  "content-manager.popUpWarning.warning.updateAllSettings":
    "Isto vai alterar todas as suas configurações",
  "content-manager.success.record.delete": "Apagado",
  "content-manager.success.record.save": "Guardado",
  "form.button.done": "Concluir",
  "global.prompt.unsaved":
    "Tens a certeza que queres sair desta página? Todas as tuas modificações serão perdidas",
  "notification.contentType.relations.conflict":
    "O tipo de conteúdo tem relações que entram em conflito",
...
//# sourceMappingURL=pt-TrdDLCZ4.mjs.map
