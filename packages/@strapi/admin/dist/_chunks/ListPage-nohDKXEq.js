...
const ListPage = () => {
  ...
  const permissions = index.useTypedSelector(
    (state) => state.admin_app.permissions.settings?.webhooks
  );
  ...
  const selectOneCheckbox = (selected, id) =>
    selected
      ...
      : setWebhooksToDelete((prev) =>
          prev.filter((webhookId) => webhookId !== id)
        );
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, {
        ...
        children: [
          ...
          webhooksToDeleteLength > 0 &&
            canDelete &&
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.ActionLayout, {
              startActions: /* @__PURE__ */ jsxRuntime.jsxs(
                jsxRuntime.Fragment,
                {
                  children: [
                              ...
                              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, {
                                ...
                                children: /* @__PURE__ */ jsxRuntime.jsx(
                                  designSystem.BaseCheckbox,
                                  {
                                    ...
                                    value: webhooksToDelete?.includes(
                                      webhook.id
                                    ),
                                    onValueChange: (selected) =>
                                      selectOneCheckbox(selected, webhook.id),
                                    name: "select",
                                  }
                                ),
                              }),
...
//# sourceMappingURL=ListPage-nohDKXEq.js.map
