...
const PROFILE_VALIDTION_SCHEMA = yup__namespace.object().shape({
  ...
  currentPassword: yup__namespace
    .string()
    .when(
      ["password", "confirmPassword"],
      (password, confirmPassword, passSchema) => {
        return password || confirmPassword
          ? passSchema.required(helperPlugin.translatedErrors.required)
          : passSchema;
      }
    ),
...
const ProfilePage = () => {
  const localeNames = index.useTypedSelector(
  ...
  const currentTheme = index.useTypedSelector(
  ...
  const [updateMe, { isLoading: isSubmittingForm }] =
    index.useUpdateMeMutation();
  const {
    isLoading,
    data: dataSSO,
    error,
          ...
          return /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Form, {
            children: [
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
                title:
                  username2 ||
                  AuthenticatedApp.getFullName(firstname2 ?? "", lastname2),
                    ...
                    children: /* @__PURE__ */ jsxRuntime.jsxs(
                      designSystem.Flex,
                      {
                        ...
                        children: [
                          ...
                          !hasLockedRole &&
                            /* @__PURE__ */ jsxRuntime.jsx(PasswordSection, {
                              errors,
                              onChange: handleChange,
...
const PasswordSection = ({ errors, onChange, values }) => {
  const { formatMessage } = reactIntl.useIntl();
  const [currentPasswordShown, setCurrentPasswordShown] =
    ...
    children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, {
          gap: 5,
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
            s: 12,
            col: 6,
        ...
        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
              s: 12,
              col: 6,
              children: /* @__PURE__ */ jsxRuntime.jsx(PasswordInput, {
...
const PreferencesSection = ({ onChange, values, localeNames }) => {
  const { formatMessage } = reactIntl.useIntl();
  const themesToDisplay = index.useTypedSelector(
    (state) => state.admin_app.theme.availableThemes
  );
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    background: "neutral0",
    hasRadius: true,
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(
                designSystem.SingleSelect,
                {
                  ...
                  children: Object.entries(localeNames).map(
                    ([language, langName]) =>
                      /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.SingleSelectOption,
                        { value: language, children: langName },
                        language
                      )
                  ),
                }
                          ...
                          children: formatMessage(
                            ...
                            },
                            {
                              name: formatMessage({
                                id: theme,
                                defaultMessage:
                                  upperFirst__default.default(theme),
                              }),
                            }
                          ),
                        },
...
//# sourceMappingURL=ProfilePage-m9T_jYzt.js.map
