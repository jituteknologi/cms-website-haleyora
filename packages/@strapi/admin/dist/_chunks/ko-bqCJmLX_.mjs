const Analytics = "통계";
const Documentation = "도큐멘테이션";
const Email = "이메일";
const Password = "비밀번호";
const Provider = "프로바이더(provider)";
const ResetPasswordToken = "비밀번호 토큰 재설정";
const Role = "역할";
const Username = "사용자 이름(Username)";
const Users = "사용자";
const anErrorOccurred = "에러가 발생했습니다. 잠시 후에 다시 시도해주세요.";
const clearLabel = "초기화";
const or = "또는";
const skipToContent = "콘텐츠로 건너뛰기";
const submit = "등록";
const ko = {
  Analytics,
  "Auth.components.Oops.text": "계정이 정지되었습니다.",
  "Auth.components.Oops.text.admin":
    "오류가 있는 경우 관리자에게 문의해주세요.",
  ...
  "Auth.form.error.password.format":
    "비밀번호에 `$` 문자를 세 번 이상 포함 할 수 없습니다.",
  "Auth.form.error.password.local":
    "비밀번호를 설정하지 않았습니다. 다른 방법으로 로그인 하세요.",
  ...
  "Auth.form.password.hint":
    "암호는 대문자 1자, 소문자 1자, 숫자 1자를 포함한 8자 이상의 문자를 입력해주세요.",
  "Auth.form.password.show-password": "비밀번호 표시",
  "Auth.form.register.news.label":
    "새 기능과 향후 개선 사항에 대한 최신 정보를 계속 제공해주세요 (선택시 {terms}과 {policy}에 동의하는 걸로 간주됩니다).",
  "Auth.form.register.subtitle":
    "인증 정보는 관리자 패널에서 자신을 인증하는 데만 사용됩니다. 저장된 모든 데이터는 사용자의 데이터베이스에 저장됩니다.",
  ...
  "HomePage.welcome.congrats.content":
    "첫번째 관리자로 로그인하셨습니다. Strapi의 강력한 기능을 확인하시려면,",
  ...
  "Settings.permissions.users.listview.header.subtitle":
    "{number, plural, =0 {# 명} one {# 명} other {# 명}}의 사용자를 찾았습니다.",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "선택한 언어로 인터페이스의 언어가 변경됩니다.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "선택하면 이 계정에서만 인터페이스 언어가 변경됩니다. 팀에서 다른 언어를 사용할 수 있도록 하려면 이 {documentation}를 참조해주세요.",
  ...
  "Settings.roles.form.button.users-with-role":
    "{number, plural, =0 {# 명} one {# 명} other {# 명}}의 사용자가 이 역할을 가지고 있습니다.",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "이 이벤트는 초안/발행 시스템이 활성화된 콘텐츠에 대해서만 존재합니다.",
  ...
  "Settings.webhooks.to.delete":
    "{webhooksToDeleteLength, plural, one {# 개의 에셋이} other {# 개의 에셋이}} 선택됨",
  ...
  "Users.components.List.empty.withFilters":
    "적용된 필터와 일치하는 사용자가 없습니다.",
  "Users.components.List.empty.withSearch":
    "({search}) 검색 결과와 일치하는 사용자가 없습니다.",
  ...
  "app.components.HomePage.community.content":
    "다양한 채널에서 Strapi 팀원, 콘트리뷰터 및 개발자들과 토론해보세요.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "축하드립니다! 첫 번째 관리자로 로그인하셨습니다. Strapi가 제공하는 강력한 기능을 알아보려면 첫 번째 콘텐츠 유형을 만들어보세요!",
  "app.components.HomePage.welcomeBlock.content.again":
    "Strapi에 대한 최신 뉴스를 자유롭게 읽어보세요. 저희는 여러분의 피드백을 바탕으로 제품을 개선하기 위해 최선을 다하고 있습니다.",
  ...
  "app.components.MarketplaceBanner":
    "Discover plugins built by the community, and many more awesome things to kickstart your project, on Strapi Awesome.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "autoReload 기능을 사용하지 않도록 설정해야 합니다. `yarn develop`로 앱을 시작하세요.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "보안상의 이유로 개발 환경에서만 플러그인을 다운로드할 수 있습니다.",
  ...
  "app.components.Users.MagicLink.connect":
    "이 링크를 가입할 사용자에게 보내주세요.",
  "app.components.Users.MagicLink.connect.sso":
    "이 링크를 가입할 사용자에게 보내주세요. SSO 프로바이더를 통해 처음 로그인할 수 있습니다.",
  ...
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "링크를 받지 못했다면 관리자에게 문의해주세요.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "비밀번호 복구 링크를 받는 데 몇 분 정도 걸릴 수 있습니다.",
  ...
  "components.AutoReloadBlocker.description":
    "다음 명령어 중 하나를 사용하여 Strapi를 실행합니다:",
  "components.AutoReloadBlocker.header":
    "이 플러그인은 리로드 기능이 필요합니다.",
  ...
  "components.Input.error.contain.lowercase":
    "비밀번호는 소문자 하나를 반드시 포함해야 합니다.",
  "components.Input.error.contain.number":
    "비밀번호는 숫자 하나를 반드시 포함해야 합니다.",
  "components.Input.error.contain.uppercase":
    "비밀번호는 대문자 하나를 반드시 포함해야 합니다.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "파일을 끌어 놓으세요. 혹은 클립보드에서 붙혀넣거나 {browse} 하세요.",
  ...
  "content-manager.ListViewTable.relation-loaded": "릴레이션을 불러왔습니다.",
  ...
  "content-manager.components.DynamicZone.missing-components":
    "{number, plural, =0 {# 개} one {is # 개} other {are # 개}}의 누락된 컴포넌트가 있습니다.",
  ...
  "content-manager.components.notification.info.minimum-requirement":
    "최소 요구 사항과 일치하도록 필드가 추가되었습니다.",
  "content-manager.components.repeatable.reorder.error":
    "컴포넌트 필드를 재정렬하는 중에 오류가 발생했습니다. 다시 시도하십시오.",
  ...
  "content-manager.containers.Home.introduction":
    "항목을 수정하려면 왼편 링크를 클릭하세요. 이 플러그인은 설정을 편집할 수 있는 방법을 개발 중입니다.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "쉽고 강력한 UI를 통해 항목들을 관리 하세요.",
  ...
  "content-manager.containers.SettingPage.editSettings.relation-field.description":
    "편집 및 목록 보기 화면에 모두 표시되는 필드를 설정합니다.",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "모든 콘텐츠 타입 및 그룹에 대한 설정을 구성합니다.",
  "content-manager.containers.SettingsView.list.subtitle":
    "콘텐츠 타입 및 그룹의 레이아웃과 표시를 구성합니다.",
  ...
  "content-manager.utils.data-loaded":
    "The {number, plural, =1 {개} other {개}}의 항목을 불러왔습니다.",
  ...
  "global.prompt.unsaved":
    "이 페이지를 떠나시겠습니까? 모든 변경 사항이 없어집니다.",
  "notification.contentType.relations.conflict":
    "콘텐츠 타입에 충돌하는 릴레이션(conflict relation)이 있습니다.",
...
//# sourceMappingURL=ko-bqCJmLX_.mjs.map
