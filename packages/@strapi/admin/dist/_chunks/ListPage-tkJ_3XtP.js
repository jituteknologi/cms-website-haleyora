...
const Modal = ({ handleClose, logId }) => {
  ...
  const formattedDate =
    data && "date" in data ? formatTimeStamp(data.date) : "";
...
const ComboboxFilter = (
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Combobox, {
    ...
    value,
    onChange,
    children: options?.map(({ label, customValue }) => {
      return /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.ComboboxOption,
        { value: customValue, children: label },
        customValue
      );
    }),
  });
...
const ListPage = () => {
  ...
  const permissions = index.useTypedSelector(
    (state) => state.admin_app.permissions.settings
  );
  const {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Main, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.ActionLayout, {
        startActions: /* @__PURE__ */ jsxRuntime.jsx(Filters.Filters, {
          displayedFilters,
        }),
      }),
      ...
      query?.id &&
        /* @__PURE__ */ jsxRuntime.jsx(Modal, {
          handleClose: () => setQuery({ id: null }, "remove"),
          logId: query.id,
        }),
    ],
  });
...
//# sourceMappingURL=ListPage-tkJ_3XtP.js.map
