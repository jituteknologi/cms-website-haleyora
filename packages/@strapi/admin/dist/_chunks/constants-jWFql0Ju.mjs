...
import { a as useAuth } from "./index-qQynS5yD.mjs";
...
const SETTINGS_LINKS_EE = () => ({
  global: [
    ...
    ...(window.strapi.features.isEnabled(
      window.strapi.features.REVIEW_WORKFLOWS
    )
      ? [
          {
            intlLabel: {
...
export { ADMIN_PERMISSIONS_EE, ROUTES_EE, SETTINGS_LINKS_EE };
//# sourceMappingURL=constants-jWFql0Ju.mjs.map
