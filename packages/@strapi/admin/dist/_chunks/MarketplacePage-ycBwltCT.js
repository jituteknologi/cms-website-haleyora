...
const NpmPackagesFilters = ({
  ...
  const handleTagRemove = (tagToRemove, filterType) => {
    const update = {
      [filterType]: (query[filterType] ?? []).filter(
        (previousTag) => previousTag !== tagToRemove
      ),
    };
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
        ...
        paddingBottom: 1,
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(ButtonToggle, {
            variant: "tertiary",
            ref: buttonRef,
          ...
          isVisible &&
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Popover, {
              ...
              padding: 3,
              spacing: 4,
              children: /* @__PURE__ */ jsxRuntime.jsxs(FiltersFlex, {
                direction: "column",
                alignItems: "stretch",
                gap: 1,
                children: [
...
const NpmPackageCard = ({
  ...
  const npmPackageHref = `https://market.strapi.io/${pluralize__default.default.plural(
    npmPackageType
  )}/${attributes.slug}`;
  const versionRange = semver__namespace.validRange(attributes.strapiVersion);
  const isCompatible = semver__namespace.satisfies(
    strapiAppVersion ?? "",
    versionRange ?? ""
  );
...
const NpmPackagesGrid = ({
  ...
  if (npmPackages.length === 0) {
    return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
      position: "relative",
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridLayout, {
          children: Array(12)
            .fill(null)
            .map((_, idx) =>
              /* @__PURE__ */ jsxRuntime.jsx(
                EmptyPluginCard,
                { height: "234px", hasRadius: true },
                idx
              )
            ),
        }),
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Grid, {
    gap: 4,
    children: npmPackages.map((npmPackage) =>
      /* @__PURE__ */ jsxRuntime.jsx(
        designSystem.GridItem,
        {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(NpmPackageCard, {
            npmPackage,
            isInstalled: installedPackageNames.includes(
              npmPackage.attributes.npmPackageName
            ),
            useYarn,
            isInDevelopmentMode,
            npmPackageType,
...
const PageHeader = ({ isOnline, npmPackageType = "plugin" }) => {
  ...
  const { trackUsage } = helperPlugin.useTracking();
  const tracking =
    npmPackageType === "provider" ? "didSubmitProvider" : "didSubmitPlugin";
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.HeaderLayout, {
    title: formatMessage({
    ...
    children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelect, {
      ...
      children: Object.entries(SORT_TYPES).map(([sortName, messages]) => {
        return /* @__PURE__ */ jsxRuntime.jsx(
          ...
          { value: sortName, children: formatMessage(messages.option) },
          sortName
        );
      }),
    }),
...
function useMarketplaceData({
    ...
    async () => {
      try {
        ...
        const res = await fetch(
          `${MARKETPLACE_API_URL}/plugins?${queryString}`
        );
        if (!res.ok) {
  ...
  const { data: providersResponse, status: providersStatus } =
    reactQuery.useQuery(
      ["marketplace", "providers", providerParams],
      async () => {
        const queryString = qs__namespace.stringify(providerParams);
        const res = await fetch(
          `${MARKETPLACE_API_URL}/providers?${queryString}`
        );
        if (!res.ok) {
  ...
  const npmPackageTypeResponse =
    npmPackageType === "plugin" ? pluginsResponse : providersResponse;
...
const MarketplacePage = () => {
  ...
  const handleTabChange = (selected) => {
    ...
    const hasTabQuery =
      tabQuery[selectedTab] && Object.keys(tabQuery[selectedTab]).length;
    if (hasTabQuery) {
      setQuery({
                ...
                /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tabs, {
                      children: [
                        /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Tab, {
                          children: [
                            formatMessage({
...
const ProtectedMarketplacePage = () => {
  ...
  return (
    ...
    /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.CheckPagePermissions, {
...
//# sourceMappingURL=MarketplacePage-ycBwltCT.js.map
