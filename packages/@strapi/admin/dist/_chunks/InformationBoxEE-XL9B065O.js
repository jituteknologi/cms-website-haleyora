...
const AssigneeSelect = () => {
  const { initialData, layout, isSingleType, onChange } =
  ...
  const currentAssignee =
    initialData?.[constants.ASSIGNEE_ATTRIBUTE_NAME] ?? null;
  const [updateAssignee, { error, isLoading: isMutating }] =
    reviewWorkflows.useUpdateAssigneeMutation();
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field, {
    name: constants.ASSIGNEE_ATTRIBUTE_NAME,
...
const StageSelect = () => {
  ...
  const activeWorkflowStage =
    initialData?.[constants.STAGE_ATTRIBUTE_NAME] ?? null;
  const [updateStage, { error }] = reviewWorkflows.useUpdateStageMutation();
  const handleChange = async (stageId) => {
    try {
      if (
        limits?.[constants$1.CHARGEBEE_WORKFLOW_ENTITLEMENT_NAME] &&
        parseInt(limits[constants$1.CHARGEBEE_WORKFLOW_ENTITLEMENT_NAME], 10) <
          (meta?.workflowCount ?? 0)
      ) {
        setShowLimitModal("workflow");
      } else if (
        limits?.[constants$1.CHARGEBEE_STAGES_PER_WORKFLOW_ENTITLEMENT_NAME] &&
        parseInt(
          limits[constants$1.CHARGEBEE_STAGES_PER_WORKFLOW_ENTITLEMENT_NAME],
          10
        ) < stages.length
  ...
  const { themeColorName } =
    colors.getStageColorByHex(activeWorkflowStage?.color) ?? {};
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Field, {
        hint:
          ...
          formatMessage({
            ...
            defaultMessage:
              "You don’t have the permission to update this stage.",
          }),
        name: constants.STAGE_ATTRIBUTE_NAME,
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.SingleSelect, {
              ...
              startIcon:
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
                  ...
                  borderColor:
                    themeColorName === "neutral0" ? "neutral150" : void 0,
                  hasRadius: true,
                  shrink: 0,
                  width: 2,
                  marginRight: "-3px",
...
const InformationBoxEE = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(index.Information.Root, {
    children: [
...
//# sourceMappingURL=InformationBoxEE-XL9B065O.js.map
