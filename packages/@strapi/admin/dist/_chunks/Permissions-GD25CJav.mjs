...
import { F as isObject } from "./index-qQynS5yD.mjs";
...
const [PermissionsDataManagerProvider, usePermissionsDataManagerContext] =
  createContext("PermissionsDataManager");
...
const formatLayout = (layout, groupByKey) => {
  return Object.entries(groupBy(layout, groupByKey)).map(
    ([itemName, item]) => ({
      category: itemName,
...
const SubActionRow = ({
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...
    children: [
      ...
      childrenForm.map(
        ({ label, value, required, children: subChildrenForm }, index) => {
    ...
    children: [
      /* @__PURE__ */ jsx(ModalHeader, {
        children: /* @__PURE__ */ jsx(Breadcrumbs, {
          ...
          children: headerBreadCrumbs.map((label, index, arr) =>
            /* @__PURE__ */ jsx(
              Crumb,
              {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx("ul", {
            children: actionsToDisplay.map(
              ({ actionId, label, pathToConditionsObject }, index) => {
...
const Permissions = React.forwardRef(
  ({ layout, isFormDisabled, permissions = [] }, api) => {
    ...
    React.useImperativeHandle(api, () => {
      return {
        getPermissions() {
          ...
          const singleTypesDiff = difference(
    ...
    const handleChangeSimpleCheckbox = React.useCallback(
      ({ target: { name, value } }) => {
        dispatch({
    ...
    const handleChangeParentCheckbox = React.useCallback(
      ({ target: { name, value } }) => {
        dispatch({
    ...
    return /* @__PURE__ */ jsx(PermissionsDataManagerProvider, {
      ...
      children: /* @__PURE__ */ jsxs(TabGroup, {
        id: "tabs",
        label: formatMessage({
...
//# sourceMappingURL=Permissions-GD25CJav.mjs.map
