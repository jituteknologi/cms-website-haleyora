...
import { a as Events } from "./EditPage-_4I8Oa-k.mjs";
import "react";
...
const EventsTableEE = () => {
  return /* @__PURE__ */ jsxs(Events.Root, {
    children: [
      ...
      Object.keys(eeTables).map((table) =>
...
//# sourceMappingURL=EventsTable-sSfq6Y3w.mjs.map
