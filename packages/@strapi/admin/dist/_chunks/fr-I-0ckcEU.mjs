...
const anErrorOccurred = "Oups ! Une erreur s'est produite. Veuillez réessayer.";
const clearLabel = "Vider";
const dark = "Sombre";
const light = "Clair";
const or = "OU";
const selectButtonTitle = "Sélectionner";
const skipToContent = "Aller au contenu";
const submit = "Soumettre";
const fr = {
  Analytics,
  "Auth.components.Oops.text": "Votre compte a été suspendu.",
  "Auth.components.Oops.text.admin":
    "Si c'est une erreur, veuillez contacter votre administrateur.",
  ...
  "Auth.form.button.login.providers.error":
    "Nous ne pouvons pas vous connecter via le fournisseur sélectionné",
  ...
  "Auth.form.error.password.format":
    "Votre mot de passe ne peut pas contenir trois fois le symbole `$`.",
  ...
  "Auth.form.forgot-password.email.label.success":
    "E-mail envoyé avec succès à l'adresse suivante",
  ...
  "Auth.form.register.news.label":
    "Me tenir au courant des nouvelles fonctionnalités et améliorations à venir (en faisant cela vous acceptez les {terms} et {policy}).",
  "Auth.form.register.subtitle":
    "Vos identifiants sont utilisé uniquement pour vous authentifier sur l'interface d'administration. Toutes les données sauvegardées seront stockées dans votre propre base de données.",
  ...
  "HomePage.welcome.congrats.content":
    "Vous êtes connecté en tant que premier Administrateur. Afin de découvrir les fonctionnalités proposées par Strapi,",
  "HomePage.welcome.congrats.content.bold":
    "nous vous conseillons de créer votre première Collection.",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "Certains rôles n'ont pas pu être supprimés car ils sont associés à des utilisateurs.",
  "Roles.ListPage.notification.delete-not-allowed":
    "Un rôle ne peu pas être supprimé s'il est associé à des utilisateurs.",
  "Roles.RoleRow.select-all": "Sélectionner {name} pour action groupée",
  "Roles.RoleRow.user-count":
    "{number, plural, =0 {# utilisateur} one {# utilisateur} other {# utilisateurs}}",
  "Roles.components.List.empty.withSearch":
    "Il n'y a pas de rôles correspondant à la recherche ({search})...",
  ...
  "Settings.apiTokens.createPage.permissions.header.hint":
    "Sélectionner les actions de l'application ou du plugin et sur l'icône de la roue crantée pour afficher la route rattachée",
  ...
  "Settings.tokens.popUpWarning.message":
    "Êtes-vous sûr(e) de vouloir régénérer ce jeton ?",
  ...
  "Settings.transferTokens.description":
    "Liste des jetons de transfert générés",
  "Settings.transferTokens.create": "Créer un nouveau jeton de transfert",
  "Settings.transferTokens.addFirstToken":
    "Ajouter votre premier jeton de transfert",
  "Settings.transferTokens.addNewToken":
    "Ajouter un nouveau jeton de transfert",
  "Settings.transferTokens.emptyStateLayout":
    "Vous n'avez aucun contenu pour le moment...",
  ...
  "Settings.application.ee.admin-seats.at-limit-tooltip":
    "Limite atteinte : ajouter des places pour inviter d'autres utilisateurs",
  "Settings.application.ee.admin-seats.add-seats":
    "{isHostedOnStrapiCloud, select, true {AJouter des places} other {Contacter le service clients}}",
  "Settings.application.customization": "Customisation",
  "Settings.application.customization.auth-logo.carousel-hint":
    "Remplacer le logo dans la page de connexion",
  "Settings.application.customization.carousel-hint":
    "Changer le logo dans l'interface d'administration (dimensions maximales: {dimension}x{dimension}, poids maximal du fichier : {size}KB)",
  ...
  "Settings.application.customization.menu-logo.carousel-hint":
    "Remplacer le logo dans la navigation principale",
  ...
  "Settings.application.customization.modal.pending.subtitle":
    "Gérer le logo choisi avant de le télécharger",
  "Settings.application.customization.modal.pending.title":
    "Logo prêt pour le téléchargement",
  ...
  "Settings.application.customization.modal.tab.label":
    "Comment voulez-vous télécharger vos medias ?",
  ...
  "Settings.application.customization.modal.upload.error-format":
    "Mauvais format chargé (formats acceptés : jpeg, jpg, png, svg).",
  "Settings.application.customization.modal.upload.error-network":
    "Erreur réseau",
  "Settings.application.customization.modal.upload.error-size":
    "Le fichier téléchargé est trop grand (dimensions max : {dimension}x{dimension}, poids max: {size}KB)",
  "Settings.application.customization.modal.upload.file-validation":
    "Dimensions maximales : {dimension}x{dimension}, poids maximal : {size}KB",
  ...
  "Settings.application.customization.size-details":
    "Dimensions maximales : {dimension}×{dimension}, poids maximal : {size}KB",
  "Settings.application.description":
    "Informations globales du panneau d'administration",
  "Settings.application.edition-title": "plan actuel",
  "Settings.application.ee-or-ce":
    "{communityEdition, select, true {Édition Communauté} other {Édition Entreprise}}",
  ...
  "Settings.application.link-upgrade":
    "Mettez à niveau votre panneau d'administration",
  ...
  "Settings.permissions.category":
    "Paramètres de permissions pour la catégorie {category}",
  "Settings.permissions.category.plugins":
    "Paramètres de permissions pour le plugin {plugin}",
  ...
  "Settings.permissions.conditions.no-actions":
    "Vous devez d'abord sélectionner des actions (créer, lire, mettre à jour, ...) avant de définir des conditions sur celles-ci.",
  ...
  "Settings.permissions.select-all-by-permission":
    "Sélectionner toutes les permissions de {label}",
  "Settings.permissions.select-by-permission":
    "Sélectionner la permission de {label}",
  ...
  "Settings.permissions.users.form.sso.description":
    "Quand activé, les  utilisateurs peuvent se connecter via SSO",
  "Settings.permissions.users.listview.header.subtitle":
    "Tous les utilisateurs ayant accès au panneau d'administration de Strapi",
  "Settings.permissions.users.tabs.label": "Onglet Autorisations",
  "Settings.profile.form.notify.data.loaded":
    "Les données de votre profil ont été chargées",
  "Settings.profile.form.section.experience.clear.select":
    "Vider la langue de l'interface sélectionnée",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "Cela affichera seulement votre propre interface dans la langue sélectionnée",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "La sélection changera la langue de l'interface uniquement pour vous. Veuillez vous référer à cette {here} pour rendre d'autres langues disponibles pour votre équipe.",
  ...
  "Settings.roles.form.button.users-with-role":
    "{number, plural, =0 {# utilisateurs} one {# utilisateur} other {# utilisateurs}} possédant ce rôle",
  ...
  "Settings.sso.form.defaultRole.description":
    "Cela attribuera le nouvel utilisateur authentifié au rôle sélectionné",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "Vous devez avec la permission de lire les rôles administateurs",
  "Settings.sso.form.defaultRole.label": "Rôle par défaut",
  "Settings.sso.form.registration.description":
    "Créer un nouvel utilisateur lors de la connexion via SSO si aucun compte n'existe",
  ...
  "Settings.webhooks.list.description":
    "Recevoir des notifications de modifications en POST",
  ...
  "Settings.webhooks.to.delete":
    "{webhooksToDeleteLength, plural, one {# élément} other {# éléments}} sélectionné",
  ...
  "Users.components.List.empty.withFilters":
    "Aucun utilisateur avec les filtres appliqués...",
  "Users.components.List.empty.withSearch":
    "Aucun utilisateur correspondant à la recherche ({search})...",
  ...
  "app.components.BlockLink.blog.content":
    "Lire les dernières actualités à propos de Strapi et de son écosystème",
  "app.components.BlockLink.code": "Apps d'exemple",
  "app.components.BlockLink.code.content":
    "Apprenez en testant des projets réels développés par la communauté.",
  "app.components.BlockLink.documentation.content":
    "Découvrir les concepts essentials, guides et instructions.",
  "app.components.BlockLink.tutorial": "Tutoriels",
  "app.components.BlockLink.tutorial.content":
    "Suivre les instructions étapes par étapes pour utiliser et personnaliser Strapi.",
  ...
  "app.components.DownloadInfo.text":
    "Cela peut prendre une minute. Merci de patienter.",
  ...
  "app.components.EmptyStateLayout.content-permissions":
    "Vous n'avez pas les permissions pour accéder à ce contenu",
  ...
  "app.components.HomePage.community.content":
    "Discutez avec les membres de l'équipe, contributeurs et développeurs sur différent supports.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "Félicitations ! Vous êtes connecté en tant que tout premier administrateur. Pour découvrir les puissantes fonctionnalités fournies par Strapi, nous vous recommandons de créer votre premier Type de Contenu !",
  "app.components.HomePage.welcomeBlock.content.again":
    "Nous espérons que votre projet avance bien... Découvrez les derniers articles à propos de Strapi. Nous faisons de notre mieux pour améliorer le produit selon vos retours.",
  ...
  "app.components.ImgPreview.hint":
    "Glissez-déposez dans cette zone ou {browse} un fichier à télécharger",
  ...
  "app.components.InstallPluginPage.Download.description":
    "L'installation d'un plugin peut prendre quelques secondes.",
  "app.components.InstallPluginPage.Download.title":
    "Téléchargement en cours...",
  "app.components.InstallPluginPage.description":
    "Améliorez votre app sans efforts",
  ...
  "app.components.MarketplaceBanner":
    "Découvrez les plugins construits par la communauté, et bien d'autres choses géniales pour démarrer votre projet, sur Strapi Awesome.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "La configuration d'autoReload a besoin d'être activée pour télécharger un plugin. Veuillez démarrer votre application avec `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "Pour des raisoins de sécurité, un plugin ne peut être installé qu'en dévelopment.",
  ...
  "app.components.Users.MagicLink.connect":
    "Envoyez ce lien à l'utilisateur pour qu'il se connecte.",
  "app.components.Users.MagicLink.connect.sso":
    "Envoyez ce lien à l'utilisateur, la première connexion peut être effectué via un fournisseur SSO",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "Une erreur est survenue pendant la désintallation",
  "app.containers.App.notification.error.init":
    "Une erreur est survenue en requêtant l'API",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "Si vous ne recevez pas ce lien, veuillez contacter votre administrateur.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "La réception de votre lien de récupération de mot de passe peut prendre quelques minutes.",
  ...
  clearLabel,
  "coming.soon":
    "Ce contenu est actuellement en construction et sera de retour dans quelques semaines !",
  "component.Input.error.validation.integer":
    "La valeur doit être un nombre entier",
  "components.AutoReloadBlocker.description":
    "Démarrez Strapi avec l'une des commandes suivantes:",
  ...
  "components.Input.error.attribute.sameKeyAndName":
  ...
  "components.Input.error.validation.email":
    "Le format n'est pas de type e-mail",
  ...
  "components.OverlayBlocker.description":
    "Vous utilisez une fonctionnalité qui nécessite le redémarrage du server. Merci d'attendre que celui-ci ait redémarré.",
  "components.OverlayBlocker.description.serverError":
    "Le serveur aurait déjà du redémarrer, vous devriez regarder les messages dans le terminal.",
  "components.OverlayBlocker.title": "Le serveur est en train de redémarrer",
  "components.OverlayBlocker.title.serverError":
    "Le serveur aurait déjà du redémarrer",
  "components.PageFooter.select": "entrées par page",
  "components.ProductionBlocker.description":
    "Pour des raisons de sécurité il est désactivé dans les autres environnements.",
  "components.ProductionBlocker.header":
    "Ce plugin est disponible uniquement en développement.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "Ajouter des fichiers en les 'glissant-déposant', {browse}, ou en les collant depuis le presse-papier",
  ...
  "content-manager.App.schemas.data-loaded":
    "Les schéma ont été chargés avec succès",
  "content-manager.ListViewTable.relation-loaded":
    "Les relations on été chargées",
  ...
  "content-manager.components.DragHandle-label": "Glisser",
  "content-manager.components.DraggableAttr.edit": "Cliquez pour modifier",
  ...
  "content-manager.components.DynamicZone.pick-compo": "Choisir un composant",
  "content-manager.components.DynamicZone.required": "Composant requis",
  "content-manager.components.EmptyAttributesBlock.button":
    "Voir la page des configurations",
  "content-manager.components.EmptyAttributesBlock.description":
    "Vous pouvez modifiez vos paramètres",
  "content-manager.components.FieldItem.linkToComponentLayout":
    "Modifier le layout du composant",
  "content-manager.components.FieldSelect.label": "Ajouter un champ",
  "content-manager.components.FilterOptions.button.apply": "Appliquer",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "Définissez les conditions des filtres à appliquer",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "Filtres",
  "content-manager.components.FiltersPickWrapper.hide": "Fermer",
  "content-manager.components.LeftMenu.Search.label":
    "Chercher un type de contenu",
  "content-manager.components.LeftMenu.collection-types":
    "Types de Collections",
  "content-manager.components.LeftMenu.single-types": "Types uniques",
  "content-manager.components.LimitSelect.itemsPerPage": "Éléments par page",
  "content-manager.components.NotAllowedInput.text":
    "Vous n'avez pas la permission de voir ce champ",
  "content-manager.components.RepeatableComponent.error-message":
    "Le composant contient une ou des erreurs",
  "content-manager.components.Search.placeholder": "Rechercher une entrée...",
  "content-manager.components.Select.draft-info-title": "Statut: Brouillon",
  "content-manager.components.Select.publish-info-title": "Statut: Publié",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "Définissez l'apparence de la vue edit.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "Définir les paramètres de la vue liste.",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "Configurer la vue - {name}",
  "content-manager.components.TableDelete.delete": "Tout supprimer",
  "content-manager.components.TableDelete.deleteSelected":
    "Supprimer les éléments sélectionnés",
  "content-manager.components.TableDelete.label":
    "{number, plural, one {# entrée sélectionnée} other {# entrées sélectionnées}}",
  "content-manager.components.TableEmpty.withFilters":
    "Aucun {contentType} n'a été trouvé avec ces filtres...",
  "content-manager.components.TableEmpty.withSearch":
    "Aucun {contentType} n'a été trouvé avec cette recherche ({search})...",
  "content-manager.components.TableEmpty.withoutFilter":
    "Aucun {contentType} n'a été trouvé...",
  "content-manager.components.empty-repeatable":
    "Il n'a pas encore d'entrée. Cliquez sur le bouton pour en ajouter une.",
  "content-manager.components.notification.info.maximum-requirement":
    "Le nombre maximal de champs est atteint",
  "content-manager.components.notification.info.minimum-requirement":
    "Un champ a été rajouté pour remplir les conditions minimales",
  "content-manager.components.repeatable.reorder.error":
    "Une erreur s'est produite lors de la réorganisation du champ de votre composant, veuillez réessayer",
  "content-manager.components.reset-entry": "Supprimer l'entrée",
  "content-manager.components.uid.apply": "appliquer",
  "content-manager.components.uid.available": "disponible",
  "content-manager.components.uid.regenerate": "regénérer",
  "content-manager.components.uid.suggested": "suggéré",
  "content-manager.components.uid.unavailable": "indisponible",
  "content-manager.containers.Edit.Link.Layout": "Paramétrer la vue",
  "content-manager.containers.Edit.Link.Model": "Éditer le modèle",
  "content-manager.containers.Edit.addAnItem": "Ajouter un élément...",
  "content-manager.containers.Edit.clickToJump": "Cliquer pour voir l'entrée",
  "content-manager.containers.Edit.delete": "Supprimer",
  "content-manager.containers.Edit.delete-entry": "Supprimer cette entrée",
  "content-manager.containers.Edit.editing": "Édition en cours...",
  "content-manager.containers.Edit.information": "Informations",
  "content-manager.containers.Edit.information.by": "Par",
  "content-manager.containers.Edit.information.created": "Créé",
  "content-manager.containers.Edit.information.draftVersion":
    "version brouillon",
  "content-manager.containers.Edit.information.editing": "Édition :",
  "content-manager.containers.Edit.information.lastUpdate":
    "Dernière modification",
  "content-manager.containers.Edit.information.publishedVersion":
    "version publiée",
  "content-manager.containers.Edit.pluginHeader.title.new": "Créer un document",
  "content-manager.containers.Edit.reset": "Annuler",
  "content-manager.containers.Edit.returnList": "Retourner à la liste",
  "content-manager.containers.Edit.seeDetails": "Détails",
  "content-manager.containers.Edit.submit": "Valider",
  "content-manager.containers.EditSettingsView.modal-form.edit-field":
    "Editer le champ",
  "content-manager.containers.EditView.add.new-entry":
    "Ajouter une nouvelle entrée",
  "content-manager.containers.EditView.notification.errors":
    "Le formulaire contient des erreurs",
  "content-manager.containers.Home.introduction":
    "Pour éditer du contenu, choisissez un type de données dans le menu de gauche.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "Créer et modifier votre type de contenu",
  "content-manager.containers.Home.pluginHeaderTitle": "Type de contenu",
  "content-manager.containers.List.draft": "Brouillon",
  "content-manager.containers.List.errorFetchRecords": "Erreur",
  ...
  "content-manager.containers.ListPage.items":
    "{number, plural, =0 {élements} one {élement} other {élements}}",
  ...
  "content-manager.containers.SettingPage.attributes": "Attributs",
  "content-manager.containers.SettingPage.attributes.description":
    "Organisez les attributs du modèle",
  "content-manager.containers.SettingPage.editSettings.description":
    "Glissez & déposez les champs pour construire le layout",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title.description":
    "Définissez quel champ sera affiché",
  "content-manager.containers.SettingPage.editSettings.relation-field.description":
    "Définir le champ affiché dans les vues d'édition et de liste",
  ...
  "content-manager.containers.SettingPage.listSettings.description":
    "Configurez les options de ce modèle",
  ...
  "content-manager.containers.SettingPage.pluginHeaderDescription":
    "Configurez les paramètres de ce modèle",
  "content-manager.containers.SettingPage.settings": "Paramètres",
  "content-manager.containers.SettingPage.view": "Vue",
  "content-manager.containers.SettingViewModel.pluginHeader.title":
    "Gestion du contenu - {name}",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "Configurez les paramètres de vos modèles et groupes",
  "content-manager.containers.SettingsView.list.subtitle":
    "Configurez le layout et l'affichage de vos types de collection et groupes",
  ...
  "content-manager.emptyAttributes.button":
    "Ouvrir le constructeur de types de contenu",
  "content-manager.emptyAttributes.description":
    "Ajoutez votre premier champ a votre modèle",
  "content-manager.emptyAttributes.title": "Il n'y a pas encore de champs",
  "content-manager.error.attribute.key.taken": "Cette valeur existe déjà",
  "content-manager.error.attribute.sameKeyAndName": "Ne peuvent pas être égaux",
  "content-manager.error.attribute.taken": "Ce champ existe déjà",
  "content-manager.error.contentTypeName.taken": "Ce nom existe déjà",
  "content-manager.error.model.fetch":
    "Une erreur est survenue lors de la réception des modèles.",
  "content-manager.error.record.create":
    "Une erreur est survenue lors de la création de l'entrée.",
  ...
  "content-manager.error.record.fetch":
    "Une erreur est survenue lors de la réception de l'entrée.",
  "content-manager.error.record.update":
    "Une erreur est survenue lors de la modification de l'entrée.",
  "content-manager.error.records.count":
    "Une erreur est survenue lors de la réception du nombre d'entrées.",
  "content-manager.error.records.fetch":
    "Une erreur est survenue lors de la réception des entrées.",
  "content-manager.error.schema.generation":
    "Une erreur est survenue lors de la génération du schéma.",
  "content-manager.error.validation.json": "Le format JSON n'est pas respecté",
  "content-manager.error.validation.max": "La valeur est trop grande.",
  "content-manager.error.validation.maxLength": "La valeur est trop longue.",
  "content-manager.error.validation.min": "La valeur est trop basse.",
  "content-manager.error.validation.minLength": "La valeur est trop courte.",
  "content-manager.error.validation.minSupMax": "Ne peut pas être plus grand",
  "content-manager.error.validation.regex":
    "La valeur ne correspond pas au format attendu.",
  "content-manager.error.validation.required": "Ce champ est obligatoire.",
  "content-manager.form.Input.bulkActions": "Autoriser les actions groupées",
  "content-manager.form.Input.defaultSort": "Attribut de tri par défault",
  "content-manager.form.Input.description": "Description",
  "content-manager.form.Input.description.placeholder":
    "Afficher le nom dans le profil",
  "content-manager.form.Input.editable": "Champ editable",
  "content-manager.form.Input.filters": "Autoriser les filtres",
  "content-manager.form.Input.label": "Label",
  "content-manager.form.Input.label.inputDescription":
    "Cette valeur modifie celle du champs de la table",
  "content-manager.form.Input.pageEntries": "Nombre d'entrées par page",
  "content-manager.form.Input.pageEntries.inputDescription":
    "Note : Vous pouvez modifier ces valeurs par modèle",
  "content-manager.form.Input.placeholder": "Placeholder",
  "content-manager.form.Input.placeholder.placeholder": "Mon super placeholder",
  "content-manager.form.Input.search": "Autoriser la recherche",
  "content-manager.form.Input.search.field":
    "Autoriser la recherche sur ce champs",
  "content-manager.form.Input.sort.field": "Autoriser le tri sur ce champs",
  "content-manager.form.Input.sort.order": "Ordre de tri par défaut",
  "content-manager.form.Input.wysiwyg": "Afficher comme WYSIWYG",
  "content-manager.global.displayedFields": "Champs affichés",
  "content-manager.groups": "Groupes",
  "content-manager.groups.numbered": "Groupes ({number})",
  "content-manager.header.name": "Contenu",
  "content-manager.link-to-ctb": "Editer le modèle",
  "content-manager.models": "Types de Collection",
  "content-manager.models.numbered": "Types de Collection ({number})",
  "content-manager.notification.error.displayedFields":
    "Vous devez avoir au moins un champ d'affiché",
  "content-manager.notification.error.relationship.fetch":
    "Une erreur est survenue en récupérant les relations.",
  "content-manager.notification.info.SettingPage.disableSort":
    "Vous devez avoir au moins un attribut de tri par défaut",
  "content-manager.notification.info.minimumFields":
    "Vous devez avoir au moins un champ d'affiché",
  "content-manager.notification.upload.error":
    "Une erreur est survenues en téléchargeant vos fichiers",
  "content-manager.pageNotFound": "Page non trouvée",
  "content-manager.pages.ListView.header-subtitle":
    "{number, plural, =0 {# entrées trouvée} one {# entrée trouvée} other {# entrées trouvées}}",
  "content-manager.pages.NoContentType.button":
    "Créer votre premier Type de Contenu",
  "content-manager.pages.NoContentType.text":
    "Vous n'avez encore aucun contenu, nous vous recommandons de créer votre premier Type de Contenu",
  "content-manager.permissions.not-allowed.create":
    "Vous n'êtes pas autorisé à créer un document",
  "content-manager.permissions.not-allowed.update":
    "Vous n'êtes pas autorisé à voir ce document",
  "content-manager.plugin.description.long":
    "Visualisez, modifiez et supprimez les données de votre base de données.",
  ...
  "content-manager.select.currently.selected":
    "{count} actuellement sélectionnées",
  ...
  "content-manager.utils.data-loaded":
    "{number, plural, =1 {L'entrée a été chargée} other {Les entrées on été chargées} avec  succès",
  ...
  "content-manager.popUpWarning.warning.publish-question":
    "Êtes-vous sûr de vouloir le publier ?",
  ...
  "global.prompt.unsaved":
    "Êtes-vous sûr de vouloir quitter cette page? Toutes vos modifications seront perdues",
  "notification.contentType.relations.conflict":
    "Le Type de Contenu à des relations qui rentrent en conflit",
  ...
  "notification.version.update.message":
    "Une nouvelle version de Strapi est disponible !",
...
//# sourceMappingURL=fr-I-0ckcEU.mjs.map
