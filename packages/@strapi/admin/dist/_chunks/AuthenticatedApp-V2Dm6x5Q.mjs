...
import {
  u as useConfiguration,
  a as useAuth,
  c as createTypedSelector,
  b as useOnce,
  d as createRoute,
  e as useInformationQuery,
  f as useGetMyPermissionsQuery,
  R as RBACProvider,
  N as NpsSurvey,
} from "./index-qQynS5yD.mjs";
            ...
            /* @__PURE__ */ jsx(Box, {
              ...
              children: /* @__PURE__ */ jsx(GuidedTourStepper, {
                ...
                children:
                  stepData &&
                  "content" in stepData &&
                  /* @__PURE__ */ jsx(GuidedTourContent, {
                    ...stepData.content,
                  }),
              }),
            }),
...
const Bold = (children) =>
  /* @__PURE__ */ jsx(Typography, { fontWeight: "semiBold", children });
    ...
    children: [
      /* @__PURE__ */ jsx(HelperButton, {
        ...
        children: /* @__PURE__ */ jsx(Icon, {
          as: isOpen ? Cross : Question,
          color: "buttonNeutral0",
        }),
      }),
      isOpen &&
        /* @__PURE__ */ jsx(Portal, {
          children: /* @__PURE__ */ jsxs(PopoverPrimitives.Content, {
            padding: 0,
            ...
            children: [
              /* @__PURE__ */ jsxs(Flex, {
                ...
                paddingTop: 6,
                children: [
                  /* @__PURE__ */ jsx(TypographyLineHeight, {
                    fontWeight: "bold",
                    children: formatMessage({
...
const selectAdminPermissions = createTypedSelector(
...
const useMenu = () => {
  ...
  const generalSectionLinksRef = React.useRef(
...
const getGeneralLinks = async (
  ...
  authorizedGeneralLinksClone[settingsLinkIndex].notificationsCount =
    shouldUpdateStrapi ? 1 : 0;
  ...
  return /* @__PURE__ */ jsxs(Box, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs(Flex, {
        ...
        children: [sideNav, /* @__PURE__ */ jsx(FlexBox, { children })],
      }),
    ],
  });
};
const CM = React.lazy(() =>
  import("./index-qQynS5yD.mjs")
    .then((n) => n.a0)
    .then((mod) => ({ default: mod.App }))
);
const HomePage = React.lazy(() =>
  import("./HomePage-kMCTTezi.mjs").then((mod) => ({
    default: mod.HomePage,
  }))
);
const InstalledPluginsPage = React.lazy(() =>
  import("./InstalledPluginsPage-IbGZ86IQ.mjs").then((mod) => ({
    default: mod.ProtectedInstalledPluginsPage,
  }))
);
const MarketplacePage = React.lazy(() =>
  import("./MarketplacePage-JD39Vp_U.mjs").then((mod) => ({
    default: mod.ProtectedMarketplacePage,
  }))
);
...
const InternalErrorPage = React.lazy(() =>
  import("./InternalErrorPage-7JIAF-Ev.mjs").then(
...
const ProfilePage = React.lazy(() =>
  import("./ProfilePage-Z1dDvamO.mjs").then((mod) => ({
    default: mod.ProfilePage,
  }))
);
const SettingsPage = React.lazy(() =>
  import("./SettingsPage-Wo10cVFB.mjs").then((mod) => ({
          ...
          children: /* @__PURE__ */ jsxs(Switch, {
            children: [
              ...
              /* @__PURE__ */ jsx(Route, {
                path: "/list-plugins",
                exact: true,
                children: /* @__PURE__ */ jsx(InstalledPluginsPage, {}),
              }),
              /* @__PURE__ */ jsx(Route, {
                path: "/404",
...
const PluginsInitializer = () => {
  ...
  if (hasApluginNotReady) {
    ...
    return /* @__PURE__ */ jsxs(Fragment, {
      children: [initializers, /* @__PURE__ */ jsx(LoadingIndicatorPage, {})],
    });
  }
...
const AuthenticatedApp = () => {
  ...
  return /* @__PURE__ */ jsx(AppInfoProvider, {
    ...appInfo,
    userId,
    ...
    userDisplayName,
    children: /* @__PURE__ */ jsxs(RBACProvider, {
...
//# sourceMappingURL=AuthenticatedApp-V2Dm6x5Q.mjs.map
