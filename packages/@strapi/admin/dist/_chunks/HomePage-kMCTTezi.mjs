...
import {
  ...
  S as STATES,
} from "./AuthenticatedApp-V2Dm6x5Q.mjs";
import { u as useContentTypes } from "./useContentTypes-XTpMl3U-.mjs";
import { p as useEnterprise } from "./index-qQynS5yD.mjs";
                        ...
                        /* @__PURE__ */ jsx(Flex, {
                          ...
                          children:
                            index === sections.length - 1
                              ? null
                              : /* @__PURE__ */ jsx(VerticalDivider, { state }),
                        }),
                        /* @__PURE__ */ jsx(Box, {
                          marginTop: 2,
                          children:
                            state === STATES.IS_ACTIVE ? section.content : null,
                        }),
                      ],
                    }),
                  ],
                ...
                children: [
                  /* @__PURE__ */ jsx(GridItem, {
                    ...
                    children: showGuidedTour
                      ? /* @__PURE__ */ jsx(GuidedTourHomepage, {})
    ...
    children: [
      /* @__PURE__ */ jsx(BlockLink, {
        ...
        children: /* @__PURE__ */ jsxs(Flex, {
          ...
          gap: 6,
          children: [
            /* @__PURE__ */ jsx(CloudCustomWrapper, {
              hasRadius: true,
              padding: 3,
              children: /* @__PURE__ */ jsx(CloudIconWrapper, {
                width: "2rem",
                height: "2rem",
                justifyContent: "center",
                hasRadius: true,
        ...
        children: socialLinksExtended.map(({ icon, link, name }) => {
          return /* @__PURE__ */ jsx(
            GridItem,
            {
              col: 6,
              s: 12,
              children: /* @__PURE__ */ jsx(LinkCustom, {
                size: "L",
                startIcon: icon,
                variant: "tertiary",
                href: link,
...
const HomePage = () => {
  const Page = useEnterprise(
    ...
    async () => (await import("./HomePage--1av04GJ.mjs")).HomePageEE
  );
  if (!Page) {
    return null;
  }
...
//# sourceMappingURL=HomePage-kMCTTezi.mjs.map
