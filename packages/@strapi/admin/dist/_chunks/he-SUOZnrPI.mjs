const Analytics = "אנליטיקס";
const Documentation = "תיאור";
const Email = 'דוא"ל';
const Password = "סיסמה";
const Provider = "ספק";
const ResetPasswordToken = "אפס אסימון סיסמה";
const Role = "תפקיד";
...
const he = {
  ...
  "Auth.form.button.login.providers.error":
    "אנחנו לא יכולים לחבר אותך באמצעות הספק שנבחר.",
  ...
  "Auth.form.error.password.format":
    "הסיסמה לא יכולה להכיל את הסמל `$` יותר משלוש פעמים.",
  "Auth.form.error.password.local":
    "משתמש זה מעולם לא הגדיר סיסמה מקומית, יש להתחבר באמצעות הספק ששימש במהלך יצירת החשבון.",
  ...
  "Auth.form.register.news.label":
    "עדכנו אותי לגבי תכונות חדשות ושיפורים עתידיים (על ידי כך אתה מאשר את {terms} ואת {policy}).",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "לא ניתן היה למחוק תפקידים מסוימים מכיוון שהם משויכים למשתמשים",
  "Roles.ListPage.notification.delete-not-allowed":
    "לא ניתן למחוק תפקיד אם הוא משויך למשתמשים",
  "Roles.components.List.empty.withSearch":
    "אין תפקיד שמתאים לחיפוש ({search}) ...",
  ...
  "Settings.permissions.users.form.sso.description":
    "כשמאופשר (ON), משתמשים יוכלו להתחבר באמצעות SSO",
  ...
  "Settings.sso.form.defaultRole.description":
    "אפשרות זו תעניק הרשאה דיפולטית למשתמש שהתחבר בפעם הראשונה",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "נדרשות הרשאות כדי לצפות בהרשאות מנהל",
  "Settings.sso.form.defaultRole.label": "הרשאה דיפולטית",
  "Settings.sso.form.registration.description":
    "צור חשבון משתמש בעת התחברות עם SSO במידה ולא קיים חשבון זהה",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "מופע זה קיים רק לתוכן לו מופעל מנגנון הטיוטה/פורסם",
  ...
  "Users.components.List.empty.withFilters":
    "אין משתמשים עם הפילטרים שנבחרו ...",
  "Users.components.List.empty.withSearch":
    "אין משתמשים המתאימים לחיפוש ({search})...",
  ...
  "app.components.HomePage.community.content":
    "שוחח בערוצים שונים עם חברי הצוות, התורמים והמפתחים.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "אנו שמחים לקבל אתכם כחלק מהקהילה. אנחנו כל הזמן מחפשים משוב אז אל תהסס לשלוח לנו DM",
  "app.components.HomePage.welcomeBlock.content.again":
    "אנו מקווים שאתה מתקדם בפרויקט שלך... אל תהסס לקרוא את החדשות האחרונות על סטראפי. אנו עושים כמיטב יכולתנו לשפר את המוצר על סמך המשוב שלך.",
  ...
  "app.components.ImgPreview.hint":
    "גרור ושחרר את הקובץ לאזור זה או {browse} קובץ להעלאה",
  ...
  "app.components.InstallPluginPage.Download.description":
    "ייתכן שיידרשו כמה שניות להוריד ולהתקין את התוסף.",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "ייתכן שיחלפו מספר שניות להסרת התוסף.",
  "app.components.ListPluginsPage.deletePlugin.title": "מסיר התקנה",
  "app.components.ListPluginsPage.description":
    "רשימת התוספים המותקנים בפרויקט.",
  "app.components.ListPluginsPage.helmet.title": "רשימת תוספים",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "יש להפעיל את תכונת הטעינה האוטומטית. נא להתחיל את האפליקציה באמצעות `yarn develop`.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "מטעמי אבטחה, ניתן להוריד תוספים רק בסביבת פיתוח.",
  ...
  "app.components.Users.MagicLink.connect":
    "שלח קישור זה למשתמש כדי שיוכל להתחבר.",
  "app.components.Users.MagicLink.connect.sso":
    "שלח את הקישור הזה למשתמש, ההתחברות הראשונה יכולה להתבצע באמצעות ספק SSO",
  ...
  "app.components.Users.ModalCreateBody.block-title.roles.description":
    "לחשבון שלך יכולה להיות הרשאה אחת או יותר",
  ...
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "אם אינך מקבל קישור זה, יש לפנות אל מנהל המערכת.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "זה יכול לקחת כמה דקות עד לקבלת הקישור לשחזור הסיסמה.",
  ...
  "components.AutoReloadBlocker.description":
    "הפעל את סטראפי באמצעות אחת מהפקודות הבאות:",
  "components.AutoReloadBlocker.header":
    "יש צורך בתכונת טעינה מחדש עבור תוסף זה.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "גרור ושחרר קבצים, הדבק מהלוח או {browse}.",
  ...
  "global.prompt.unsaved":
    "האם אתה בטוח שברצונך לעזוב את עמוד? כל השינויים ילכו לאיבוד",
...
//# sourceMappingURL=he-SUOZnrPI.mjs.map
