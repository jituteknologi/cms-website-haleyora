const Analytics = "એનાલિટિક્સ";
const anErrorOccurred = "ઉફ્ફ! કંઈક ખોટું થયું. કૃપા કરીને, ફરી પ્રયાસ કરો.";
const clearLabel = "સાફ કરો";
const skipToContent = "સામગ્રી પર જાઓ";
const submit = "સબમિટ કરો";
const gu = {
  Analytics,
  "Auth.components.Oops.text": "તમારું એકાઉન્ટ સસ્પેન્ડ કરવામાં આવ્યું છે.",
  "Auth.components.Oops.text.admin":
    "જો આ ભૂલ છે, તો કૃપા કરીને તમારા વ્યવસ્થાપકનો સંપર્ક કરો",
  ...
  "Auth.form.button.login.providers.error":
    "અમે તમને પસંદ કરેલ પ્રદાતા દ્વારા કનેક્ટ કરી શકતા નથી",
  ...
  "Auth.form.error.blocked":
    "તમારું એકાઉન્ટ એડમિનિસ્ટ્રેટર દ્વારા અવરોધિત કરવામાં આવ્યું છે",
  ...
  "Auth.form.error.email.provide":
    "કૃપા કરીને તમારું વપરાશકર્તા નામ અથવા તમારું ઇમેઇલ પ્રદાન કરો",
  ...
  "Auth.form.error.password.format":
    "તમારા પાસવર્ડમાં ત્રણ કરતા વધુ વખત `$` ચિહ્ન ન હોઈ શકે",
  "Auth.form.error.password.local":
    "આ વપરાશકર્તાએ ક્યારેય સ્થાનિક પાસવર્ડ સેટ કર્યો નથી, કૃપા કરીને એકાઉન્ટ બનાવતી વખતે ઉપયોગમાં લેવાતા પ્રદાતા દ્વારા લૉગિન કરો",
  ...
  "Settings.permissions.conditions.no-actions":
    "તમારે તેના પર શરતો વ્યાખ્યાયિત કરતા પહેલા ક્રિયાઓ (બનાવો, વાંચો, અપડેટ કરો, ...) પસંદ કરો.",
  ...
  "Settings.profile.form.section.experience.interfaceLanguage.hint":
    "આ ફક્ત પસંદ કરેલી ભાષામાં તમારું પોતાનું ઈન્ટરફેસ પ્રદર્શિત કરશે.",
  "Settings.profile.form.section.experience.interfaceLanguageHelp":
    "પસંદગીના ફેરફારો ફક્ત તમને જ લાગુ થશે. વધુ માહિતી {અહીં} ઉપલબ્ધ છે.",
  "Settings.profile.form.section.experience.mode.label": "ઇન્ટરફેસ મોડ",
  "Settings.profile.form.section.experience.mode.hint":
    "તમારું ઇન્ટરફેસ પસંદ કરેલ મોડમાં દર્શાવે છે.",
  ...
  "Settings.roles.create.description":
    "ભૂમિકાને આપવામાં આવેલા અધિકારોને વ્યાખ્યાયિત કરો",
  ...
  "Settings.roles.form.button.users-with-role":
    "{સંખ્યા, બહુવચન, =0 {# વપરાશકર્તાઓ} એક {# વપરાશકર્તા} અન્ય {# વપરાશકર્તાઓ}} આ ભૂમિકા સાથે",
  ...
  "Settings.sso.form.defaultRole.description":
    "તે નવા પ્રમાણિત વપરાશકર્તાને પસંદ કરેલ ભૂમિકા સાથે જોડશે",
  "Settings.sso.form.defaultRole.description-not-allowed":
    "તમારી પાસે એડમિન ભૂમિકાઓ વાંચવા માટે પરવાનગી હોવી જરૂરી છે",
  "Settings.sso.form.defaultRole.label": "મૂળભૂત ભૂમિકા",
  "Settings.sso.form.registration.description":
    "જો કોઈ એકાઉન્ટ અસ્તિત્વમાં ન હોય તો SSO લૉગિન પર નવો વપરાશકર્તા બનાવો",
  ...
  "Settings.webhooks.event.publish-tooltip":
    "આ ઇવેન્ટ ફક્ત ડ્રાફ્ટ/પ્રકાશિત સિસ્ટમ સક્ષમ કરેલ સામગ્રીઓ માટે જ અસ્તિત્વમાં છે",
  ...
  "Settings.webhooks.to.delete":
    "{webhooksToDeleteLength, બહુવચન, એક {# સંપત્તિ} અન્ય {# સંપત્તિ}} પસંદ કરેલ",
  ...
  "usecase.notification.success.project-created":
    "પ્રોજેક્ટ સફળતાપૂર્વક બનાવવામાં આવ્યો છે",
  "Usecase.other": "અન્ય",
  ...
  "Users.components.List.empty.withFilters":
    "લાગુ કરેલ ફિલ્ટર્સ સાથે કોઈ વપરાશકર્તા નથી...",
  "Users.components.List.empty.withSearch":
    "શોધને અનુરૂપ કોઈ વપરાશકર્તાઓ નથી ({search})...",
  ...
  "admin.pages.MarketPlacePage.offline.subtitle":
    "સ્ટ્રેપી માર્કેટને ઍક્સેસ કરવા માટે તમારે ઇન્ટરનેટ સાથે કનેક્ટેડ હોવું જરૂરી છે.",
  "admin.pages.MarketPlacePage.plugin.copy": "ઇન્સ્ટોલ આદેશની નકલ કરો",
  "admin.pages.MarketPlacePage.plugin.copy.success":
    "તમારા ટર્મિનલમાં પેસ્ટ કરવા માટે તૈયાર આદેશ ઇન્સ્ટોલ કરો",
  ...
  "admin.pages.MarketPlacePage.missingPlugin.description":
    "તમે કયું પ્લગઇન શોધી રહ્યાં છો તે અમને કહો અને અમે અમારા સમુદાય પ્લગઇન ડેવલપર્સને જણાવીશું કે તેઓ પ્રેરણાની શોધમાં હોય તો!",
  anErrorOccurred,
  ...
  "app.components.BlockLink.blog.content":
    "સ્ટ્રેપી અને ઇકોસિસ્ટમ વિશે નવીનતમ સમાચાર વાંચો.",
  "app.components.BlockLink.code": "કોડ ઉદાહરણો",
  "app.components.BlockLink.code.content":
    "સમુદાય દ્વારા વિકસિત વાસ્તવિક પ્રોજેક્ટ્સનું પરીક્ષણ કરીને શીખો.",
  "app.components.BlockLink.documentation.content":
    "આવશ્યક ખ્યાલો, માર્ગદર્શિકાઓ અને સૂચનાઓ શોધો.",
  "app.components.BlockLink.tutorial": "ટ્યુટોરિયલ્સ",
  "app.components.BlockLink.tutorial.content":
    "સ્ટ્રેપીનો ઉપયોગ કરવા અને કસ્ટમાઇઝ કરવા માટે પગલું-દર-પગલાં સૂચનોને અનુસરો.",
  ...
  "app.components.DownloadInfo.text":
    "આમાં એક મિનિટ લાગી શકે છે. તમારી ધીરજ બદલ આભાર.",
  ...
  "app.components.EmptyStateLayout.content-permissions":
    "તમારી પાસે તે સામગ્રીને ઍક્સેસ કરવાની પરવાનગીઓ નથી",
  "app.components.GuidedTour.CM.create.content":
    "<p>અહીં કન્ટેન્ટ મેનેજરમાં તમામ કન્ટેન્ટ બનાવો અને મેનેજ કરો.</p><p>ઉદા.: બ્લોગ વેબસાઈટના ઉદાહરણને આગળ લઈએ તો, કોઈ એક લખી શકે છે. તેમને ગમે તે રીતે લેખ, સાચવો અને પ્રકાશિત કરો.</p><p>💡 ઝડપી ટીપ - તમે જે સામગ્રી બનાવો છો તેના પર પ્રકાશિત કરવાનું ભૂલશો નહીં.</p>",
  "app.components.GuidedTour.CM.create.title": "⚡️ સામગ્રી બનાવો",
  "app.components.GuidedTour.CM.success.content":
    "<p>અદ્ભુત, જવા માટેનું એક છેલ્લું પગલું!</p><b>🚀 ક્રિયામાં સામગ્રી જુઓ</b>",
  ...
  "app.components.GuidedTour.CTB.create.content":
    "<p>સંગ્રહના પ્રકારો તમને ઘણી એન્ટ્રીઓનું સંચાલન કરવામાં મદદ કરે છે, સિંગલ પ્રકારો માત્ર એક જ એન્ટ્રીને મેનેજ કરવા માટે યોગ્ય છે.</p> <p>ઉદા.: બ્લોગ વેબસાઇટ માટે, લેખો એક સંગ્રહ પ્રકાર હશે જ્યારે હોમપેજ એક પ્રકારનું હશે.</p>",
  ...
  "app.components.GuidedTour.CTB.success.content":
    "<p>સારું ચાલી રહ્યું છે!</p><b>⚡️ તમે વિશ્વ સાથે શું શેર કરવા માંગો છો?</b>",
  "app.components.GuidedTour.CTB.success.title": "પગલું 1: પૂર્ણ ✅",
  "app.components.GuidedTour.apiTokens.create.content":
    "<p>અહીં એક પ્રમાણીકરણ ટોકન જનરેટ કરો અને તમે હમણાં જ બનાવેલ સામગ્રી પુનઃપ્રાપ્ત કરો.</p>",
  "app.components.GuidedTour.apiTokens.create.cta.title": "એક API ટોકન બનાવો",
  "app.components.GuidedTour.apiTokens.create.title":
    "🚀 ક્રિયામાં સામગ્રી જુઓ",
  "app.components.GuidedTour.apiTokens.success.content":
    "<p>એક HTTP વિનંતી કરીને સામગ્રીને ક્રિયામાં જુઓ:</p><ul><li><p>આ URL પર: <light>https: //'<'YOUR_DOMAIN'>'/api/'<'YOUR_CT'>'</light></p></li><li><p>હેડર સાથે: <light>અધિકૃતતા: વાહક '<' YOUR_API_TOKEN'>'</light></p></li></ul><p>સામગ્રી સાથે ક્રિયાપ્રતિક્રિયા કરવાની વધુ રીતો માટે, <documentationLink>દસ્તાવેજીકરણ</documentationLink> જુઓ.</p>",
  ...
  "app.components.GuidedTour.home.CM.title":
    "⚡️ તમે વિશ્વ સાથે શું શેર કરવા માંગો છો?",
  "app.components.GuidedTour.home.CTB.cta.title":
    "સામગ્રી પ્રકાર બિલ્ડર પર જાઓ",
  ...
  "app.components.HomePage.community.content":
    "વિવિધ ચેનલો પર ટીમના સભ્યો, યોગદાનકર્તાઓ અને વિકાસકર્તાઓ સાથે ચર્ચા કરો.",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "અભિનંદન! તમે પ્રથમ એડમિનિસ્ટ્રેટર તરીકે લૉગ ઇન થયા છો. સ્ટ્રેપી દ્વારા પ્રદાન કરવામાં આવેલ શક્તિશાળી સુવિધાઓ શોધવા માટે, અમે તમને તમારો પ્રથમ સામગ્રી પ્રકાર બનાવવાની ભલામણ કરીએ છીએ!",
  "app.components.HomePage.welcomeBlock.content.again":
    "અમને આશા છે કે તમે તમારા પ્રોજેક્ટમાં પ્રગતિ કરી રહ્યાં છો! સ્ટ્રેપી વિશેના નવીનતમ સમાચાર વાંચવા માટે નિઃસંકોચ. અમે તમારા પ્રતિસાદના આધારે ઉત્પાદનને સુધારવા માટે અમારા શ્રેષ્ઠ પ્રયાસો આપી રહ્યા છીએ.",
  ...
  "app.components.ImgPreview.hint":
    "તમારી ફાઇલને આ વિસ્તારમાં ખેંચો અને છોડો અથવા ફાઇલ અપલોડ કરવા માટે {બ્રાઉઝ કરો",
  ...
  "app.components.LeftMenuLinkContainer.noPluginsInstalled":
    "હજુ સુધી કોઈ પ્લગઈન્સ ઇન્સ્ટોલ કરેલ નથી",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "પ્લગઇનને અનઇન્સ્ટોલ કરવામાં થોડીક સેકન્ડ લાગી શકે છે.",
  "app.components.ListPluginsPage.deletePlugin.title":
    "અનઇન્સ્ટોલ કરી રહ્યું છે",
  "app.components.ListPluginsPage.description":
    "પ્રોજેક્ટમાં ઇન્સ્ટોલ કરેલ પ્લગિન્સની સૂચિ.",
  ...
  "app.components.MarketplaceBanner":
    "સમુદાય દ્વારા બનાવવામાં આવેલ પ્લગઇન્સ અને તમારા પ્રોજેક્ટને કિકસ્ટાર્ટ કરવા માટે ઘણી વધુ અદ્ભુત વસ્તુઓ, Strapi Awesome પર શોધો.",
  ...
  "app.components.PluginCard.Button.label.install":
    "પહેલેથી જ ઇન્સ્ટોલ કરેલ છે",
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "ઓટોરીલોડ સુવિધાને સક્ષમ કરવાની જરૂર છે. કૃપા કરીને તમારી એપ્લિકેશનને `યાર્ન ડેવલપ` સાથે પ્રારંભ કરો.",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.environment":
    "સુરક્ષા કારણોસર, પ્લગઇન ફક્ત વિકાસ વાતાવરણમાં જ ડાઉનલોડ કરી શકાય છે.",
  "app.components.PluginCard.PopUpWarning.install.impossible.title":
    "ડાઉનલોડ કરવું અશક્ય છે",
  ...
  "app.components.Users.MagicLink.connect":
    "આ વપરાશકર્તાને ઍક્સેસ આપવા માટે આ લિંક કૉપિ કરો અને શેર કરો",
  "app.components.Users.MagicLink.connect.sso":
    "વપરાશકર્તાને આ લિંક મોકલો, પ્રથમ લૉગિન SSO પ્રદાતા દ્વારા કરી શકાય છે",
  ...
  "app.components.Users.ModalCreateBody.block-title.roles.description":
    "વપરાશકર્તા એક અથવા અનેક ભૂમિકાઓ ધરાવી શકે છે",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "પ્લગઇનને અનઇન્સ્ટોલ કરતી વખતે ભૂલ આવી",
  "app.containers.App.notification.error.init":
    "એપીઆઈની વિનંતી કરતી વખતે ભૂલ આવી",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "જો તમને આ લિંક પ્રાપ્ત ન થાય, તો કૃપા કરીને તમારા વ્યવસ્થાપકનો સંપર્ક કરો.",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "તમારી પાસવર્ડ પુનઃપ્રાપ્તિ લિંક પ્રાપ્ત કરવામાં થોડી મિનિટો લાગી શકે છે.",
  ...
  "app.containers.Users.ModalForm.footer.button-success":
    "વપરાશકર્તાને આમંત્રિત કરો",
  "app.links.configure-view": "દૃશ્યને ગોઠવો",
  "app.page.not.found":
    "અરેરે! તમે જે પૃષ્ઠ શોધી રહ્યાં છો તે અમે શોધી શકતા નથી...",
  ...
  "components.Input.error.validation.lowercase":
    "મૂલ્ય લોઅરકેસ સ્ટ્રિંગ હોવી જોઈએ",
  ...
  "components.Input.error.validation.regex":
    "મૂલ્ય રેગેક્સ સાથે મેળ ખાતું નથી.",
  ...
  "components.OverlayBlocker.description":
    "તમે એવી સુવિધાનો ઉપયોગ કરી રહ્યાં છો કે જેને સર્વર પુનઃપ્રારંભ કરવાની જરૂર છે. કૃપા કરીને સર્વર ચાલુ થાય ત્યાં સુધી રાહ જુઓ.",
  "components.OverlayBlocker.description.serverError":
    "સર્વર પુનઃપ્રારંભ થયેલ હોવું જોઈએ, કૃપા કરીને ટર્મિનલમાં તમારા લોગ તપાસો.",
  "components.OverlayBlocker.title": "પુનઃશરૂ થવાની રાહ જોઈ રહ્યાં છીએ...",
  "components.OverlayBlocker.title.serverError":
    "પુનઃપ્રારંભમાં અપેક્ષા કરતા વધુ સમય લાગી રહ્યો છે",
  "components.PageFooter.select": "પ્રતિ પાનાની એન્ટ્રી",
  "components.ProductionBlocker.description":
    "સુરક્ષા હેતુઓ માટે અમારે અન્ય વાતાવરણમાં આ પ્લગઈનને અક્ષમ કરવું પડશે.",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "ફાઈલોને ખેંચો અને છોડો, ક્લિપબોર્ડમાંથી પેસ્ટ કરો અથવા {બ્રાઉઝ કરો}.",
  ...
  "content-manager.App.schemas.data-loaded":
    "સ્કીમા સફળતાપૂર્વક લોડ કરવામાં આવી છે",
  "content-manager.ListViewTable.relation-loaded":
    "સંબંધો લોડ કરવામાં આવ્યા છે",
  "content-manager.ListViewTable.relation-loading": "સંબંધો લોડ થઈ રહ્યા છે",
  "content-manager.ListViewTable.relation-more":
    "આ સંબંધમાં પ્રદર્શિત કરતાં વધુ એકમો છે",
  ...
  "content-manager.components.DynamicZone.missing-components":
    "ત્યાં {સંખ્યા, બહુવચન, =0 {are # ખૂટે છે} એક {છે # ખૂટે છે} અન્ય {છે # ખૂટે છે}}",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "એન્ટ્રીઓને ફિલ્ટર કરવા માટે લાગુ કરવા માટેની શરતો સેટ કરો",
  ...
  "content-manager.components.TableDelete.label":
    "{સંખ્યા, બહુવચન, એક {# એન્ટ્રી} અન્ય {# એન્ટ્રી}} પસંદ કરેલ",
  "content-manager.components.TableEmpty.withFilters":
    "લાગુ કરેલ ફિલ્ટર્સ સાથે કોઈ {contentType} નથી...",
  "content-manager.components.TableEmpty.withSearch":
    "શોધને અનુરૂપ કોઈ {contentType} નથી ({search})...",
  "content-manager.components.TableEmpty.withoutFilter":
    "ત્યાં કોઈ {contentType} નથી...",
  "content-manager.components.empty-repeatable":
    "હજી સુધી કોઈ એન્ટ્રી નથી. એક ઉમેરવા માટે નીચેના બટન પર ક્લિક કરો.",
  "content-manager.components.notification.info.maximum-requirement":
    "તમે પહેલેથી જ ફીલ્ડ્સની મહત્તમ સંખ્યા પર પહોંચી ગયા છો",
  "content-manager.components.notification.info.minimum-requirement":
    "લઘુત્તમ જરૂરિયાતને મેચ કરવા માટે એક ક્ષેત્ર ઉમેરવામાં આવ્યું છે",
  "content-manager.components.repeatable.reorder.error":
    "તમારા ઘટકના ક્ષેત્રને પુનઃક્રમાંકિત કરતી વખતે એક ભૂલ આવી, કૃપા કરીને ફરી પ્રયાસ કરો",
  ...
  "content-manager.containers.EditView.notification.errors":
    "ફોર્મમાં કેટલીક ભૂલો છે",
  "content-manager.containers.Home.introduction":
    "તમારી એન્ટ્રીઓને સંપાદિત કરવા માટે ડાબા મેનુમાંની ચોક્કસ લિંક પર જાઓ. આ પ્લગઇન પાસે સેટિંગ્સને સંપાદિત કરવાની યોગ્ય રીત નથી અને તે હજુ પણ સક્રિય વિકાસ હેઠળ છે.",
  "content-manager.containers.Home.pluginHeaderDescription":
    "એક શક્તિશાળી અને સુંદર ઇન્ટરફેસ દ્વારા તમારી એન્ટ્રીઓનું સંચાલન કરો.",
  ...
  "content-manager.containers.ListPage.items":
    "{સંખ્યા, બહુવચન, =0 {items} એક {item} અન્ય {items}}",
  ...
  "content-manager.containers.SettingPage.attributes.description":
    "લક્ષણોનો ક્રમ વ્યાખ્યાયિત કરો",
  "content-manager.containers.SettingPage.editSettings.description":
    "લેઆઉટ બનાવવા માટે ફીલ્ડ્સને ખેંચો અને છોડો",
  ...
  "content-manager.containers.SettingsPage.Block.generalSettings.description":
    "તમારા સંગ્રહના પ્રકારો માટે ડિફૉલ્ટ વિકલ્પોને ગોઠવો",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "તમારા તમામ સંગ્રહ પ્રકારો અને જૂથો માટે સેટિંગ્સ ગોઠવો",
  "content-manager.containers.SettingsView.list.subtitle":
    "તમારા સંગ્રહ પ્રકારો અને જૂથોના લેઆઉટ અને પ્રદર્શનને ગોઠવો",
  ...
  "content-manager.error.records.count":
    "ગણના રેકોર્ડ્સ લાવવા દરમિયાન ભૂલ આવી છે.",
  ...
  "content-manager.form.Input.label.inputDescription":
    "આ મૂલ્ય ટેબલના હેડમાં પ્રદર્શિત લેબલને ઓવરરાઇડ કરે છે",
  "content-manager.form.Input.pageEntries": "પ્રતિ પાનાની એન્ટ્રી",
  "content-manager.form.Input.pageEntries.inputDescription":
    "નોંધ: તમે સંગ્રહ પ્રકાર સેટિંગ્સ પૃષ્ઠમાં આ મૂલ્યને ઓવરરાઇડ કરી શકો છો.",
  ...
  "content-manager.notification.error.displayedFields":
    "તમને ઓછામાં ઓછા એક પ્રદર્શિત ક્ષેત્રની જરૂર છે",
  "content-manager.notification.error.relationship.fetch":
    "સંબંધ લાવવા દરમિયાન એક ભૂલ આવી છે.",
  "content-manager.notification.info.SettingPage.disableSort":
    "તમારી પાસે અનુમતિ વર્ગીકરણ સાથે એક વિશેષતા હોવી જરૂરી છે",
  "content-manager.notification.info.minimumFields":
    "તમારે ઓછામાં ઓછું એક ફીલ્ડ પ્રદર્શિત કરવું જરૂરી છે",
  "content-manager.notification.upload.error":
    "તમારી ફાઇલો અપલોડ કરતી વખતે એક ભૂલ આવી છે",
  "content-manager.pageNotFound": "પૃષ્ઠ મળ્યું નથી",
  "content-manager.pages.ListView.header-subtitle":
    "{સંખ્યા, બહુવચન, =0 {# એન્ટ્રી} એક {# એન્ટ્રી} અન્ય {# એન્ટ્રી}} મળી",
  "content-manager.pages.NoContentType.button":
    "તમારો પ્રથમ સામગ્રી-પ્રકાર બનાવો",
  "content-manager.pages.NoContentType.text":
    "તમારી પાસે હજી સુધી કોઈ સામગ્રી નથી, અમે તમને તમારો પ્રથમ સામગ્રી-પ્રકાર બનાવવાની ભલામણ કરીએ છીએ.",
  "content-manager.permissions.not-allowed.create":
    "તમને દસ્તાવેજ બનાવવાની મંજૂરી નથી",
  "content-manager.permissions.not-allowed.update":
    "તમને આ દસ્તાવેજ જોવાની મંજૂરી નથી",
  "content-manager.plugin.description.long":
    "તમારા ડેટાબેઝમાં ડેટા જોવા, સંપાદિત કરવા અને કાઢી નાખવાની ઝડપી રીત.",
  ...
  "content-manager.utils.data-loaded":
    "{સંખ્યા, બહુવચન, =1 {એન્ટ્રી છે} અન્ય {એન્ટ્રીઝ છે}} સફળતાપૂર્વક લોડ કરવામાં આવી છે",
  "content-manager.apiError. આ વિશેષતા અનન્ય હોવી જોઈએ":
    "{field} અનન્ય હોવી જોઈએ",
  "content-manager.popUpWarning.warning.publish-question":
    "શું તમે હજુ પણ તેને પ્રકાશિત કરવા માંગો છો?",
  ...
  "content-manager.popUpwarning.warning.has-draft-relations.message":
    "<b>{ગણતરી, બહુવચન, =0 { તમારા સામગ્રી સંબંધોમાંથી એક { તમારા સામગ્રી સંબંધો છે} અન્ય { તમારા સામગ્રી સંબંધો છે}</b> હજુ સુધી પ્રકાશિત થયા નથી.<br></br>તે તમારા પ્રોજેક્ટમાં તૂટેલી લિંક્સ અને ભૂલો પેદા કરી શકે છે.",
  ...
  "global.prompt.unsaved":
    "શું તમે ખરેખર આ પૃષ્ઠ છોડવા માંગો છો? તમારા બધા ફેરફારો ખોવાઈ જશે",
  ...
  "notification.contentType.relations.conflict":
    "સામગ્રીના પ્રકારમાં વિરોધાભાસી સંબંધો છે",
...
//# sourceMappingURL=gu-k2JKO75-.mjs.map
