...
const Table = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.DynamicTable, {
    headers,
    contentType,
    rows: tokens,
...
const TableRows = ({
  ...
  const [, sortOrder] =
    query && query.sort ? query.sort.split(":") : [void 0, "ASC"];
  const {
    push,
    location: { pathname },
            ...
            withBulkActions &&
              /* @__PURE__ */ jsxRuntime.jsx(designSystem.Td, {
                children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  ...
                  children: [
                    canUpdate &&
                      /* @__PURE__ */ jsxRuntime.jsx(UpdateButton, {
                        tokenName: token.name,
                        tokenId: token.id,
                      }),
                    !canUpdate &&
                      canRead &&
                      /* @__PURE__ */ jsxRuntime.jsx(ReadButton, {
                        tokenName: token.name,
                        tokenId: token.id,
                      }),
                    canDelete &&
                      /* @__PURE__ */ jsxRuntime.jsx(DeleteButton, {
                        tokenName: token.name,
...
const DefaultButton = ({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(LinkStyled, {
...
const UpdateButton = ({ tokenName, tokenId }) => {
  return /* @__PURE__ */ jsxRuntime.jsx(DefaultButton, {
    tokenName,
    tokenId,
    children: /* @__PURE__ */ jsxRuntime.jsx(Icons.Pencil, { width: 12 }),
  });
};
exports.Table = Table;
