...
import { S as StrapiLogo, r as useDebounce } from "./index-qQynS5yD.mjs";
        ...
        children: [
          ...
          isVisible &&
            /* @__PURE__ */ jsx(Popover, {
              ...
              padding: 3,
              spacing: 4,
              children: /* @__PURE__ */ jsxs(FiltersFlex, {
                direction: "column",
                alignItems: "stretch",
                gap: 1,
                children: [
...
const NpmPackageCard = ({
  ...
  const npmPackageHref = `https://market.strapi.io/${pluralize.plural(
    npmPackageType
  )}/${attributes.slug}`;
...
const NpmPackagesGrid = ({
  ...
  if (status === "loading") {
    return /* @__PURE__ */ jsx(Flex, {
      ...
      paddingTop: 8,
      children: /* @__PURE__ */ jsx(Loader, { children: "Loading content..." }),
    });
  }
...
const ProtectedMarketplacePage = () => {
  ...
  return (
    ...
    /* @__PURE__ */ jsx(CheckPagePermissions, {
...
//# sourceMappingURL=MarketplacePage-JD39Vp_U.mjs.map
