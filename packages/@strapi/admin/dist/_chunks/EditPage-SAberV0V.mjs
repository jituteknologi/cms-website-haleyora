...
import { u as useAdminRoles } from "./useAdminRoles-1eHA6jB7.mjs";
import { u as useContentTypes } from "./useContentTypes-XTpMl3U-.mjs";
import {
  j as selectServerState,
  a as selectIsWorkflowDirty,
  b as selectCurrentWorkflow,
  k as selectHasDeletedServerStages,
  c as selectRoles,
  s as selectIsLoading,
  v as validateWorkflow,
  u as useInjectReducer,
  l as setWorkflow,
  d as setWorkflows,
  e as setContentTypes,
  f as setRoles,
  g as setIsLoading,
  r as resetWorkflow,
  W as WorkflowAttributes,
  S as Stages,
  i as reducer,
} from "./validateWorkflow-cqSZZDgN.mjs";
import { s as selectAdminPermissions } from "./AuthenticatedApp-V2Dm6x5Q.mjs";
import {
  m as useLicenseLimits,
  x as isBaseQueryError,
} from "./index-qQynS5yD.mjs";
import { e as useUpdateWorkflowMutation } from "./reviewWorkflows-lF_2qmI8.mjs";
import {
  D as DragLayerRendered,
  H as Header,
  B as Back,
  R as Root,
} from "./Layout-gqXnnLEz.mjs";
import { L as LimitsModal } from "./LimitsModal-slvRtty7.mjs";
import {
  C as CHARGEBEE_WORKFLOW_ENTITLEMENT_NAME,
  a as CHARGEBEE_STAGES_PER_WORKFLOW_ENTITLEMENT_NAME,
  R as REDUX_NAMESPACE,
} from "./constants-8sAt6dKz.mjs";
import { u as useReviewWorkflows } from "./useReviewWorkflows--OSBhIG-.mjs";
...
const ReviewWorkflowsEditPage = () => {
  ...
  React.useEffect(() => {
    ...
    dispatch(
      setIsLoading(isLoadingWorkflow || isLoadingContentTypes || isLoadingRoles)
    );
    return () => {
  ...
  return /* @__PURE__ */ jsxs(Fragment, {
    children: [
      ...
      /* @__PURE__ */ jsx(FormikProvider, {
        value: formik,
        children: /* @__PURE__ */ jsxs(Form, {
          onSubmit: formik.handleSubmit,
          children: [
            /* @__PURE__ */ jsx(Header, {
              navigationAction: /* @__PURE__ */ jsx(Back, {
...
export { ReviewWorkflowsEditPage };
//# sourceMappingURL=EditPage-SAberV0V.mjs.map
