    ...
    switch (action.type) {
      ...
      case constants.ACTION_DELETE_STAGE: {
        ...
        draft.clientState.currentWorkflow.data.stages =
          currentWorkflow.data.stages?.filter(
      ...
      case constants.ACTION_ADD_STAGE: {
        ...
        const newTempKey = getMaxTempKey(
          draft.clientState.currentWorkflow.data.stages
        );
      ...
      case constants.ACTION_CLONE_STAGE: {
        ...
        if (sourceStageIndex !== void 0 && sourceStageIndex !== -1) {
          ...
          draft.clientState.currentWorkflow.data.stages?.splice(
            sourceStageIndex + 1,
            0,
            {
              ...sourceStage,
      ...
      case constants.ACTION_UPDATE_STAGE: {
        ...
        draft.clientState.currentWorkflow.data.stages =
          currentWorkflow.data.stages?.map((stage) =>
...
const selectNamespace = (state) =>
  state[constants.REDUX_NAMESPACE] ?? initialState;
const selectContentTypes = toolkit.createSelector(
  selectNamespace,
  ({ serverState: { contentTypes } }) => contentTypes
);
const selectRoles = toolkit.createSelector(
  selectNamespace,
...
const selectIsWorkflowDirty = toolkit.createSelector(
  ...
  ({ serverState, clientState: { currentWorkflow } }) =>
    !isEqual__default.default(serverState.workflow, currentWorkflow.data)
);
const selectHasDeletedServerStages = toolkit.createSelector(
  ...
  ({ serverState, clientState: { currentWorkflow } }) =>
    !(serverState.workflow?.stages ?? []).every(
      (stage) =>
        !!currentWorkflow.data.stages?.find(({ id }) => id === stage.id)
    )
);
...
const selectServerState = toolkit.createSelector(
  selectNamespace,
...
const Stage = ({
  ...
  const [isApplyAllConfirmationOpen, setIsApplyAllConfirmationOpen] =
    React__namespace.useState(false);
  const [nameField, nameMeta, nameHelper] = formik.useField(
    `stages.${index$1}.name`
  );
  const [colorField, colorMeta, colorHelper] = formik.useField(
    `stages.${index$1}.color`
  );
  const [permissionsField, permissionsMeta, permissionsHelper] =
    formik.useField(`stages.${index$1}.permissions`);
  ...
  const [
    ...
    dragRef,
    dragPreviewRef,
  ] = index.useDragAndDrop(canReorder, {
    index: index$1,
    item: {
      index: index$1,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
    ...
    children: [
      ...
      isDragging
        ? /* @__PURE__ */ jsxRuntime.jsx(StageDropPreview, {})
                                ...
                                children: [
                                  canUpdate &&
                                    /* @__PURE__ */ jsxRuntime.jsx(
                                      v2.MenuItem,
                                      {
                                        onClick: () => dispatch(cloneStage(id)),
                                        children: formatMessage({
                      ...
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.TextInput,
                        {
                          ...
                          onChange: (event) => {
                            ...
                            dispatch(
                              updateStage(id, { name: event.target.value })
                            );
                          },
                          required: true,
                        }
                      ...
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                        designSystem.SingleSelect,
                        {
                          ...
                          children: colorOptions.map(
                            ({ value, label, color }) => {
                              const { themeColorName: themeColorName2 } =
                                colors.getStageColorByHex(color) || {};
                          ...
                          ? /* @__PURE__ */ jsxRuntime.jsx(
                              helperPlugin.NotAllowedInput,
                              {
                                description: {
                                  ...
                                  defaultMessage:
                                    "You don’t have the permission to see roles",
                                },
                                intlLabel: {
                                  id: "Settings.review-workflows.stage.permissions.label",
                                  defaultMessage:
                                    "Roles that can change this stage",
                                },
                              ...
                              children: [
                                    ...
                                    children: /* @__PURE__ */ jsxRuntime.jsx(
                                      designSystem.MultiSelect,
                                      {
                                        ...
                                        onChange: (values) => {
                                          ...
                                          permissionsHelper.setValue(
                                            permissions
                                          );
                                          dispatch(
                                            updateStage(id, { permissions })
                                          );
                                        },
                                        ...
                                        children:
                                          /* @__PURE__ */ jsxRuntime.jsx(
                                            designSystem.MultiSelectGroup,
                                            {
                                              ...
                                              values: filteredRoles?.map(
                                                (r) => `${r.id}`
                                              ),
                                              children: filteredRoles?.map(
                                                (role) => {
                                                  return /* @__PURE__ */ jsxRuntime.jsx(
                                                    NestedOption$1,
                                                    {
                                ...
                                /* @__PURE__ */ jsxRuntime.jsx(
                                  designSystem.IconButton,
                                  {
                                    ...
                                    variant: "secondary",
                                    onClick: () =>
                                      handleApplyPermissionsToAllStages(),
                                  }
                                ),
                              ],
                            }),
      ...
      /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.ConfirmDialog.Root, {
        ...
        onConfirm: () => {
          ...
          toggleNotification({
            ...
            message: formatMessage({
              ...
              defaultMessage:
                "Applied roles to all other stages of the workflow",
            }),
          });
        },
        variantRightButton: "default",
        children: /* @__PURE__ */ jsxRuntime.jsx(
          helperPlugin.ConfirmDialog.Body,
          {
...
const Stages = ({ canDelete = true, canUpdate = true, stages = [] }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
    ...
    children: [
      ...
      canUpdate &&
        /* @__PURE__ */ jsxRuntime.jsx(AddStage, {
          type: "button",
          onClick: () => {
...
const WorkflowAttributes = ({ canUpdate = true }) => {
  ...
  const [contentTypesField, contentTypesMeta, contentTypesHelper] =
    formik.useField("contentTypes");
  const formatter = helperPlugin.useCollator(locale, {
    sensitivity: "base",
  });
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Grid, {
    background: "neutral0",
    hasRadius: true,
    gap: 4,
    padding: 6,
    ...
    children: [
      ...
      contentTypes &&
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.GridItem, {
          col: 6,
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.MultiSelect, {
            ...contentTypesField,
                ...
                ? [
                    {
                      ...
                      children: [...contentTypes.singleTypes].map(
                        (contentType) => ({
                          label: contentType.info.displayName,
                          value: contentType.uid,
                        })
                              ...
                              children: formatMessage(
                                ...
                                },
                                {
                                  ...
                                  em: (...children) =>
                                    /* @__PURE__ */ jsxRuntime.jsx(
                                      designSystem.Typography,
                                      { as: "em", fontWeight: "bold", children }
                                    ),
                                  i: (...children) =>
                                    /* @__PURE__ */ jsxRuntime.jsx(
                                      ContentTypeTakeNotice,
                                      { children }
                                    ),
                                }
                              ),
          ...
          name: yup__namespace
            ...
            .test(
              ...
              function (stageName) {
                ...
                return (
                  context?.stages.filter((stage) => stage.name === stageName)
                    .length === 1
                );
              }
            ),
          color: yup__namespace
            .string()
            .required(
              formatMessage({
...
//# sourceMappingURL=validateWorkflow-nEwtJ3ZE.js.map
