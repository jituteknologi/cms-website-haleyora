const Analytics = "การวิเคราะห์";
const Documentation = "เอกสารคู่มือ";
const Email = "อีเมล";
const Password = "รหัสผ่าน";
const Provider = "ผู้ให้บริการ";
const ResetPasswordToken = "โทเค็นสำหรับรีเซ็ตรหัสผ่าน";
const Role = "บทบาท";
...
const th = {
  ...
  "Auth.form.error.password.format":
    "รหัสผ่านของคุณไม่สามารถมีสัญลักษณ์ `$` ได้มากกว่าสามครั้ง",
  "Auth.form.error.password.local":
    "ผู้ใช้นี้ไม่เคยตั้งค่ารหัสผ่าน, โปรดล็อกอินผ่านผู้ให้บริการที่ใช้ในระหว่างการสร้างแอคเคาต์",
  ...
  "Auth.form.error.ratelimit":
    "มีความพยายามมากเกินไป โปรดลองใหม่อีกครั้งในนาทีถัดไป",
  ...
  "Auth.form.register.news.label":
    "อัพเดตให้ฉันเกี่ยวกับคุณลักษณะใหม่และการปรับปรุงที่กำลังจะเกิดขึ้น (โดยการทำสิ่งนี้คุณยอมรับ {terms} และ {policy})",
  ...
  "HomePage.helmet.title": "โฮมเพจ",
  "HomePage.roadmap": "ดูโรดแม็พของเรา",
  "HomePage.welcome.congrats": "ยินดีด้วย!",
  "HomePage.welcome.congrats.content":
    "คุณได้ล็อกอินเป็นผู้ดูแลระบบคนแรก เพื่อค้นพบคุณสมบัติอันทรงพลังที่ให้ไว้กับ Strapi,",
  "HomePage.welcome.congrats.content.bold":
    "เราแนะนำให้คุณสร้างชนิดคอลเล็กชัน-ชนิดแรกของคุณ",
  ...
  "Roles.ListPage.notification.delete-all-not-allowed":
    "ไม่สามารถลบบางบทบาทได้เนื่องจากบทบาทถูกเชื่อมโยงกับผู้ใช้",
  "Roles.ListPage.notification.delete-not-allowed":
    "บทบาทไม่สามารถถูกลบได้ถ้าเชื่อมโยงกับผู้ใช้",
  "Roles.components.List.empty.withSearch":
    "ไม่มีบทบาทที่สอดคล้องกับการค้นหา ({search})...",
  ...
  "Settings.webhooks.list.description":
    "รับการแจ้งเตือนการเปลี่ยนแปลงผ่าน POST",
  "Settings.webhooks.list.empty.description":
    "เพิ่มรายการแรกของคุณลงในรายการนี้",
  ...
  "Users.components.List.empty.withSearch":
    "ไม่มีผู้ใช้ที่สอดคล้องกับการค้นหา ({search})...",
  ...
  "app.components.DownloadInfo.text":
    "อาจใช้เวลาหนึ่งสักครู่ ขอบคุณสำหรับความอดทนของคุณ",
  ...
  "app.components.HomePage.community.content":
    "ปรึกษากับสมาชิกของทีมผู้ให้การสนับสนุนและผู้พัฒนาบนอีกช่องทาง",
  ...
  "app.components.HomePage.welcomeBlock.content":
    "เรายินดีที่จะมีคุณเป็นส่วนหนึ่งของชุมชน. คุณรู้ไหม? เรากำลังมองหาผลตอบรับอย่างต่อเนื่อง ดังนั้นให้คุณสบายใจที่จะส่งข้อความโดยตรงให้กับเรา ",
  "app.components.HomePage.welcomeBlock.content.again":
    "เราหวังว่าคุณจะดำเนินการตามโครงการของคุณ ... อ่านข่าวล่าสุดเกี่ยวกับ Strapi เรากำลังให้สิ่งที่ดีที่สุดแก่เราเพื่อปรับปรุงผลิตภัณฑ์โดยยึดตามความคิดเห็นของคุณ",
  ...
  "app.components.ImgPreview.hint":
    "ลาก & ปล่อยไฟล์ของคุณลงในพื้นที่นี้ หรือ{browse}เพื่อหาไฟล์ที่จะอัพโหลด",
  ...
  "app.components.ListPluginsPage.deletePlugin.description":
    "อาจใช้เวลาสองสามวินาทีเพื่อถอนการติดตั้งปลั๊กอิน",
  "app.components.ListPluginsPage.deletePlugin.title": "การถอนติดตั้ง",
  "app.components.ListPluginsPage.description":
    "รายการของปลั๊กอินที่ติดตั้งไว้ในโปรเจ็กต์",
  "app.components.ListPluginsPage.helmet.title": "รายการปลั๊กอิน",
  ...
  "app.components.PluginCard.PopUpWarning.install.impossible.autoReload.needed":
    "คุณลักษณะ autoReload ต้องถูกเปิดใช้งาน โปรดเริ่มต้นแอปของคุณโดยใช้ `yarn develop`",
  ...
  "app.components.listPluginsPage.deletePlugin.error":
    "มีข้อผิดพลาดเกิดขึ้นขณะถอนการติดตั้งปลั๊กอิน",
  "app.containers.App.notification.error.init":
    "เกิดข้อผิดพลาดขึ้นขณะร้องขอ API",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.contact-admin":
    "ถ้าคุณไม่ได้รับลิงก์นี้โปรดติดต่อผู้ดูแลระบบของคุณ",
  "app.containers.AuthPage.ForgotPasswordSuccess.text.email":
    "อาจใช้เวลาสองสามนาทีเพื่อรับลิงก์การกู้คืนรหัสผ่านของคุณ",
  ...
  "components.AutoReloadBlocker.description":
    "รัน Strapi ด้วยหนึ่งในคำสั่งต่อไปนี้:",
  "components.AutoReloadBlocker.header":
    "รีโหลดคุณลักษณะที่จำเป็นสำหรับปลั๊กอินนี้",
  ...
  "components.OverlayBlocker.description":
    "คุณกำลังใช้คุณลักษณะที่ต้องมีการรีสตาร์ทเซิร์ฟเวอร์ โปรดรอจนกว่าเซิร์ฟเวอร์จะเริ่มทำงาน",
  "components.OverlayBlocker.description.serverError":
    "เซิร์ฟเวอร์ควรถูกรีสตาร์ท โปรดตรวจสอบบันทึกการทำงานของคุณในเทอร์มินัล",
  "components.OverlayBlocker.title": "กำลังรอการรีสตาร์ท...",
  "components.OverlayBlocker.title.serverError":
    "การรีสตาร์ทใช้เวลานานกว่าที่คาดไว้",
  "components.PageFooter.select": "รายการต่อหน้า",
  "components.ProductionBlocker.description":
    "เพื่อความปลอดภัยเราต้องปิดใช้งานปลั๊กอินนี้ในสภาวะแวดล้อมอื่น",
  "components.ProductionBlocker.header":
    "ปลั๊กอินนี้พร้อมใช้งานในการพัฒนาเท่านั้น",
  ...
  "components.WysiwygBottomControls.uploadFiles":
    "ลาก & ปล่อยไฟล์วางจากคลิปบอร์ดหรือ {browse}",
  ...
  "content-manager.EditRelations.title": "ข้อมูลเชิงสัมพันธ์",
  "content-manager.api.id": "รหัส API",
  "content-manager.components.AddFilterCTA.add": "ตัวกรอง",
  "content-manager.components.AddFilterCTA.hide": "ตัวกรอง",
  "content-manager.components.DraggableAttr.edit": "คลิกเพื่อแก้ไข",
  "content-manager.components.DynamicZone.pick-compo": "เลือกหนึ่งคอมโพเนนต์",
  "content-manager.components.DynamicZone.required": "ต้องการคอมโพเนนต์",
  "content-manager.components.EmptyAttributesBlock.button":
    "ไปที่หน้าค่าติดตั้ง",
  "content-manager.components.EmptyAttributesBlock.description":
    "คุณสามารถเปลี่ยนค่าติดตั้งของคุณ",
  "content-manager.components.FieldItem.linkToComponentLayout":
    "ตั้งค่าโครงร่างของคอมโพเนนต์",
  "content-manager.components.FilterOptions.button.apply": "นำไปใช้",
  ...
  "content-manager.components.FiltersPickWrapper.PluginHeader.description":
    "ตั้งค่าเงื่อนไขเพื่อใช้เพื่อกรองรายการต่างๆ",
  "content-manager.components.FiltersPickWrapper.PluginHeader.title.filter":
    "ตัวกรอง",
  "content-manager.components.FiltersPickWrapper.hide": "ซ่อน",
  "content-manager.components.LimitSelect.itemsPerPage": "ไอเท็มต่อเพจ",
  "content-manager.components.NotAllowedInput.text":
    "ไม่มีสิทธิในการดูฟิลด์นี้",
  "content-manager.components.Search.placeholder": "ค้นหารายการ...",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.edit-settings":
    "กำหนดวิธีที่มุมมองแก้ไขจะมีลักษณะเหมือน",
  "content-manager.components.SettingsViewWrapper.pluginHeader.description.list-settings":
    "กำหนดค่าติดตั้งของมุมมองรายการ",
  "content-manager.components.SettingsViewWrapper.pluginHeader.title":
    "กำหนดคอนฟิกมุมมอง - {name}",
  "content-manager.components.TableDelete.delete": "ลบทั้งหมด",
  "content-manager.components.TableDelete.deleteSelected": "ลบที่เลือกไว้",
  "content-manager.components.TableEmpty.withFilters":
    "ไม่มี {contentType} ตามตัวกรองที่ใช้ ...",
  "content-manager.components.TableEmpty.withSearch":
    "ไม่มี {contentType} ที่สอดคล้องกับการค้นหา ({search})...",
  ...
  "content-manager.components.notification.info.maximum-requirement":
    "คุณได้มาถึงจำนวนสูงสุดของฟิลด์แล้ว",
  "content-manager.components.notification.info.minimum-requirement":
    "ฟิลด์ถูกเพิ่มให้ตรงกับข้อกำหนดต่ำสุด",
  "content-manager.components.reset-entry": "รีเซ็ตรายการ",
  "content-manager.components.uid.apply": "สมัคร",
  "content-manager.components.uid.available": "ที่พร้อมใช้งาน",
  "content-manager.components.uid.regenerate": "สร้างใหม่อีกครั้ง",
  "content-manager.components.uid.suggested": "ค่าแนะนำ",
  "content-manager.components.uid.unavailable": "ไม่ว่าง",
  "content-manager.containers.Edit.Link.Layout": "กำหนดคอนฟิกโครงร่าง",
  "content-manager.containers.Edit.Link.Model": "แก้ไขชนิดของคอลเล็กชัน",
  "content-manager.containers.Edit.addAnItem": "เพิ่มไอเท็ม...",
  "content-manager.containers.Edit.clickToJump": "คลิกเพื่อข้ามไปยังรายการ",
  "content-manager.containers.Edit.delete": "ลบ",
  "content-manager.containers.Edit.editing": "กำลังแก้ไข...",
  "content-manager.containers.Edit.pluginHeader.title.new": "สร้างรายการ",
  "content-manager.containers.Edit.reset": "รีเซ็ต",
  "content-manager.containers.Edit.returnList": "กลับไปที่รายการ",
  "content-manager.containers.Edit.seeDetails": "รายละเอียด",
  "content-manager.containers.Edit.submit": "บันทึก",
  "content-manager.containers.EditSettingsView.modal-form.edit-field":
    "แก้ไขฟิลด์",
  "content-manager.containers.EditView.notification.errors":
    "ฟอร์มมีข้อผิดพลาดบางอย่าง",
  "content-manager.containers.Home.introduction":
    "หากต้องการแก้ไขรายการของคุณให้ไปยังลิงก์ที่ระบุเฉพาะในเมนูด้านซ้าย ปลั๊กอินนี้ไม่มีวิธีที่เหมาะสมในการแก้ไขการตั้งค่าและยังคงอยู่ภายใต้การพัฒนา",
  "content-manager.containers.Home.pluginHeaderDescription":
    "จัดการรายการของคุณโดยใช้อินเตอร์เฟสที่ทรงพลังและสวยงาม",
  "content-manager.containers.Home.pluginHeaderTitle": "ตัวจัดการเนื้อหา",
  "content-manager.containers.List.errorFetchRecords": "ข้อผิดพลาด",
  "content-manager.containers.ListPage.displayedFields": "ฟิลด์ที่แสดง",
  "content-manager.containers.ListSettingsView.modal-form.edit-label":
    "แก้ไขเลเบล",
  "content-manager.containers.SettingPage.add.field": "แทรกฟิลด์อื่น",
  "content-manager.containers.SettingPage.attributes": "ฟิลด์ Attributes",
  ...
  "content-manager.containers.SettingPage.editSettings.description":
    "ลาก & ปล่อยฟิลด์เพื่อสร้างโครงร่าง",
  ...
  "content-manager.containers.SettingPage.editSettings.entry.title.description":
    "ตั้งค่าฟิลด์ที่แสดงของรายการของคุณ",
  "content-manager.containers.SettingPage.editSettings.title":
    "มุมมองแก้ไข (ค่าติดตั้ง)",
  "content-manager.containers.SettingPage.layout": "โครงร่าง",
  "content-manager.containers.SettingPage.listSettings.description":
    "กำหนดคอนฟิกอ็อพชันสำหรับชนิดคอลเล็กชันนี้",
  "content-manager.containers.SettingPage.listSettings.title":
    "มุมมองรายการ (การตั้งค่า)",
  "content-manager.containers.SettingPage.pluginHeaderDescription":
    "กำหนดคอนฟิกค่าติดตั้งเฉพาะสำหรับชนิดคอลเล็กชันนี้",
  "content-manager.containers.SettingPage.settings": "การตั้งค่า",
  "content-manager.containers.SettingPage.view": "ดู",
  ...
  "content-manager.containers.SettingsPage.pluginHeaderDescription":
    "กำหนดคอนฟิกค่าติดตั้งสำหรับชนิดและกลุ่มคอลเล็กชันของคุณทั้งหมด",
  "content-manager.containers.SettingsView.list.subtitle":
    "กำหนดคอนฟิกโครงร่างและการแสดงชนิดคอลเล็กชันและกลุ่มของคุณ",
  "content-manager.containers.SettingsView.list.title": "แสดงการตั้งค่า",
  "content-manager.emptyAttributes.button": "ไปที่ตัวสร้างชนิดคอลเล็กชัน",
  "content-manager.emptyAttributes.description":
    "เพิ่มฟิลด์แรกของคุณลงในชนิดคอลเล็กชันของคุณ",
  "content-manager.emptyAttributes.title": "ยังไม่มีฟิลด์",
  "content-manager.error.attribute.key.taken": "ค่านี้มีอยู่แล้ว",
  "content-manager.error.attribute.sameKeyAndName": "ไม่สามารถเท่ากับ",
  "content-manager.error.attribute.taken": "ชื่อฟิลด์นี้มีอยู่แล้ว",
  "content-manager.error.contentTypeName.taken": "ชื่อนี้มีอยู่แล้ว",
  "content-manager.error.model.fetch":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลคอนฟิกโมเดล",
  "content-manager.error.record.create":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการสร้างเร็กคอร์ด",
  "content-manager.error.record.delete":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการลบเร็กคอร์ด",
  "content-manager.error.record.fetch":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลเร็กคอร์ด",
  "content-manager.error.record.update":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการอัพเดตเร็กคอร์ด",
  "content-manager.error.records.count":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลจำนวนนับเร็กคอร์ด",
  "content-manager.error.records.fetch":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลเร็กคอร์ด",
  "content-manager.error.schema.generation":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการสร้างสกีมา",
  "content-manager.error.validation.json": "นี่ไม่ใช่ JSON ้",
  "content-manager.error.validation.max": "ค่านั้นสูงเกินไป",
  "content-manager.error.validation.maxLength": "ค่ามีขนาดยาวเกินไป",
  "content-manager.error.validation.min": "ค่านี้ต่ำเกินไป",
  "content-manager.error.validation.minLength": "ค่านี้สั้นเกินไป",
  "content-manager.error.validation.minSupMax": "ไม่สามารถมากกว่า",
  "content-manager.error.validation.regex": "ค่าไม่ตรงกับ regex",
  "content-manager.error.validation.required": "ค่าที่ป้อนนี้จำเป็นต้องมี",
  "content-manager.form.Input.bulkActions": "เปิดใช้งานแอ็คชันขนาดใหญ่",
  "content-manager.form.Input.defaultSort": "แอ็ตทริบิวต์การเรียงเริ่มต้น",
  "content-manager.form.Input.description": "รายละเอียด",
  "content-manager.form.Input.description.placeholder": "แสดงชื่อในโปรไฟล์",
  "content-manager.form.Input.editable": "ฟิลด์แก้ไขได้",
  "content-manager.form.Input.filters": "เปิดใช้งานตัวกรอง",
  "content-manager.form.Input.label": "เลเบล",
  "content-manager.form.Input.label.inputDescription":
    "ค่านี้แทนที่เลเบลที่แสดงในส่วนหัวของตาราง",
  "content-manager.form.Input.pageEntries": "รายการต่อหน้า",
  "content-manager.form.Input.pageEntries.inputDescription":
    "หมายเหตุ: คุณสามารถแทนที่ค่านี้ในหน้าค่าติดตั้งชนิดคอลเล็กชัน",
  "content-manager.form.Input.placeholder": "ตัวอย่าง",
  "content-manager.form.Input.placeholder.placeholder": "ค่าของฉัน",
  "content-manager.form.Input.search": "เปิดใช้งานการค้นหา",
  "content-manager.form.Input.search.field": "เปิดใช้งานการค้นหาบนฟิลด์นี้",
  "content-manager.form.Input.sort.field": "เปิดใช้งานการเรียงลำดับบนฟิลด์นี้",
  "content-manager.form.Input.wysiwyg": "แสดงเป็น WYSIWYG",
  "content-manager.global.displayedFields": "ฟิลด์ที่แสดง",
  "content-manager.groups": "กลุ่ม",
  "content-manager.groups.numbered": "กลุ่ม ({number})",
  "content-manager.models": "ชนิดของคอลเล็กชัน",
  "content-manager.models.numbered": "ชนิดคอลเล็กชัน ({number})",
  "content-manager.notification.error.displayedFields":
    "คุณต้องการฟิลด์ที่แสดงอย่างน้อยหนึ่งฟิลด์",
  "content-manager.notification.error.relationship.fetch":
    "มีข้อผิดพลาดเกิดขึ้นระหว่างการดึงข้อมูลความสัมพันธ์",
  "content-manager.notification.info.SettingPage.disableSort":
    "คุณต้องมีหนึ่งแอ็ตทริบิวต์ที่มีการเรียงลำดับที่อนุญาต",
  "content-manager.notification.info.minimumFields":
    "คุณต้องมีการแสดงฟิลด์อย่างน้อยหนึ่งฟิลด์",
  "content-manager.notification.upload.error":
    "มีข้อผิดพลาดเกิดขึ้นขณะอัพโหลดไฟล์ของคุณ",
  "content-manager.pageNotFound": "ไม่พบหน้า",
  "content-manager.permissions.not-allowed.create":
    "คุณไม่ได้รับอนุญาตให้สร้างเอกสาร",
  "content-manager.permissions.not-allowed.update":
    "คุณไม่ได้รับอนุญาตให้ดูเอกสารนี้",
  "content-manager.plugin.description.long":
    "วิธีที่รวดเร็วในการดูแก้ไขและลบข้อมูลในฐานข้อมูลของคุณ",
  ...
  "content-manager.popUpWarning.bodyMessage.contentType.delete.all":
    "คุณแน่ใจว่าคุณต้องการลบรายการเหล่านี้หรือไม่?",
  "content-manager.popUpWarning.warning.cancelAllSettings":
    "คุณแน่ใจว่าต้องการยกเลิกการแก้ไขของคุณหรือไม่?",
  "content-manager.popUpWarning.warning.updateAllSettings":
    "สิ่งนี้จะปรับเปลี่ยนค่าติดตั้งทั้งหมดของคุณ",
  "content-manager.success.record.delete": "ลบแล้ว",
  "content-manager.success.record.save": "ถูกบันทึก",
  "form.button.done": "เสร็จแล้ว",
  "global.prompt.unsaved":
    "คุณแน่ใจว่าต้องการออกจากหน้านี้หรือไม่? การแก้ไขของคุณทั้งหมดจะหายไป",
...
//# sourceMappingURL=th-TrS9p5eO.mjs.map
