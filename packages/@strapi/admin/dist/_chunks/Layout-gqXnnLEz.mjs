...
import { P as DragLayer } from "./index-qQynS5yD.mjs";
...
const DragLayerRendered = () => {
  return /* @__PURE__ */ jsx(DragLayer, {
    renderItem: (item) => {
      if (item.type === DRAG_DROP_TYPES.STAGE) {
        return /* @__PURE__ */ jsx(StageDragPreview, {
...
const Root = ({ children }) => {
  return /* @__PURE__ */ jsx(Layout, {
    children: /* @__PURE__ */ jsx(Main, {
      tabIndex: -1,
      children: /* @__PURE__ */ jsx(ContentLayout, { children }),
    }),
  });
};
const Back = ({ href }) => {
...
export { Back as B, DragLayerRendered as D, Header as H, Root as R };
//# sourceMappingURL=Layout-gqXnnLEz.mjs.map
