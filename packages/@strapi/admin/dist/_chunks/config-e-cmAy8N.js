...
const browserslistToEsbuild__default = /* @__PURE__ */ _interopDefault(
  browserslistToEsbuild
);
const HtmlWebpackPlugin__default =
  /* @__PURE__ */ _interopDefault(HtmlWebpackPlugin);
const MiniCssExtractPlugin__default =
  /* @__PURE__ */ _interopDefault(MiniCssExtractPlugin);
const ForkTsCheckerPlugin__default =
  /* @__PURE__ */ _interopDefault(ForkTsCheckerPlugin);
const crypto__default = /* @__PURE__ */ _interopDefault(crypto);
const path__default = /* @__PURE__ */ _interopDefault(path);
const ReactRefreshWebpackPlugin__default = /* @__PURE__ */ _interopDefault(
...
const getAdminDependencyAliases = (monorepo) =>
  adminPackageAliases
    .filter(
      (moduleName) =>
        !monorepo?.path ||
        (monorepo.path && moduleName !== "@strapi/helper-plugin")
    )
    .reduce((acc, moduleName) => {
      acc[`${moduleName}$`] = findRoot__default.default(
...
const resolveBaseConfig = async (ctx) => {
  ...
  return {
    ...
    plugins: [
      ...
      ctx.tsconfig &&
        new ForkTsCheckerPlugin__default.default({
          typescript: {
...
const resolveDevelopmentConfig = async (ctx) => {
  ...
  return {
    ...
    cache: {
      ...
      version: crypto__default.default
        .createHash("md5")
