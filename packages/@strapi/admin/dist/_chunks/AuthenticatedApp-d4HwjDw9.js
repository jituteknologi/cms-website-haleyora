...
const files = ["./dist", "strapi-server.js", "index.js", "index.d.ts"];
const scripts = {
  build: "pack-up build",
  clean: "run -T rimraf ./dist",
  lint: "run -T eslint .",
  "test:front":
    "run -T cross-env IS_EE=true jest --config ./jest.config.front.js",
  "test:front:watch":
    "run -T cross-env IS_EE=true jest --config ./jest.config.front.js --watchAll",
  "test:ts": "run -T tsc -p tsconfig.json",
  "test:ts:back": "run -T tsc --noEmit -p server/tsconfig.json",
  "test:ts:front":
    "run -T tsc -p admin/tsconfig.json && run -T tsc -p ee/admin/tsconfig.json",
...
const devDependencies = {
  "@strapi/admin-test-utils": "4.25.10",
...
const VerticalDivider = ({ state, ...props }) =>
  /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
    ...
    minHeight:
      state === STATES.IS_ACTIVE
        ? helperPlugin.pxToRem(85)
        : helperPlugin.pxToRem(65),
    ...props,
  });
const GuidedTourModal = () => {
  ...
  const hasStepAfter =
    stepIndex < Object.keys(guidedTourState[sectionName]).length - 1;
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(GuidedTourStepper, {
                title:
                  stepData && "title" in stepData ? stepData.title : void 0,
                ...
                children:
                  stepData &&
                  "content" in stepData &&
                  /* @__PURE__ */ jsxRuntime.jsx(GuidedTourContent, {
                    ...stepData.content,
                  }),
              }),
            }),
          ...
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
            ...
            children:
              ...
              /* @__PURE__ */ jsxRuntime.jsx(VerticalDivider, {
                state: STATES.IS_DONE,
                minHeight: helperPlugin.pxToRem(24),
              }),
          }),
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Typography, {
            variant: "sigma",
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
            marginRight: 8,
            minWidth: helperPlugin.pxToRem(30),
            children: /* @__PURE__ */ jsxRuntime.jsx(Number, {
            ...
            children:
              ...
              /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, {
                children: [
                  ...
                  hasStepsBefore &&
                    /* @__PURE__ */ jsxRuntime.jsx(Number, {
                      state: STATES.IS_ACTIVE,
                      paddingTop: 3,
      ...
      hasStepsBefore &&
        ...
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Box, {
          ...
          children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
            ...
            justifyContent: "center",
            width: helperPlugin.pxToRem(30),
            children: /* @__PURE__ */ jsxRuntime.jsx(VerticalDivider, {
              state: STATES.IS_DONE,
              minHeight: helperPlugin.pxToRem(24),
            }),
          }),
...
const ListItem = (children) =>
  /* @__PURE__ */ jsxRuntime.jsx(LiStyled, { children });
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  const [userLinksVisible, setUserLinksVisible] =
    React__namespace.useState(false);
  const {
    logos: { menu },
  } = index.useConfiguration("LeftMenu");
  const [condensed, setCondensed] = helperPlugin.usePersistentState(
    "navbar-condensed",
    false
  );
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(v2.MainNav, {
    condensed,
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(v2.NavBrand, {
        as: reactRouterDom.NavLink,
        to: "/content-manager",
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(v2.NavSections, {
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(v2.NavLink, {
            as: reactRouterDom.NavLink,
            to: "/content-manager",
          ...
          pluginsSectionLinks.length > 0
            ? /* @__PURE__ */ jsxRuntime.jsx(v2.NavSection, {
                label: formatMessage({
                ...
                children: pluginsSectionLinks.map((link) => {
                  ...
                  return /* @__PURE__ */ jsxRuntime.jsx(
                    NavLinkWrapper,
                    {
                      children: /* @__PURE__ */ jsxRuntime.jsx(v2.NavLink, {
                        as: reactRouterDom.NavLink,
                        to: link.to,
                        ...
                        badgeContent:
                          ...
                          link?.lockIcon
                            ? /* @__PURE__ */ jsxRuntime.jsx(BadgeIcon, {
                                width: `${15 / 16}rem`,
                                height: `${15 / 16}rem`,
                                as: Icons.Lightning,
                              })
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(v2.NavFooter, {
        children: [
          /* @__PURE__ */ jsxRuntime.jsx(v2.NavUser, {
          ...
          userLinksVisible &&
            /* @__PURE__ */ jsxRuntime.jsx(LinkUserWrapper, {
              onBlur: handleBlur,
              padding: 1,
              shadow: "tableShadow",
              background: "neutral0",
              ...
              children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.FocusTrap, {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  ...
                  gap: 0,
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(LinkUser, {
                      tabIndex: 0,
                      onClick: handleToggleUserLinks,
                      to: "/me",
                      children: /* @__PURE__ */ jsxRuntime.jsx(
                    ...
                    /* @__PURE__ */ jsxRuntime.jsxs(LinkUser, {
                      tabIndex: 0,
                      onClick: logout,
                      to: "/auth/login",
                      children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(v2.NavCondense, {
...
const Onboarding = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Box, {
    ...
    right: 2,
    children: [
      /* @__PURE__ */ jsxRuntime.jsx(HelperButton, {
        "aria-label": formatMessage(
          isOpen
            ? {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(designSystem.Icon, {
          as: isOpen ? Icons.Cross : Icons.Question,
          color: "buttonNeutral0",
        }),
      }),
      isOpen &&
        /* @__PURE__ */ jsxRuntime.jsx(designSystem.Portal, {
            ...
            designSystem.PopoverPrimitives.Content,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  ...
                  paddingTop: 6,
                  children: [
                    /* @__PURE__ */ jsxRuntime.jsx(TypographyLineHeight, {
                      fontWeight: "bold",
                      children: formatMessage({
                    ...
                    /* @__PURE__ */ jsxRuntime.jsx(TextLink, {
                      as: "a",
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Divider, {}),
                VIDEO_LINKS.map(({ href, duration, label }, index2) =>
                ...
                /* @__PURE__ */ jsxRuntime.jsx(designSystem.Flex, {
                  ...
                  paddingTop: 2,
                  paddingBottom: 5,
                  children: docLinks.map(({ label, href, icon }) =>
                    /* @__PURE__ */ jsxRuntime.jsxs(
                      designSystem.Flex,
                      {
                        gap: 3,
...
const selectAdminPermissions = index.createTypedSelector(
  (state) => state.admin_app.permissions
);
const useMenu = () => {
  ...
  const [menuWithUserPermissions, setMenuWithUserPermissions] =
  ...
  const generalSectionLinksRef = React__namespace.useRef(
    menuWithUserPermissions.generalSectionLinks
  );
...
const getGeneralLinks = async (
  ...
  const generalSectionLinksPermissions = await Promise.all(
    generalSectionRawLinks.map(({ permissions }) =>
      helperPlugin.hasPermissions(userPermissions, permissions)
    )
  );
  ...
  const authorizedGeneralLinksClone = cloneDeep__default.default(
...
const getPluginSectionLinks = async (
  ...
  const pluginSectionLinksPermissions = await Promise.all(
    pluginsSectionRawLinks.map(({ permissions }) =>
      helperPlugin.hasPermissions(userPermissions, permissions)
    )
  );
...
const CM = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./index-VyjiJi0S.js"))
    .then((n) => n.App)
    .then((mod) => ({ default: mod.App }))
);
const HomePage = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./HomePage-8_8QD2eN.js"))
    .then((mod) => ({
...
const InstalledPluginsPage = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./InstalledPluginsPage-RK949zqM.js"))
    .then((mod) => ({
...
const MarketplacePage = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./MarketplacePage-ycBwltCT.js"))
    .then((mod) => ({ default: mod.ProtectedMarketplacePage }))
);
const NotFoundPage = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./index-VyjiJi0S.js"))
    .then((n) => n.NotFoundPage)
    .then(({ NotFoundPage: NotFoundPage2 }) => ({ default: NotFoundPage2 }))
);
const InternalErrorPage = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./InternalErrorPage-MkOX2w_Q.js"))
    .then(({ InternalErrorPage: InternalErrorPage2 }) => ({
      default: InternalErrorPage2,
    }))
);
const ProfilePage = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./ProfilePage-m9T_jYzt.js"))
    .then((mod) => ({
...
const SettingsPage = React__namespace.lazy(() =>
  Promise.resolve()
    .then(() => require("./SettingsPage-r7M2dq3I.js"))
    .then((mod) => ({
...
const Admin = () => {
  ...
  const routes = React__namespace.useMemo(() => {
    return menu
      ...
      .map(({ to, Component, exact }) =>
        index.createRoute(Component, to, exact)
      );
  }, [menu]);
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntime.jsx(
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(reactDnd.DndProvider, {
    ...
    children: /* @__PURE__ */ jsxRuntime.jsxs(AppLayout, {
      sideNav: /* @__PURE__ */ jsxRuntime.jsx(LeftMenu, {
        generalSectionLinks,
        pluginsSectionLinks,
      }),
      children: [
        /* @__PURE__ */ jsxRuntime.jsx(React__namespace.Suspense, {
    ...
    switch (action.type) {
      case "SET_PLUGIN_READY": {
        set__default.default(
          draftState,
          ["plugins", action.pluginId, "isReady"],
          true
        );
        break;
      }
...
const AuthenticatedApp = () => {
  ...
  const { showReleaseNotification } =
    index.useConfiguration("AuthenticatedApp");
  const { data: appInfo, isLoading: isLoadingAppInfo } =
    index.useInformationQuery();
  const {
    data: permissions,
  ...
  React__namespace.useEffect(() => {
    if (userRoles) {
      const isUserSuperAdmin = userRoles.find(
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.AppInfoProvider, {
    ...appInfo,
    userId,
    ...
    userDisplayName,
    children: /* @__PURE__ */ jsxRuntime.jsxs(index.RBACProvider, {
...
const checkLatestStrapiVersion = (
  ...
  if (
    !valid__default.default(currentPackageVersion) ||
    !valid__default.default(latestPublishedVersion)
  ) {
    return false;
  }
  return lt__default.default(currentPackageVersion, latestPublishedVersion);
};
const AuthenticatedApp$1 = /* @__PURE__ */ Object.freeze(
...
//# sourceMappingURL=AuthenticatedApp-d4HwjDw9.js.map
