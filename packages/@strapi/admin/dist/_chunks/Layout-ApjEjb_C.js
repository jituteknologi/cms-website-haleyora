...
const DragLayerRendered = () => {
  return /* @__PURE__ */ jsxRuntime.jsx(index.DragLayer, {
    renderItem: (item) => {
      if (item.type === constants.DRAG_DROP_TYPES.STAGE) {
        return /* @__PURE__ */ jsxRuntime.jsx(StageDragPreview, {
...
const Back = ({ href }) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(helperPlugin.Link, {
...
exports.Root = Root;
//# sourceMappingURL=Layout-ApjEjb_C.js.map
