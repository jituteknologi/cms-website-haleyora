...
import { u as useWebhooks } from "./useWebhooks-ukVCvQKw.mjs";
...
const EventsRoot = ({ children }) => {
  ...
  return /* @__PURE__ */ jsx(WebhookEventProvider, {
    isDraftAndPublish,
  ...
  return /* @__PURE__ */ jsxs(RawTr, {
    children: [
      ...
      events.length < targetColumns &&
        /* @__PURE__ */ jsx(RawTd, { colSpan: targetColumns - events.length }),
    ],
  });
};
...
const HeaderCombobox = ({ name, onChange, value, ...restProps }) => {
  ...
  return /* @__PURE__ */ jsx(CreatableCombobox, {
    ...restProps,
    ...
    children: options.map((key) =>
      /* @__PURE__ */ jsx(ComboboxOption, { value: key, children: key }, key)
    ),
  });
};
const HTTP_HEADERS = [
  ...
  return /* @__PURE__ */ jsx(Box, {
    ...
    children: /* @__PURE__ */ jsxs(Grid, {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx(GridItem, {
          col: 3,
          children: /* @__PURE__ */ jsx(Status, { isPending, statusCode }),
        }),
        /* @__PURE__ */ jsx(GridItem, {
          col: 6,
          children: !isPending
            ? /* @__PURE__ */ jsx(Message, { statusCode, message })
            : /* @__PURE__ */ jsx(Flex, {
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-sSfq6Y3w.mjs")).EventsTableEE
  );
  ...
  return /* @__PURE__ */ jsx(FormikProvider, {
    value: formik,
...
//# sourceMappingURL=EditPage-_4I8Oa-k.mjs.map
