...
const schema = yup__namespace.object().shape({
  autoRegister: yup__namespace
    .bool()
    .required(helperPlugin.translatedErrors.required),
  defaultRole: yup__namespace
    .mixed()
    .when("autoRegister", (value, initSchema) => {
      return value
        ? initSchema.required(helperPlugin.translatedErrors.required)
        : initSchema.nullable();
    }),
  ssoLockedRoles: yup__namespace
    .array()
    .nullable()
    .of(
...
const SingleSignOnPage = () => {
  ...
  const { isLoading: isLoadingProviderOptions, data } =
    index.useGetProviderOptionsQuery();
  const [updateProviderOptions, { isLoading: isSubmittingForm }] =
    index.useUpdateProviderOptionsMutation();
  const {
  ...
  const { roles, isLoading: isLoadingRoles } = useAdminRoles.useAdminRoles(
    void 0,
    {
      skip: !canReadRoles,
    }
  ...
  const isLoadingData =
    isLoadingRoles || isLoadingPermissions || isLoadingProviderOptions;
      ...
      /* @__PURE__ */ jsxRuntime.jsx(designSystem.Main, {
        ...
        children: /* @__PURE__ */ jsxRuntime.jsx(formik.Formik, {
          ...
          children: ({
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(helperPlugin.Form, {
              children: [
...
const ProtectedSSO = () => {
  const permissions = index.useTypedSelector(
    (state) => state.admin_app.permissions.settings?.sso?.main
  );
...
//# sourceMappingURL=SingleSignOnPage-NyiQL_wU.js.map
