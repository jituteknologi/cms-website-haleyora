...
const REVIEW_WORKFLOW_COLUMNS_EE = [
  {
    ...
    metadatas: {
      ...
      label: {
        id: getTranslation(
          `containers.ListPage.table-headers.reviewWorkflows.stage`
        ),
  ...
  },
  {
    ...
    metadatas: {
      label: {
        id: getTranslation(
          `containers.ListPage.table-headers.reviewWorkflows.assignee`
        ),
...
const REVIEW_WORKFLOW_FILTERS = [
  ...
  },
  {
    ...
    metadatas: {
      ...
      label: {
        id: getTranslation(
          `containers.ListPage.table-headers.reviewWorkflows.assignee.label`
        ),
        defaultMessage: "Assignee",
      },
    },
...
//# sourceMappingURL=constants-jro5nuh2.mjs.map
