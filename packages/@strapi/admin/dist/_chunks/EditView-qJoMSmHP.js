...
const transferTokens = require("./transferTokens-GuF0F-xw.js");
    ...
    if (isPermissionsTransferPermission(permissions2)) {
      try {
        if (isCreating) {
          ...
          history.push(`/settings/transfer-tokens/${res.data.id}`, {
                ...
                children: /* @__PURE__ */ jsxRuntime.jsxs(designSystem.Flex, {
                  ...
                  children: [
                    transferToken &&
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx(TokenTypeSelect.TokenBox, {
...
//# sourceMappingURL=EditView-qJoMSmHP.js.map
