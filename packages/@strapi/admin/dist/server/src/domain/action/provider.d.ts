...
declare const createActionProvider: (options?: Options) => {
  ...
  register(
    actionAttributes: CreateActionPayload
  ): Promise<import("@strapi/utils/dist/provider-factory").Provider<Action>>;
  ...
  size(): number;
  clear(): Promise<
    import("@strapi/utils/dist/provider-factory").Provider<Action>
  >;
};
