...
export declare const sanitizedPermissionFields: readonly [
  "id",
  "action",
  "actionParameters",
  "subject",
...
export declare const sanitizePermissionFields: (
  p: Permission
) => SanitizedPermission;
/**
 ...
 * @return
 */
export declare const addCondition: import("lodash").CurriedFunction2<
  string,
  Permission,
  Permission
>;
 ...
 */
export declare const removeCondition: import("lodash").CurriedFunction2<
  string,
  Permission,
  Permission
>;
 ...
 */
export declare const getProperty: import("lodash").CurriedFunction2<
  string,
  Permission,
  Permission
>;
 ...
 */
export declare const deleteProperty: <TProperty extends string>(
  property: TProperty,
  permission: Permission
) => Omit<Permission, TProperty>;
/**
 * Creates a new {@link Permission} object from raw attributes. Set default values for certain fields
 * @param  attributes
 */
export declare const create: (
  attributes: CreatePermissionPayload
) => Permission;
/**
 ...
 */
export declare const sanitizeConditions: import("lodash").CurriedFunction2<
  import("@strapi/utils/dist/provider-factory").Provider<unknown>,
  Permission,
  Permission
>;
/**
 ...
 */
export declare const toPermission: <T extends object | object[]>(
  payload: T
) => T extends object[] ? Permission[] : Permission;
declare const _default: {
  addCondition: import("lodash").CurriedFunction2<
    string,
    Permission,
    Permission
  >;
  removeCondition: import("lodash").CurriedFunction2<
    string,
    Permission,
    Permission
  >;
  create: (attributes: CreatePermissionPayload) => Permission;
  deleteProperty: <TProperty extends string>(
    property: TProperty,
    permission: Permission
  ) => Omit<Permission, TProperty>;
  permissionFields: string[];
  getProperty: import("lodash").CurriedFunction2<
    string,
    Permission,
    Permission
  >;
  sanitizedPermissionFields: readonly [
    "id",
    "action",
    "actionParameters",
    "subject",
  ...
  sanitizeConditions: import("lodash").CurriedFunction2<
    import("@strapi/utils/dist/provider-factory").Provider<unknown>,
    Permission,
    Permission
  >;
  ...
  toPermission: <T extends object | object[]>(
    payload: T
  ) => T extends object[] ? Permission[] : Permission;
};
