 ...
 * @return {string[]}
 */
export declare const conditionFields: readonly [
  "id",
  "displayName",
  "handler",
  "plugin",
...
export declare const computeConditionId: (
  condition: CreateConditionPayload
) => string;
/**
 * Assign an id attribute to a {@link CreateConditionPayload} object
 * @param  attrs - Payload used to create a condition
 */
export declare const assignConditionId: (
  attrs: CreateConditionPayload
) => Condition;
/**
