 ...
 */
declare const getNestedFieldsWithIntermediate: (
  model: Schema.ContentType,
  { prefix, nestingLevel, components }: FieldOptions
) => string[];
/**
 * Creates an array of permissions with the "properties.fields" attribute filled
 */
declare const getPermissionsWithNestedFields: (
  actions: any[],
 ...
 */
declare const cleanPermissionFields: (
