...
declare const _default: {
  auth: {
    checkCredentials: ({
      ...
      | (import("../../../shared/contracts/shared").AdminUser | null)[]
      | (
          | boolean
          | {
              message: string;
  ...
  user: {
    ...
    updateById: (
      ...
      attributes: Partial<
        import("../../../shared/contracts/shared").AdminUserUpdatePayload
      >
    ) => Promise<import("../../../shared/contracts/shared").AdminUser>;
    ...
    ) => import("../../../shared/contracts/shared").SanitizedAdminUser;
    findOne: (
      id: import("@strapi/types/dist/types/core/entity").ID,
      populate?: string[]
    ) => Promise<
    ...
    deleteById: (
      id: import("@strapi/types/dist/types/core/entity").ID
    ) => Promise<import("../../../shared/contracts/shared").AdminUser | null>;
    deleteByIds: (
      ids: (string | number)[]
    ) => Promise<import("../../../shared/contracts/shared").AdminUser[]>;
    ...
    assignARoleToAll: (
      roleId: import("@strapi/types/dist/types/core/entity").ID
    ) => Promise<void>;
  ...
  role: {
    hooks: {
      willResetSuperAdminPermissions: {
        ...
        register(
          handler: import("@strapi/utils/dist/hooks").Handler
        ): import("@strapi/utils/dist/hooks").Hook<
          import("@strapi/utils/dist/hooks").Handler
        >;
        delete(
          handler: import("@strapi/utils/dist/hooks").Handler
        ): import("@strapi/utils/dist/hooks").Hook<
    ...
    sanitizeRole: <T extends object>(
      obj: T
    ) => Omit<T, "users" | "permissions">;
    create: (
      attributes: Partial<import("../../../shared/contracts/shared").AdminRole>
    ) => Promise<import("../../../shared/contracts/shared").AdminRole>;
    findOne: (
      params?: {},
      populate?: unknown
    ) => Promise<import("../../../shared/contracts/shared").AdminRole>;
    findOneWithUsersCount: (
      params?: {},
      populate?: unknown
    ) => Promise<import("./role").AdminRoleWithUsersCount>;
    find: (
      params: {} | undefined,
      populate: unknown
    ) => Promise<import("../../../shared/contracts/shared").AdminRole[]>;
    ...
    deleteByIds: (
      ids?: import("@strapi/types/dist/types/core/entity").ID[]
    ) => Promise<import("../../../shared/contracts/shared").AdminRole[]>;
    getUsersCount: (
      roleId: import("@strapi/types/dist/types/core/entity").ID
    ) => Promise<number>;
    getSuperAdmin: () => Promise<
      import("../../../shared/contracts/shared").AdminRole | undefined
    >;
    getSuperAdminWithUsersCount: () => Promise<
      import("./role").AdminRoleWithUsersCount
    >;
    ...
    addPermissions: (
      roleId: import("@strapi/types/dist/types/core/entity").ID,
      permissions: any
    ) => Promise<import("../../../shared/contracts/shared").Permission[]>;
    hasSuperAdminRole: (
      user: import("../../../shared/contracts/shared").AdminUser
    ) => boolean;
    assignPermissions: (
  ...
  metrics: {
    ...
    sendUpdateProjectInformation: () => Promise<void>;
    startCron: (strapi: import("@strapi/types").Strapi) => void;
  };
