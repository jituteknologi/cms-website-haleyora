...
declare const actionProvider: {
  ...
  register(
    actionAttributes: import("../domain/action").CreateActionPayload
  ): Promise<
    import("@strapi/utils/dist/provider-factory").Provider<
      import("../domain/action").Action
    >
  >;
  registerMany(
    actionsAttributes: import("../domain/action").CreateActionPayload[]
  ): Promise<any>;
  appliesToProperty(
    property: string,
    actionId: string,
...
declare const conditionProvider: {
  register(
    conditionAttributes: import("../domain/condition").CreateConditionPayload
  ): Promise<
    import("@strapi/utils/dist/provider-factory").Provider<{
      [x: string]: unknown;
    }>
  >;
  registerMany(
    conditionsAttributes: import("../domain/condition").CreateConditionPayload[]
  ): Promise<any>;
...
declare const sectionsBuilder: {
  createSection(
    sectionName: string,
    options: import("./permission/sections-builder/section").SectionOptions
  ): any;
...
declare const sanitizePermission: (
  p: import("../../../shared/contracts/shared").Permission
) => import("../../../shared/contracts/roles").SanitizedPermission;
declare const engine: {
  ...
  generateUserAbility(
    ...
    import("@casl/ability").Ability<import("@casl/ability").AbilityTuple, any>
  >;
  checkMany: import("lodash").CurriedFunction2<
    import("@casl/ability").Ability<import("@casl/ability").AbilityTuple, any>,
