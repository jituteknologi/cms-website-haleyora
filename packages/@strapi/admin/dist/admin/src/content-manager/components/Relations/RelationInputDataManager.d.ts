...
declare const RelationInputDataManager: ({
  componentUid,
  name,
  error,
  editable,
  ...
  mainField,
  placeholder,
  queryInfos: { defaultParams, shouldDisplayRelationLink },
  required,
  relationType,
  size,
  targetModel,
}: RelationInputDataManagerProps) => import("react/jsx-runtime").JSX.Element;
