...
export declare const normalizeSearchResults: (
  relations: UseInfiniteQueryResult<
    Contracts.Relations.FindAvailable.Response | null,
    unknown
  >,
  ...
  | {
      ...
      fetchNextPage: (
        ...
        import("react-query").InfiniteQueryObserverResult<
          Contracts.Relations.FindAvailable.Response | null,
          unknown
        >
      >;
      fetchPreviousPage: (
        options?: import("react-query").FetchPreviousPageOptions | undefined
      ) => Promise<
        import("react-query").InfiniteQueryObserverResult<
          Contracts.Relations.FindAvailable.Response | null,
          unknown
      ...
      refetch: <TPageData>(
        ...
        import("react-query").QueryObserverResult<
          import("react-query").InfiniteData<Contracts.Relations.FindAvailable.Response | null>,
          unknown
        >
      >;
      remove: () => void;
