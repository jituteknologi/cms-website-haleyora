...
interface RenderChildProps {
  ...
  onDraftRelationCheck: () => Promise<
    Contracts.SingleTypes.CountDraftRelations.Response["data"]
  >;
...
declare const ContentTypeFormWrapper: ({
  children,
  slug,
  id,
  origin,
  collectionType,
}: ContentTypeFormWrapperProps) => React.JSX.Element;
