...
interface RelationInputProps
  extends Pick<
    ...
    Pick<
      RelationItemProps,
      "onCancel" | "onDropItem" | "onGrabItem" | "iconButtonAriaLabel"
    > {
  canReorder: boolean;
...
declare const RelationInput: ({
  ...
  searchResults,
  size,
}: RelationInputProps) => import("react/jsx-runtime").JSX.Element;
declare const DisconnectButton: import("styled-components").StyledComponent<
  "button",
  import("styled-components").DefaultTheme,
  {},
  never
>;
declare const LinkEllipsis: import("styled-components").StyledComponent<
  React.ForwardRefExoticComponent<
    import("@strapi/design-system/Link/Link.js").LinkProps &
...
declare const FlexWrapper: import("styled-components").StyledComponent<
  "div",
  import("styled-components").DefaultTheme,
  FlexProps<"div">,
  never
>;
declare const ChildrenWrapper: import("styled-components").StyledComponent<
  "div",
  import("styled-components").DefaultTheme,
  FlexProps<"div">,
  never
