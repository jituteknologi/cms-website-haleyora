...
declare const ListViewLayoutManager: ({
  layout,
  ...props
}: ListViewLayoutManagerProps) =>
...
declare const ON_CHANGE_LIST_HEADERS =
  "ContentManager/ListView/ON_CHANGE_LIST_HEADERS ";
declare const ON_RESET_LIST_HEADERS =
  "ContentManager/ListView/ON_RESET_LIST_HEADERS ";
...
interface GetDataSucceededAction
  extends Pick<ListViewLayoutManagerState, "data" | "pagination"> {
  type: typeof GET_DATA_SUCCEEDED;
}
declare const getDataSucceeded: (
...
declare const onChangeListHeaders: (
  target: OnChangeListHeadersAction["target"]
) => {
...
declare const reducer: (
  state: ListViewLayoutManagerState | undefined,
  action: Action
) => ListViewLayoutManagerState;
export {
