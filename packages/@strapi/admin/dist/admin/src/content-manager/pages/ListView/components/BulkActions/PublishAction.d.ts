...
interface SelectedEntriesTableContentProps {
  ...
  validationErrors: Record<
    string,
    EntryValidationTextProps["validationErrors"]
  >;
}
...
declare const SelectedEntriesModalContent: ({
  toggleModal,
  refetchModalData,
  onSuccessfulPublish,
  validationErrors,
}: SelectedEntriesModalContentProps) => import("react/jsx-runtime").JSX.Element;
