...
declare const selectSchemas: ((state: {
  readonly adminApi: import("@reduxjs/toolkit/query").CombinedState<
    {
      regenerateToken: import("@reduxjs/toolkit/query").MutationDefinition<
        string,
        ...
        | "User"
        | "Webhook",
        import("../../../../shared/contracts/transfer").TransferToken,
        "adminApi"
      >;
    },
    | "ApiToken"
  ...
  import("reselect").OutputSelectorFields<
    (
      args_0: ContentManagerAppState
    ) => (
      | Contracts.Components.Component
      | Contracts.ContentTypes.ContentType
    )[],
    {
      clearCache: () => void;
    }
...
declare const reducer: (
  state: ContentManagerAppState | undefined,
  action: Action
