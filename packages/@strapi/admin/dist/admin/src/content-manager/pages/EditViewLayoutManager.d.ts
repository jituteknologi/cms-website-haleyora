...
declare const EditViewLayoutManager: ({
  layout,
  ...rest
}: EditViewLayoutManagerProps) => import("react/jsx-runtime").JSX.Element;
...
declare const reducer: (
  state: EditViewLayoutManagerState | undefined,
  action: Action
) => EditViewLayoutManagerState;
