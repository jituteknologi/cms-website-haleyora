...
declare const ListViewPage: ({
  ...
  layout,
  slug,
}: ListViewPageProps) => import("react/jsx-runtime").JSX.Element | null;
interface ProtectedListViewPageProps extends ListViewPageProps {
  permissions?: Permission[] | null;
}
declare const ProtectedListViewPage: ({
  permissions,
  ...restProps
}: ProtectedListViewPageProps) => import("react/jsx-runtime").JSX.Element;
