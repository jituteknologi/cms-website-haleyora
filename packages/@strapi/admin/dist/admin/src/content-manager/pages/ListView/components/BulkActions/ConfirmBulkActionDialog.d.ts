...
interface ConfirmBulkActionDialogProps
  extends Pick<DialogFooterProps, "endAction"> {
  onToggleDialog: () => void;
  isOpen?: boolean;
  dialogBody: React.ReactNode;
}
declare const ConfirmBulkActionDialog: ({
  onToggleDialog,
  isOpen,
  dialogBody,
  endAction,
}: ConfirmBulkActionDialogProps) => import("react/jsx-runtime").JSX.Element;
interface ConfirmDialogPublishAllProps
  extends Pick<ConfirmBulkActionDialogProps, "isOpen" | "onToggleDialog"> {
  isConfirmButtonLoading?: boolean;
  onConfirm: () => void;
}
declare const ConfirmDialogPublishAll: ({
  isOpen,
  onToggleDialog,
