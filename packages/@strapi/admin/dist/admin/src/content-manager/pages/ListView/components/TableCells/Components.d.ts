...
declare const SingleComponent: ({
  content,
  metadatas,
}: SingleComponentProps) => import("react/jsx-runtime").JSX.Element | null;
...
declare const RepeatableComponent: ({
  content,
  metadatas,
}: RepeatableComponentProps) => import("react/jsx-runtime").JSX.Element | null;
