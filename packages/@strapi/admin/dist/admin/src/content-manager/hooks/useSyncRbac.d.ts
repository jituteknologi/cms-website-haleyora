...
interface SyncRbacState {
  permissions:
    | RBACState["collectionTypesRelatedPermissions"][string][string]
    | null;
}
declare const SET_PERMISSIONS = "ContentManager/RBACManager/SET_PERMISSIONS";
declare const RESET_PERMISSIONS =
  "ContentManager/RBACManager/RESET_PERMISSIONS";
