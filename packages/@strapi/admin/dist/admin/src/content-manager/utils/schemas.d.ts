...
type ModifiedLayoutData<TKey> = TKey extends "component"
  ? Omit<ComponentsWithSchemas<ComponentLayoutData>, TKey> & {
      [K in TKey]: Contracts.Components.ComponentConfiguration &
        Contracts.Components.Component;
    }
  : TKey extends "contentType"
  ? Omit<ComponentsWithSchemas<ContentTypeLayoutData>, TKey> & {
      [K in TKey]: Contracts.ContentTypes.Configuration &
 ...
 */
declare const mergeMetasWithSchema: <TKey extends "component" | "contentType">(
