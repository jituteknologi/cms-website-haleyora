...
type Models = Array<
  Contracts.Components.Component | Contracts.ContentTypes.ContentType
>;
type FormattedContentTypeLayout = Omit<
  SchemasWithMeta["contentType"],
  "layouts"
> & {
  layouts: {
    edit: EditLayoutRow[][];
...
type FormattedComponentLayout = Omit<
  SchemasWithMeta["components"][string],
  "layouts"
> & {
  layouts: {
    list: string[];
...
interface SchemasWithMeta {
  contentType: Omit<
    ModifiedLayoutData<"contentType">["contentType"],
    "metadatas"
  > & {
  ...
  components: Record<
    string,
    Omit<
      ModifiedLayoutData<"contentType">["components"][string],
      "metadatas"
    > & {
      metadatas: Record<string, Metadata>;
    }
...
declare const formatLayoutForSettingsView: <
  TLayout extends FormattedComponentLayout | FormattedContentTypeLayout
>({
  layouts,
  metadatas,
  ...rest
