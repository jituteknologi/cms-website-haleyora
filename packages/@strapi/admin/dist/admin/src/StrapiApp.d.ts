...
interface StrapiAppConstructorArgs
  extends Partial<Pick<StrapiApp, "appPlugins">> {
  adminConfig?: {
...
interface StrapiAppPlugin {
  ...
  registerTrads: (args: { locales: string[] }) => Promise<
    {
...
declare class StrapiApp {
  ...
  injectContentManagerComponent: <
    TContainerName extends "listView" | "editView"
  >(
  ...
  injectAdminComponent: <TContainerName extends "tutorials">(
    containerName: TContainerName,
    blockName: keyof {
      tutorials: {
