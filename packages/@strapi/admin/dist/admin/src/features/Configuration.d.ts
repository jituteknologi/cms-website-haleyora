...
interface UpdateProjectSettingsBody {
  authLogo:
    | ((
        | UpdateProjectSettings.Request["body"]["authLogo"]
        | ConfigurationLogo["custom"]
      ) & {
        rawFile?: File;
      })
    | null;
  menuLogo:
    | ((
        | UpdateProjectSettings.Request["body"]["menuLogo"]
        | ConfigurationLogo["custom"]
      ) & {
        rawFile?: File;
      })
...
declare const ConfigurationProvider: ({
  children,
  authLogo: defaultAuthLogo,
  menuLogo: defaultMenuLogo,
  showReleaseNotification,
  showTutorials,
}: ConfigurationProviderProps) => import("react/jsx-runtime").JSX.Element;
export {
