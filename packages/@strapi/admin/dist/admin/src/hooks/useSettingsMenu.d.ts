...
interface SettingsMenuLinkWithPermissionsAndDisplayed
  extends SettingsMenuLinkWithPermissions {
  isDisplayed: boolean;
}
interface StrapiAppSettingLinkWithDisplayed extends StrapiAppSettingsLink {
  isDisplayed: boolean;
}
interface SettingsMenuSectionWithDisplayedLinks
  extends Omit<SettingsMenuSection, "links"> {
  links: Array<
    | SettingsMenuLinkWithPermissionsAndDisplayed
    | StrapiAppSettingLinkWithDisplayed
  >;
}
