...
declare const adminApi: import("@reduxjs/toolkit/query/react").Api<
  ...
  >,
  {
     ...
     */
    regenerateToken: import("@reduxjs/toolkit/query/react").MutationDefinition<
      string,
      import("@reduxjs/toolkit/query/react").BaseQueryFn<
        string | import("../utils/baseQuery").QueryArguments,
        unknown,
...
>;
declare const useRegenerateTokenMutation: import("@reduxjs/toolkit/dist/query/react/buildHooks").UseMutation<
