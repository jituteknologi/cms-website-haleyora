...
declare const RBACProvider: ({
  children,
  permissions,
  refetchPermissions,
}: RBACProviderProps) => import("react/jsx-runtime").JSX.Element;
interface RBACState {
  allPermissions: null | Permission[];
  collectionTypesRelatedPermissions: Record<
    string,
