...
interface PluginsAndSettingsPermissionsProps
  extends Pick<RowProps, "kind" | "isFormDisabled"> {
  layout: Layout;
}
declare const PluginsAndSettingsPermissions: ({
  layout,
  ...restProps
}: PluginsAndSettingsPermissionsProps) => import("react/jsx-runtime").JSX.Element;
interface RowProps extends Pick<Layout[number], "childrenForm"> {
  kind: Exclude<
    keyof PermissionsDataManagerContextValue["modifiedData"],
    `${string}Types`
  >;
  name: string;
