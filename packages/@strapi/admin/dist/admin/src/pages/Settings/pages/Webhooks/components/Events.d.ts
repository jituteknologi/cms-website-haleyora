...
declare const Events: {
  Root: ({
    children,
  }: EventsRootProps) => import("react/jsx-runtime").JSX.Element;
  Headers: ({
    getHeaders,
  }: EventsHeadersProps) => import("react/jsx-runtime").JSX.Element;
  Body: ({
    providedEvents,
  }: EventsBodyProps) => import("react/jsx-runtime").JSX.Element;
  Row: ({
    disabledEvents,
    name,
    events,
    ...
    handleSelect,
    handleSelectAll,
  }: EventsRowProps) => import("react/jsx-runtime").JSX.Element;
};
export { Events };
export type {
  EventsRowProps,
