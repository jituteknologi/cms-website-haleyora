...
interface ConditionsButtonProps
  extends Pick<ButtonProps, "className" | "onClick" | "variant"> {
 ...
 */
declare const ConditionsButton: import("styled-components").StyledComponent<
  ({
    onClick,
    className,
    hasConditions,
    variant,
  }: ConditionsButtonProps) => import("react/jsx-runtime").JSX.Element,
