 ...
 */
declare const createDefaultConditionsForm: (
...
declare const createDefaultForm: <
  TLayout extends Omit<SettingPermission, "category">
>(
  layout: GenericLayout<TLayout>[],
  conditions: Condition[],
  initialPermissions?: Permission[]
) => Record<string, Form>;
interface PropertyChildForm
  extends Record<string, boolean | PropertyChildForm> {}
 ...
 */
declare const createDefaultCTForm: (
