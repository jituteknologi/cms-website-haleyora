...
interface ApiTokenPermissionsContextProviderProps
  extends ApiTokenPermissionsContextValue {
  children: React.ReactNode | React.ReactNode[];
}
declare const ApiTokenPermissionsProvider: ({
  children,
  ...rest
}: ApiTokenPermissionsContextProviderProps) => import("react/jsx-runtime").JSX.Element;
