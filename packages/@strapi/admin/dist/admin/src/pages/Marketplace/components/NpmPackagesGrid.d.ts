...
interface NpmPackagesGridProps
  extends Pick<NpmPackageCardProps, "npmPackageType" | "useYarn"> {
...
declare const NpmPackagesGrid: ({
  ...
  strapiAppVersion,
  debouncedSearch,
}: NpmPackagesGridProps) => import("react/jsx-runtime").JSX.Element;
