    ...
    <Stack size={4} padding={4}>
      <Box padding={4} shadow="filterShadow" hasRadius background="neutral0">
        ...
        {source ? (
          ...
          <FormAction>
            <Button disabled={loading} variant="secondary" onClick={upload}>
      ...
      >
        <Typography variant="beta">
          Step 2: Choose target content type
        </Typography>
        <Select
        ...
        <FormAction>
          <Button disabled={loading} onClick={submit} variant="default">
