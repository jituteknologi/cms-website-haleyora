...
module.exports = {
  ...
  <html xmlns="http://www.w3.org/1999/xhtml">
    <head>
      ...
      <title>SELOG - Tender Invitation</title>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="padding-top: 63px">
                        <strong>Halo PIC Tender Invitation</strong>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding-top: 12px">
                        <span>Berikut undangan tender terbaru dari Customer dengan detail sebagai berikut :</span>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <table border="0" width="100%">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><strong><%= result.services %></strong></td>
                            </tr>
                            <tr>
                              <td>Kebutuhan</td>
                            ...
                            <tr>
                              <td>Lampiran</td>
                              <td><strong><a href="<%= result.attachment %>" target="_blank">Download</a></strong></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
                        ...
                        <table border="0" width="100%">
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td><strong><%= result.companyAddress %></strong></td>
                            </tr>
                            <tr>
                              <td>Divisi / Departemen</td>
                              <td><strong><%= result.department %></strong></td>
                            </tr>
                          </tbody>
                        </table>
                      </td>
  ...
  Halo PIC Tender Invitation

  Berikut undangan tender terbaru dari Customer dengan detail sebagai berikut :
  ...
  Divisi/Departmen  : <%= result.department %>
  Nama Perusahaan   : <%= result.companyName %>
  Alamat Perusahaan : <%= result.companyAddress %>
  Kota              : <%= result.city.name %>
  Layanan           : <%= result.services %>
  Kebutuhan         : <%= result.message %>
  Lampiran          : <%= result.attachment %>
                ...
                <table border="0" width="100%">
                  <tbody>
                    ...
                    <tr>
                      <td style="padding-top: 12px">
                        <span>
                          Terimakasih sudah menghubungi kami pada <%= result.createdAt %>. Secepatnya tim SELOG akan membantu menjawab undangan tender Anda
                          <br /><br />
