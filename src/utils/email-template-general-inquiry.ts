...
module.exports = {
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td style="padding-top: 63px">
                        <strong>Halo PIC General Inquiry</strong>
                      </td>
                    </tr>
                    <tr>
                      <td style="padding-top: 12px">
                        <span>Berikut kebutuhan terbaru dari Customer dengan detail sebagai berikut :</span>
                      </td>
                    </tr>
                    <tr>
  ...
  Halo PIC General Inquiry

  Berikut kebutuhan terbaru dari Customer dengan detail sebagai berikut :
      ...
      <center style="background-color: #f8fafc">
        <table border="0" width="640" style="font-family: 'Open Sans', sans-serif; border-spacing: 0; max-width: 640px;">
          <tbody>
            ...
            <tr>
              <td style="padding: 49px; line-height: 26px; padding-bottom: 75px; background-color: #fff;">
                <table border="0" width="100%">
                  <tbody>
                    <tr>
                      <td>
                    ...
                    <tr>
                      <td style="padding-top: 12px">
                        <span>
                          Terimakasih sudah menghubungi kami pada <%= result.createdAt %>. Secepatnya tim SELOG akan membantu menjawab kebutuhan Anda
                          <br /><br />
